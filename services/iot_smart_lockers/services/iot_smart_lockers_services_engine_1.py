...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_1
...
@dataclass
class IotSmartLockersServicesEntity1:
...
class IotSmartLockersServicesSchema1(BaseModel):
...
class IotSmartLockersServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersServicesProcessor1()
