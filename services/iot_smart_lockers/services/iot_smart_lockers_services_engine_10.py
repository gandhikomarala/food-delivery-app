...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_10
...
@dataclass
class IotSmartLockersServicesEntity10:
...
class IotSmartLockersServicesSchema10(BaseModel):
...
class IotSmartLockersServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersServicesProcessor10()
