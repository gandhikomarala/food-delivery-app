...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_6
...
@dataclass
class IotSmartLockersServicesEntity6:
...
class IotSmartLockersServicesSchema6(BaseModel):
...
class IotSmartLockersServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersServicesProcessor6()
