...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_20
...
@dataclass
class IotSmartLockersServicesEntity20:
...
class IotSmartLockersServicesSchema20(BaseModel):
...
class IotSmartLockersServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersServicesProcessor20()
