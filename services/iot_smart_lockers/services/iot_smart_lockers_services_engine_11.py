...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_11
...
@dataclass
class IotSmartLockersServicesEntity11:
...
class IotSmartLockersServicesSchema11(BaseModel):
...
class IotSmartLockersServicesProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersServicesProcessor11()
