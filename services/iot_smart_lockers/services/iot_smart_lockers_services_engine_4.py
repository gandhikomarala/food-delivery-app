...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_4
...
@dataclass
class IotSmartLockersServicesEntity4:
...
class IotSmartLockersServicesSchema4(BaseModel):
...
class IotSmartLockersServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersServicesProcessor4()
