...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_5
...
@dataclass
class IotSmartLockersServicesEntity5:
...
class IotSmartLockersServicesSchema5(BaseModel):
...
class IotSmartLockersServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersServicesProcessor5()
