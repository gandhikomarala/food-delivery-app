...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_3
...
@dataclass
class IotSmartLockersServicesEntity3:
...
class IotSmartLockersServicesSchema3(BaseModel):
...
class IotSmartLockersServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersServicesProcessor3()
