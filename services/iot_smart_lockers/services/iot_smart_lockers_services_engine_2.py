...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_2
...
@dataclass
class IotSmartLockersServicesEntity2:
...
class IotSmartLockersServicesSchema2(BaseModel):
...
class IotSmartLockersServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersServicesProcessor2()
