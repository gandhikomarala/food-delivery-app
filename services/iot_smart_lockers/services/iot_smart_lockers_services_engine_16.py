...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_16
...
@dataclass
class IotSmartLockersServicesEntity16:
...
class IotSmartLockersServicesSchema16(BaseModel):
...
class IotSmartLockersServicesProcessor16:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema16) -> Dict[str, Any]:
...
default_processor_16 = IotSmartLockersServicesProcessor16()
