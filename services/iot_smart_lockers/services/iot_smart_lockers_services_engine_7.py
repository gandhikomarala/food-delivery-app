...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_7
...
@dataclass
class IotSmartLockersServicesEntity7:
...
class IotSmartLockersServicesSchema7(BaseModel):
...
class IotSmartLockersServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersServicesProcessor7()
