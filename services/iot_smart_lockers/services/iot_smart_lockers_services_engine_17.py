...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_17
...
@dataclass
class IotSmartLockersServicesEntity17:
...
class IotSmartLockersServicesSchema17(BaseModel):
...
class IotSmartLockersServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersServicesProcessor17()
