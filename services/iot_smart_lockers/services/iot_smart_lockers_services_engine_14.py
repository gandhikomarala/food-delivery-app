...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_14
...
@dataclass
class IotSmartLockersServicesEntity14:
...
class IotSmartLockersServicesSchema14(BaseModel):
...
class IotSmartLockersServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersServicesProcessor14()
