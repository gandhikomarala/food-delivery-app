...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_12
...
@dataclass
class IotSmartLockersServicesEntity12:
...
class IotSmartLockersServicesSchema12(BaseModel):
...
class IotSmartLockersServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersServicesProcessor12()
