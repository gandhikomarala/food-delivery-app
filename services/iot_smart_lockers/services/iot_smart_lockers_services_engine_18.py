...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_18
...
@dataclass
class IotSmartLockersServicesEntity18:
...
class IotSmartLockersServicesSchema18(BaseModel):
...
class IotSmartLockersServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersServicesProcessor18()
