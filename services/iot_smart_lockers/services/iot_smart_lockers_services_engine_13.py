...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_13
...
@dataclass
class IotSmartLockersServicesEntity13:
...
class IotSmartLockersServicesSchema13(BaseModel):
...
class IotSmartLockersServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersServicesProcessor13()
