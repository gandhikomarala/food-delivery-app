...
Submodule: SERVICES | Component ID: IOT_SMART_LOCKERS_SERVICES_8
...
@dataclass
class IotSmartLockersServicesEntity8:
...
class IotSmartLockersServicesSchema8(BaseModel):
...
class IotSmartLockersServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersServicesProcessor8()
