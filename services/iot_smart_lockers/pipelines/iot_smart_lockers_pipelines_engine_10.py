...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_10
...
@dataclass
class IotSmartLockersPipelinesEntity10:
...
class IotSmartLockersPipelinesSchema10(BaseModel):
...
class IotSmartLockersPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersPipelinesProcessor10()
