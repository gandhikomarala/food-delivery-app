...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_15
...
@dataclass
class IotSmartLockersPipelinesEntity15:
...
class IotSmartLockersPipelinesSchema15(BaseModel):
...
class IotSmartLockersPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersPipelinesProcessor15()
