...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_3
...
@dataclass
class IotSmartLockersPipelinesEntity3:
...
class IotSmartLockersPipelinesSchema3(BaseModel):
...
class IotSmartLockersPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersPipelinesProcessor3()
