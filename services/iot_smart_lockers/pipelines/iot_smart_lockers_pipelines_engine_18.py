...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_18
...
@dataclass
class IotSmartLockersPipelinesEntity18:
...
class IotSmartLockersPipelinesSchema18(BaseModel):
...
class IotSmartLockersPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersPipelinesProcessor18()
