...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_20
...
@dataclass
class IotSmartLockersPipelinesEntity20:
...
class IotSmartLockersPipelinesSchema20(BaseModel):
...
class IotSmartLockersPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersPipelinesProcessor20()
