...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_13
...
@dataclass
class IotSmartLockersPipelinesEntity13:
...
class IotSmartLockersPipelinesSchema13(BaseModel):
...
class IotSmartLockersPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersPipelinesProcessor13()
