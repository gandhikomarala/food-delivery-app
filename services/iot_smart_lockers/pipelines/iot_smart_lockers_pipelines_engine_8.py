...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_8
...
@dataclass
class IotSmartLockersPipelinesEntity8:
...
class IotSmartLockersPipelinesSchema8(BaseModel):
...
class IotSmartLockersPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersPipelinesProcessor8()
