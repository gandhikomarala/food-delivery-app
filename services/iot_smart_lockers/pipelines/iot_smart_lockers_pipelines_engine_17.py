...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_17
...
@dataclass
class IotSmartLockersPipelinesEntity17:
...
class IotSmartLockersPipelinesSchema17(BaseModel):
...
class IotSmartLockersPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersPipelinesProcessor17()
