...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_4
...
@dataclass
class IotSmartLockersPipelinesEntity4:
...
class IotSmartLockersPipelinesSchema4(BaseModel):
...
class IotSmartLockersPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersPipelinesProcessor4()
