...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_1
...
@dataclass
class IotSmartLockersPipelinesEntity1:
...
class IotSmartLockersPipelinesSchema1(BaseModel):
...
class IotSmartLockersPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersPipelinesProcessor1()
