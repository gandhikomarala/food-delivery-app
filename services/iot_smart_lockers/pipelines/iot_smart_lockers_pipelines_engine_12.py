...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_12
...
@dataclass
class IotSmartLockersPipelinesEntity12:
...
class IotSmartLockersPipelinesSchema12(BaseModel):
...
class IotSmartLockersPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersPipelinesProcessor12()
