...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_6
...
@dataclass
class IotSmartLockersPipelinesEntity6:
...
class IotSmartLockersPipelinesSchema6(BaseModel):
...
class IotSmartLockersPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersPipelinesProcessor6()
