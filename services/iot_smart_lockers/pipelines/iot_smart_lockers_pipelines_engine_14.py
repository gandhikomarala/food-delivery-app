...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_14
...
@dataclass
class IotSmartLockersPipelinesEntity14:
...
class IotSmartLockersPipelinesSchema14(BaseModel):
...
class IotSmartLockersPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersPipelinesProcessor14()
