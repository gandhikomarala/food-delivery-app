...
Submodule: PIPELINES | Component ID: IOT_SMART_LOCKERS_PIPELINES_2
...
@dataclass
class IotSmartLockersPipelinesEntity2:
...
class IotSmartLockersPipelinesSchema2(BaseModel):
...
class IotSmartLockersPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersPipelinesProcessor2()
