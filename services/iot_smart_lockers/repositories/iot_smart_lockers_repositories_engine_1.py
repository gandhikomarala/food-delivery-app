...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_1
...
@dataclass
class IotSmartLockersRepositoriesEntity1:
...
class IotSmartLockersRepositoriesSchema1(BaseModel):
...
class IotSmartLockersRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersRepositoriesProcessor1()
