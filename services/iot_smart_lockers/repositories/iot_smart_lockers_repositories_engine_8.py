...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_8
...
@dataclass
class IotSmartLockersRepositoriesEntity8:
...
class IotSmartLockersRepositoriesSchema8(BaseModel):
...
class IotSmartLockersRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersRepositoriesProcessor8()
