...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_17
...
@dataclass
class IotSmartLockersRepositoriesEntity17:
...
class IotSmartLockersRepositoriesSchema17(BaseModel):
...
class IotSmartLockersRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersRepositoriesProcessor17()
