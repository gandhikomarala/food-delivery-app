...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_7
...
@dataclass
class IotSmartLockersRepositoriesEntity7:
...
class IotSmartLockersRepositoriesSchema7(BaseModel):
...
class IotSmartLockersRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersRepositoriesProcessor7()
