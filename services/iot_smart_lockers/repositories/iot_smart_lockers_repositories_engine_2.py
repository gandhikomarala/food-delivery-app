...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_2
...
@dataclass
class IotSmartLockersRepositoriesEntity2:
...
class IotSmartLockersRepositoriesSchema2(BaseModel):
...
class IotSmartLockersRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersRepositoriesProcessor2()
