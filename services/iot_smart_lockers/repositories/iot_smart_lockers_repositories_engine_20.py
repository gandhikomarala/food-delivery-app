...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_20
...
@dataclass
class IotSmartLockersRepositoriesEntity20:
...
class IotSmartLockersRepositoriesSchema20(BaseModel):
...
class IotSmartLockersRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersRepositoriesProcessor20()
