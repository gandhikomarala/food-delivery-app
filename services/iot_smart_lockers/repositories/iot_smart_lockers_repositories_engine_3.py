...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_3
...
@dataclass
class IotSmartLockersRepositoriesEntity3:
...
class IotSmartLockersRepositoriesSchema3(BaseModel):
...
class IotSmartLockersRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersRepositoriesProcessor3()
