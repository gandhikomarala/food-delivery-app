...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_13
...
@dataclass
class IotSmartLockersRepositoriesEntity13:
...
class IotSmartLockersRepositoriesSchema13(BaseModel):
...
class IotSmartLockersRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersRepositoriesProcessor13()
