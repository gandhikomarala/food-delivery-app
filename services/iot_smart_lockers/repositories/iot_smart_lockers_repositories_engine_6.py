...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_6
...
@dataclass
class IotSmartLockersRepositoriesEntity6:
...
class IotSmartLockersRepositoriesSchema6(BaseModel):
...
class IotSmartLockersRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersRepositoriesProcessor6()
