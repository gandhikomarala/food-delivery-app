...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_14
...
@dataclass
class IotSmartLockersRepositoriesEntity14:
...
class IotSmartLockersRepositoriesSchema14(BaseModel):
...
class IotSmartLockersRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersRepositoriesProcessor14()
