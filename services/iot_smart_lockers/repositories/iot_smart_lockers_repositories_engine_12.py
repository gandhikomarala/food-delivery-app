...
Submodule: REPOSITORIES | Component ID: IOT_SMART_LOCKERS_REPOSITORIES_12
...
@dataclass
class IotSmartLockersRepositoriesEntity12:
...
class IotSmartLockersRepositoriesSchema12(BaseModel):
...
class IotSmartLockersRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersRepositoriesProcessor12()
