...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_6
...
@dataclass
class IotSmartLockersEventsEntity6:
...
class IotSmartLockersEventsSchema6(BaseModel):
...
class IotSmartLockersEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersEventsProcessor6()
