...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_12
...
@dataclass
class IotSmartLockersEventsEntity12:
...
class IotSmartLockersEventsSchema12(BaseModel):
...
class IotSmartLockersEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersEventsProcessor12()
