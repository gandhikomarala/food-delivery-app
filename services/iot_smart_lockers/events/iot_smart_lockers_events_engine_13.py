...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_13
...
@dataclass
class IotSmartLockersEventsEntity13:
...
class IotSmartLockersEventsSchema13(BaseModel):
...
class IotSmartLockersEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersEventsProcessor13()
