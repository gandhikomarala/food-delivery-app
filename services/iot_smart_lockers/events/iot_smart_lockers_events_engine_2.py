...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_2
...
@dataclass
class IotSmartLockersEventsEntity2:
...
class IotSmartLockersEventsSchema2(BaseModel):
...
class IotSmartLockersEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersEventsProcessor2()
