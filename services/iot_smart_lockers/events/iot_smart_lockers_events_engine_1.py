...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_1
...
@dataclass
class IotSmartLockersEventsEntity1:
...
class IotSmartLockersEventsSchema1(BaseModel):
...
class IotSmartLockersEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersEventsProcessor1()
