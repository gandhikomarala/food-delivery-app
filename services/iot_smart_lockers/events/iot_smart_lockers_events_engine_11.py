...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_11
...
@dataclass
class IotSmartLockersEventsEntity11:
...
class IotSmartLockersEventsSchema11(BaseModel):
...
class IotSmartLockersEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersEventsProcessor11()
