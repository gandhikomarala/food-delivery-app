...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_18
...
@dataclass
class IotSmartLockersEventsEntity18:
...
class IotSmartLockersEventsSchema18(BaseModel):
...
class IotSmartLockersEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersEventsProcessor18()
