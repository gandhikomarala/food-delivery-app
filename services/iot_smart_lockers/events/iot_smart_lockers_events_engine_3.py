...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_3
...
@dataclass
class IotSmartLockersEventsEntity3:
...
class IotSmartLockersEventsSchema3(BaseModel):
...
class IotSmartLockersEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersEventsProcessor3()
