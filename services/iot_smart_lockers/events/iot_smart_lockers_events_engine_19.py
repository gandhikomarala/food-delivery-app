...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_19
...
@dataclass
class IotSmartLockersEventsEntity19:
...
class IotSmartLockersEventsSchema19(BaseModel):
...
class IotSmartLockersEventsProcessor19:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema19) -> Dict[str, Any]:
...
default_processor_19 = IotSmartLockersEventsProcessor19()
