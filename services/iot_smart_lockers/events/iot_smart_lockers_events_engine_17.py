...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_17
...
@dataclass
class IotSmartLockersEventsEntity17:
...
class IotSmartLockersEventsSchema17(BaseModel):
...
class IotSmartLockersEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersEventsProcessor17()
