...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_4
...
@dataclass
class IotSmartLockersEventsEntity4:
...
class IotSmartLockersEventsSchema4(BaseModel):
...
class IotSmartLockersEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersEventsProcessor4()
