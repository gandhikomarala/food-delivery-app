...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_20
...
@dataclass
class IotSmartLockersEventsEntity20:
...
class IotSmartLockersEventsSchema20(BaseModel):
...
class IotSmartLockersEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersEventsProcessor20()
