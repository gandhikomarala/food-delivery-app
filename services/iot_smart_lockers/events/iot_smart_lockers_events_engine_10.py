...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_10
...
@dataclass
class IotSmartLockersEventsEntity10:
...
class IotSmartLockersEventsSchema10(BaseModel):
...
class IotSmartLockersEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersEventsProcessor10()
