...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_14
...
@dataclass
class IotSmartLockersEventsEntity14:
...
class IotSmartLockersEventsSchema14(BaseModel):
...
class IotSmartLockersEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersEventsProcessor14()
