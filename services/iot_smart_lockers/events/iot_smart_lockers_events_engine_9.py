...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_9
...
@dataclass
class IotSmartLockersEventsEntity9:
...
class IotSmartLockersEventsSchema9(BaseModel):
...
class IotSmartLockersEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = IotSmartLockersEventsProcessor9()
