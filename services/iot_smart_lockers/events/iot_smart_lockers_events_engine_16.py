...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_16
...
@dataclass
class IotSmartLockersEventsEntity16:
...
class IotSmartLockersEventsSchema16(BaseModel):
...
class IotSmartLockersEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = IotSmartLockersEventsProcessor16()
