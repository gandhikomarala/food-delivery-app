...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_5
...
@dataclass
class IotSmartLockersEventsEntity5:
...
class IotSmartLockersEventsSchema5(BaseModel):
...
class IotSmartLockersEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersEventsProcessor5()
