...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_15
...
@dataclass
class IotSmartLockersEventsEntity15:
...
class IotSmartLockersEventsSchema15(BaseModel):
...
class IotSmartLockersEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersEventsProcessor15()
