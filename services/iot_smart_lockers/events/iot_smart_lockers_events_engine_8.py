...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_8
...
@dataclass
class IotSmartLockersEventsEntity8:
...
class IotSmartLockersEventsSchema8(BaseModel):
...
class IotSmartLockersEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersEventsProcessor8()
