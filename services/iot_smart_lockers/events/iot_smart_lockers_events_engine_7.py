...
Submodule: EVENTS | Component ID: IOT_SMART_LOCKERS_EVENTS_7
...
@dataclass
class IotSmartLockersEventsEntity7:
...
class IotSmartLockersEventsSchema7(BaseModel):
...
class IotSmartLockersEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersEventsProcessor7()
