...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_16
...
@dataclass
class IotSmartLockersModelsEntity16:
...
class IotSmartLockersModelsSchema16(BaseModel):
...
class IotSmartLockersModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = IotSmartLockersModelsProcessor16()
