...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_15
...
@dataclass
class IotSmartLockersModelsEntity15:
...
class IotSmartLockersModelsSchema15(BaseModel):
...
class IotSmartLockersModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersModelsProcessor15()
