...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_3
...
@dataclass
class IotSmartLockersModelsEntity3:
...
class IotSmartLockersModelsSchema3(BaseModel):
...
class IotSmartLockersModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersModelsProcessor3()
