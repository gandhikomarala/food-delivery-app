...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_17
...
@dataclass
class IotSmartLockersModelsEntity17:
...
class IotSmartLockersModelsSchema17(BaseModel):
...
class IotSmartLockersModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersModelsProcessor17()
