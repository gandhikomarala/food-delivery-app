...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_1
...
@dataclass
class IotSmartLockersModelsEntity1:
...
class IotSmartLockersModelsSchema1(BaseModel):
...
class IotSmartLockersModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersModelsProcessor1()
