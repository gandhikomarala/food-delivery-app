...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_12
...
@dataclass
class IotSmartLockersModelsEntity12:
...
class IotSmartLockersModelsSchema12(BaseModel):
...
class IotSmartLockersModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersModelsProcessor12()
