...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_7
...
@dataclass
class IotSmartLockersModelsEntity7:
...
class IotSmartLockersModelsSchema7(BaseModel):
...
class IotSmartLockersModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersModelsProcessor7()
