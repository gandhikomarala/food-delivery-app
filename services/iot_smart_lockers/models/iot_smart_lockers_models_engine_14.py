...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_14
...
@dataclass
class IotSmartLockersModelsEntity14:
...
class IotSmartLockersModelsSchema14(BaseModel):
...
class IotSmartLockersModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersModelsProcessor14()
