...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_11
...
@dataclass
class IotSmartLockersModelsEntity11:
...
class IotSmartLockersModelsSchema11(BaseModel):
...
class IotSmartLockersModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersModelsProcessor11()
