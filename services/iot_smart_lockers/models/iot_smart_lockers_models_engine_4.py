...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_4
...
@dataclass
class IotSmartLockersModelsEntity4:
...
class IotSmartLockersModelsSchema4(BaseModel):
...
class IotSmartLockersModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersModelsProcessor4()
