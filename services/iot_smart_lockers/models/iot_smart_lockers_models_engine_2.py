...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_2
...
@dataclass
class IotSmartLockersModelsEntity2:
...
class IotSmartLockersModelsSchema2(BaseModel):
...
class IotSmartLockersModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersModelsProcessor2()
