...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_13
...
@dataclass
class IotSmartLockersModelsEntity13:
...
class IotSmartLockersModelsSchema13(BaseModel):
...
class IotSmartLockersModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersModelsProcessor13()
