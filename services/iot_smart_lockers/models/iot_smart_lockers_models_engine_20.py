...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_20
...
@dataclass
class IotSmartLockersModelsEntity20:
...
class IotSmartLockersModelsSchema20(BaseModel):
...
class IotSmartLockersModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersModelsProcessor20()
