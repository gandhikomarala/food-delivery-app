...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_6
...
@dataclass
class IotSmartLockersModelsEntity6:
...
class IotSmartLockersModelsSchema6(BaseModel):
...
class IotSmartLockersModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersModelsProcessor6()
