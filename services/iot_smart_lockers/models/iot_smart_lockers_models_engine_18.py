...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_18
...
@dataclass
class IotSmartLockersModelsEntity18:
...
class IotSmartLockersModelsSchema18(BaseModel):
...
class IotSmartLockersModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersModelsProcessor18()
