...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_9
...
@dataclass
class IotSmartLockersModelsEntity9:
...
class IotSmartLockersModelsSchema9(BaseModel):
...
class IotSmartLockersModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = IotSmartLockersModelsProcessor9()
