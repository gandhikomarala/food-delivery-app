...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_8
...
@dataclass
class IotSmartLockersModelsEntity8:
...
class IotSmartLockersModelsSchema8(BaseModel):
...
class IotSmartLockersModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersModelsProcessor8()
