...
Submodule: MODELS | Component ID: IOT_SMART_LOCKERS_MODELS_10
...
@dataclass
class IotSmartLockersModelsEntity10:
...
class IotSmartLockersModelsSchema10(BaseModel):
...
class IotSmartLockersModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersModelsProcessor10()
