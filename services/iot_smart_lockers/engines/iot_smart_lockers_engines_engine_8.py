...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_8
...
@dataclass
class IotSmartLockersEnginesEntity8:
...
class IotSmartLockersEnginesSchema8(BaseModel):
...
class IotSmartLockersEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersEnginesProcessor8()
