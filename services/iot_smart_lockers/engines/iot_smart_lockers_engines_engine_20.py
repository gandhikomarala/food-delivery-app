...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_20
...
@dataclass
class IotSmartLockersEnginesEntity20:
...
class IotSmartLockersEnginesSchema20(BaseModel):
...
class IotSmartLockersEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersEnginesProcessor20()
