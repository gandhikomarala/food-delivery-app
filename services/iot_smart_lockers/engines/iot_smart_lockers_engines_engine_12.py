...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_12
...
@dataclass
class IotSmartLockersEnginesEntity12:
...
class IotSmartLockersEnginesSchema12(BaseModel):
...
class IotSmartLockersEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersEnginesProcessor12()
