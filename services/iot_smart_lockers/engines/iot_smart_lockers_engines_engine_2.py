...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_2
...
@dataclass
class IotSmartLockersEnginesEntity2:
...
class IotSmartLockersEnginesSchema2(BaseModel):
...
class IotSmartLockersEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersEnginesProcessor2()
