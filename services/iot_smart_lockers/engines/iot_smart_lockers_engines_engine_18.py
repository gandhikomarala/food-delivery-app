...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_18
...
@dataclass
class IotSmartLockersEnginesEntity18:
...
class IotSmartLockersEnginesSchema18(BaseModel):
...
class IotSmartLockersEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersEnginesProcessor18()
