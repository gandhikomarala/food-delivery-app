...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_1
...
@dataclass
class IotSmartLockersEnginesEntity1:
...
class IotSmartLockersEnginesSchema1(BaseModel):
...
class IotSmartLockersEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersEnginesProcessor1()
