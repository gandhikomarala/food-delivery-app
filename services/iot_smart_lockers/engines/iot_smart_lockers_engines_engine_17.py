...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_17
...
@dataclass
class IotSmartLockersEnginesEntity17:
...
class IotSmartLockersEnginesSchema17(BaseModel):
...
class IotSmartLockersEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersEnginesProcessor17()
