...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_15
...
@dataclass
class IotSmartLockersEnginesEntity15:
...
class IotSmartLockersEnginesSchema15(BaseModel):
...
class IotSmartLockersEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersEnginesProcessor15()
