...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_6
...
@dataclass
class IotSmartLockersEnginesEntity6:
...
class IotSmartLockersEnginesSchema6(BaseModel):
...
class IotSmartLockersEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersEnginesProcessor6()
