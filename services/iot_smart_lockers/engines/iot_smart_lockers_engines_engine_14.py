...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_14
...
@dataclass
class IotSmartLockersEnginesEntity14:
...
class IotSmartLockersEnginesSchema14(BaseModel):
...
class IotSmartLockersEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersEnginesProcessor14()
