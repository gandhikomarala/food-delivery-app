...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_13
...
@dataclass
class IotSmartLockersEnginesEntity13:
...
class IotSmartLockersEnginesSchema13(BaseModel):
...
class IotSmartLockersEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersEnginesProcessor13()
