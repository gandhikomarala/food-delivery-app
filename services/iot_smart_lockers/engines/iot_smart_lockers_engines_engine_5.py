...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_5
...
@dataclass
class IotSmartLockersEnginesEntity5:
...
class IotSmartLockersEnginesSchema5(BaseModel):
...
class IotSmartLockersEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersEnginesProcessor5()
