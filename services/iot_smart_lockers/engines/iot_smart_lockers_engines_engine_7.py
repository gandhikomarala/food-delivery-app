...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_7
...
@dataclass
class IotSmartLockersEnginesEntity7:
...
class IotSmartLockersEnginesSchema7(BaseModel):
...
class IotSmartLockersEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersEnginesProcessor7()
