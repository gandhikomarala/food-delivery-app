...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_11
...
@dataclass
class IotSmartLockersEnginesEntity11:
...
class IotSmartLockersEnginesSchema11(BaseModel):
...
class IotSmartLockersEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersEnginesProcessor11()
