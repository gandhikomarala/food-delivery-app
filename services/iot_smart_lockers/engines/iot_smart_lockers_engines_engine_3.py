...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_3
...
@dataclass
class IotSmartLockersEnginesEntity3:
...
class IotSmartLockersEnginesSchema3(BaseModel):
...
class IotSmartLockersEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersEnginesProcessor3()
