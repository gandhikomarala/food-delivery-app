...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_10
...
@dataclass
class IotSmartLockersEnginesEntity10:
...
class IotSmartLockersEnginesSchema10(BaseModel):
...
class IotSmartLockersEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersEnginesProcessor10()
