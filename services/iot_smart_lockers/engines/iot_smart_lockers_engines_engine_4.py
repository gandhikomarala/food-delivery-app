...
Submodule: ENGINES | Component ID: IOT_SMART_LOCKERS_ENGINES_4
...
@dataclass
class IotSmartLockersEnginesEntity4:
...
class IotSmartLockersEnginesSchema4(BaseModel):
...
class IotSmartLockersEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersEnginesProcessor4()
