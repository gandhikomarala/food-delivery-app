...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_3
...
@dataclass
class IotSmartLockersValidatorsEntity3:
...
class IotSmartLockersValidatorsSchema3(BaseModel):
...
class IotSmartLockersValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersValidatorsProcessor3()
