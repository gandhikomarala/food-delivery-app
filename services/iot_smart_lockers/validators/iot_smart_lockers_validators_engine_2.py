...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_2
...
@dataclass
class IotSmartLockersValidatorsEntity2:
...
class IotSmartLockersValidatorsSchema2(BaseModel):
...
class IotSmartLockersValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersValidatorsProcessor2()
