...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_14
...
@dataclass
class IotSmartLockersValidatorsEntity14:
...
class IotSmartLockersValidatorsSchema14(BaseModel):
...
class IotSmartLockersValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersValidatorsProcessor14()
