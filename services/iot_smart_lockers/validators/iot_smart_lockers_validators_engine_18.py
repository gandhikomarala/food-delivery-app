...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_18
...
@dataclass
class IotSmartLockersValidatorsEntity18:
...
class IotSmartLockersValidatorsSchema18(BaseModel):
...
class IotSmartLockersValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersValidatorsProcessor18()
