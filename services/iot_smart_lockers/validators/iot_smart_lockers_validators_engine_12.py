...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_12
...
@dataclass
class IotSmartLockersValidatorsEntity12:
...
class IotSmartLockersValidatorsSchema12(BaseModel):
...
class IotSmartLockersValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersValidatorsProcessor12()
