...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_1
...
@dataclass
class IotSmartLockersValidatorsEntity1:
...
class IotSmartLockersValidatorsSchema1(BaseModel):
...
class IotSmartLockersValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersValidatorsProcessor1()
