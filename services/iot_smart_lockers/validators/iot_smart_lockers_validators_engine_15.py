...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_15
...
@dataclass
class IotSmartLockersValidatorsEntity15:
...
class IotSmartLockersValidatorsSchema15(BaseModel):
...
class IotSmartLockersValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersValidatorsProcessor15()
