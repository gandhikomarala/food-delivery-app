...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_13
...
@dataclass
class IotSmartLockersValidatorsEntity13:
...
class IotSmartLockersValidatorsSchema13(BaseModel):
...
class IotSmartLockersValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersValidatorsProcessor13()
