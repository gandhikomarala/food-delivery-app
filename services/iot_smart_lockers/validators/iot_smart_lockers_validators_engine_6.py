...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_6
...
@dataclass
class IotSmartLockersValidatorsEntity6:
...
class IotSmartLockersValidatorsSchema6(BaseModel):
...
class IotSmartLockersValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersValidatorsProcessor6()
