...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_11
...
@dataclass
class IotSmartLockersValidatorsEntity11:
...
class IotSmartLockersValidatorsSchema11(BaseModel):
...
class IotSmartLockersValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersValidatorsProcessor11()
