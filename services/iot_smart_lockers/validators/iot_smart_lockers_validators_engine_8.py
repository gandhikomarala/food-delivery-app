...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_8
...
@dataclass
class IotSmartLockersValidatorsEntity8:
...
class IotSmartLockersValidatorsSchema8(BaseModel):
...
class IotSmartLockersValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersValidatorsProcessor8()
