...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_17
...
@dataclass
class IotSmartLockersValidatorsEntity17:
...
class IotSmartLockersValidatorsSchema17(BaseModel):
...
class IotSmartLockersValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersValidatorsProcessor17()
