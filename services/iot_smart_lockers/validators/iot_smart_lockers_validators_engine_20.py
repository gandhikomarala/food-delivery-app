...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_20
...
@dataclass
class IotSmartLockersValidatorsEntity20:
...
class IotSmartLockersValidatorsSchema20(BaseModel):
...
class IotSmartLockersValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersValidatorsProcessor20()
