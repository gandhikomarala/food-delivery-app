...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_5
...
@dataclass
class IotSmartLockersValidatorsEntity5:
...
class IotSmartLockersValidatorsSchema5(BaseModel):
...
class IotSmartLockersValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersValidatorsProcessor5()
