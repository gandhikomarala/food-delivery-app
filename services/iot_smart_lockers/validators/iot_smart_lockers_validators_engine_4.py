...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_4
...
@dataclass
class IotSmartLockersValidatorsEntity4:
...
class IotSmartLockersValidatorsSchema4(BaseModel):
...
class IotSmartLockersValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersValidatorsProcessor4()
