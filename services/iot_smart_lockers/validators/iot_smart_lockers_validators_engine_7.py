...
Submodule: VALIDATORS | Component ID: IOT_SMART_LOCKERS_VALIDATORS_7
...
@dataclass
class IotSmartLockersValidatorsEntity7:
...
class IotSmartLockersValidatorsSchema7(BaseModel):
...
class IotSmartLockersValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersValidatorsProcessor7()
