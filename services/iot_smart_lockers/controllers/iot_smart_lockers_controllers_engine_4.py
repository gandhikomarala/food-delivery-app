...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_4
...
@dataclass
class IotSmartLockersControllersEntity4:
...
class IotSmartLockersControllersSchema4(BaseModel):
...
class IotSmartLockersControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersControllersProcessor4()
