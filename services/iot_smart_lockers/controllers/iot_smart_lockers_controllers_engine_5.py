...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_5
...
@dataclass
class IotSmartLockersControllersEntity5:
...
class IotSmartLockersControllersSchema5(BaseModel):
...
class IotSmartLockersControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersControllersProcessor5()
