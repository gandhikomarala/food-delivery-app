...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_17
...
@dataclass
class IotSmartLockersControllersEntity17:
...
class IotSmartLockersControllersSchema17(BaseModel):
...
class IotSmartLockersControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersControllersProcessor17()
