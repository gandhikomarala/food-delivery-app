...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_15
...
@dataclass
class IotSmartLockersControllersEntity15:
...
class IotSmartLockersControllersSchema15(BaseModel):
...
class IotSmartLockersControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersControllersProcessor15()
