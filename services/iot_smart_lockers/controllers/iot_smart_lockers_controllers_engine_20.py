...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_20
...
@dataclass
class IotSmartLockersControllersEntity20:
...
class IotSmartLockersControllersSchema20(BaseModel):
...
class IotSmartLockersControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersControllersProcessor20()
