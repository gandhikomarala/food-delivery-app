...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_16
...
@dataclass
class IotSmartLockersControllersEntity16:
...
class IotSmartLockersControllersSchema16(BaseModel):
...
class IotSmartLockersControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = IotSmartLockersControllersProcessor16()
