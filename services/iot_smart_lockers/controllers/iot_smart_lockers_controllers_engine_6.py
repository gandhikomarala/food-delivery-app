...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_6
...
@dataclass
class IotSmartLockersControllersEntity6:
...
class IotSmartLockersControllersSchema6(BaseModel):
...
class IotSmartLockersControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersControllersProcessor6()
