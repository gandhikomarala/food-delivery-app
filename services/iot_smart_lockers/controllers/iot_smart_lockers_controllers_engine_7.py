...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_7
...
@dataclass
class IotSmartLockersControllersEntity7:
...
class IotSmartLockersControllersSchema7(BaseModel):
...
class IotSmartLockersControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersControllersProcessor7()
