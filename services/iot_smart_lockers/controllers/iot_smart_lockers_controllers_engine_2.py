...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_2
...
@dataclass
class IotSmartLockersControllersEntity2:
...
class IotSmartLockersControllersSchema2(BaseModel):
...
class IotSmartLockersControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersControllersProcessor2()
