...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_10
...
@dataclass
class IotSmartLockersControllersEntity10:
...
class IotSmartLockersControllersSchema10(BaseModel):
...
class IotSmartLockersControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersControllersProcessor10()
