...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_9
...
@dataclass
class IotSmartLockersControllersEntity9:
...
class IotSmartLockersControllersSchema9(BaseModel):
...
class IotSmartLockersControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = IotSmartLockersControllersProcessor9()
