...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_11
...
@dataclass
class IotSmartLockersControllersEntity11:
...
class IotSmartLockersControllersSchema11(BaseModel):
...
class IotSmartLockersControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersControllersProcessor11()
