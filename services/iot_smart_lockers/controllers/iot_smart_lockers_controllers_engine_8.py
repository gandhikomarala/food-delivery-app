...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_8
...
@dataclass
class IotSmartLockersControllersEntity8:
...
class IotSmartLockersControllersSchema8(BaseModel):
...
class IotSmartLockersControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersControllersProcessor8()
