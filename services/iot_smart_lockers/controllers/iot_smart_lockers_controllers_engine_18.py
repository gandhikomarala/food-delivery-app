...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_18
...
@dataclass
class IotSmartLockersControllersEntity18:
...
class IotSmartLockersControllersSchema18(BaseModel):
...
class IotSmartLockersControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersControllersProcessor18()
