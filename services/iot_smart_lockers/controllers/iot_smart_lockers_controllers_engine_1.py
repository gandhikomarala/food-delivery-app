...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_1
...
@dataclass
class IotSmartLockersControllersEntity1:
...
class IotSmartLockersControllersSchema1(BaseModel):
...
class IotSmartLockersControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersControllersProcessor1()
