...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_13
...
@dataclass
class IotSmartLockersControllersEntity13:
...
class IotSmartLockersControllersSchema13(BaseModel):
...
class IotSmartLockersControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersControllersProcessor13()
