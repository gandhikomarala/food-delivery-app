...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_14
...
@dataclass
class IotSmartLockersControllersEntity14:
...
class IotSmartLockersControllersSchema14(BaseModel):
...
class IotSmartLockersControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersControllersProcessor14()
