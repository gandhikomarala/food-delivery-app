...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_3
...
@dataclass
class IotSmartLockersControllersEntity3:
...
class IotSmartLockersControllersSchema3(BaseModel):
...
class IotSmartLockersControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersControllersProcessor3()
