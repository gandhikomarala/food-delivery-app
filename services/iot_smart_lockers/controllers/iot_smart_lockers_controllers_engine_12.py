...
Submodule: CONTROLLERS | Component ID: IOT_SMART_LOCKERS_CONTROLLERS_12
...
@dataclass
class IotSmartLockersControllersEntity12:
...
class IotSmartLockersControllersSchema12(BaseModel):
...
class IotSmartLockersControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersControllersProcessor12()
