...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_3
...
@dataclass
class IotSmartLockersDtoEntity3:
...
class IotSmartLockersDtoSchema3(BaseModel):
...
class IotSmartLockersDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersDtoProcessor3()
