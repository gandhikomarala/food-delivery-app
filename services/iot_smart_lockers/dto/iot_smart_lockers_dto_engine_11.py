...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_11
...
@dataclass
class IotSmartLockersDtoEntity11:
...
class IotSmartLockersDtoSchema11(BaseModel):
...
class IotSmartLockersDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersDtoProcessor11()
