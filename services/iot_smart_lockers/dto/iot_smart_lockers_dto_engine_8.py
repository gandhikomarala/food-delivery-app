...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_8
...
@dataclass
class IotSmartLockersDtoEntity8:
...
class IotSmartLockersDtoSchema8(BaseModel):
...
class IotSmartLockersDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersDtoProcessor8()
