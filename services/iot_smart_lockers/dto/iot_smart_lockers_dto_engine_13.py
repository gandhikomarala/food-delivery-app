...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_13
...
@dataclass
class IotSmartLockersDtoEntity13:
...
class IotSmartLockersDtoSchema13(BaseModel):
...
class IotSmartLockersDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersDtoProcessor13()
