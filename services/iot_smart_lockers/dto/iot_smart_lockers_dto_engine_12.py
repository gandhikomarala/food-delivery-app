...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_12
...
@dataclass
class IotSmartLockersDtoEntity12:
...
class IotSmartLockersDtoSchema12(BaseModel):
...
class IotSmartLockersDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersDtoProcessor12()
