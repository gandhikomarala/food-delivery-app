...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_1
...
@dataclass
class IotSmartLockersDtoEntity1:
...
class IotSmartLockersDtoSchema1(BaseModel):
...
class IotSmartLockersDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersDtoProcessor1()
