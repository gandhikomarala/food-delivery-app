...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_14
...
@dataclass
class IotSmartLockersDtoEntity14:
...
class IotSmartLockersDtoSchema14(BaseModel):
...
class IotSmartLockersDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersDtoProcessor14()
