...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_17
...
@dataclass
class IotSmartLockersDtoEntity17:
...
class IotSmartLockersDtoSchema17(BaseModel):
...
class IotSmartLockersDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersDtoProcessor17()
