...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_5
...
@dataclass
class IotSmartLockersDtoEntity5:
...
class IotSmartLockersDtoSchema5(BaseModel):
...
class IotSmartLockersDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersDtoProcessor5()
