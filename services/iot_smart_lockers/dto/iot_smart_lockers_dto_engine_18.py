...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_18
...
@dataclass
class IotSmartLockersDtoEntity18:
...
class IotSmartLockersDtoSchema18(BaseModel):
...
class IotSmartLockersDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersDtoProcessor18()
