...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_9
...
@dataclass
class IotSmartLockersDtoEntity9:
...
class IotSmartLockersDtoSchema9(BaseModel):
...
class IotSmartLockersDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = IotSmartLockersDtoProcessor9()
