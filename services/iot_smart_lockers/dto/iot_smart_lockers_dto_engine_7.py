...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_7
...
@dataclass
class IotSmartLockersDtoEntity7:
...
class IotSmartLockersDtoSchema7(BaseModel):
...
class IotSmartLockersDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersDtoProcessor7()
