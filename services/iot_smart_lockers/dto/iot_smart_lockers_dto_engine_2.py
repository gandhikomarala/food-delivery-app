...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_2
...
@dataclass
class IotSmartLockersDtoEntity2:
...
class IotSmartLockersDtoSchema2(BaseModel):
...
class IotSmartLockersDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersDtoProcessor2()
