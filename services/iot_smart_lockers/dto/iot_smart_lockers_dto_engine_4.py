...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_4
...
@dataclass
class IotSmartLockersDtoEntity4:
...
class IotSmartLockersDtoSchema4(BaseModel):
...
class IotSmartLockersDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersDtoProcessor4()
