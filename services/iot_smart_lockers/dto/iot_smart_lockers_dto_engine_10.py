...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_10
...
@dataclass
class IotSmartLockersDtoEntity10:
...
class IotSmartLockersDtoSchema10(BaseModel):
...
class IotSmartLockersDtoProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersDtoProcessor10()
