...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_20
...
@dataclass
class IotSmartLockersDtoEntity20:
...
class IotSmartLockersDtoSchema20(BaseModel):
...
class IotSmartLockersDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersDtoProcessor20()
