...
Submodule: DTO | Component ID: IOT_SMART_LOCKERS_DTO_6
...
@dataclass
class IotSmartLockersDtoEntity6:
...
class IotSmartLockersDtoSchema6(BaseModel):
...
class IotSmartLockersDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersDtoProcessor6()
