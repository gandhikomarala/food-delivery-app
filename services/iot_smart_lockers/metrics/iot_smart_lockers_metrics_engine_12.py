...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_12
...
@dataclass
class IotSmartLockersMetricsEntity12:
...
class IotSmartLockersMetricsSchema12(BaseModel):
...
class IotSmartLockersMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = IotSmartLockersMetricsProcessor12()
