...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_3
...
@dataclass
class IotSmartLockersMetricsEntity3:
...
class IotSmartLockersMetricsSchema3(BaseModel):
...
class IotSmartLockersMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = IotSmartLockersMetricsProcessor3()
