...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_14
...
@dataclass
class IotSmartLockersMetricsEntity14:
...
class IotSmartLockersMetricsSchema14(BaseModel):
...
class IotSmartLockersMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = IotSmartLockersMetricsProcessor14()
