...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_18
...
@dataclass
class IotSmartLockersMetricsEntity18:
...
class IotSmartLockersMetricsSchema18(BaseModel):
...
class IotSmartLockersMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = IotSmartLockersMetricsProcessor18()
