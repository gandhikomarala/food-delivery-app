...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_5
...
@dataclass
class IotSmartLockersMetricsEntity5:
...
class IotSmartLockersMetricsSchema5(BaseModel):
...
class IotSmartLockersMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = IotSmartLockersMetricsProcessor5()
