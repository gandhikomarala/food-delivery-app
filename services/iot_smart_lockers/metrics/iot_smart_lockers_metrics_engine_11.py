...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_11
...
@dataclass
class IotSmartLockersMetricsEntity11:
...
class IotSmartLockersMetricsSchema11(BaseModel):
...
class IotSmartLockersMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = IotSmartLockersMetricsProcessor11()
