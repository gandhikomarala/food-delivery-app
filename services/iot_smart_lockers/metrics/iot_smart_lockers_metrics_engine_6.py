...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_6
...
@dataclass
class IotSmartLockersMetricsEntity6:
...
class IotSmartLockersMetricsSchema6(BaseModel):
...
class IotSmartLockersMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = IotSmartLockersMetricsProcessor6()
