...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_13
...
@dataclass
class IotSmartLockersMetricsEntity13:
...
class IotSmartLockersMetricsSchema13(BaseModel):
...
class IotSmartLockersMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = IotSmartLockersMetricsProcessor13()
