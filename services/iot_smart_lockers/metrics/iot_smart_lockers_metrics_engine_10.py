...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_10
...
@dataclass
class IotSmartLockersMetricsEntity10:
...
class IotSmartLockersMetricsSchema10(BaseModel):
...
class IotSmartLockersMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = IotSmartLockersMetricsProcessor10()
