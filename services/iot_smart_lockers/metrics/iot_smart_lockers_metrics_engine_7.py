...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_7
...
@dataclass
class IotSmartLockersMetricsEntity7:
...
class IotSmartLockersMetricsSchema7(BaseModel):
...
class IotSmartLockersMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = IotSmartLockersMetricsProcessor7()
