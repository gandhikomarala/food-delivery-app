...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_15
...
@dataclass
class IotSmartLockersMetricsEntity15:
...
class IotSmartLockersMetricsSchema15(BaseModel):
...
class IotSmartLockersMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = IotSmartLockersMetricsProcessor15()
