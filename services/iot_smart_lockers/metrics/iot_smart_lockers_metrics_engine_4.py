...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_4
...
@dataclass
class IotSmartLockersMetricsEntity4:
...
class IotSmartLockersMetricsSchema4(BaseModel):
...
class IotSmartLockersMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = IotSmartLockersMetricsProcessor4()
