...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_1
...
@dataclass
class IotSmartLockersMetricsEntity1:
...
class IotSmartLockersMetricsSchema1(BaseModel):
...
class IotSmartLockersMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = IotSmartLockersMetricsProcessor1()
