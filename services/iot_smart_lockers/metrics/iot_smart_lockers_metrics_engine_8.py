...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_8
...
@dataclass
class IotSmartLockersMetricsEntity8:
...
class IotSmartLockersMetricsSchema8(BaseModel):
...
class IotSmartLockersMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = IotSmartLockersMetricsProcessor8()
