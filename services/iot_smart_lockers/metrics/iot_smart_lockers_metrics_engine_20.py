...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_20
...
@dataclass
class IotSmartLockersMetricsEntity20:
...
class IotSmartLockersMetricsSchema20(BaseModel):
...
class IotSmartLockersMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = IotSmartLockersMetricsProcessor20()
