...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_9
...
@dataclass
class IotSmartLockersMetricsEntity9:
...
class IotSmartLockersMetricsSchema9(BaseModel):
...
class IotSmartLockersMetricsProcessor9:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema9) -> Dict[str, Any]:
...
default_processor_9 = IotSmartLockersMetricsProcessor9()
