...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_2
...
@dataclass
class IotSmartLockersMetricsEntity2:
...
class IotSmartLockersMetricsSchema2(BaseModel):
...
class IotSmartLockersMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = IotSmartLockersMetricsProcessor2()
