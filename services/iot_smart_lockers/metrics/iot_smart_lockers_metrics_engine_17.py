...
Submodule: METRICS | Component ID: IOT_SMART_LOCKERS_METRICS_17
...
@dataclass
class IotSmartLockersMetricsEntity17:
...
class IotSmartLockersMetricsSchema17(BaseModel):
...
class IotSmartLockersMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: IotSmartLockersMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = IotSmartLockersMetricsProcessor17()
