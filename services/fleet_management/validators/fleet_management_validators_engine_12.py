...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_12
...
@dataclass
class FleetManagementValidatorsEntity12:
...
class FleetManagementValidatorsSchema12(BaseModel):
...
class FleetManagementValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementValidatorsProcessor12()
