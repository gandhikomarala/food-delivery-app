...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_18
...
@dataclass
class FleetManagementValidatorsEntity18:
...
class FleetManagementValidatorsSchema18(BaseModel):
...
class FleetManagementValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementValidatorsProcessor18()
