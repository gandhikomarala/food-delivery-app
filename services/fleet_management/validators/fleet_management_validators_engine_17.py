...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_17
...
@dataclass
class FleetManagementValidatorsEntity17:
...
class FleetManagementValidatorsSchema17(BaseModel):
...
class FleetManagementValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementValidatorsProcessor17()
