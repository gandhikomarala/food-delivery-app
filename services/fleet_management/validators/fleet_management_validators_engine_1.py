...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_1
...
@dataclass
class FleetManagementValidatorsEntity1:
...
class FleetManagementValidatorsSchema1(BaseModel):
...
class FleetManagementValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementValidatorsProcessor1()
