...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_5
...
@dataclass
class FleetManagementValidatorsEntity5:
...
class FleetManagementValidatorsSchema5(BaseModel):
...
class FleetManagementValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementValidatorsProcessor5()
