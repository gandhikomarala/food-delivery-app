...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_13
...
@dataclass
class FleetManagementValidatorsEntity13:
...
class FleetManagementValidatorsSchema13(BaseModel):
...
class FleetManagementValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementValidatorsProcessor13()
