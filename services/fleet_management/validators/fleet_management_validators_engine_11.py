...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_11
...
@dataclass
class FleetManagementValidatorsEntity11:
...
class FleetManagementValidatorsSchema11(BaseModel):
...
class FleetManagementValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementValidatorsProcessor11()
