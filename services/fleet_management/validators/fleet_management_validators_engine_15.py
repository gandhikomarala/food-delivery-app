...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_15
...
@dataclass
class FleetManagementValidatorsEntity15:
...
class FleetManagementValidatorsSchema15(BaseModel):
...
class FleetManagementValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementValidatorsProcessor15()
