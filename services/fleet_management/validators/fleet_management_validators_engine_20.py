...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_20
...
@dataclass
class FleetManagementValidatorsEntity20:
...
class FleetManagementValidatorsSchema20(BaseModel):
...
class FleetManagementValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementValidatorsProcessor20()
