...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_10
...
@dataclass
class FleetManagementValidatorsEntity10:
...
class FleetManagementValidatorsSchema10(BaseModel):
...
class FleetManagementValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementValidatorsProcessor10()
