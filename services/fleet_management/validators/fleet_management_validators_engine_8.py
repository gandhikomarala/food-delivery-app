...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_8
...
@dataclass
class FleetManagementValidatorsEntity8:
...
class FleetManagementValidatorsSchema8(BaseModel):
...
class FleetManagementValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementValidatorsProcessor8()
