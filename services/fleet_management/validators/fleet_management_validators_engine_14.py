...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_14
...
@dataclass
class FleetManagementValidatorsEntity14:
...
class FleetManagementValidatorsSchema14(BaseModel):
...
class FleetManagementValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementValidatorsProcessor14()
