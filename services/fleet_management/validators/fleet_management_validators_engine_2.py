...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_2
...
@dataclass
class FleetManagementValidatorsEntity2:
...
class FleetManagementValidatorsSchema2(BaseModel):
...
class FleetManagementValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementValidatorsProcessor2()
