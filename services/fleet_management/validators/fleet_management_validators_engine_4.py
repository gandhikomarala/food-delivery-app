...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_4
...
@dataclass
class FleetManagementValidatorsEntity4:
...
class FleetManagementValidatorsSchema4(BaseModel):
...
class FleetManagementValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementValidatorsProcessor4()
