...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_9
...
@dataclass
class FleetManagementValidatorsEntity9:
...
class FleetManagementValidatorsSchema9(BaseModel):
...
class FleetManagementValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementValidatorsProcessor9()
