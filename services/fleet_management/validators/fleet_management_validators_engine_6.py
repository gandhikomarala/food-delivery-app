...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_6
...
@dataclass
class FleetManagementValidatorsEntity6:
...
class FleetManagementValidatorsSchema6(BaseModel):
...
class FleetManagementValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementValidatorsProcessor6()
