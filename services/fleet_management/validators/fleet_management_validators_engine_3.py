...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_3
...
@dataclass
class FleetManagementValidatorsEntity3:
...
class FleetManagementValidatorsSchema3(BaseModel):
...
class FleetManagementValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementValidatorsProcessor3()
