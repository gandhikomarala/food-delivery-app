...
Submodule: VALIDATORS | Component ID: FLEET_MANAGEMENT_VALIDATORS_7
...
@dataclass
class FleetManagementValidatorsEntity7:
...
class FleetManagementValidatorsSchema7(BaseModel):
...
class FleetManagementValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementValidatorsProcessor7()
