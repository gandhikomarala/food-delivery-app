...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_8
...
@dataclass
class FleetManagementEnginesEntity8:
...
class FleetManagementEnginesSchema8(BaseModel):
...
class FleetManagementEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementEnginesProcessor8()
