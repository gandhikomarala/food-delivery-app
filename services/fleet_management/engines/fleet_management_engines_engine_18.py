...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_18
...
@dataclass
class FleetManagementEnginesEntity18:
...
class FleetManagementEnginesSchema18(BaseModel):
...
class FleetManagementEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementEnginesProcessor18()
