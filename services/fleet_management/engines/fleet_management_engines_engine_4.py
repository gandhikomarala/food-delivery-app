...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_4
...
@dataclass
class FleetManagementEnginesEntity4:
...
class FleetManagementEnginesSchema4(BaseModel):
...
class FleetManagementEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementEnginesProcessor4()
