...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_9
...
@dataclass
class FleetManagementEnginesEntity9:
...
class FleetManagementEnginesSchema9(BaseModel):
...
class FleetManagementEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementEnginesProcessor9()
