...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_6
...
@dataclass
class FleetManagementEnginesEntity6:
...
class FleetManagementEnginesSchema6(BaseModel):
...
class FleetManagementEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementEnginesProcessor6()
