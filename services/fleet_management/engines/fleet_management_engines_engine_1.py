...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_1
...
@dataclass
class FleetManagementEnginesEntity1:
...
class FleetManagementEnginesSchema1(BaseModel):
...
class FleetManagementEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementEnginesProcessor1()
