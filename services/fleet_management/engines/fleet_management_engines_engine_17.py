...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_17
...
@dataclass
class FleetManagementEnginesEntity17:
...
class FleetManagementEnginesSchema17(BaseModel):
...
class FleetManagementEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementEnginesProcessor17()
