...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_2
...
@dataclass
class FleetManagementEnginesEntity2:
...
class FleetManagementEnginesSchema2(BaseModel):
...
class FleetManagementEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementEnginesProcessor2()
