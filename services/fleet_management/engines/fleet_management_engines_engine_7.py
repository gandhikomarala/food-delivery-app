...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_7
...
@dataclass
class FleetManagementEnginesEntity7:
...
class FleetManagementEnginesSchema7(BaseModel):
...
class FleetManagementEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementEnginesProcessor7()
