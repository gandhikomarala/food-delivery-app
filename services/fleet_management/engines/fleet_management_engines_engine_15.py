...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_15
...
@dataclass
class FleetManagementEnginesEntity15:
...
class FleetManagementEnginesSchema15(BaseModel):
...
class FleetManagementEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementEnginesProcessor15()
