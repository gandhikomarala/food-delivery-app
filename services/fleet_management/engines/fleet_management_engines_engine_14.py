...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_14
...
@dataclass
class FleetManagementEnginesEntity14:
...
class FleetManagementEnginesSchema14(BaseModel):
...
class FleetManagementEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementEnginesProcessor14()
