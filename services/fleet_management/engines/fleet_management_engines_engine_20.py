...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_20
...
@dataclass
class FleetManagementEnginesEntity20:
...
class FleetManagementEnginesSchema20(BaseModel):
...
class FleetManagementEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementEnginesProcessor20()
