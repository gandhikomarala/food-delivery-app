...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_10
...
@dataclass
class FleetManagementEnginesEntity10:
...
class FleetManagementEnginesSchema10(BaseModel):
...
class FleetManagementEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementEnginesProcessor10()
