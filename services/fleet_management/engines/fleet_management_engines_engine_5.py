...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_5
...
@dataclass
class FleetManagementEnginesEntity5:
...
class FleetManagementEnginesSchema5(BaseModel):
...
class FleetManagementEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementEnginesProcessor5()
