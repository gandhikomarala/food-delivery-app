...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_3
...
@dataclass
class FleetManagementEnginesEntity3:
...
class FleetManagementEnginesSchema3(BaseModel):
...
class FleetManagementEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementEnginesProcessor3()
