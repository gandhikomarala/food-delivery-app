...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_13
...
@dataclass
class FleetManagementEnginesEntity13:
...
class FleetManagementEnginesSchema13(BaseModel):
...
class FleetManagementEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementEnginesProcessor13()
