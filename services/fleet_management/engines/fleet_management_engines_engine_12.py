...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_12
...
@dataclass
class FleetManagementEnginesEntity12:
...
class FleetManagementEnginesSchema12(BaseModel):
...
class FleetManagementEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementEnginesProcessor12()
