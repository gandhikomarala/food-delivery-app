...
Submodule: ENGINES | Component ID: FLEET_MANAGEMENT_ENGINES_16
...
@dataclass
class FleetManagementEnginesEntity16:
...
class FleetManagementEnginesSchema16(BaseModel):
...
class FleetManagementEnginesProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEnginesSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementEnginesProcessor16()
