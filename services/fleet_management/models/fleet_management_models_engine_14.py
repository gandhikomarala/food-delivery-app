...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_14
...
@dataclass
class FleetManagementModelsEntity14:
...
class FleetManagementModelsSchema14(BaseModel):
...
class FleetManagementModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementModelsProcessor14()
