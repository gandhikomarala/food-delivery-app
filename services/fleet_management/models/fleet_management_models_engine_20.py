...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_20
...
@dataclass
class FleetManagementModelsEntity20:
...
class FleetManagementModelsSchema20(BaseModel):
...
class FleetManagementModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementModelsProcessor20()
