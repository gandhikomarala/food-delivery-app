...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_7
...
@dataclass
class FleetManagementModelsEntity7:
...
class FleetManagementModelsSchema7(BaseModel):
...
class FleetManagementModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementModelsProcessor7()
