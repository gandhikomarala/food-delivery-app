...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_16
...
@dataclass
class FleetManagementModelsEntity16:
...
class FleetManagementModelsSchema16(BaseModel):
...
class FleetManagementModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementModelsProcessor16()
