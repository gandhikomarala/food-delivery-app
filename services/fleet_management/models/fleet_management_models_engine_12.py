...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_12
...
@dataclass
class FleetManagementModelsEntity12:
...
class FleetManagementModelsSchema12(BaseModel):
...
class FleetManagementModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementModelsProcessor12()
