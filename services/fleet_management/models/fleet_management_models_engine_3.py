...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_3
...
@dataclass
class FleetManagementModelsEntity3:
...
class FleetManagementModelsSchema3(BaseModel):
...
class FleetManagementModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementModelsProcessor3()
