...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_9
...
@dataclass
class FleetManagementModelsEntity9:
...
class FleetManagementModelsSchema9(BaseModel):
...
class FleetManagementModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementModelsProcessor9()
