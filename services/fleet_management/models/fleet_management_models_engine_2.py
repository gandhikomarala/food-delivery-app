...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_2
...
@dataclass
class FleetManagementModelsEntity2:
...
class FleetManagementModelsSchema2(BaseModel):
...
class FleetManagementModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementModelsProcessor2()
