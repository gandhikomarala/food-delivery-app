...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_15
...
@dataclass
class FleetManagementModelsEntity15:
...
class FleetManagementModelsSchema15(BaseModel):
...
class FleetManagementModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementModelsProcessor15()
