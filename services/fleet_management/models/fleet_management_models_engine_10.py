...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_10
...
@dataclass
class FleetManagementModelsEntity10:
...
class FleetManagementModelsSchema10(BaseModel):
...
class FleetManagementModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementModelsProcessor10()
