...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_6
...
@dataclass
class FleetManagementModelsEntity6:
...
class FleetManagementModelsSchema6(BaseModel):
...
class FleetManagementModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementModelsProcessor6()
