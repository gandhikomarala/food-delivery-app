...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_11
...
@dataclass
class FleetManagementModelsEntity11:
...
class FleetManagementModelsSchema11(BaseModel):
...
class FleetManagementModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementModelsProcessor11()
