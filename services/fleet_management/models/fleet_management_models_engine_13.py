...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_13
...
@dataclass
class FleetManagementModelsEntity13:
...
class FleetManagementModelsSchema13(BaseModel):
...
class FleetManagementModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementModelsProcessor13()
