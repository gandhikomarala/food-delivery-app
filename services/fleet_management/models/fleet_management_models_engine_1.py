...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_1
...
@dataclass
class FleetManagementModelsEntity1:
...
class FleetManagementModelsSchema1(BaseModel):
...
class FleetManagementModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementModelsProcessor1()
