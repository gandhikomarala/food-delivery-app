...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_4
...
@dataclass
class FleetManagementModelsEntity4:
...
class FleetManagementModelsSchema4(BaseModel):
...
class FleetManagementModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementModelsProcessor4()
