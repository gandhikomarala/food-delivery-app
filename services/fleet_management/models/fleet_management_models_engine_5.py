...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_5
...
@dataclass
class FleetManagementModelsEntity5:
...
class FleetManagementModelsSchema5(BaseModel):
...
class FleetManagementModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementModelsProcessor5()
