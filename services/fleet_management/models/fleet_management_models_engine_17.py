...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_17
...
@dataclass
class FleetManagementModelsEntity17:
...
class FleetManagementModelsSchema17(BaseModel):
...
class FleetManagementModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementModelsProcessor17()
