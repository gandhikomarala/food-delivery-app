...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_18
...
@dataclass
class FleetManagementModelsEntity18:
...
class FleetManagementModelsSchema18(BaseModel):
...
class FleetManagementModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementModelsProcessor18()
