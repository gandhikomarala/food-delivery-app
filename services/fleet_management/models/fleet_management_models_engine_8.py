...
Submodule: MODELS | Component ID: FLEET_MANAGEMENT_MODELS_8
...
@dataclass
class FleetManagementModelsEntity8:
...
class FleetManagementModelsSchema8(BaseModel):
...
class FleetManagementModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementModelsProcessor8()
