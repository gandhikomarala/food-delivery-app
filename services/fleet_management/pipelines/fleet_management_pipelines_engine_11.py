...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_11
...
@dataclass
class FleetManagementPipelinesEntity11:
...
class FleetManagementPipelinesSchema11(BaseModel):
...
class FleetManagementPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementPipelinesProcessor11()
