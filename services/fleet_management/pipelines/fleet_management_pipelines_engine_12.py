...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_12
...
@dataclass
class FleetManagementPipelinesEntity12:
...
class FleetManagementPipelinesSchema12(BaseModel):
...
class FleetManagementPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementPipelinesProcessor12()
