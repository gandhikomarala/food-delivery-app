...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_4
...
@dataclass
class FleetManagementPipelinesEntity4:
...
class FleetManagementPipelinesSchema4(BaseModel):
...
class FleetManagementPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementPipelinesProcessor4()
