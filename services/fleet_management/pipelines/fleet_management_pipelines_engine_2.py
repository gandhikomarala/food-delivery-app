...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_2
...
@dataclass
class FleetManagementPipelinesEntity2:
...
class FleetManagementPipelinesSchema2(BaseModel):
...
class FleetManagementPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementPipelinesProcessor2()
