...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_15
...
@dataclass
class FleetManagementPipelinesEntity15:
...
class FleetManagementPipelinesSchema15(BaseModel):
...
class FleetManagementPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementPipelinesProcessor15()
