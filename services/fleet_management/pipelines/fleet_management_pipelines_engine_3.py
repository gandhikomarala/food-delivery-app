...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_3
...
@dataclass
class FleetManagementPipelinesEntity3:
...
class FleetManagementPipelinesSchema3(BaseModel):
...
class FleetManagementPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementPipelinesProcessor3()
