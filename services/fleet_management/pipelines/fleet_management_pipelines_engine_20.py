...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_20
...
@dataclass
class FleetManagementPipelinesEntity20:
...
class FleetManagementPipelinesSchema20(BaseModel):
...
class FleetManagementPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementPipelinesProcessor20()
