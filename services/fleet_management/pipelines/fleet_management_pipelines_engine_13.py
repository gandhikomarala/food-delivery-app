...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_13
...
@dataclass
class FleetManagementPipelinesEntity13:
...
class FleetManagementPipelinesSchema13(BaseModel):
...
class FleetManagementPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementPipelinesProcessor13()
