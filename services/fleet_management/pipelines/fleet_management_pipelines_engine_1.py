...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_1
...
@dataclass
class FleetManagementPipelinesEntity1:
...
class FleetManagementPipelinesSchema1(BaseModel):
...
class FleetManagementPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementPipelinesProcessor1()
