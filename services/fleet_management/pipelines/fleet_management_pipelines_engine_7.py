...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_7
...
@dataclass
class FleetManagementPipelinesEntity7:
...
class FleetManagementPipelinesSchema7(BaseModel):
...
class FleetManagementPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementPipelinesProcessor7()
