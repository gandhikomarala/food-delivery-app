...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_5
...
@dataclass
class FleetManagementPipelinesEntity5:
...
class FleetManagementPipelinesSchema5(BaseModel):
...
class FleetManagementPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementPipelinesProcessor5()
