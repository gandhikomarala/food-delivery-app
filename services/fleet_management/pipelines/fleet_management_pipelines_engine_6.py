...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_6
...
@dataclass
class FleetManagementPipelinesEntity6:
...
class FleetManagementPipelinesSchema6(BaseModel):
...
class FleetManagementPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementPipelinesProcessor6()
