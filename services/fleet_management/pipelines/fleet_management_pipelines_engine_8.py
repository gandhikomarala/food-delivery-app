...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_8
...
@dataclass
class FleetManagementPipelinesEntity8:
...
class FleetManagementPipelinesSchema8(BaseModel):
...
class FleetManagementPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementPipelinesProcessor8()
