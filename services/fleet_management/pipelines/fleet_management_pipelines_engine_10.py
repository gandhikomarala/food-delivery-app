...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_10
...
@dataclass
class FleetManagementPipelinesEntity10:
...
class FleetManagementPipelinesSchema10(BaseModel):
...
class FleetManagementPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementPipelinesProcessor10()
