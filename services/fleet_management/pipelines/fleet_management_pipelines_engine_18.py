...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_18
...
@dataclass
class FleetManagementPipelinesEntity18:
...
class FleetManagementPipelinesSchema18(BaseModel):
...
class FleetManagementPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementPipelinesProcessor18()
