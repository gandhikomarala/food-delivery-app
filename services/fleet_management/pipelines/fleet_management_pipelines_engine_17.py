...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_17
...
@dataclass
class FleetManagementPipelinesEntity17:
...
class FleetManagementPipelinesSchema17(BaseModel):
...
class FleetManagementPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementPipelinesProcessor17()
