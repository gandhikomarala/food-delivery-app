...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_9
...
@dataclass
class FleetManagementPipelinesEntity9:
...
class FleetManagementPipelinesSchema9(BaseModel):
...
class FleetManagementPipelinesProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementPipelinesProcessor9()
