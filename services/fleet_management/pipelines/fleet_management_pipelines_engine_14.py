...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_14
...
@dataclass
class FleetManagementPipelinesEntity14:
...
class FleetManagementPipelinesSchema14(BaseModel):
...
class FleetManagementPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementPipelinesProcessor14()
