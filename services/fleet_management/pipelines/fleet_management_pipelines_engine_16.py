...
Submodule: PIPELINES | Component ID: FLEET_MANAGEMENT_PIPELINES_16
...
@dataclass
class FleetManagementPipelinesEntity16:
...
class FleetManagementPipelinesSchema16(BaseModel):
...
class FleetManagementPipelinesProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementPipelinesSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementPipelinesProcessor16()
