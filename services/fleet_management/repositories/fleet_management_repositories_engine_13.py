...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_13
...
@dataclass
class FleetManagementRepositoriesEntity13:
...
class FleetManagementRepositoriesSchema13(BaseModel):
...
class FleetManagementRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementRepositoriesProcessor13()
