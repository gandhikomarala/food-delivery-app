...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_2
...
@dataclass
class FleetManagementRepositoriesEntity2:
...
class FleetManagementRepositoriesSchema2(BaseModel):
...
class FleetManagementRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementRepositoriesProcessor2()
