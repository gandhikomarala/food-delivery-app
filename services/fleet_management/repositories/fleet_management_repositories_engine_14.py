...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_14
...
@dataclass
class FleetManagementRepositoriesEntity14:
...
class FleetManagementRepositoriesSchema14(BaseModel):
...
class FleetManagementRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementRepositoriesProcessor14()
