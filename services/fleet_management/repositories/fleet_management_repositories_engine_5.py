...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_5
...
@dataclass
class FleetManagementRepositoriesEntity5:
...
class FleetManagementRepositoriesSchema5(BaseModel):
...
class FleetManagementRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementRepositoriesProcessor5()
