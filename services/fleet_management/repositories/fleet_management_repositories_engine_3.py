...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_3
...
@dataclass
class FleetManagementRepositoriesEntity3:
...
class FleetManagementRepositoriesSchema3(BaseModel):
...
class FleetManagementRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementRepositoriesProcessor3()
