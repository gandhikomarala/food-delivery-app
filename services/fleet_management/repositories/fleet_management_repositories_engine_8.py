...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_8
...
@dataclass
class FleetManagementRepositoriesEntity8:
...
class FleetManagementRepositoriesSchema8(BaseModel):
...
class FleetManagementRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementRepositoriesProcessor8()
