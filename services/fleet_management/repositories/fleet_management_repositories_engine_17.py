...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_17
...
@dataclass
class FleetManagementRepositoriesEntity17:
...
class FleetManagementRepositoriesSchema17(BaseModel):
...
class FleetManagementRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementRepositoriesProcessor17()
