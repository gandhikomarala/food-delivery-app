...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_12
...
@dataclass
class FleetManagementRepositoriesEntity12:
...
class FleetManagementRepositoriesSchema12(BaseModel):
...
class FleetManagementRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementRepositoriesProcessor12()
