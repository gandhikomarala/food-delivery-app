...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_20
...
@dataclass
class FleetManagementRepositoriesEntity20:
...
class FleetManagementRepositoriesSchema20(BaseModel):
...
class FleetManagementRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementRepositoriesProcessor20()
