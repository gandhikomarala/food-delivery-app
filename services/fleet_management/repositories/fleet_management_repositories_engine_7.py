...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_7
...
@dataclass
class FleetManagementRepositoriesEntity7:
...
class FleetManagementRepositoriesSchema7(BaseModel):
...
class FleetManagementRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementRepositoriesProcessor7()
