...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_1
...
@dataclass
class FleetManagementRepositoriesEntity1:
...
class FleetManagementRepositoriesSchema1(BaseModel):
...
class FleetManagementRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementRepositoriesProcessor1()
