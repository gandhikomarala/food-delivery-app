...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_6
...
@dataclass
class FleetManagementRepositoriesEntity6:
...
class FleetManagementRepositoriesSchema6(BaseModel):
...
class FleetManagementRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementRepositoriesProcessor6()
