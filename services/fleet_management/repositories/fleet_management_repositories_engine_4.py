...
Submodule: REPOSITORIES | Component ID: FLEET_MANAGEMENT_REPOSITORIES_4
...
@dataclass
class FleetManagementRepositoriesEntity4:
...
class FleetManagementRepositoriesSchema4(BaseModel):
...
class FleetManagementRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementRepositoriesProcessor4()
