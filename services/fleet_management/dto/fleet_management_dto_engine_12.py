...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_12
...
@dataclass
class FleetManagementDtoEntity12:
...
class FleetManagementDtoSchema12(BaseModel):
...
class FleetManagementDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementDtoProcessor12()
