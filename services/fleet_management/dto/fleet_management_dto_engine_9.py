...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_9
...
@dataclass
class FleetManagementDtoEntity9:
...
class FleetManagementDtoSchema9(BaseModel):
...
class FleetManagementDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementDtoProcessor9()
