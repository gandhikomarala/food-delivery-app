...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_8
...
@dataclass
class FleetManagementDtoEntity8:
...
class FleetManagementDtoSchema8(BaseModel):
...
class FleetManagementDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementDtoProcessor8()
