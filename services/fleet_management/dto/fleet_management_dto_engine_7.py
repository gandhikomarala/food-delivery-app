...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_7
...
@dataclass
class FleetManagementDtoEntity7:
...
class FleetManagementDtoSchema7(BaseModel):
...
class FleetManagementDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementDtoProcessor7()
