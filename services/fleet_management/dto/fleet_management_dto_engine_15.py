...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_15
...
@dataclass
class FleetManagementDtoEntity15:
...
class FleetManagementDtoSchema15(BaseModel):
...
class FleetManagementDtoProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementDtoProcessor15()
