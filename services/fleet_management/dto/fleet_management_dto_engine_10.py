...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_10
...
@dataclass
class FleetManagementDtoEntity10:
...
class FleetManagementDtoSchema10(BaseModel):
...
class FleetManagementDtoProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementDtoProcessor10()
