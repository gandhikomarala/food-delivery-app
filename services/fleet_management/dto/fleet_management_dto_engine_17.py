...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_17
...
@dataclass
class FleetManagementDtoEntity17:
...
class FleetManagementDtoSchema17(BaseModel):
...
class FleetManagementDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementDtoProcessor17()
