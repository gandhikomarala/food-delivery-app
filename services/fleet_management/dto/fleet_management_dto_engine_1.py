...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_1
...
@dataclass
class FleetManagementDtoEntity1:
...
class FleetManagementDtoSchema1(BaseModel):
...
class FleetManagementDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementDtoProcessor1()
