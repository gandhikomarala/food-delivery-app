...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_18
...
@dataclass
class FleetManagementDtoEntity18:
...
class FleetManagementDtoSchema18(BaseModel):
...
class FleetManagementDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementDtoProcessor18()
