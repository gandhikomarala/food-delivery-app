...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_11
...
@dataclass
class FleetManagementDtoEntity11:
...
class FleetManagementDtoSchema11(BaseModel):
...
class FleetManagementDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementDtoProcessor11()
