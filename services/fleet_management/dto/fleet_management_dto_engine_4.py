...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_4
...
@dataclass
class FleetManagementDtoEntity4:
...
class FleetManagementDtoSchema4(BaseModel):
...
class FleetManagementDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementDtoProcessor4()
