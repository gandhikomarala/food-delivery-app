...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_14
...
@dataclass
class FleetManagementDtoEntity14:
...
class FleetManagementDtoSchema14(BaseModel):
...
class FleetManagementDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementDtoProcessor14()
