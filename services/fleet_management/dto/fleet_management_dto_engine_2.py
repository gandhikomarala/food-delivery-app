...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_2
...
@dataclass
class FleetManagementDtoEntity2:
...
class FleetManagementDtoSchema2(BaseModel):
...
class FleetManagementDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementDtoProcessor2()
