...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_6
...
@dataclass
class FleetManagementDtoEntity6:
...
class FleetManagementDtoSchema6(BaseModel):
...
class FleetManagementDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementDtoProcessor6()
