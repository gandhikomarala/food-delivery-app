...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_3
...
@dataclass
class FleetManagementDtoEntity3:
...
class FleetManagementDtoSchema3(BaseModel):
...
class FleetManagementDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementDtoProcessor3()
