...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_20
...
@dataclass
class FleetManagementDtoEntity20:
...
class FleetManagementDtoSchema20(BaseModel):
...
class FleetManagementDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementDtoProcessor20()
