...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_5
...
@dataclass
class FleetManagementDtoEntity5:
...
class FleetManagementDtoSchema5(BaseModel):
...
class FleetManagementDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementDtoProcessor5()
