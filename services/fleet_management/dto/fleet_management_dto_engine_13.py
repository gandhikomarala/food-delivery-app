...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_13
...
@dataclass
class FleetManagementDtoEntity13:
...
class FleetManagementDtoSchema13(BaseModel):
...
class FleetManagementDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementDtoProcessor13()
