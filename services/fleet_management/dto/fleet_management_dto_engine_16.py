...
Submodule: DTO | Component ID: FLEET_MANAGEMENT_DTO_16
...
@dataclass
class FleetManagementDtoEntity16:
...
class FleetManagementDtoSchema16(BaseModel):
...
class FleetManagementDtoProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementDtoSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementDtoProcessor16()
