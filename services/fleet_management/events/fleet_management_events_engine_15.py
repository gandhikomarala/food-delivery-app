...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_15
...
@dataclass
class FleetManagementEventsEntity15:
...
class FleetManagementEventsSchema15(BaseModel):
...
class FleetManagementEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementEventsProcessor15()
