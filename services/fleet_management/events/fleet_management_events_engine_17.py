...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_17
...
@dataclass
class FleetManagementEventsEntity17:
...
class FleetManagementEventsSchema17(BaseModel):
...
class FleetManagementEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementEventsProcessor17()
