...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_18
...
@dataclass
class FleetManagementEventsEntity18:
...
class FleetManagementEventsSchema18(BaseModel):
...
class FleetManagementEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementEventsProcessor18()
