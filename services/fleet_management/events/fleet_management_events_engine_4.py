...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_4
...
@dataclass
class FleetManagementEventsEntity4:
...
class FleetManagementEventsSchema4(BaseModel):
...
class FleetManagementEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementEventsProcessor4()
