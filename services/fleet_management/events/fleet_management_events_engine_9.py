...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_9
...
@dataclass
class FleetManagementEventsEntity9:
...
class FleetManagementEventsSchema9(BaseModel):
...
class FleetManagementEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementEventsProcessor9()
