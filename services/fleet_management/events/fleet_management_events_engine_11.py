...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_11
...
@dataclass
class FleetManagementEventsEntity11:
...
class FleetManagementEventsSchema11(BaseModel):
...
class FleetManagementEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementEventsProcessor11()
