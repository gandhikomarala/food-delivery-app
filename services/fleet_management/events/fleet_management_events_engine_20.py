...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_20
...
@dataclass
class FleetManagementEventsEntity20:
...
class FleetManagementEventsSchema20(BaseModel):
...
class FleetManagementEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementEventsProcessor20()
