...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_1
...
@dataclass
class FleetManagementEventsEntity1:
...
class FleetManagementEventsSchema1(BaseModel):
...
class FleetManagementEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementEventsProcessor1()
