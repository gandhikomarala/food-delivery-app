...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_16
...
@dataclass
class FleetManagementEventsEntity16:
...
class FleetManagementEventsSchema16(BaseModel):
...
class FleetManagementEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementEventsProcessor16()
