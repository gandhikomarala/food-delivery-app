...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_3
...
@dataclass
class FleetManagementEventsEntity3:
...
class FleetManagementEventsSchema3(BaseModel):
...
class FleetManagementEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementEventsProcessor3()
