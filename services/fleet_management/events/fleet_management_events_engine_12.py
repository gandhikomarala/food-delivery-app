...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_12
...
@dataclass
class FleetManagementEventsEntity12:
...
class FleetManagementEventsSchema12(BaseModel):
...
class FleetManagementEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementEventsProcessor12()
