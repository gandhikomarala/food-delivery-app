...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_10
...
@dataclass
class FleetManagementEventsEntity10:
...
class FleetManagementEventsSchema10(BaseModel):
...
class FleetManagementEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementEventsProcessor10()
