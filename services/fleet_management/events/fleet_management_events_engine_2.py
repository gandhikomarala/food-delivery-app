...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_2
...
@dataclass
class FleetManagementEventsEntity2:
...
class FleetManagementEventsSchema2(BaseModel):
...
class FleetManagementEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementEventsProcessor2()
