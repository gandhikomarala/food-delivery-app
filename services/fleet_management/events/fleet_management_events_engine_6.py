...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_6
...
@dataclass
class FleetManagementEventsEntity6:
...
class FleetManagementEventsSchema6(BaseModel):
...
class FleetManagementEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementEventsProcessor6()
