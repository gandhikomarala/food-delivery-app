...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_5
...
@dataclass
class FleetManagementEventsEntity5:
...
class FleetManagementEventsSchema5(BaseModel):
...
class FleetManagementEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementEventsProcessor5()
