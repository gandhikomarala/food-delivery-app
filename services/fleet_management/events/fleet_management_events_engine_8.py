...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_8
...
@dataclass
class FleetManagementEventsEntity8:
...
class FleetManagementEventsSchema8(BaseModel):
...
class FleetManagementEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementEventsProcessor8()
