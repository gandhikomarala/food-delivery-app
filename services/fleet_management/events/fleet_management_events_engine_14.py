...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_14
...
@dataclass
class FleetManagementEventsEntity14:
...
class FleetManagementEventsSchema14(BaseModel):
...
class FleetManagementEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementEventsProcessor14()
