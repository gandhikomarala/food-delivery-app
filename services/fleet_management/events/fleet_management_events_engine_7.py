...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_7
...
@dataclass
class FleetManagementEventsEntity7:
...
class FleetManagementEventsSchema7(BaseModel):
...
class FleetManagementEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementEventsProcessor7()
