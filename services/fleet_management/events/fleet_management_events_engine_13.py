...
Submodule: EVENTS | Component ID: FLEET_MANAGEMENT_EVENTS_13
...
@dataclass
class FleetManagementEventsEntity13:
...
class FleetManagementEventsSchema13(BaseModel):
...
class FleetManagementEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementEventsProcessor13()
