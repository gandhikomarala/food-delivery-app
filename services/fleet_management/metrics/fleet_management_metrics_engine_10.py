...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_10
...
@dataclass
class FleetManagementMetricsEntity10:
...
class FleetManagementMetricsSchema10(BaseModel):
...
class FleetManagementMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementMetricsProcessor10()
