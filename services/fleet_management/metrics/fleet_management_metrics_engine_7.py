...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_7
...
@dataclass
class FleetManagementMetricsEntity7:
...
class FleetManagementMetricsSchema7(BaseModel):
...
class FleetManagementMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementMetricsProcessor7()
