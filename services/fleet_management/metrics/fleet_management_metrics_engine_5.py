...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_5
...
@dataclass
class FleetManagementMetricsEntity5:
...
class FleetManagementMetricsSchema5(BaseModel):
...
class FleetManagementMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementMetricsProcessor5()
