...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_15
...
@dataclass
class FleetManagementMetricsEntity15:
...
class FleetManagementMetricsSchema15(BaseModel):
...
class FleetManagementMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementMetricsProcessor15()
