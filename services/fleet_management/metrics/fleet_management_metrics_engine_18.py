...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_18
...
@dataclass
class FleetManagementMetricsEntity18:
...
class FleetManagementMetricsSchema18(BaseModel):
...
class FleetManagementMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementMetricsProcessor18()
