...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_13
...
@dataclass
class FleetManagementMetricsEntity13:
...
class FleetManagementMetricsSchema13(BaseModel):
...
class FleetManagementMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementMetricsProcessor13()
