...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_2
...
@dataclass
class FleetManagementMetricsEntity2:
...
class FleetManagementMetricsSchema2(BaseModel):
...
class FleetManagementMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementMetricsProcessor2()
