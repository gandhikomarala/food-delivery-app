...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_11
...
@dataclass
class FleetManagementMetricsEntity11:
...
class FleetManagementMetricsSchema11(BaseModel):
...
class FleetManagementMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementMetricsProcessor11()
