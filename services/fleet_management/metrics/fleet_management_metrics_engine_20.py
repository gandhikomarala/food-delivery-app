...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_20
...
@dataclass
class FleetManagementMetricsEntity20:
...
class FleetManagementMetricsSchema20(BaseModel):
...
class FleetManagementMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementMetricsProcessor20()
