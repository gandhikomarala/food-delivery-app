...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_1
...
@dataclass
class FleetManagementMetricsEntity1:
...
class FleetManagementMetricsSchema1(BaseModel):
...
class FleetManagementMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementMetricsProcessor1()
