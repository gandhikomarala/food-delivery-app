...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_3
...
@dataclass
class FleetManagementMetricsEntity3:
...
class FleetManagementMetricsSchema3(BaseModel):
...
class FleetManagementMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementMetricsProcessor3()
