...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_8
...
@dataclass
class FleetManagementMetricsEntity8:
...
class FleetManagementMetricsSchema8(BaseModel):
...
class FleetManagementMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementMetricsProcessor8()
