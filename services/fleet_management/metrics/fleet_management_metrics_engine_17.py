...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_17
...
@dataclass
class FleetManagementMetricsEntity17:
...
class FleetManagementMetricsSchema17(BaseModel):
...
class FleetManagementMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementMetricsProcessor17()
