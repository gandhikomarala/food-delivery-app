...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_4
...
@dataclass
class FleetManagementMetricsEntity4:
...
class FleetManagementMetricsSchema4(BaseModel):
...
class FleetManagementMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementMetricsProcessor4()
