...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_9
...
@dataclass
class FleetManagementMetricsEntity9:
...
class FleetManagementMetricsSchema9(BaseModel):
...
class FleetManagementMetricsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementMetricsProcessor9()
