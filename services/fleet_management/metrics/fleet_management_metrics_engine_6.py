...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_6
...
@dataclass
class FleetManagementMetricsEntity6:
...
class FleetManagementMetricsSchema6(BaseModel):
...
class FleetManagementMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementMetricsProcessor6()
