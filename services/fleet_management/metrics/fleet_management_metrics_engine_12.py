...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_12
...
@dataclass
class FleetManagementMetricsEntity12:
...
class FleetManagementMetricsSchema12(BaseModel):
...
class FleetManagementMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementMetricsProcessor12()
