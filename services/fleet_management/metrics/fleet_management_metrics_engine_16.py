...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_16
...
@dataclass
class FleetManagementMetricsEntity16:
...
class FleetManagementMetricsSchema16(BaseModel):
...
class FleetManagementMetricsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementMetricsProcessor16()
