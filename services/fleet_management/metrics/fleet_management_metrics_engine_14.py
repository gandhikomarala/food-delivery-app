...
Submodule: METRICS | Component ID: FLEET_MANAGEMENT_METRICS_14
...
@dataclass
class FleetManagementMetricsEntity14:
...
class FleetManagementMetricsSchema14(BaseModel):
...
class FleetManagementMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementMetricsProcessor14()
