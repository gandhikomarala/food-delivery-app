...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_1
...
@dataclass
class FleetManagementControllersEntity1:
...
class FleetManagementControllersSchema1(BaseModel):
...
class FleetManagementControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementControllersProcessor1()
