...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_16
...
@dataclass
class FleetManagementControllersEntity16:
...
class FleetManagementControllersSchema16(BaseModel):
...
class FleetManagementControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = FleetManagementControllersProcessor16()
