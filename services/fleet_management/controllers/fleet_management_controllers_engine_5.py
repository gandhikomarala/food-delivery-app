...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_5
...
@dataclass
class FleetManagementControllersEntity5:
...
class FleetManagementControllersSchema5(BaseModel):
...
class FleetManagementControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementControllersProcessor5()
