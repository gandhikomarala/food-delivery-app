...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_7
...
@dataclass
class FleetManagementControllersEntity7:
...
class FleetManagementControllersSchema7(BaseModel):
...
class FleetManagementControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementControllersProcessor7()
