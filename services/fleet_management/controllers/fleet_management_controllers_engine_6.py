...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_6
...
@dataclass
class FleetManagementControllersEntity6:
...
class FleetManagementControllersSchema6(BaseModel):
...
class FleetManagementControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementControllersProcessor6()
