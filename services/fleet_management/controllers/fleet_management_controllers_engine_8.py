...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_8
...
@dataclass
class FleetManagementControllersEntity8:
...
class FleetManagementControllersSchema8(BaseModel):
...
class FleetManagementControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementControllersProcessor8()
