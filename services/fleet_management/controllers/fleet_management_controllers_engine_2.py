...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_2
...
@dataclass
class FleetManagementControllersEntity2:
...
class FleetManagementControllersSchema2(BaseModel):
...
class FleetManagementControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementControllersProcessor2()
