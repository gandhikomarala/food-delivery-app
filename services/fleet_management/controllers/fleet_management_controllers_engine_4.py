...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_4
...
@dataclass
class FleetManagementControllersEntity4:
...
class FleetManagementControllersSchema4(BaseModel):
...
class FleetManagementControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementControllersProcessor4()
