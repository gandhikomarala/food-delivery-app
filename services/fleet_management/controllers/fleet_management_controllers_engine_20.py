...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_20
...
@dataclass
class FleetManagementControllersEntity20:
...
class FleetManagementControllersSchema20(BaseModel):
...
class FleetManagementControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementControllersProcessor20()
