...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_14
...
@dataclass
class FleetManagementControllersEntity14:
...
class FleetManagementControllersSchema14(BaseModel):
...
class FleetManagementControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementControllersProcessor14()
