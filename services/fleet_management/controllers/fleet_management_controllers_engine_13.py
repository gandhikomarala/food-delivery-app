...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_13
...
@dataclass
class FleetManagementControllersEntity13:
...
class FleetManagementControllersSchema13(BaseModel):
...
class FleetManagementControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementControllersProcessor13()
