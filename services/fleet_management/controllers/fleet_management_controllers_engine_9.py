...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_9
...
@dataclass
class FleetManagementControllersEntity9:
...
class FleetManagementControllersSchema9(BaseModel):
...
class FleetManagementControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementControllersProcessor9()
