...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_3
...
@dataclass
class FleetManagementControllersEntity3:
...
class FleetManagementControllersSchema3(BaseModel):
...
class FleetManagementControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementControllersProcessor3()
