...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_12
...
@dataclass
class FleetManagementControllersEntity12:
...
class FleetManagementControllersSchema12(BaseModel):
...
class FleetManagementControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementControllersProcessor12()
