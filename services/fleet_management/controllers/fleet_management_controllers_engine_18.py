...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_18
...
@dataclass
class FleetManagementControllersEntity18:
...
class FleetManagementControllersSchema18(BaseModel):
...
class FleetManagementControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementControllersProcessor18()
