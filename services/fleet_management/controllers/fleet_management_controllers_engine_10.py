...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_10
...
@dataclass
class FleetManagementControllersEntity10:
...
class FleetManagementControllersSchema10(BaseModel):
...
class FleetManagementControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementControllersProcessor10()
