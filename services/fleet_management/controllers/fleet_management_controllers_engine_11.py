...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_11
...
@dataclass
class FleetManagementControllersEntity11:
...
class FleetManagementControllersSchema11(BaseModel):
...
class FleetManagementControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementControllersProcessor11()
