...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_15
...
@dataclass
class FleetManagementControllersEntity15:
...
class FleetManagementControllersSchema15(BaseModel):
...
class FleetManagementControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementControllersProcessor15()
