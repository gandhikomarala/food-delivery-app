...
Submodule: CONTROLLERS | Component ID: FLEET_MANAGEMENT_CONTROLLERS_17
...
@dataclass
class FleetManagementControllersEntity17:
...
class FleetManagementControllersSchema17(BaseModel):
...
class FleetManagementControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementControllersProcessor17()
