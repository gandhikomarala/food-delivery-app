...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_13
...
@dataclass
class FleetManagementServicesEntity13:
...
class FleetManagementServicesSchema13(BaseModel):
...
class FleetManagementServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FleetManagementServicesProcessor13()
