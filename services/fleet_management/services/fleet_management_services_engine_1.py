...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_1
...
@dataclass
class FleetManagementServicesEntity1:
...
class FleetManagementServicesSchema1(BaseModel):
...
class FleetManagementServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FleetManagementServicesProcessor1()
