...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_15
...
@dataclass
class FleetManagementServicesEntity15:
...
class FleetManagementServicesSchema15(BaseModel):
...
class FleetManagementServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FleetManagementServicesProcessor15()
