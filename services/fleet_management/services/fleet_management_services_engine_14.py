...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_14
...
@dataclass
class FleetManagementServicesEntity14:
...
class FleetManagementServicesSchema14(BaseModel):
...
class FleetManagementServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FleetManagementServicesProcessor14()
