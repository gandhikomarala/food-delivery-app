...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_12
...
@dataclass
class FleetManagementServicesEntity12:
...
class FleetManagementServicesSchema12(BaseModel):
...
class FleetManagementServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = FleetManagementServicesProcessor12()
