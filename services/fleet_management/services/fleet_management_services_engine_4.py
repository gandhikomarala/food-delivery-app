...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_4
...
@dataclass
class FleetManagementServicesEntity4:
...
class FleetManagementServicesSchema4(BaseModel):
...
class FleetManagementServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FleetManagementServicesProcessor4()
