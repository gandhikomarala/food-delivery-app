...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_6
...
@dataclass
class FleetManagementServicesEntity6:
...
class FleetManagementServicesSchema6(BaseModel):
...
class FleetManagementServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FleetManagementServicesProcessor6()
