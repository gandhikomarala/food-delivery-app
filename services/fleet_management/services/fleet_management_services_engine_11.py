...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_11
...
@dataclass
class FleetManagementServicesEntity11:
...
class FleetManagementServicesSchema11(BaseModel):
...
class FleetManagementServicesProcessor11:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema11) -> Dict[str, Any]:
...
default_processor_11 = FleetManagementServicesProcessor11()
