...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_18
...
@dataclass
class FleetManagementServicesEntity18:
...
class FleetManagementServicesSchema18(BaseModel):
...
class FleetManagementServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FleetManagementServicesProcessor18()
