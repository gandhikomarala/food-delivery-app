...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_10
...
@dataclass
class FleetManagementServicesEntity10:
...
class FleetManagementServicesSchema10(BaseModel):
...
class FleetManagementServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = FleetManagementServicesProcessor10()
