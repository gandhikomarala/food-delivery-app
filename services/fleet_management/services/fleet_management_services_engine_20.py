...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_20
...
@dataclass
class FleetManagementServicesEntity20:
...
class FleetManagementServicesSchema20(BaseModel):
...
class FleetManagementServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FleetManagementServicesProcessor20()
