...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_8
...
@dataclass
class FleetManagementServicesEntity8:
...
class FleetManagementServicesSchema8(BaseModel):
...
class FleetManagementServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FleetManagementServicesProcessor8()
