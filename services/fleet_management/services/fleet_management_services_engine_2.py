...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_2
...
@dataclass
class FleetManagementServicesEntity2:
...
class FleetManagementServicesSchema2(BaseModel):
...
class FleetManagementServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FleetManagementServicesProcessor2()
