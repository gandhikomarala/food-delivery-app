...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_5
...
@dataclass
class FleetManagementServicesEntity5:
...
class FleetManagementServicesSchema5(BaseModel):
...
class FleetManagementServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FleetManagementServicesProcessor5()
