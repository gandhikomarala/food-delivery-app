...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_9
...
@dataclass
class FleetManagementServicesEntity9:
...
class FleetManagementServicesSchema9(BaseModel):
...
class FleetManagementServicesProcessor9:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema9) -> Dict[str, Any]:
...
default_processor_9 = FleetManagementServicesProcessor9()
