...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_17
...
@dataclass
class FleetManagementServicesEntity17:
...
class FleetManagementServicesSchema17(BaseModel):
...
class FleetManagementServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FleetManagementServicesProcessor17()
