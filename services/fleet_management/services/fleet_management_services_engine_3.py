...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_3
...
@dataclass
class FleetManagementServicesEntity3:
...
class FleetManagementServicesSchema3(BaseModel):
...
class FleetManagementServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FleetManagementServicesProcessor3()
