...
Submodule: SERVICES | Component ID: FLEET_MANAGEMENT_SERVICES_7
...
@dataclass
class FleetManagementServicesEntity7:
...
class FleetManagementServicesSchema7(BaseModel):
...
class FleetManagementServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: FleetManagementServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = FleetManagementServicesProcessor7()
