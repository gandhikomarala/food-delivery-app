...
Submodule: EVENTS | Component ID: CATALOG_INVENTORY_EVENTS_17
...
@dataclass
class CatalogInventoryEventsEntity17:
...
class CatalogInventoryEventsSchema17(BaseModel):
...
class CatalogInventoryEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = CatalogInventoryEventsProcessor17()
