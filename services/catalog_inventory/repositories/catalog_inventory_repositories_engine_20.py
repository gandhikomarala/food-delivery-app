...
Submodule: REPOSITORIES | Component ID: CATALOG_INVENTORY_REPOSITORIES_20
...
@dataclass
class CatalogInventoryRepositoriesEntity20:
...
class CatalogInventoryRepositoriesSchema20(BaseModel):
...
class CatalogInventoryRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = CatalogInventoryRepositoriesProcessor20()
