...
Submodule: CONTROLLERS | Component ID: CATALOG_INVENTORY_CONTROLLERS_2
...
@dataclass
class CatalogInventoryControllersEntity2:
...
class CatalogInventoryControllersSchema2(BaseModel):
...
class CatalogInventoryControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = CatalogInventoryControllersProcessor2()
