...
Submodule: CONTROLLERS | Component ID: CATALOG_INVENTORY_CONTROLLERS_12
...
@dataclass
class CatalogInventoryControllersEntity12:
...
class CatalogInventoryControllersSchema12(BaseModel):
...
class CatalogInventoryControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = CatalogInventoryControllersProcessor12()
