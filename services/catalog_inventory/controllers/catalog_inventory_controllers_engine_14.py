...
Submodule: CONTROLLERS | Component ID: CATALOG_INVENTORY_CONTROLLERS_14
...
@dataclass
class CatalogInventoryControllersEntity14:
...
class CatalogInventoryControllersSchema14(BaseModel):
...
class CatalogInventoryControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = CatalogInventoryControllersProcessor14()
