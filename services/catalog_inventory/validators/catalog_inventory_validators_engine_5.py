...
Submodule: VALIDATORS | Component ID: CATALOG_INVENTORY_VALIDATORS_5
...
@dataclass
class CatalogInventoryValidatorsEntity5:
...
class CatalogInventoryValidatorsSchema5(BaseModel):
...
class CatalogInventoryValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = CatalogInventoryValidatorsProcessor5()
