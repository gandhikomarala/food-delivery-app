...
Submodule: VALIDATORS | Component ID: CATALOG_INVENTORY_VALIDATORS_2
...
@dataclass
class CatalogInventoryValidatorsEntity2:
...
class CatalogInventoryValidatorsSchema2(BaseModel):
...
class CatalogInventoryValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = CatalogInventoryValidatorsProcessor2()
