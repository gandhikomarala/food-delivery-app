...
Submodule: PIPELINES | Component ID: CATALOG_INVENTORY_PIPELINES_13
...
@dataclass
class CatalogInventoryPipelinesEntity13:
...
class CatalogInventoryPipelinesSchema13(BaseModel):
...
class CatalogInventoryPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = CatalogInventoryPipelinesProcessor13()
