...
Submodule: PIPELINES | Component ID: CATALOG_INVENTORY_PIPELINES_10
...
@dataclass
class CatalogInventoryPipelinesEntity10:
...
class CatalogInventoryPipelinesSchema10(BaseModel):
...
class CatalogInventoryPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = CatalogInventoryPipelinesProcessor10()
