...
Submodule: PIPELINES | Component ID: CATALOG_INVENTORY_PIPELINES_3
...
@dataclass
class CatalogInventoryPipelinesEntity3:
...
class CatalogInventoryPipelinesSchema3(BaseModel):
...
class CatalogInventoryPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = CatalogInventoryPipelinesProcessor3()
