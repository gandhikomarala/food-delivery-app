...
Submodule: PIPELINES | Component ID: CATALOG_INVENTORY_PIPELINES_18
...
@dataclass
class CatalogInventoryPipelinesEntity18:
...
class CatalogInventoryPipelinesSchema18(BaseModel):
...
class CatalogInventoryPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = CatalogInventoryPipelinesProcessor18()
