...
Submodule: PIPELINES | Component ID: CATALOG_INVENTORY_PIPELINES_15
...
@dataclass
class CatalogInventoryPipelinesEntity15:
...
class CatalogInventoryPipelinesSchema15(BaseModel):
...
class CatalogInventoryPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = CatalogInventoryPipelinesProcessor15()
