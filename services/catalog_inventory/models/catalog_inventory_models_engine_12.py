...
Submodule: MODELS | Component ID: CATALOG_INVENTORY_MODELS_12
...
@dataclass
class CatalogInventoryModelsEntity12:
...
class CatalogInventoryModelsSchema12(BaseModel):
...
class CatalogInventoryModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = CatalogInventoryModelsProcessor12()
