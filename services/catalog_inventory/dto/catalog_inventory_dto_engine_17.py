...
Submodule: DTO | Component ID: CATALOG_INVENTORY_DTO_17
...
@dataclass
class CatalogInventoryDtoEntity17:
...
class CatalogInventoryDtoSchema17(BaseModel):
...
class CatalogInventoryDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: CatalogInventoryDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = CatalogInventoryDtoProcessor17()
