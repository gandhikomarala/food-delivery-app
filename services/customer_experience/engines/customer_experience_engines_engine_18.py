...
Submodule: ENGINES | Component ID: CUSTOMER_EXPERIENCE_ENGINES_18
...
@dataclass
class CustomerExperienceEnginesEntity18:
...
class CustomerExperienceEnginesSchema18(BaseModel):
...
class CustomerExperienceEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = CustomerExperienceEnginesProcessor18()
