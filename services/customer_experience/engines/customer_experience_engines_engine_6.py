...
Submodule: ENGINES | Component ID: CUSTOMER_EXPERIENCE_ENGINES_6
...
@dataclass
class CustomerExperienceEnginesEntity6:
...
class CustomerExperienceEnginesSchema6(BaseModel):
...
class CustomerExperienceEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = CustomerExperienceEnginesProcessor6()
