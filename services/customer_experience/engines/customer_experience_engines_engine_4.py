...
Submodule: ENGINES | Component ID: CUSTOMER_EXPERIENCE_ENGINES_4
...
@dataclass
class CustomerExperienceEnginesEntity4:
...
class CustomerExperienceEnginesSchema4(BaseModel):
...
class CustomerExperienceEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = CustomerExperienceEnginesProcessor4()
