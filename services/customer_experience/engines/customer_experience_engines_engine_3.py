...
Submodule: ENGINES | Component ID: CUSTOMER_EXPERIENCE_ENGINES_3
...
@dataclass
class CustomerExperienceEnginesEntity3:
...
class CustomerExperienceEnginesSchema3(BaseModel):
...
class CustomerExperienceEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceEnginesProcessor3()
