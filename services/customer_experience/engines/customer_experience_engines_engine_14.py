...
Submodule: ENGINES | Component ID: CUSTOMER_EXPERIENCE_ENGINES_14
...
@dataclass
class CustomerExperienceEnginesEntity14:
...
class CustomerExperienceEnginesSchema14(BaseModel):
...
class CustomerExperienceEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = CustomerExperienceEnginesProcessor14()
