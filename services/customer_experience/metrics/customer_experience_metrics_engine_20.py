...
Submodule: METRICS | Component ID: CUSTOMER_EXPERIENCE_METRICS_20
...
@dataclass
class CustomerExperienceMetricsEntity20:
...
class CustomerExperienceMetricsSchema20(BaseModel):
...
class CustomerExperienceMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = CustomerExperienceMetricsProcessor20()
