...
Submodule: METRICS | Component ID: CUSTOMER_EXPERIENCE_METRICS_3
...
@dataclass
class CustomerExperienceMetricsEntity3:
...
class CustomerExperienceMetricsSchema3(BaseModel):
...
class CustomerExperienceMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceMetricsProcessor3()
