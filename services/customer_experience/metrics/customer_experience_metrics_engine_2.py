...
Submodule: METRICS | Component ID: CUSTOMER_EXPERIENCE_METRICS_2
...
@dataclass
class CustomerExperienceMetricsEntity2:
...
class CustomerExperienceMetricsSchema2(BaseModel):
...
class CustomerExperienceMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = CustomerExperienceMetricsProcessor2()
