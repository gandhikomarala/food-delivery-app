...
Submodule: MODELS | Component ID: CUSTOMER_EXPERIENCE_MODELS_3
...
@dataclass
class CustomerExperienceModelsEntity3:
...
class CustomerExperienceModelsSchema3(BaseModel):
...
class CustomerExperienceModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceModelsProcessor3()
