...
Submodule: MODELS | Component ID: CUSTOMER_EXPERIENCE_MODELS_2
...
@dataclass
class CustomerExperienceModelsEntity2:
...
class CustomerExperienceModelsSchema2(BaseModel):
...
class CustomerExperienceModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = CustomerExperienceModelsProcessor2()
