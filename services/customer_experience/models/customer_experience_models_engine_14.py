...
Submodule: MODELS | Component ID: CUSTOMER_EXPERIENCE_MODELS_14
...
@dataclass
class CustomerExperienceModelsEntity14:
...
class CustomerExperienceModelsSchema14(BaseModel):
...
class CustomerExperienceModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = CustomerExperienceModelsProcessor14()
