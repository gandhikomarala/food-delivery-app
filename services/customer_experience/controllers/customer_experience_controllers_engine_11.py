...
Submodule: CONTROLLERS | Component ID: CUSTOMER_EXPERIENCE_CONTROLLERS_11
...
@dataclass
class CustomerExperienceControllersEntity11:
...
class CustomerExperienceControllersSchema11(BaseModel):
...
class CustomerExperienceControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = CustomerExperienceControllersProcessor11()
