...
Submodule: CONTROLLERS | Component ID: CUSTOMER_EXPERIENCE_CONTROLLERS_3
...
@dataclass
class CustomerExperienceControllersEntity3:
...
class CustomerExperienceControllersSchema3(BaseModel):
...
class CustomerExperienceControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceControllersProcessor3()
