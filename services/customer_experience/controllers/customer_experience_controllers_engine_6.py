...
Submodule: CONTROLLERS | Component ID: CUSTOMER_EXPERIENCE_CONTROLLERS_6
...
@dataclass
class CustomerExperienceControllersEntity6:
...
class CustomerExperienceControllersSchema6(BaseModel):
...
class CustomerExperienceControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = CustomerExperienceControllersProcessor6()
