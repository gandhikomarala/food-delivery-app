...
Submodule: CONTROLLERS | Component ID: CUSTOMER_EXPERIENCE_CONTROLLERS_15
...
@dataclass
class CustomerExperienceControllersEntity15:
...
class CustomerExperienceControllersSchema15(BaseModel):
...
class CustomerExperienceControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = CustomerExperienceControllersProcessor15()
