...
Submodule: DTO | Component ID: CUSTOMER_EXPERIENCE_DTO_3
...
@dataclass
class CustomerExperienceDtoEntity3:
...
class CustomerExperienceDtoSchema3(BaseModel):
...
class CustomerExperienceDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceDtoProcessor3()
