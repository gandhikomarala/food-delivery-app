...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_8
...
@dataclass
class CustomerExperiencePipelinesEntity8:
...
class CustomerExperiencePipelinesSchema8(BaseModel):
...
class CustomerExperiencePipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = CustomerExperiencePipelinesProcessor8()
