...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_3
...
@dataclass
class CustomerExperiencePipelinesEntity3:
...
class CustomerExperiencePipelinesSchema3(BaseModel):
...
class CustomerExperiencePipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperiencePipelinesProcessor3()
