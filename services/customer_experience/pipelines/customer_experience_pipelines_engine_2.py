...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_2
...
@dataclass
class CustomerExperiencePipelinesEntity2:
...
class CustomerExperiencePipelinesSchema2(BaseModel):
...
class CustomerExperiencePipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = CustomerExperiencePipelinesProcessor2()
