...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_13
...
@dataclass
class CustomerExperiencePipelinesEntity13:
...
class CustomerExperiencePipelinesSchema13(BaseModel):
...
class CustomerExperiencePipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = CustomerExperiencePipelinesProcessor13()
