...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_14
...
@dataclass
class CustomerExperiencePipelinesEntity14:
...
class CustomerExperiencePipelinesSchema14(BaseModel):
...
class CustomerExperiencePipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = CustomerExperiencePipelinesProcessor14()
