...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_5
...
@dataclass
class CustomerExperiencePipelinesEntity5:
...
class CustomerExperiencePipelinesSchema5(BaseModel):
...
class CustomerExperiencePipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = CustomerExperiencePipelinesProcessor5()
