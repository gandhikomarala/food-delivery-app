...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_6
...
@dataclass
class CustomerExperiencePipelinesEntity6:
...
class CustomerExperiencePipelinesSchema6(BaseModel):
...
class CustomerExperiencePipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = CustomerExperiencePipelinesProcessor6()
