...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_9
...
@dataclass
class CustomerExperiencePipelinesEntity9:
...
class CustomerExperiencePipelinesSchema9(BaseModel):
...
class CustomerExperiencePipelinesProcessor9:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema9) -> Dict[str, Any]:
...
default_processor_9 = CustomerExperiencePipelinesProcessor9()
