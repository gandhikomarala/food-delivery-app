...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_20
...
@dataclass
class CustomerExperiencePipelinesEntity20:
...
class CustomerExperiencePipelinesSchema20(BaseModel):
...
class CustomerExperiencePipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = CustomerExperiencePipelinesProcessor20()
