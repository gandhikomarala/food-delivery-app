...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_17
...
@dataclass
class CustomerExperiencePipelinesEntity17:
...
class CustomerExperiencePipelinesSchema17(BaseModel):
...
class CustomerExperiencePipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = CustomerExperiencePipelinesProcessor17()
