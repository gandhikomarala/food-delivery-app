...
Submodule: PIPELINES | Component ID: CUSTOMER_EXPERIENCE_PIPELINES_4
...
@dataclass
class CustomerExperiencePipelinesEntity4:
...
class CustomerExperiencePipelinesSchema4(BaseModel):
...
class CustomerExperiencePipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: CustomerExperiencePipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = CustomerExperiencePipelinesProcessor4()
