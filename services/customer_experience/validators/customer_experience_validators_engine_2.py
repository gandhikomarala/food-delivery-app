...
Submodule: VALIDATORS | Component ID: CUSTOMER_EXPERIENCE_VALIDATORS_2
...
@dataclass
class CustomerExperienceValidatorsEntity2:
...
class CustomerExperienceValidatorsSchema2(BaseModel):
...
class CustomerExperienceValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = CustomerExperienceValidatorsProcessor2()
