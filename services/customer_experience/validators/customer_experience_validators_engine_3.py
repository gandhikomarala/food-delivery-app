...
Submodule: VALIDATORS | Component ID: CUSTOMER_EXPERIENCE_VALIDATORS_3
...
@dataclass
class CustomerExperienceValidatorsEntity3:
...
class CustomerExperienceValidatorsSchema3(BaseModel):
...
class CustomerExperienceValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceValidatorsProcessor3()
