...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_17
...
@dataclass
class CustomerExperienceEventsEntity17:
...
class CustomerExperienceEventsSchema17(BaseModel):
...
class CustomerExperienceEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = CustomerExperienceEventsProcessor17()
