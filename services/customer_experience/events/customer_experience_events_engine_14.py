...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_14
...
@dataclass
class CustomerExperienceEventsEntity14:
...
class CustomerExperienceEventsSchema14(BaseModel):
...
class CustomerExperienceEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = CustomerExperienceEventsProcessor14()
