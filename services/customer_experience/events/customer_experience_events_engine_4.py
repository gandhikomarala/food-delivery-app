...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_4
...
@dataclass
class CustomerExperienceEventsEntity4:
...
class CustomerExperienceEventsSchema4(BaseModel):
...
class CustomerExperienceEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = CustomerExperienceEventsProcessor4()
