...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_2
...
@dataclass
class CustomerExperienceEventsEntity2:
...
class CustomerExperienceEventsSchema2(BaseModel):
...
class CustomerExperienceEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = CustomerExperienceEventsProcessor2()
