...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_3
...
@dataclass
class CustomerExperienceEventsEntity3:
...
class CustomerExperienceEventsSchema3(BaseModel):
...
class CustomerExperienceEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = CustomerExperienceEventsProcessor3()
