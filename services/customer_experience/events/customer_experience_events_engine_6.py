...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_6
...
@dataclass
class CustomerExperienceEventsEntity6:
...
class CustomerExperienceEventsSchema6(BaseModel):
...
class CustomerExperienceEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = CustomerExperienceEventsProcessor6()
