...
Submodule: EVENTS | Component ID: CUSTOMER_EXPERIENCE_EVENTS_11
...
@dataclass
class CustomerExperienceEventsEntity11:
...
class CustomerExperienceEventsSchema11(BaseModel):
...
class CustomerExperienceEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: CustomerExperienceEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = CustomerExperienceEventsProcessor11()
