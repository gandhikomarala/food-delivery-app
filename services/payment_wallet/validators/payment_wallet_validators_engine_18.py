...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_18
...
@dataclass
class PaymentWalletValidatorsEntity18:
...
class PaymentWalletValidatorsSchema18(BaseModel):
...
class PaymentWalletValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletValidatorsProcessor18()
