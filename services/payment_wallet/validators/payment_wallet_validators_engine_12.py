...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_12
...
@dataclass
class PaymentWalletValidatorsEntity12:
...
class PaymentWalletValidatorsSchema12(BaseModel):
...
class PaymentWalletValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletValidatorsProcessor12()
