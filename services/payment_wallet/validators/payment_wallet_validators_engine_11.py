...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_11
...
@dataclass
class PaymentWalletValidatorsEntity11:
...
class PaymentWalletValidatorsSchema11(BaseModel):
...
class PaymentWalletValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = PaymentWalletValidatorsProcessor11()
