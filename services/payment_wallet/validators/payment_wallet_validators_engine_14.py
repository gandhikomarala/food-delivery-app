...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_14
...
@dataclass
class PaymentWalletValidatorsEntity14:
...
class PaymentWalletValidatorsSchema14(BaseModel):
...
class PaymentWalletValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletValidatorsProcessor14()
