...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_17
...
@dataclass
class PaymentWalletValidatorsEntity17:
...
class PaymentWalletValidatorsSchema17(BaseModel):
...
class PaymentWalletValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = PaymentWalletValidatorsProcessor17()
