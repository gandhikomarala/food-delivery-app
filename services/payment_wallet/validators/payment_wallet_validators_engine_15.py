...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_15
...
@dataclass
class PaymentWalletValidatorsEntity15:
...
class PaymentWalletValidatorsSchema15(BaseModel):
...
class PaymentWalletValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletValidatorsProcessor15()
