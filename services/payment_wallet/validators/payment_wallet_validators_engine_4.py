...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_4
...
@dataclass
class PaymentWalletValidatorsEntity4:
...
class PaymentWalletValidatorsSchema4(BaseModel):
...
class PaymentWalletValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletValidatorsProcessor4()
