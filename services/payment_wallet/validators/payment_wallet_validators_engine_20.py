...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_20
...
@dataclass
class PaymentWalletValidatorsEntity20:
...
class PaymentWalletValidatorsSchema20(BaseModel):
...
class PaymentWalletValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletValidatorsProcessor20()
