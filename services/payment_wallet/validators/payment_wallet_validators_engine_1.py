...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_1
...
@dataclass
class PaymentWalletValidatorsEntity1:
...
class PaymentWalletValidatorsSchema1(BaseModel):
...
class PaymentWalletValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletValidatorsProcessor1()
