...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_3
...
@dataclass
class PaymentWalletValidatorsEntity3:
...
class PaymentWalletValidatorsSchema3(BaseModel):
...
class PaymentWalletValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletValidatorsProcessor3()
