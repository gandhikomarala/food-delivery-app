...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_5
...
@dataclass
class PaymentWalletValidatorsEntity5:
...
class PaymentWalletValidatorsSchema5(BaseModel):
...
class PaymentWalletValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletValidatorsProcessor5()
