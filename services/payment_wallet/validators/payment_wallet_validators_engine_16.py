...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_16
...
@dataclass
class PaymentWalletValidatorsEntity16:
...
class PaymentWalletValidatorsSchema16(BaseModel):
...
class PaymentWalletValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = PaymentWalletValidatorsProcessor16()
