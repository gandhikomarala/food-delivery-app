...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_2
...
@dataclass
class PaymentWalletValidatorsEntity2:
...
class PaymentWalletValidatorsSchema2(BaseModel):
...
class PaymentWalletValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletValidatorsProcessor2()
