...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_10
...
@dataclass
class PaymentWalletValidatorsEntity10:
...
class PaymentWalletValidatorsSchema10(BaseModel):
...
class PaymentWalletValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = PaymentWalletValidatorsProcessor10()
