...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_13
...
@dataclass
class PaymentWalletValidatorsEntity13:
...
class PaymentWalletValidatorsSchema13(BaseModel):
...
class PaymentWalletValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletValidatorsProcessor13()
