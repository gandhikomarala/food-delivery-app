...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_6
...
@dataclass
class PaymentWalletValidatorsEntity6:
...
class PaymentWalletValidatorsSchema6(BaseModel):
...
class PaymentWalletValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletValidatorsProcessor6()
