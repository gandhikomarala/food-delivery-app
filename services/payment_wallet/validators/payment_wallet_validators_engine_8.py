...
Submodule: VALIDATORS | Component ID: PAYMENT_WALLET_VALIDATORS_8
...
@dataclass
class PaymentWalletValidatorsEntity8:
...
class PaymentWalletValidatorsSchema8(BaseModel):
...
class PaymentWalletValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletValidatorsProcessor8()
