...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_6
...
@dataclass
class PaymentWalletEventsEntity6:
...
class PaymentWalletEventsSchema6(BaseModel):
...
class PaymentWalletEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletEventsProcessor6()
