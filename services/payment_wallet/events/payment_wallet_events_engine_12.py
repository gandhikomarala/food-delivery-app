...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_12
...
@dataclass
class PaymentWalletEventsEntity12:
...
class PaymentWalletEventsSchema12(BaseModel):
...
class PaymentWalletEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletEventsProcessor12()
