...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_17
...
@dataclass
class PaymentWalletEventsEntity17:
...
class PaymentWalletEventsSchema17(BaseModel):
...
class PaymentWalletEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = PaymentWalletEventsProcessor17()
