...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_14
...
@dataclass
class PaymentWalletEventsEntity14:
...
class PaymentWalletEventsSchema14(BaseModel):
...
class PaymentWalletEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletEventsProcessor14()
