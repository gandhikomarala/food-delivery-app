...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_8
...
@dataclass
class PaymentWalletEventsEntity8:
...
class PaymentWalletEventsSchema8(BaseModel):
...
class PaymentWalletEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletEventsProcessor8()
