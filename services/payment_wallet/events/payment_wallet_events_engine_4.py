...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_4
...
@dataclass
class PaymentWalletEventsEntity4:
...
class PaymentWalletEventsSchema4(BaseModel):
...
class PaymentWalletEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletEventsProcessor4()
