...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_18
...
@dataclass
class PaymentWalletEventsEntity18:
...
class PaymentWalletEventsSchema18(BaseModel):
...
class PaymentWalletEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletEventsProcessor18()
