...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_15
...
@dataclass
class PaymentWalletEventsEntity15:
...
class PaymentWalletEventsSchema15(BaseModel):
...
class PaymentWalletEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletEventsProcessor15()
