...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_13
...
@dataclass
class PaymentWalletEventsEntity13:
...
class PaymentWalletEventsSchema13(BaseModel):
...
class PaymentWalletEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletEventsProcessor13()
