...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_3
...
@dataclass
class PaymentWalletEventsEntity3:
...
class PaymentWalletEventsSchema3(BaseModel):
...
class PaymentWalletEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletEventsProcessor3()
