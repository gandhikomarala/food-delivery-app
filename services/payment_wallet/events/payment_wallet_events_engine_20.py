...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_20
...
@dataclass
class PaymentWalletEventsEntity20:
...
class PaymentWalletEventsSchema20(BaseModel):
...
class PaymentWalletEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletEventsProcessor20()
