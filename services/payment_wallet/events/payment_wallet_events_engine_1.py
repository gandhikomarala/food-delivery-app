...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_1
...
@dataclass
class PaymentWalletEventsEntity1:
...
class PaymentWalletEventsSchema1(BaseModel):
...
class PaymentWalletEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletEventsProcessor1()
