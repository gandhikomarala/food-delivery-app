...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_5
...
@dataclass
class PaymentWalletEventsEntity5:
...
class PaymentWalletEventsSchema5(BaseModel):
...
class PaymentWalletEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletEventsProcessor5()
