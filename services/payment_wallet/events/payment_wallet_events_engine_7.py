...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_7
...
@dataclass
class PaymentWalletEventsEntity7:
...
class PaymentWalletEventsSchema7(BaseModel):
...
class PaymentWalletEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = PaymentWalletEventsProcessor7()
