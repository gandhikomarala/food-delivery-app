...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_16
...
@dataclass
class PaymentWalletEventsEntity16:
...
class PaymentWalletEventsSchema16(BaseModel):
...
class PaymentWalletEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = PaymentWalletEventsProcessor16()
