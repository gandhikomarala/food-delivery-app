...
Submodule: EVENTS | Component ID: PAYMENT_WALLET_EVENTS_2
...
@dataclass
class PaymentWalletEventsEntity2:
...
class PaymentWalletEventsSchema2(BaseModel):
...
class PaymentWalletEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletEventsProcessor2()
