...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_17
...
@dataclass
class PaymentWalletPipelinesEntity17:
...
class PaymentWalletPipelinesSchema17(BaseModel):
...
class PaymentWalletPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = PaymentWalletPipelinesProcessor17()
