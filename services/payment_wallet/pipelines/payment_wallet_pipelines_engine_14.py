...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_14
...
@dataclass
class PaymentWalletPipelinesEntity14:
...
class PaymentWalletPipelinesSchema14(BaseModel):
...
class PaymentWalletPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletPipelinesProcessor14()
