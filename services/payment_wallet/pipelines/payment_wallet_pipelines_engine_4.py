...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_4
...
@dataclass
class PaymentWalletPipelinesEntity4:
...
class PaymentWalletPipelinesSchema4(BaseModel):
...
class PaymentWalletPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletPipelinesProcessor4()
