...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_13
...
@dataclass
class PaymentWalletPipelinesEntity13:
...
class PaymentWalletPipelinesSchema13(BaseModel):
...
class PaymentWalletPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletPipelinesProcessor13()
