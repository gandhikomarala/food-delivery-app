...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_7
...
@dataclass
class PaymentWalletPipelinesEntity7:
...
class PaymentWalletPipelinesSchema7(BaseModel):
...
class PaymentWalletPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = PaymentWalletPipelinesProcessor7()
