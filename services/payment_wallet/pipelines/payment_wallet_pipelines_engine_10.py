...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_10
...
@dataclass
class PaymentWalletPipelinesEntity10:
...
class PaymentWalletPipelinesSchema10(BaseModel):
...
class PaymentWalletPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = PaymentWalletPipelinesProcessor10()
