...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_1
...
@dataclass
class PaymentWalletPipelinesEntity1:
...
class PaymentWalletPipelinesSchema1(BaseModel):
...
class PaymentWalletPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletPipelinesProcessor1()
