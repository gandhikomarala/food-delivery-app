...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_8
...
@dataclass
class PaymentWalletPipelinesEntity8:
...
class PaymentWalletPipelinesSchema8(BaseModel):
...
class PaymentWalletPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletPipelinesProcessor8()
