...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_5
...
@dataclass
class PaymentWalletPipelinesEntity5:
...
class PaymentWalletPipelinesSchema5(BaseModel):
...
class PaymentWalletPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletPipelinesProcessor5()
