...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_18
...
@dataclass
class PaymentWalletPipelinesEntity18:
...
class PaymentWalletPipelinesSchema18(BaseModel):
...
class PaymentWalletPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletPipelinesProcessor18()
