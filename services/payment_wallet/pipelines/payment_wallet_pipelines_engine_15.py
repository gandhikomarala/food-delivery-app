...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_15
...
@dataclass
class PaymentWalletPipelinesEntity15:
...
class PaymentWalletPipelinesSchema15(BaseModel):
...
class PaymentWalletPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletPipelinesProcessor15()
