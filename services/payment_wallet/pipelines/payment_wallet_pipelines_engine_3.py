...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_3
...
@dataclass
class PaymentWalletPipelinesEntity3:
...
class PaymentWalletPipelinesSchema3(BaseModel):
...
class PaymentWalletPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletPipelinesProcessor3()
