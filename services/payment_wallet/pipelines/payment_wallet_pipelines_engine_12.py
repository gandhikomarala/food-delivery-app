...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_12
...
@dataclass
class PaymentWalletPipelinesEntity12:
...
class PaymentWalletPipelinesSchema12(BaseModel):
...
class PaymentWalletPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletPipelinesProcessor12()
