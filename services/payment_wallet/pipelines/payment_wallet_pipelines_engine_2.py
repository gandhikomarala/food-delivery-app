...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_2
...
@dataclass
class PaymentWalletPipelinesEntity2:
...
class PaymentWalletPipelinesSchema2(BaseModel):
...
class PaymentWalletPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletPipelinesProcessor2()
