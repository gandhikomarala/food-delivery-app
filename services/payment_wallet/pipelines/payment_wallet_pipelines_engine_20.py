...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_20
...
@dataclass
class PaymentWalletPipelinesEntity20:
...
class PaymentWalletPipelinesSchema20(BaseModel):
...
class PaymentWalletPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletPipelinesProcessor20()
