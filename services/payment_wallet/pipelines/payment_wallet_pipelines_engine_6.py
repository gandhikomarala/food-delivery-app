...
Submodule: PIPELINES | Component ID: PAYMENT_WALLET_PIPELINES_6
...
@dataclass
class PaymentWalletPipelinesEntity6:
...
class PaymentWalletPipelinesSchema6(BaseModel):
...
class PaymentWalletPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletPipelinesProcessor6()
