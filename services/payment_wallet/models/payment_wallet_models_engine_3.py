...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_3
...
@dataclass
class PaymentWalletModelsEntity3:
...
class PaymentWalletModelsSchema3(BaseModel):
...
class PaymentWalletModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletModelsProcessor3()
