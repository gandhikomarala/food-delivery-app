...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_6
...
@dataclass
class PaymentWalletModelsEntity6:
...
class PaymentWalletModelsSchema6(BaseModel):
...
class PaymentWalletModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletModelsProcessor6()
