...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_15
...
@dataclass
class PaymentWalletModelsEntity15:
...
class PaymentWalletModelsSchema15(BaseModel):
...
class PaymentWalletModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletModelsProcessor15()
