...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_4
...
@dataclass
class PaymentWalletModelsEntity4:
...
class PaymentWalletModelsSchema4(BaseModel):
...
class PaymentWalletModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletModelsProcessor4()
