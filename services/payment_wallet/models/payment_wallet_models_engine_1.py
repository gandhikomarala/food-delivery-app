...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_1
...
@dataclass
class PaymentWalletModelsEntity1:
...
class PaymentWalletModelsSchema1(BaseModel):
...
class PaymentWalletModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletModelsProcessor1()
