...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_18
...
@dataclass
class PaymentWalletModelsEntity18:
...
class PaymentWalletModelsSchema18(BaseModel):
...
class PaymentWalletModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletModelsProcessor18()
