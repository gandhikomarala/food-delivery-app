...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_20
...
@dataclass
class PaymentWalletModelsEntity20:
...
class PaymentWalletModelsSchema20(BaseModel):
...
class PaymentWalletModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletModelsProcessor20()
