...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_13
...
@dataclass
class PaymentWalletModelsEntity13:
...
class PaymentWalletModelsSchema13(BaseModel):
...
class PaymentWalletModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletModelsProcessor13()
