...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_14
...
@dataclass
class PaymentWalletModelsEntity14:
...
class PaymentWalletModelsSchema14(BaseModel):
...
class PaymentWalletModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletModelsProcessor14()
