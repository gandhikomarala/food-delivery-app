...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_8
...
@dataclass
class PaymentWalletModelsEntity8:
...
class PaymentWalletModelsSchema8(BaseModel):
...
class PaymentWalletModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletModelsProcessor8()
