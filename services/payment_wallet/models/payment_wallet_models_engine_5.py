...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_5
...
@dataclass
class PaymentWalletModelsEntity5:
...
class PaymentWalletModelsSchema5(BaseModel):
...
class PaymentWalletModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletModelsProcessor5()
