...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_7
...
@dataclass
class PaymentWalletModelsEntity7:
...
class PaymentWalletModelsSchema7(BaseModel):
...
class PaymentWalletModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = PaymentWalletModelsProcessor7()
