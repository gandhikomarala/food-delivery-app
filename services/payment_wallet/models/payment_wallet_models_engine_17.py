...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_17
...
@dataclass
class PaymentWalletModelsEntity17:
...
class PaymentWalletModelsSchema17(BaseModel):
...
class PaymentWalletModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = PaymentWalletModelsProcessor17()
