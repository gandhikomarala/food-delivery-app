...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_9
...
@dataclass
class PaymentWalletModelsEntity9:
...
class PaymentWalletModelsSchema9(BaseModel):
...
class PaymentWalletModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = PaymentWalletModelsProcessor9()
