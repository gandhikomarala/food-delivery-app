...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_12
...
@dataclass
class PaymentWalletModelsEntity12:
...
class PaymentWalletModelsSchema12(BaseModel):
...
class PaymentWalletModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletModelsProcessor12()
