...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_10
...
@dataclass
class PaymentWalletModelsEntity10:
...
class PaymentWalletModelsSchema10(BaseModel):
...
class PaymentWalletModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = PaymentWalletModelsProcessor10()
