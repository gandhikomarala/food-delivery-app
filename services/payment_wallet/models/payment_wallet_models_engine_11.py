...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_11
...
@dataclass
class PaymentWalletModelsEntity11:
...
class PaymentWalletModelsSchema11(BaseModel):
...
class PaymentWalletModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = PaymentWalletModelsProcessor11()
