...
Submodule: MODELS | Component ID: PAYMENT_WALLET_MODELS_2
...
@dataclass
class PaymentWalletModelsEntity2:
...
class PaymentWalletModelsSchema2(BaseModel):
...
class PaymentWalletModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletModelsProcessor2()
