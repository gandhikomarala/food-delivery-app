...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_2
...
@dataclass
class PaymentWalletMetricsEntity2:
...
class PaymentWalletMetricsSchema2(BaseModel):
...
class PaymentWalletMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletMetricsProcessor2()
