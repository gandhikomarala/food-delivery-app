...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_8
...
@dataclass
class PaymentWalletMetricsEntity8:
...
class PaymentWalletMetricsSchema8(BaseModel):
...
class PaymentWalletMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletMetricsProcessor8()
