...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_5
...
@dataclass
class PaymentWalletMetricsEntity5:
...
class PaymentWalletMetricsSchema5(BaseModel):
...
class PaymentWalletMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletMetricsProcessor5()
