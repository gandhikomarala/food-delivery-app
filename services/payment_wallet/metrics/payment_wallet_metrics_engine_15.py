...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_15
...
@dataclass
class PaymentWalletMetricsEntity15:
...
class PaymentWalletMetricsSchema15(BaseModel):
...
class PaymentWalletMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletMetricsProcessor15()
