...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_4
...
@dataclass
class PaymentWalletMetricsEntity4:
...
class PaymentWalletMetricsSchema4(BaseModel):
...
class PaymentWalletMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletMetricsProcessor4()
