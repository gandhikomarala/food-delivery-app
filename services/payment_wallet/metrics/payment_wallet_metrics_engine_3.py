...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_3
...
@dataclass
class PaymentWalletMetricsEntity3:
...
class PaymentWalletMetricsSchema3(BaseModel):
...
class PaymentWalletMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletMetricsProcessor3()
