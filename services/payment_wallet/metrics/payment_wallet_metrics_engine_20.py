...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_20
...
@dataclass
class PaymentWalletMetricsEntity20:
...
class PaymentWalletMetricsSchema20(BaseModel):
...
class PaymentWalletMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletMetricsProcessor20()
