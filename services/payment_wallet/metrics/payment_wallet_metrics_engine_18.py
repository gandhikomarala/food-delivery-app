...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_18
...
@dataclass
class PaymentWalletMetricsEntity18:
...
class PaymentWalletMetricsSchema18(BaseModel):
...
class PaymentWalletMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletMetricsProcessor18()
