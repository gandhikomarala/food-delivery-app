...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_6
...
@dataclass
class PaymentWalletMetricsEntity6:
...
class PaymentWalletMetricsSchema6(BaseModel):
...
class PaymentWalletMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletMetricsProcessor6()
