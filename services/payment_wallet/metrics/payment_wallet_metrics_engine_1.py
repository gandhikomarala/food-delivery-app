...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_1
...
@dataclass
class PaymentWalletMetricsEntity1:
...
class PaymentWalletMetricsSchema1(BaseModel):
...
class PaymentWalletMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletMetricsProcessor1()
