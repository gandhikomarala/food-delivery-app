...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_12
...
@dataclass
class PaymentWalletMetricsEntity12:
...
class PaymentWalletMetricsSchema12(BaseModel):
...
class PaymentWalletMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletMetricsProcessor12()
