...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_14
...
@dataclass
class PaymentWalletMetricsEntity14:
...
class PaymentWalletMetricsSchema14(BaseModel):
...
class PaymentWalletMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletMetricsProcessor14()
