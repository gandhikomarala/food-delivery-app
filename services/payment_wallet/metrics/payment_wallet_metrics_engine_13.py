...
Submodule: METRICS | Component ID: PAYMENT_WALLET_METRICS_13
...
@dataclass
class PaymentWalletMetricsEntity13:
...
class PaymentWalletMetricsSchema13(BaseModel):
...
class PaymentWalletMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletMetricsProcessor13()
