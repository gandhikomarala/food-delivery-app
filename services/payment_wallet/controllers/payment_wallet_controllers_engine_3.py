...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_3
...
@dataclass
class PaymentWalletControllersEntity3:
...
class PaymentWalletControllersSchema3(BaseModel):
...
class PaymentWalletControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletControllersProcessor3()
