...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_1
...
@dataclass
class PaymentWalletControllersEntity1:
...
class PaymentWalletControllersSchema1(BaseModel):
...
class PaymentWalletControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletControllersProcessor1()
