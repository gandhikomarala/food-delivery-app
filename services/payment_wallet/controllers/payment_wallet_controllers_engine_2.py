...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_2
...
@dataclass
class PaymentWalletControllersEntity2:
...
class PaymentWalletControllersSchema2(BaseModel):
...
class PaymentWalletControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletControllersProcessor2()
