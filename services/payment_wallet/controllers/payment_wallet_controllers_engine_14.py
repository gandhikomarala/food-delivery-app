...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_14
...
@dataclass
class PaymentWalletControllersEntity14:
...
class PaymentWalletControllersSchema14(BaseModel):
...
class PaymentWalletControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletControllersProcessor14()
