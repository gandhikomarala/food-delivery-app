...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_7
...
@dataclass
class PaymentWalletControllersEntity7:
...
class PaymentWalletControllersSchema7(BaseModel):
...
class PaymentWalletControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = PaymentWalletControllersProcessor7()
