...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_20
...
@dataclass
class PaymentWalletControllersEntity20:
...
class PaymentWalletControllersSchema20(BaseModel):
...
class PaymentWalletControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletControllersProcessor20()
