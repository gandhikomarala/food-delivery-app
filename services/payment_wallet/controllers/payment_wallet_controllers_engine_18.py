...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_18
...
@dataclass
class PaymentWalletControllersEntity18:
...
class PaymentWalletControllersSchema18(BaseModel):
...
class PaymentWalletControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletControllersProcessor18()
