...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_4
...
@dataclass
class PaymentWalletControllersEntity4:
...
class PaymentWalletControllersSchema4(BaseModel):
...
class PaymentWalletControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletControllersProcessor4()
