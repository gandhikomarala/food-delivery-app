...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_12
...
@dataclass
class PaymentWalletControllersEntity12:
...
class PaymentWalletControllersSchema12(BaseModel):
...
class PaymentWalletControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletControllersProcessor12()
