...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_8
...
@dataclass
class PaymentWalletControllersEntity8:
...
class PaymentWalletControllersSchema8(BaseModel):
...
class PaymentWalletControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletControllersProcessor8()
