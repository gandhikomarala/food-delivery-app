...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_5
...
@dataclass
class PaymentWalletControllersEntity5:
...
class PaymentWalletControllersSchema5(BaseModel):
...
class PaymentWalletControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletControllersProcessor5()
