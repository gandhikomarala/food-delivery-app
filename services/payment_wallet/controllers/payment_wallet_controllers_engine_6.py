...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_6
...
@dataclass
class PaymentWalletControllersEntity6:
...
class PaymentWalletControllersSchema6(BaseModel):
...
class PaymentWalletControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletControllersProcessor6()
