...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_13
...
@dataclass
class PaymentWalletControllersEntity13:
...
class PaymentWalletControllersSchema13(BaseModel):
...
class PaymentWalletControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletControllersProcessor13()
