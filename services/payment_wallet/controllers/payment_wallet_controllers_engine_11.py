...
Submodule: CONTROLLERS | Component ID: PAYMENT_WALLET_CONTROLLERS_11
...
@dataclass
class PaymentWalletControllersEntity11:
...
class PaymentWalletControllersSchema11(BaseModel):
...
class PaymentWalletControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = PaymentWalletControllersProcessor11()
