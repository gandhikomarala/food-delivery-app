...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_4
...
@dataclass
class PaymentWalletServicesEntity4:
...
class PaymentWalletServicesSchema4(BaseModel):
...
class PaymentWalletServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletServicesProcessor4()
