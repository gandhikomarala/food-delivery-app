...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_13
...
@dataclass
class PaymentWalletServicesEntity13:
...
class PaymentWalletServicesSchema13(BaseModel):
...
class PaymentWalletServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletServicesProcessor13()
