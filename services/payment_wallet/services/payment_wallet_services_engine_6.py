...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_6
...
@dataclass
class PaymentWalletServicesEntity6:
...
class PaymentWalletServicesSchema6(BaseModel):
...
class PaymentWalletServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletServicesProcessor6()
