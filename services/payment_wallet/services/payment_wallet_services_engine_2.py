...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_2
...
@dataclass
class PaymentWalletServicesEntity2:
...
class PaymentWalletServicesSchema2(BaseModel):
...
class PaymentWalletServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletServicesProcessor2()
