...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_8
...
@dataclass
class PaymentWalletServicesEntity8:
...
class PaymentWalletServicesSchema8(BaseModel):
...
class PaymentWalletServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletServicesProcessor8()
