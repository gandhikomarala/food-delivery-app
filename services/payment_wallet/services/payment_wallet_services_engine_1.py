...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_1
...
@dataclass
class PaymentWalletServicesEntity1:
...
class PaymentWalletServicesSchema1(BaseModel):
...
class PaymentWalletServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletServicesProcessor1()
