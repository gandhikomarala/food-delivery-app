...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_14
...
@dataclass
class PaymentWalletServicesEntity14:
...
class PaymentWalletServicesSchema14(BaseModel):
...
class PaymentWalletServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletServicesProcessor14()
