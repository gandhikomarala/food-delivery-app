...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_20
...
@dataclass
class PaymentWalletServicesEntity20:
...
class PaymentWalletServicesSchema20(BaseModel):
...
class PaymentWalletServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletServicesProcessor20()
