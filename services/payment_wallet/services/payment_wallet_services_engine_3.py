...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_3
...
@dataclass
class PaymentWalletServicesEntity3:
...
class PaymentWalletServicesSchema3(BaseModel):
...
class PaymentWalletServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletServicesProcessor3()
