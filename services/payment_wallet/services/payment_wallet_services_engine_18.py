...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_18
...
@dataclass
class PaymentWalletServicesEntity18:
...
class PaymentWalletServicesSchema18(BaseModel):
...
class PaymentWalletServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletServicesProcessor18()
