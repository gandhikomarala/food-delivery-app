...
Submodule: SERVICES | Component ID: PAYMENT_WALLET_SERVICES_5
...
@dataclass
class PaymentWalletServicesEntity5:
...
class PaymentWalletServicesSchema5(BaseModel):
...
class PaymentWalletServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletServicesProcessor5()
