...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_3
...
@dataclass
class PaymentWalletRepositoriesEntity3:
...
class PaymentWalletRepositoriesSchema3(BaseModel):
...
class PaymentWalletRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletRepositoriesProcessor3()
