...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_6
...
@dataclass
class PaymentWalletRepositoriesEntity6:
...
class PaymentWalletRepositoriesSchema6(BaseModel):
...
class PaymentWalletRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletRepositoriesProcessor6()
