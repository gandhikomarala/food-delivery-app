...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_20
...
@dataclass
class PaymentWalletRepositoriesEntity20:
...
class PaymentWalletRepositoriesSchema20(BaseModel):
...
class PaymentWalletRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletRepositoriesProcessor20()
