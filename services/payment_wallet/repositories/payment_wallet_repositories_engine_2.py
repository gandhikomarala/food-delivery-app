...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_2
...
@dataclass
class PaymentWalletRepositoriesEntity2:
...
class PaymentWalletRepositoriesSchema2(BaseModel):
...
class PaymentWalletRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletRepositoriesProcessor2()
