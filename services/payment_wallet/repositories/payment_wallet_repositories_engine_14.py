...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_14
...
@dataclass
class PaymentWalletRepositoriesEntity14:
...
class PaymentWalletRepositoriesSchema14(BaseModel):
...
class PaymentWalletRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletRepositoriesProcessor14()
