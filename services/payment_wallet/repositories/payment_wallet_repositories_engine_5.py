...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_5
...
@dataclass
class PaymentWalletRepositoriesEntity5:
...
class PaymentWalletRepositoriesSchema5(BaseModel):
...
class PaymentWalletRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletRepositoriesProcessor5()
