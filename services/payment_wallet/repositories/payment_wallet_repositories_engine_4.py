...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_4
...
@dataclass
class PaymentWalletRepositoriesEntity4:
...
class PaymentWalletRepositoriesSchema4(BaseModel):
...
class PaymentWalletRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletRepositoriesProcessor4()
