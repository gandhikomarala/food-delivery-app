...
Submodule: REPOSITORIES | Component ID: PAYMENT_WALLET_REPOSITORIES_1
...
@dataclass
class PaymentWalletRepositoriesEntity1:
...
class PaymentWalletRepositoriesSchema1(BaseModel):
...
class PaymentWalletRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletRepositoriesProcessor1()
