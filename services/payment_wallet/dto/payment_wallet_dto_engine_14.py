...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_14
...
@dataclass
class PaymentWalletDtoEntity14:
...
class PaymentWalletDtoSchema14(BaseModel):
...
class PaymentWalletDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletDtoProcessor14()
