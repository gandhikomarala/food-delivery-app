...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_20
...
@dataclass
class PaymentWalletDtoEntity20:
...
class PaymentWalletDtoSchema20(BaseModel):
...
class PaymentWalletDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletDtoProcessor20()
