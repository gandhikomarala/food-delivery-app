...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_11
...
@dataclass
class PaymentWalletDtoEntity11:
...
class PaymentWalletDtoSchema11(BaseModel):
...
class PaymentWalletDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = PaymentWalletDtoProcessor11()
