...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_2
...
class PaymentWalletDtoSchema2(BaseModel):
...
class PaymentWalletDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletDtoProcessor2()
