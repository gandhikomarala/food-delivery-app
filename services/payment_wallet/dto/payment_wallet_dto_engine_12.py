...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_12
...
@dataclass
class PaymentWalletDtoEntity12:
...
class PaymentWalletDtoSchema12(BaseModel):
...
class PaymentWalletDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletDtoProcessor12()
