...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_4
...
class PaymentWalletDtoSchema4(BaseModel):
...
class PaymentWalletDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletDtoProcessor4()
