...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_8
...
class PaymentWalletDtoSchema8(BaseModel):
...
class PaymentWalletDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletDtoProcessor8()
