...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_15
...
@dataclass
class PaymentWalletDtoEntity15:
...
class PaymentWalletDtoSchema15(BaseModel):
...
class PaymentWalletDtoProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletDtoProcessor15()
