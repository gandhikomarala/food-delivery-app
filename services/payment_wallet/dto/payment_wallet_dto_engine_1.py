...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_1
...
class PaymentWalletDtoSchema1(BaseModel):
...
class PaymentWalletDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletDtoProcessor1()
