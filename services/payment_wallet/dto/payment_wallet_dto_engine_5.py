...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_5
...
class PaymentWalletDtoSchema5(BaseModel):
...
class PaymentWalletDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletDtoProcessor5()
