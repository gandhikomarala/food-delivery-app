...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_3
...
class PaymentWalletDtoSchema3(BaseModel):
...
class PaymentWalletDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletDtoProcessor3()
