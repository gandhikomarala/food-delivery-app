...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_6
...
class PaymentWalletDtoSchema6(BaseModel):
...
class PaymentWalletDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletDtoProcessor6()
