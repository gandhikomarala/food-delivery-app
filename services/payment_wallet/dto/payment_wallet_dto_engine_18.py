...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_18
...
@dataclass
class PaymentWalletDtoEntity18:
...
class PaymentWalletDtoSchema18(BaseModel):
...
class PaymentWalletDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletDtoProcessor18()
