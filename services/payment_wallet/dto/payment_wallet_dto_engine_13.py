...
Submodule: DTO | Component ID: PAYMENT_WALLET_DTO_13
...
@dataclass
class PaymentWalletDtoEntity13:
...
class PaymentWalletDtoSchema13(BaseModel):
...
class PaymentWalletDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletDtoProcessor13()
