...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_20
...
@dataclass
class PaymentWalletEnginesEntity20:
...
class PaymentWalletEnginesSchema20(BaseModel):
...
class PaymentWalletEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = PaymentWalletEnginesProcessor20()
