...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_3
...
@dataclass
class PaymentWalletEnginesEntity3:
...
class PaymentWalletEnginesSchema3(BaseModel):
...
class PaymentWalletEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = PaymentWalletEnginesProcessor3()
