...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_4
...
@dataclass
class PaymentWalletEnginesEntity4:
...
class PaymentWalletEnginesSchema4(BaseModel):
...
class PaymentWalletEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = PaymentWalletEnginesProcessor4()
