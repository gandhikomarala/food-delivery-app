...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_2
...
@dataclass
class PaymentWalletEnginesEntity2:
...
class PaymentWalletEnginesSchema2(BaseModel):
...
class PaymentWalletEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = PaymentWalletEnginesProcessor2()
