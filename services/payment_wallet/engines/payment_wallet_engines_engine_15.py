...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_15
...
@dataclass
class PaymentWalletEnginesEntity15:
...
class PaymentWalletEnginesSchema15(BaseModel):
...
class PaymentWalletEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = PaymentWalletEnginesProcessor15()
