...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_5
...
@dataclass
class PaymentWalletEnginesEntity5:
...
class PaymentWalletEnginesSchema5(BaseModel):
...
class PaymentWalletEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = PaymentWalletEnginesProcessor5()
