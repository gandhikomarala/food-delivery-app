...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_8
...
@dataclass
class PaymentWalletEnginesEntity8:
...
class PaymentWalletEnginesSchema8(BaseModel):
...
class PaymentWalletEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = PaymentWalletEnginesProcessor8()
