...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_6
...
@dataclass
class PaymentWalletEnginesEntity6:
...
class PaymentWalletEnginesSchema6(BaseModel):
...
class PaymentWalletEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = PaymentWalletEnginesProcessor6()
