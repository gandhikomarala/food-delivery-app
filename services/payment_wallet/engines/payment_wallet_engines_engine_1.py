...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_1
...
@dataclass
class PaymentWalletEnginesEntity1:
...
class PaymentWalletEnginesSchema1(BaseModel):
...
class PaymentWalletEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = PaymentWalletEnginesProcessor1()
