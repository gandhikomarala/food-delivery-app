...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_10
...
@dataclass
class PaymentWalletEnginesEntity10:
...
class PaymentWalletEnginesSchema10(BaseModel):
...
class PaymentWalletEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = PaymentWalletEnginesProcessor10()
