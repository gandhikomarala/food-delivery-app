...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_14
...
@dataclass
class PaymentWalletEnginesEntity14:
...
class PaymentWalletEnginesSchema14(BaseModel):
...
class PaymentWalletEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = PaymentWalletEnginesProcessor14()
