...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_12
...
@dataclass
class PaymentWalletEnginesEntity12:
...
class PaymentWalletEnginesSchema12(BaseModel):
...
class PaymentWalletEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = PaymentWalletEnginesProcessor12()
