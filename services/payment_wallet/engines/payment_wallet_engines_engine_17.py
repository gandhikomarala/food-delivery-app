...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_17
...
@dataclass
class PaymentWalletEnginesEntity17:
...
class PaymentWalletEnginesSchema17(BaseModel):
...
class PaymentWalletEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = PaymentWalletEnginesProcessor17()
