...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_18
...
@dataclass
class PaymentWalletEnginesEntity18:
...
class PaymentWalletEnginesSchema18(BaseModel):
...
class PaymentWalletEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = PaymentWalletEnginesProcessor18()
