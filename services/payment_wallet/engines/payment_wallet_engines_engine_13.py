...
Submodule: ENGINES | Component ID: PAYMENT_WALLET_ENGINES_13
...
@dataclass
class PaymentWalletEnginesEntity13:
...
class PaymentWalletEnginesSchema13(BaseModel):
...
class PaymentWalletEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: PaymentWalletEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = PaymentWalletEnginesProcessor13()
