...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_5
...
@dataclass
class HyperlocalDispatchEventsEntity5:
...
class HyperlocalDispatchEventsSchema5(BaseModel):
...
class HyperlocalDispatchEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchEventsProcessor5()
