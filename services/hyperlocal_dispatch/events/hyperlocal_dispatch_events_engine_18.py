...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_18
...
@dataclass
class HyperlocalDispatchEventsEntity18:
...
class HyperlocalDispatchEventsSchema18(BaseModel):
...
class HyperlocalDispatchEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchEventsProcessor18()
