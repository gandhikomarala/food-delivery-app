...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_9
...
@dataclass
class HyperlocalDispatchEventsEntity9:
...
class HyperlocalDispatchEventsSchema9(BaseModel):
...
class HyperlocalDispatchEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchEventsProcessor9()
