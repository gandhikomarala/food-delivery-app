...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_14
...
@dataclass
class HyperlocalDispatchEventsEntity14:
...
class HyperlocalDispatchEventsSchema14(BaseModel):
...
class HyperlocalDispatchEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchEventsProcessor14()
