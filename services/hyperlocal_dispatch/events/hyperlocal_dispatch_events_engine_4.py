...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_4
...
@dataclass
class HyperlocalDispatchEventsEntity4:
...
class HyperlocalDispatchEventsSchema4(BaseModel):
...
class HyperlocalDispatchEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchEventsProcessor4()
