...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_11
...
@dataclass
class HyperlocalDispatchEventsEntity11:
...
class HyperlocalDispatchEventsSchema11(BaseModel):
...
class HyperlocalDispatchEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchEventsProcessor11()
