...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_10
...
@dataclass
class HyperlocalDispatchEventsEntity10:
...
class HyperlocalDispatchEventsSchema10(BaseModel):
...
class HyperlocalDispatchEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchEventsProcessor10()
