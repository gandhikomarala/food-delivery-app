...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_2
...
@dataclass
class HyperlocalDispatchEventsEntity2:
...
class HyperlocalDispatchEventsSchema2(BaseModel):
...
class HyperlocalDispatchEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchEventsProcessor2()
