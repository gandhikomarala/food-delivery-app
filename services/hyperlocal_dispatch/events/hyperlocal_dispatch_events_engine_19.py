...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_19
...
@dataclass
class HyperlocalDispatchEventsEntity19:
...
class HyperlocalDispatchEventsSchema19(BaseModel):
...
class HyperlocalDispatchEventsProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchEventsProcessor19()
