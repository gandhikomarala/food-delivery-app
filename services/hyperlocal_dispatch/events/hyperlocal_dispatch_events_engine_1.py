...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_1
...
@dataclass
class HyperlocalDispatchEventsEntity1:
...
class HyperlocalDispatchEventsSchema1(BaseModel):
...
class HyperlocalDispatchEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchEventsProcessor1()
