...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_8
...
@dataclass
class HyperlocalDispatchEventsEntity8:
...
class HyperlocalDispatchEventsSchema8(BaseModel):
...
class HyperlocalDispatchEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchEventsProcessor8()
