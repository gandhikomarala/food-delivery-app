...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_16
...
@dataclass
class HyperlocalDispatchEventsEntity16:
...
class HyperlocalDispatchEventsSchema16(BaseModel):
...
class HyperlocalDispatchEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchEventsProcessor16()
