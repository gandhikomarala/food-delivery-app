...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_6
...
@dataclass
class HyperlocalDispatchEventsEntity6:
...
class HyperlocalDispatchEventsSchema6(BaseModel):
...
class HyperlocalDispatchEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchEventsProcessor6()
