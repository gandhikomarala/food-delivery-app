...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_13
...
@dataclass
class HyperlocalDispatchEventsEntity13:
...
class HyperlocalDispatchEventsSchema13(BaseModel):
...
class HyperlocalDispatchEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchEventsProcessor13()
