...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_12
...
@dataclass
class HyperlocalDispatchEventsEntity12:
...
class HyperlocalDispatchEventsSchema12(BaseModel):
...
class HyperlocalDispatchEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchEventsProcessor12()
