...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_15
...
@dataclass
class HyperlocalDispatchEventsEntity15:
...
class HyperlocalDispatchEventsSchema15(BaseModel):
...
class HyperlocalDispatchEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchEventsProcessor15()
