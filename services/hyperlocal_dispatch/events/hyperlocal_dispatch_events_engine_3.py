...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_3
...
@dataclass
class HyperlocalDispatchEventsEntity3:
...
class HyperlocalDispatchEventsSchema3(BaseModel):
...
class HyperlocalDispatchEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchEventsProcessor3()
