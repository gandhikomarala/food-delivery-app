...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_20
...
@dataclass
class HyperlocalDispatchEventsEntity20:
...
class HyperlocalDispatchEventsSchema20(BaseModel):
...
class HyperlocalDispatchEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchEventsProcessor20()
