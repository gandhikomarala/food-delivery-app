...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_7
...
@dataclass
class HyperlocalDispatchEventsEntity7:
...
class HyperlocalDispatchEventsSchema7(BaseModel):
...
class HyperlocalDispatchEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchEventsProcessor7()
