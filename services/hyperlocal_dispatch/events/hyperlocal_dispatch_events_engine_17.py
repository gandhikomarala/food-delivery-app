...
Submodule: EVENTS | Component ID: HYPERLOCAL_DISPATCH_EVENTS_17
...
@dataclass
class HyperlocalDispatchEventsEntity17:
...
class HyperlocalDispatchEventsSchema17(BaseModel):
...
class HyperlocalDispatchEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchEventsProcessor17()
