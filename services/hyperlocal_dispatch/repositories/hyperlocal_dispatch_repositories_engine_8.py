...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_8
...
@dataclass
class HyperlocalDispatchRepositoriesEntity8:
...
class HyperlocalDispatchRepositoriesSchema8(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchRepositoriesProcessor8()
