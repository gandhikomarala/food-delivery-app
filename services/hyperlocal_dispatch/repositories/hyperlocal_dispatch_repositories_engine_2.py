...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_2
...
@dataclass
class HyperlocalDispatchRepositoriesEntity2:
...
class HyperlocalDispatchRepositoriesSchema2(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchRepositoriesProcessor2()
