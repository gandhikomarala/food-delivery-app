...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_13
...
@dataclass
class HyperlocalDispatchRepositoriesEntity13:
...
class HyperlocalDispatchRepositoriesSchema13(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchRepositoriesProcessor13()
