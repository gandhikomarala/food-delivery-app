...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_10
...
@dataclass
class HyperlocalDispatchRepositoriesEntity10:
...
class HyperlocalDispatchRepositoriesSchema10(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchRepositoriesProcessor10()
