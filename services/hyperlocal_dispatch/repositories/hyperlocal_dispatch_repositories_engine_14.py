...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_14
...
@dataclass
class HyperlocalDispatchRepositoriesEntity14:
...
class HyperlocalDispatchRepositoriesSchema14(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchRepositoriesProcessor14()
