...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_4
...
@dataclass
class HyperlocalDispatchRepositoriesEntity4:
...
class HyperlocalDispatchRepositoriesSchema4(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchRepositoriesProcessor4()
