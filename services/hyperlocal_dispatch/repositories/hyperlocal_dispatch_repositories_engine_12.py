...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_12
...
@dataclass
class HyperlocalDispatchRepositoriesEntity12:
...
class HyperlocalDispatchRepositoriesSchema12(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchRepositoriesProcessor12()
