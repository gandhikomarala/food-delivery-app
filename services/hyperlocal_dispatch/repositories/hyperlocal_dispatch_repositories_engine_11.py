...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_11
...
@dataclass
class HyperlocalDispatchRepositoriesEntity11:
...
class HyperlocalDispatchRepositoriesSchema11(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchRepositoriesProcessor11()
