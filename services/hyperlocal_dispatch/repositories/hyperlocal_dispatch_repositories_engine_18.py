...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_18
...
@dataclass
class HyperlocalDispatchRepositoriesEntity18:
...
class HyperlocalDispatchRepositoriesSchema18(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchRepositoriesProcessor18()
