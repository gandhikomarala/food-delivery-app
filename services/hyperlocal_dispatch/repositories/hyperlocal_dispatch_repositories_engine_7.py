...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_7
...
@dataclass
class HyperlocalDispatchRepositoriesEntity7:
...
class HyperlocalDispatchRepositoriesSchema7(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchRepositoriesProcessor7()
