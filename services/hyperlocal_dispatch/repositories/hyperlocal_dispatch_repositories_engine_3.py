...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_3
...
@dataclass
class HyperlocalDispatchRepositoriesEntity3:
...
class HyperlocalDispatchRepositoriesSchema3(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchRepositoriesProcessor3()
