...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_1
...
@dataclass
class HyperlocalDispatchRepositoriesEntity1:
...
class HyperlocalDispatchRepositoriesSchema1(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchRepositoriesProcessor1()
