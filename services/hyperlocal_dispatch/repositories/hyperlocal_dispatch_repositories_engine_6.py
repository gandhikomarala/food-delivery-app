...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_6
...
@dataclass
class HyperlocalDispatchRepositoriesEntity6:
...
class HyperlocalDispatchRepositoriesSchema6(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchRepositoriesProcessor6()
