...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_15
...
@dataclass
class HyperlocalDispatchRepositoriesEntity15:
...
class HyperlocalDispatchRepositoriesSchema15(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchRepositoriesProcessor15()
