...
Submodule: REPOSITORIES | Component ID: HYPERLOCAL_DISPATCH_REPOSITORIES_17
...
@dataclass
class HyperlocalDispatchRepositoriesEntity17:
...
class HyperlocalDispatchRepositoriesSchema17(BaseModel):
...
class HyperlocalDispatchRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchRepositoriesProcessor17()
