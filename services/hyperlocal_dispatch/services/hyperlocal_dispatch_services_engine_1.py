...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_1
...
@dataclass
class HyperlocalDispatchServicesEntity1:
...
class HyperlocalDispatchServicesSchema1(BaseModel):
...
class HyperlocalDispatchServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchServicesProcessor1()
