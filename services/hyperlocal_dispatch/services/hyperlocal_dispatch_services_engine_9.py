...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_9
...
@dataclass
class HyperlocalDispatchServicesEntity9:
...
class HyperlocalDispatchServicesSchema9(BaseModel):
...
class HyperlocalDispatchServicesProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchServicesProcessor9()
