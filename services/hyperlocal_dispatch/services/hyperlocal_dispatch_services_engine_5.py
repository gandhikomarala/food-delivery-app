...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_5
...
@dataclass
class HyperlocalDispatchServicesEntity5:
...
class HyperlocalDispatchServicesSchema5(BaseModel):
...
class HyperlocalDispatchServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchServicesProcessor5()
