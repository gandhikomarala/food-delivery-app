...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_2
...
@dataclass
class HyperlocalDispatchServicesEntity2:
...
class HyperlocalDispatchServicesSchema2(BaseModel):
...
class HyperlocalDispatchServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchServicesProcessor2()
