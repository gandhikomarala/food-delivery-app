...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_15
...
@dataclass
class HyperlocalDispatchServicesEntity15:
...
class HyperlocalDispatchServicesSchema15(BaseModel):
...
class HyperlocalDispatchServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchServicesProcessor15()
