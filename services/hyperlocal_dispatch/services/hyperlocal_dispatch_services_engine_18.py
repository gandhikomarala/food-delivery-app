...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_18
...
@dataclass
class HyperlocalDispatchServicesEntity18:
...
class HyperlocalDispatchServicesSchema18(BaseModel):
...
class HyperlocalDispatchServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchServicesProcessor18()
