...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_17
...
@dataclass
class HyperlocalDispatchServicesEntity17:
...
class HyperlocalDispatchServicesSchema17(BaseModel):
...
class HyperlocalDispatchServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchServicesProcessor17()
