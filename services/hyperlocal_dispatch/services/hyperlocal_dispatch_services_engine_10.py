...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_10
...
@dataclass
class HyperlocalDispatchServicesEntity10:
...
class HyperlocalDispatchServicesSchema10(BaseModel):
...
class HyperlocalDispatchServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchServicesProcessor10()
