...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_4
...
@dataclass
class HyperlocalDispatchServicesEntity4:
...
class HyperlocalDispatchServicesSchema4(BaseModel):
...
class HyperlocalDispatchServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchServicesProcessor4()
