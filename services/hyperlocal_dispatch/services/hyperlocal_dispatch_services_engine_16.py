...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_16
...
@dataclass
class HyperlocalDispatchServicesEntity16:
...
class HyperlocalDispatchServicesSchema16(BaseModel):
...
class HyperlocalDispatchServicesProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchServicesProcessor16()
