...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_13
...
@dataclass
class HyperlocalDispatchServicesEntity13:
...
class HyperlocalDispatchServicesSchema13(BaseModel):
...
class HyperlocalDispatchServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchServicesProcessor13()
