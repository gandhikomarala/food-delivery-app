...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_6
...
@dataclass
class HyperlocalDispatchServicesEntity6:
...
class HyperlocalDispatchServicesSchema6(BaseModel):
...
class HyperlocalDispatchServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchServicesProcessor6()
