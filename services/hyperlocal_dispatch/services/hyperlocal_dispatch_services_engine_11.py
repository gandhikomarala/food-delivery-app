...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_11
...
@dataclass
class HyperlocalDispatchServicesEntity11:
...
class HyperlocalDispatchServicesSchema11(BaseModel):
...
class HyperlocalDispatchServicesProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchServicesProcessor11()
