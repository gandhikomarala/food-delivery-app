...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_8
...
@dataclass
class HyperlocalDispatchServicesEntity8:
...
class HyperlocalDispatchServicesSchema8(BaseModel):
...
class HyperlocalDispatchServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchServicesProcessor8()
