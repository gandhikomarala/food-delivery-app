...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_12
...
@dataclass
class HyperlocalDispatchServicesEntity12:
...
class HyperlocalDispatchServicesSchema12(BaseModel):
...
class HyperlocalDispatchServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchServicesProcessor12()
