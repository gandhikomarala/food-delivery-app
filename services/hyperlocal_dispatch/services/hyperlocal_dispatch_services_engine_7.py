...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_7
...
@dataclass
class HyperlocalDispatchServicesEntity7:
...
class HyperlocalDispatchServicesSchema7(BaseModel):
...
class HyperlocalDispatchServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchServicesProcessor7()
