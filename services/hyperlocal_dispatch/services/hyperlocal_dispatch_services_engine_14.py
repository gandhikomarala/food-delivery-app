...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_14
...
@dataclass
class HyperlocalDispatchServicesEntity14:
...
class HyperlocalDispatchServicesSchema14(BaseModel):
...
class HyperlocalDispatchServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchServicesProcessor14()
