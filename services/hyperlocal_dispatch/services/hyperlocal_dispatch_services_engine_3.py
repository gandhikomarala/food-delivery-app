...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_3
...
@dataclass
class HyperlocalDispatchServicesEntity3:
...
class HyperlocalDispatchServicesSchema3(BaseModel):
...
class HyperlocalDispatchServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchServicesProcessor3()
