...
Submodule: SERVICES | Component ID: HYPERLOCAL_DISPATCH_SERVICES_20
...
@dataclass
class HyperlocalDispatchServicesEntity20:
...
class HyperlocalDispatchServicesSchema20(BaseModel):
...
class HyperlocalDispatchServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchServicesProcessor20()
