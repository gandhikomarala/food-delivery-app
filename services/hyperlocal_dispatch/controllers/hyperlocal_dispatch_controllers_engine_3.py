...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_3
...
@dataclass
class HyperlocalDispatchControllersEntity3:
...
class HyperlocalDispatchControllersSchema3(BaseModel):
...
class HyperlocalDispatchControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchControllersProcessor3()
