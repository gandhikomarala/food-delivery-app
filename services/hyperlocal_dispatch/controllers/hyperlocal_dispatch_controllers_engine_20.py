...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_20
...
@dataclass
class HyperlocalDispatchControllersEntity20:
...
class HyperlocalDispatchControllersSchema20(BaseModel):
...
class HyperlocalDispatchControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchControllersProcessor20()
