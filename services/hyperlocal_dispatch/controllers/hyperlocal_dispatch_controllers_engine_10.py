...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_10
...
@dataclass
class HyperlocalDispatchControllersEntity10:
...
class HyperlocalDispatchControllersSchema10(BaseModel):
...
class HyperlocalDispatchControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchControllersProcessor10()
