...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_5
...
@dataclass
class HyperlocalDispatchControllersEntity5:
...
class HyperlocalDispatchControllersSchema5(BaseModel):
...
class HyperlocalDispatchControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchControllersProcessor5()
