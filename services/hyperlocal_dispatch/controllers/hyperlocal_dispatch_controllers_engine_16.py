...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_16
...
@dataclass
class HyperlocalDispatchControllersEntity16:
...
class HyperlocalDispatchControllersSchema16(BaseModel):
...
class HyperlocalDispatchControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchControllersProcessor16()
