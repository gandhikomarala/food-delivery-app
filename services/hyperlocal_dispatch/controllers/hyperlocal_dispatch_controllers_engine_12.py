...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_12
...
@dataclass
class HyperlocalDispatchControllersEntity12:
...
class HyperlocalDispatchControllersSchema12(BaseModel):
...
class HyperlocalDispatchControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchControllersProcessor12()
