...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_2
...
@dataclass
class HyperlocalDispatchControllersEntity2:
...
class HyperlocalDispatchControllersSchema2(BaseModel):
...
class HyperlocalDispatchControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchControllersProcessor2()
