...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_15
...
@dataclass
class HyperlocalDispatchControllersEntity15:
...
class HyperlocalDispatchControllersSchema15(BaseModel):
...
class HyperlocalDispatchControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchControllersProcessor15()
