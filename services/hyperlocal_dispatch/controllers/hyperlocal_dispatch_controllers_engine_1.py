...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_1
...
@dataclass
class HyperlocalDispatchControllersEntity1:
...
class HyperlocalDispatchControllersSchema1(BaseModel):
...
class HyperlocalDispatchControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchControllersProcessor1()
