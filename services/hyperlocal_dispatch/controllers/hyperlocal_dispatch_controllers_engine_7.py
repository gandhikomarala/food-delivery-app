...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_7
...
@dataclass
class HyperlocalDispatchControllersEntity7:
...
class HyperlocalDispatchControllersSchema7(BaseModel):
...
class HyperlocalDispatchControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchControllersProcessor7()
