...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_11
...
@dataclass
class HyperlocalDispatchControllersEntity11:
...
class HyperlocalDispatchControllersSchema11(BaseModel):
...
class HyperlocalDispatchControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchControllersProcessor11()
