...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_8
...
@dataclass
class HyperlocalDispatchControllersEntity8:
...
class HyperlocalDispatchControllersSchema8(BaseModel):
...
class HyperlocalDispatchControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchControllersProcessor8()
