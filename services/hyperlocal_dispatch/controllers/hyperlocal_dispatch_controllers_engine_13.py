...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_13
...
@dataclass
class HyperlocalDispatchControllersEntity13:
...
class HyperlocalDispatchControllersSchema13(BaseModel):
...
class HyperlocalDispatchControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchControllersProcessor13()
