...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_9
...
@dataclass
class HyperlocalDispatchControllersEntity9:
...
class HyperlocalDispatchControllersSchema9(BaseModel):
...
class HyperlocalDispatchControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchControllersProcessor9()
