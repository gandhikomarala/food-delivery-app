...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_17
...
@dataclass
class HyperlocalDispatchControllersEntity17:
...
class HyperlocalDispatchControllersSchema17(BaseModel):
...
class HyperlocalDispatchControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchControllersProcessor17()
