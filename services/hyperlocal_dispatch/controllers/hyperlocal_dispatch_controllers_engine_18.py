...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_18
...
@dataclass
class HyperlocalDispatchControllersEntity18:
...
class HyperlocalDispatchControllersSchema18(BaseModel):
...
class HyperlocalDispatchControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchControllersProcessor18()
