...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_6
...
@dataclass
class HyperlocalDispatchControllersEntity6:
...
class HyperlocalDispatchControllersSchema6(BaseModel):
...
class HyperlocalDispatchControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchControllersProcessor6()
