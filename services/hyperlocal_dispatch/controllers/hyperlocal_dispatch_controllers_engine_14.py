...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_14
...
@dataclass
class HyperlocalDispatchControllersEntity14:
...
class HyperlocalDispatchControllersSchema14(BaseModel):
...
class HyperlocalDispatchControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchControllersProcessor14()
