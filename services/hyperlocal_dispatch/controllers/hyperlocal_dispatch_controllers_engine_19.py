...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_19
...
@dataclass
class HyperlocalDispatchControllersEntity19:
...
class HyperlocalDispatchControllersSchema19(BaseModel):
...
class HyperlocalDispatchControllersProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchControllersProcessor19()
