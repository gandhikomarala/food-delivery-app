...
Submodule: CONTROLLERS | Component ID: HYPERLOCAL_DISPATCH_CONTROLLERS_4
...
@dataclass
class HyperlocalDispatchControllersEntity4:
...
class HyperlocalDispatchControllersSchema4(BaseModel):
...
class HyperlocalDispatchControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchControllersProcessor4()
