...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_12
...
@dataclass
class HyperlocalDispatchValidatorsEntity12:
...
class HyperlocalDispatchValidatorsSchema12(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchValidatorsProcessor12()
