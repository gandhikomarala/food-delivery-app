...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_20
...
@dataclass
class HyperlocalDispatchValidatorsEntity20:
...
class HyperlocalDispatchValidatorsSchema20(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchValidatorsProcessor20()
