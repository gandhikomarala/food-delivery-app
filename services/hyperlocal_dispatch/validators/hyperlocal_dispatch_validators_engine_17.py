...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_17
...
@dataclass
class HyperlocalDispatchValidatorsEntity17:
...
class HyperlocalDispatchValidatorsSchema17(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchValidatorsProcessor17()
