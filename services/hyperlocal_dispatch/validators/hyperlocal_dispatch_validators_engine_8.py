...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_8
...
@dataclass
class HyperlocalDispatchValidatorsEntity8:
...
class HyperlocalDispatchValidatorsSchema8(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchValidatorsProcessor8()
