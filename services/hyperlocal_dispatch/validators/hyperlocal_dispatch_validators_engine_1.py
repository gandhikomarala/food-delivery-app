...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_1
...
@dataclass
class HyperlocalDispatchValidatorsEntity1:
...
class HyperlocalDispatchValidatorsSchema1(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchValidatorsProcessor1()
