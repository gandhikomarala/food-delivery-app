...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_16
...
@dataclass
class HyperlocalDispatchValidatorsEntity16:
...
class HyperlocalDispatchValidatorsSchema16(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchValidatorsProcessor16()
