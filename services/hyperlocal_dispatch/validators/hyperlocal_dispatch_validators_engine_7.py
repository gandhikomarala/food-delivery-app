...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_7
...
@dataclass
class HyperlocalDispatchValidatorsEntity7:
...
class HyperlocalDispatchValidatorsSchema7(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchValidatorsProcessor7()
