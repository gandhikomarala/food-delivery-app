...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_18
...
@dataclass
class HyperlocalDispatchValidatorsEntity18:
...
class HyperlocalDispatchValidatorsSchema18(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchValidatorsProcessor18()
