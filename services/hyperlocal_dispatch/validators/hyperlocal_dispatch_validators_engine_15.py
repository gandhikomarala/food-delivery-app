...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_15
...
@dataclass
class HyperlocalDispatchValidatorsEntity15:
...
class HyperlocalDispatchValidatorsSchema15(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchValidatorsProcessor15()
