...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_5
...
@dataclass
class HyperlocalDispatchValidatorsEntity5:
...
class HyperlocalDispatchValidatorsSchema5(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchValidatorsProcessor5()
