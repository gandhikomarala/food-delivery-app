...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_2
...
@dataclass
class HyperlocalDispatchValidatorsEntity2:
...
class HyperlocalDispatchValidatorsSchema2(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchValidatorsProcessor2()
