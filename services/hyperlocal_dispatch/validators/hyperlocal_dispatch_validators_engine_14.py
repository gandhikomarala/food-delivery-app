...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_14
...
@dataclass
class HyperlocalDispatchValidatorsEntity14:
...
class HyperlocalDispatchValidatorsSchema14(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchValidatorsProcessor14()
