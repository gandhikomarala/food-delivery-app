...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_11
...
@dataclass
class HyperlocalDispatchValidatorsEntity11:
...
class HyperlocalDispatchValidatorsSchema11(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchValidatorsProcessor11()
