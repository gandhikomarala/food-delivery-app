...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_4
...
@dataclass
class HyperlocalDispatchValidatorsEntity4:
...
class HyperlocalDispatchValidatorsSchema4(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchValidatorsProcessor4()
