...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_13
...
@dataclass
class HyperlocalDispatchValidatorsEntity13:
...
class HyperlocalDispatchValidatorsSchema13(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchValidatorsProcessor13()
