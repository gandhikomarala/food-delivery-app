...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_9
...
@dataclass
class HyperlocalDispatchValidatorsEntity9:
...
class HyperlocalDispatchValidatorsSchema9(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchValidatorsProcessor9()
