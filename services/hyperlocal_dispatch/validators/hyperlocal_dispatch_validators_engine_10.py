...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_10
...
@dataclass
class HyperlocalDispatchValidatorsEntity10:
...
class HyperlocalDispatchValidatorsSchema10(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchValidatorsProcessor10()
