...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_6
...
@dataclass
class HyperlocalDispatchValidatorsEntity6:
...
class HyperlocalDispatchValidatorsSchema6(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchValidatorsProcessor6()
