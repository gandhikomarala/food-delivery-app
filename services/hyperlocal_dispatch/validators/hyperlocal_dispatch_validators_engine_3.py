...
Submodule: VALIDATORS | Component ID: HYPERLOCAL_DISPATCH_VALIDATORS_3
...
@dataclass
class HyperlocalDispatchValidatorsEntity3:
...
class HyperlocalDispatchValidatorsSchema3(BaseModel):
...
class HyperlocalDispatchValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchValidatorsProcessor3()
