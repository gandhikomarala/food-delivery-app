...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_6
...
@dataclass
class HyperlocalDispatchPipelinesEntity6:
...
class HyperlocalDispatchPipelinesSchema6(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchPipelinesProcessor6()
