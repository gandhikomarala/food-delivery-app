...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_13
...
@dataclass
class HyperlocalDispatchPipelinesEntity13:
...
class HyperlocalDispatchPipelinesSchema13(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchPipelinesProcessor13()
