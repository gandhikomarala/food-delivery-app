...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_7
...
@dataclass
class HyperlocalDispatchPipelinesEntity7:
...
class HyperlocalDispatchPipelinesSchema7(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchPipelinesProcessor7()
