...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_8
...
@dataclass
class HyperlocalDispatchPipelinesEntity8:
...
class HyperlocalDispatchPipelinesSchema8(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchPipelinesProcessor8()
