...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_10
...
@dataclass
class HyperlocalDispatchPipelinesEntity10:
...
class HyperlocalDispatchPipelinesSchema10(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchPipelinesProcessor10()
