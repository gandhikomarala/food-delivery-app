...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_12
...
@dataclass
class HyperlocalDispatchPipelinesEntity12:
...
class HyperlocalDispatchPipelinesSchema12(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchPipelinesProcessor12()
