...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_5
...
@dataclass
class HyperlocalDispatchPipelinesEntity5:
...
class HyperlocalDispatchPipelinesSchema5(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchPipelinesProcessor5()
