...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_16
...
@dataclass
class HyperlocalDispatchPipelinesEntity16:
...
class HyperlocalDispatchPipelinesSchema16(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchPipelinesProcessor16()
