...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_3
...
@dataclass
class HyperlocalDispatchPipelinesEntity3:
...
class HyperlocalDispatchPipelinesSchema3(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchPipelinesProcessor3()
