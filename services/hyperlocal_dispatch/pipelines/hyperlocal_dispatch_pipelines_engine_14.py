...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_14
...
@dataclass
class HyperlocalDispatchPipelinesEntity14:
...
class HyperlocalDispatchPipelinesSchema14(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchPipelinesProcessor14()
