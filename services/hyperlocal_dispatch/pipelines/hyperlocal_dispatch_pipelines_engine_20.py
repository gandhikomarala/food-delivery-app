...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_20
...
@dataclass
class HyperlocalDispatchPipelinesEntity20:
...
class HyperlocalDispatchPipelinesSchema20(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchPipelinesProcessor20()
