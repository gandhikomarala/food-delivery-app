...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_15
...
@dataclass
class HyperlocalDispatchPipelinesEntity15:
...
class HyperlocalDispatchPipelinesSchema15(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchPipelinesProcessor15()
