...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_1
...
@dataclass
class HyperlocalDispatchPipelinesEntity1:
...
class HyperlocalDispatchPipelinesSchema1(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchPipelinesProcessor1()
