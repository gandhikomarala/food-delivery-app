...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_17
...
@dataclass
class HyperlocalDispatchPipelinesEntity17:
...
class HyperlocalDispatchPipelinesSchema17(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchPipelinesProcessor17()
