...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_2
...
@dataclass
class HyperlocalDispatchPipelinesEntity2:
...
class HyperlocalDispatchPipelinesSchema2(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchPipelinesProcessor2()
