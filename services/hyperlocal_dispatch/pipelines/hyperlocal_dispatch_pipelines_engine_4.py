...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_4
...
@dataclass
class HyperlocalDispatchPipelinesEntity4:
...
class HyperlocalDispatchPipelinesSchema4(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchPipelinesProcessor4()
