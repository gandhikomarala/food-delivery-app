...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_18
...
@dataclass
class HyperlocalDispatchPipelinesEntity18:
...
class HyperlocalDispatchPipelinesSchema18(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchPipelinesProcessor18()
