...
Submodule: PIPELINES | Component ID: HYPERLOCAL_DISPATCH_PIPELINES_11
...
@dataclass
class HyperlocalDispatchPipelinesEntity11:
...
class HyperlocalDispatchPipelinesSchema11(BaseModel):
...
class HyperlocalDispatchPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchPipelinesProcessor11()
