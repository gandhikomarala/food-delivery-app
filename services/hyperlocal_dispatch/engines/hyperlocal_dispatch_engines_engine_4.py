...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_4
...
@dataclass
class HyperlocalDispatchEnginesEntity4:
...
class HyperlocalDispatchEnginesSchema4(BaseModel):
...
class HyperlocalDispatchEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchEnginesProcessor4()
