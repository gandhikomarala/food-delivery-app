...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_18
...
@dataclass
class HyperlocalDispatchEnginesEntity18:
...
class HyperlocalDispatchEnginesSchema18(BaseModel):
...
class HyperlocalDispatchEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchEnginesProcessor18()
