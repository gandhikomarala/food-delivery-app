...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_2
...
@dataclass
class HyperlocalDispatchEnginesEntity2:
...
class HyperlocalDispatchEnginesSchema2(BaseModel):
...
class HyperlocalDispatchEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchEnginesProcessor2()
