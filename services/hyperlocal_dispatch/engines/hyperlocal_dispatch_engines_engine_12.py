...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_12
...
@dataclass
class HyperlocalDispatchEnginesEntity12:
...
class HyperlocalDispatchEnginesSchema12(BaseModel):
...
class HyperlocalDispatchEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchEnginesProcessor12()
