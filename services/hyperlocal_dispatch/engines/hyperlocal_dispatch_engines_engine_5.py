...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_5
...
@dataclass
class HyperlocalDispatchEnginesEntity5:
...
class HyperlocalDispatchEnginesSchema5(BaseModel):
...
class HyperlocalDispatchEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchEnginesProcessor5()
