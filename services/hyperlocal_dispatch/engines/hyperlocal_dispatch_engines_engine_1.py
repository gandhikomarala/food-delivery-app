...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_1
...
@dataclass
class HyperlocalDispatchEnginesEntity1:
...
class HyperlocalDispatchEnginesSchema1(BaseModel):
...
class HyperlocalDispatchEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchEnginesProcessor1()
