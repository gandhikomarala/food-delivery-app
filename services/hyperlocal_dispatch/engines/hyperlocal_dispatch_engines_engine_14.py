...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_14
...
@dataclass
class HyperlocalDispatchEnginesEntity14:
...
class HyperlocalDispatchEnginesSchema14(BaseModel):
...
class HyperlocalDispatchEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchEnginesProcessor14()
