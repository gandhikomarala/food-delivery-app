...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_17
...
@dataclass
class HyperlocalDispatchEnginesEntity17:
...
class HyperlocalDispatchEnginesSchema17(BaseModel):
...
class HyperlocalDispatchEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchEnginesProcessor17()
