...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_11
...
@dataclass
class HyperlocalDispatchEnginesEntity11:
...
class HyperlocalDispatchEnginesSchema11(BaseModel):
...
class HyperlocalDispatchEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchEnginesProcessor11()
