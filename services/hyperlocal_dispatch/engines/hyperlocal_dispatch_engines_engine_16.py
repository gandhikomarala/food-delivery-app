...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_16
...
@dataclass
class HyperlocalDispatchEnginesEntity16:
...
class HyperlocalDispatchEnginesSchema16(BaseModel):
...
class HyperlocalDispatchEnginesProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchEnginesProcessor16()
