...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_13
...
@dataclass
class HyperlocalDispatchEnginesEntity13:
...
class HyperlocalDispatchEnginesSchema13(BaseModel):
...
class HyperlocalDispatchEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchEnginesProcessor13()
