...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_9
...
@dataclass
class HyperlocalDispatchEnginesEntity9:
...
class HyperlocalDispatchEnginesSchema9(BaseModel):
...
class HyperlocalDispatchEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchEnginesProcessor9()
