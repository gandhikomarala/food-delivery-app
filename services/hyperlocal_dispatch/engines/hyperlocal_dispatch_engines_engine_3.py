...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_3
...
@dataclass
class HyperlocalDispatchEnginesEntity3:
...
class HyperlocalDispatchEnginesSchema3(BaseModel):
...
class HyperlocalDispatchEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchEnginesProcessor3()
