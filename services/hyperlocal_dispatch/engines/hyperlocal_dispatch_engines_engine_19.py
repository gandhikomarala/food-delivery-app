...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_19
...
@dataclass
class HyperlocalDispatchEnginesEntity19:
...
class HyperlocalDispatchEnginesSchema19(BaseModel):
...
class HyperlocalDispatchEnginesProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchEnginesProcessor19()
