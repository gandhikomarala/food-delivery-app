...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_6
...
@dataclass
class HyperlocalDispatchEnginesEntity6:
...
class HyperlocalDispatchEnginesSchema6(BaseModel):
...
class HyperlocalDispatchEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchEnginesProcessor6()
