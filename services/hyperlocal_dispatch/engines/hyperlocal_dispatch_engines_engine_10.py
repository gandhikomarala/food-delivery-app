...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_10
...
@dataclass
class HyperlocalDispatchEnginesEntity10:
...
class HyperlocalDispatchEnginesSchema10(BaseModel):
...
class HyperlocalDispatchEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchEnginesProcessor10()
