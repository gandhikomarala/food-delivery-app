...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_20
...
@dataclass
class HyperlocalDispatchEnginesEntity20:
...
class HyperlocalDispatchEnginesSchema20(BaseModel):
...
class HyperlocalDispatchEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchEnginesProcessor20()
