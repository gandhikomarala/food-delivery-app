...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_7
...
@dataclass
class HyperlocalDispatchEnginesEntity7:
...
class HyperlocalDispatchEnginesSchema7(BaseModel):
...
class HyperlocalDispatchEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchEnginesProcessor7()
