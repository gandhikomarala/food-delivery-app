...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_15
...
@dataclass
class HyperlocalDispatchEnginesEntity15:
...
class HyperlocalDispatchEnginesSchema15(BaseModel):
...
class HyperlocalDispatchEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchEnginesProcessor15()
