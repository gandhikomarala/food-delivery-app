...
Submodule: ENGINES | Component ID: HYPERLOCAL_DISPATCH_ENGINES_8
...
@dataclass
class HyperlocalDispatchEnginesEntity8:
...
class HyperlocalDispatchEnginesSchema8(BaseModel):
...
class HyperlocalDispatchEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchEnginesProcessor8()
