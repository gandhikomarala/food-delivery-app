...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_1
...
@dataclass
class HyperlocalDispatchModelsEntity1:
...
class HyperlocalDispatchModelsSchema1(BaseModel):
...
class HyperlocalDispatchModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchModelsProcessor1()
