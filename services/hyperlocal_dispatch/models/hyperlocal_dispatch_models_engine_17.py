...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_17
...
@dataclass
class HyperlocalDispatchModelsEntity17:
...
class HyperlocalDispatchModelsSchema17(BaseModel):
...
class HyperlocalDispatchModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchModelsProcessor17()
