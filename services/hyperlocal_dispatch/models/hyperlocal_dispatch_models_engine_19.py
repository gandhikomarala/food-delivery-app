...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_19
...
@dataclass
class HyperlocalDispatchModelsEntity19:
...
class HyperlocalDispatchModelsSchema19(BaseModel):
...
class HyperlocalDispatchModelsProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchModelsProcessor19()
