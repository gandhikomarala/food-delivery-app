...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_18
...
@dataclass
class HyperlocalDispatchModelsEntity18:
...
class HyperlocalDispatchModelsSchema18(BaseModel):
...
class HyperlocalDispatchModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchModelsProcessor18()
