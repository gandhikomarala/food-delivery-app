...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_4
...
@dataclass
class HyperlocalDispatchModelsEntity4:
...
class HyperlocalDispatchModelsSchema4(BaseModel):
...
class HyperlocalDispatchModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchModelsProcessor4()
