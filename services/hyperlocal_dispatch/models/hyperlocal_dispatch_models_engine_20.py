...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_20
...
@dataclass
class HyperlocalDispatchModelsEntity20:
...
class HyperlocalDispatchModelsSchema20(BaseModel):
...
class HyperlocalDispatchModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchModelsProcessor20()
