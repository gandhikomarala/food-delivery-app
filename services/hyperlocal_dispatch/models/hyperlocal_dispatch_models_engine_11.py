...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_11
...
@dataclass
class HyperlocalDispatchModelsEntity11:
...
class HyperlocalDispatchModelsSchema11(BaseModel):
...
class HyperlocalDispatchModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchModelsProcessor11()
