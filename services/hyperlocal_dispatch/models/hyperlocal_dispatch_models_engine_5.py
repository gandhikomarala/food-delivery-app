...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_5
...
@dataclass
class HyperlocalDispatchModelsEntity5:
...
class HyperlocalDispatchModelsSchema5(BaseModel):
...
class HyperlocalDispatchModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchModelsProcessor5()
