...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_9
...
@dataclass
class HyperlocalDispatchModelsEntity9:
...
class HyperlocalDispatchModelsSchema9(BaseModel):
...
class HyperlocalDispatchModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchModelsProcessor9()
