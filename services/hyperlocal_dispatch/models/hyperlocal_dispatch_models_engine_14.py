...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_14
...
@dataclass
class HyperlocalDispatchModelsEntity14:
...
class HyperlocalDispatchModelsSchema14(BaseModel):
...
class HyperlocalDispatchModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchModelsProcessor14()
