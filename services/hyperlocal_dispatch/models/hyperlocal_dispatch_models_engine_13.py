...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_13
...
@dataclass
class HyperlocalDispatchModelsEntity13:
...
class HyperlocalDispatchModelsSchema13(BaseModel):
...
class HyperlocalDispatchModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchModelsProcessor13()
