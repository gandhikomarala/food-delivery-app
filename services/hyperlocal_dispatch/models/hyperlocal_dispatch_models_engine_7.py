...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_7
...
@dataclass
class HyperlocalDispatchModelsEntity7:
...
class HyperlocalDispatchModelsSchema7(BaseModel):
...
class HyperlocalDispatchModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchModelsProcessor7()
