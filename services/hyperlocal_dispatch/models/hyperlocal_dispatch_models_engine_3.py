...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_3
...
@dataclass
class HyperlocalDispatchModelsEntity3:
...
class HyperlocalDispatchModelsSchema3(BaseModel):
...
class HyperlocalDispatchModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchModelsProcessor3()
