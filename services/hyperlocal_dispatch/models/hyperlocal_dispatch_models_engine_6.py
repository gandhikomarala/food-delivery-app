...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_6
...
@dataclass
class HyperlocalDispatchModelsEntity6:
...
class HyperlocalDispatchModelsSchema6(BaseModel):
...
class HyperlocalDispatchModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchModelsProcessor6()
