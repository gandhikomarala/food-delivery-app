...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_10
...
@dataclass
class HyperlocalDispatchModelsEntity10:
...
class HyperlocalDispatchModelsSchema10(BaseModel):
...
class HyperlocalDispatchModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchModelsProcessor10()
