...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_16
...
@dataclass
class HyperlocalDispatchModelsEntity16:
...
class HyperlocalDispatchModelsSchema16(BaseModel):
...
class HyperlocalDispatchModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchModelsProcessor16()
