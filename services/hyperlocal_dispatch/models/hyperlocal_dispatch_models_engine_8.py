...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_8
...
@dataclass
class HyperlocalDispatchModelsEntity8:
...
class HyperlocalDispatchModelsSchema8(BaseModel):
...
class HyperlocalDispatchModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchModelsProcessor8()
