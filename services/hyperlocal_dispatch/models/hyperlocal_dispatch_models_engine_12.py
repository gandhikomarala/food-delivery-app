...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_12
...
@dataclass
class HyperlocalDispatchModelsEntity12:
...
class HyperlocalDispatchModelsSchema12(BaseModel):
...
class HyperlocalDispatchModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchModelsProcessor12()
