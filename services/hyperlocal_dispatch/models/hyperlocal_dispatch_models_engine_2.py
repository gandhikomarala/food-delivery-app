...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_2
...
@dataclass
class HyperlocalDispatchModelsEntity2:
...
class HyperlocalDispatchModelsSchema2(BaseModel):
...
class HyperlocalDispatchModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchModelsProcessor2()
