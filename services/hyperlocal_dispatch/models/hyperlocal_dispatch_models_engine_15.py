...
Submodule: MODELS | Component ID: HYPERLOCAL_DISPATCH_MODELS_15
...
@dataclass
class HyperlocalDispatchModelsEntity15:
...
class HyperlocalDispatchModelsSchema15(BaseModel):
...
class HyperlocalDispatchModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchModelsProcessor15()
