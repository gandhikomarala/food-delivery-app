...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_20
...
@dataclass
class HyperlocalDispatchMetricsEntity20:
...
class HyperlocalDispatchMetricsSchema20(BaseModel):
...
class HyperlocalDispatchMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchMetricsProcessor20()
