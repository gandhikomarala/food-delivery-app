...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_19
...
@dataclass
class HyperlocalDispatchMetricsEntity19:
...
class HyperlocalDispatchMetricsSchema19(BaseModel):
...
class HyperlocalDispatchMetricsProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchMetricsProcessor19()
