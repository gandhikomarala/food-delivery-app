...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_11
...
@dataclass
class HyperlocalDispatchMetricsEntity11:
...
class HyperlocalDispatchMetricsSchema11(BaseModel):
...
class HyperlocalDispatchMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchMetricsProcessor11()
