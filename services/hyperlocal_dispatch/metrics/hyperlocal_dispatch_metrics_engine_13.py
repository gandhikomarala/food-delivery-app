...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_13
...
@dataclass
class HyperlocalDispatchMetricsEntity13:
...
class HyperlocalDispatchMetricsSchema13(BaseModel):
...
class HyperlocalDispatchMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchMetricsProcessor13()
