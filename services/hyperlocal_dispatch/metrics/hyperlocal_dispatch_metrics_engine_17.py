...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_17
...
@dataclass
class HyperlocalDispatchMetricsEntity17:
...
class HyperlocalDispatchMetricsSchema17(BaseModel):
...
class HyperlocalDispatchMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchMetricsProcessor17()
