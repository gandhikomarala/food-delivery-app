...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_7
...
@dataclass
class HyperlocalDispatchMetricsEntity7:
...
class HyperlocalDispatchMetricsSchema7(BaseModel):
...
class HyperlocalDispatchMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchMetricsProcessor7()
