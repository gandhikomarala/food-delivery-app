...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_2
...
@dataclass
class HyperlocalDispatchMetricsEntity2:
...
class HyperlocalDispatchMetricsSchema2(BaseModel):
...
class HyperlocalDispatchMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchMetricsProcessor2()
