...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_1
...
@dataclass
class HyperlocalDispatchMetricsEntity1:
...
class HyperlocalDispatchMetricsSchema1(BaseModel):
...
class HyperlocalDispatchMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchMetricsProcessor1()
