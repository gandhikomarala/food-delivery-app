...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_16
...
@dataclass
class HyperlocalDispatchMetricsEntity16:
...
class HyperlocalDispatchMetricsSchema16(BaseModel):
...
class HyperlocalDispatchMetricsProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchMetricsProcessor16()
