...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_6
...
@dataclass
class HyperlocalDispatchMetricsEntity6:
...
class HyperlocalDispatchMetricsSchema6(BaseModel):
...
class HyperlocalDispatchMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchMetricsProcessor6()
