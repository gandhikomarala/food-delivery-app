...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_3
...
@dataclass
class HyperlocalDispatchMetricsEntity3:
...
class HyperlocalDispatchMetricsSchema3(BaseModel):
...
class HyperlocalDispatchMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchMetricsProcessor3()
