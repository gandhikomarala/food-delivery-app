...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_5
...
@dataclass
class HyperlocalDispatchMetricsEntity5:
...
class HyperlocalDispatchMetricsSchema5(BaseModel):
...
class HyperlocalDispatchMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchMetricsProcessor5()
