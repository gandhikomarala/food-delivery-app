...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_18
...
@dataclass
class HyperlocalDispatchMetricsEntity18:
...
class HyperlocalDispatchMetricsSchema18(BaseModel):
...
class HyperlocalDispatchMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchMetricsProcessor18()
