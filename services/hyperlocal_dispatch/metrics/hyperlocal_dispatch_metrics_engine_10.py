...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_10
...
@dataclass
class HyperlocalDispatchMetricsEntity10:
...
class HyperlocalDispatchMetricsSchema10(BaseModel):
...
class HyperlocalDispatchMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchMetricsProcessor10()
