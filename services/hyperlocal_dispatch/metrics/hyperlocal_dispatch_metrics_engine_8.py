...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_8
...
@dataclass
class HyperlocalDispatchMetricsEntity8:
...
class HyperlocalDispatchMetricsSchema8(BaseModel):
...
class HyperlocalDispatchMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchMetricsProcessor8()
