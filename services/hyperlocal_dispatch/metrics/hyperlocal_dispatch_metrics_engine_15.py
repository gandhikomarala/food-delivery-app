...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_15
...
@dataclass
class HyperlocalDispatchMetricsEntity15:
...
class HyperlocalDispatchMetricsSchema15(BaseModel):
...
class HyperlocalDispatchMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchMetricsProcessor15()
