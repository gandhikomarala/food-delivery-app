...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_4
...
@dataclass
class HyperlocalDispatchMetricsEntity4:
...
class HyperlocalDispatchMetricsSchema4(BaseModel):
...
class HyperlocalDispatchMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchMetricsProcessor4()
