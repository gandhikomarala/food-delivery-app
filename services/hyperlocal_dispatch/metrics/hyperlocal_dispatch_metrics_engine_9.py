...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_9
...
@dataclass
class HyperlocalDispatchMetricsEntity9:
...
class HyperlocalDispatchMetricsSchema9(BaseModel):
...
class HyperlocalDispatchMetricsProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchMetricsProcessor9()
