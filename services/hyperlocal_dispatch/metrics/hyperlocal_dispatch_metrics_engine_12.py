...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_12
...
@dataclass
class HyperlocalDispatchMetricsEntity12:
...
class HyperlocalDispatchMetricsSchema12(BaseModel):
...
class HyperlocalDispatchMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchMetricsProcessor12()
