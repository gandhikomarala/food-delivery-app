...
Submodule: METRICS | Component ID: HYPERLOCAL_DISPATCH_METRICS_14
...
@dataclass
class HyperlocalDispatchMetricsEntity14:
...
class HyperlocalDispatchMetricsSchema14(BaseModel):
...
class HyperlocalDispatchMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchMetricsProcessor14()
