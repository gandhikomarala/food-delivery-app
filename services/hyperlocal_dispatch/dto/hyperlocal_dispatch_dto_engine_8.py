...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_8
...
@dataclass
class HyperlocalDispatchDtoEntity8:
...
class HyperlocalDispatchDtoSchema8(BaseModel):
...
class HyperlocalDispatchDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = HyperlocalDispatchDtoProcessor8()
