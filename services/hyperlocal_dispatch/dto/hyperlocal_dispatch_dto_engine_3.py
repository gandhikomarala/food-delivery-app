...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_3
...
@dataclass
class HyperlocalDispatchDtoEntity3:
...
class HyperlocalDispatchDtoSchema3(BaseModel):
...
class HyperlocalDispatchDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = HyperlocalDispatchDtoProcessor3()
