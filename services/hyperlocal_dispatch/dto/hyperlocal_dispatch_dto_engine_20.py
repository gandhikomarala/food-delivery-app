...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_20
...
@dataclass
class HyperlocalDispatchDtoEntity20:
...
class HyperlocalDispatchDtoSchema20(BaseModel):
...
class HyperlocalDispatchDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = HyperlocalDispatchDtoProcessor20()
