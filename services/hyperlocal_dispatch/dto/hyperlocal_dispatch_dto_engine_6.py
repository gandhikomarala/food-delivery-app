...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_6
...
@dataclass
class HyperlocalDispatchDtoEntity6:
...
class HyperlocalDispatchDtoSchema6(BaseModel):
...
class HyperlocalDispatchDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = HyperlocalDispatchDtoProcessor6()
