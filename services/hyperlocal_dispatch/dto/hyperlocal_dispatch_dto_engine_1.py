...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_1
...
@dataclass
class HyperlocalDispatchDtoEntity1:
...
class HyperlocalDispatchDtoSchema1(BaseModel):
...
class HyperlocalDispatchDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = HyperlocalDispatchDtoProcessor1()
