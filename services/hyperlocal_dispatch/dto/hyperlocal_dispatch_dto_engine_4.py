...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_4
...
@dataclass
class HyperlocalDispatchDtoEntity4:
...
class HyperlocalDispatchDtoSchema4(BaseModel):
...
class HyperlocalDispatchDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = HyperlocalDispatchDtoProcessor4()
