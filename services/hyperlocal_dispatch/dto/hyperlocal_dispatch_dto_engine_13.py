...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_13
...
@dataclass
class HyperlocalDispatchDtoEntity13:
...
class HyperlocalDispatchDtoSchema13(BaseModel):
...
class HyperlocalDispatchDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = HyperlocalDispatchDtoProcessor13()
