...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_9
...
@dataclass
class HyperlocalDispatchDtoEntity9:
...
class HyperlocalDispatchDtoSchema9(BaseModel):
...
class HyperlocalDispatchDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = HyperlocalDispatchDtoProcessor9()
