...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_18
...
@dataclass
class HyperlocalDispatchDtoEntity18:
...
class HyperlocalDispatchDtoSchema18(BaseModel):
...
class HyperlocalDispatchDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = HyperlocalDispatchDtoProcessor18()
