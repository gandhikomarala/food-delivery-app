...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_16
...
@dataclass
class HyperlocalDispatchDtoEntity16:
...
class HyperlocalDispatchDtoSchema16(BaseModel):
...
class HyperlocalDispatchDtoProcessor16:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema16) -> Dict[str, Any]:
...
default_processor_16 = HyperlocalDispatchDtoProcessor16()
