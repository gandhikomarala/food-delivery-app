...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_14
...
@dataclass
class HyperlocalDispatchDtoEntity14:
...
class HyperlocalDispatchDtoSchema14(BaseModel):
...
class HyperlocalDispatchDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = HyperlocalDispatchDtoProcessor14()
