...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_17
...
@dataclass
class HyperlocalDispatchDtoEntity17:
...
class HyperlocalDispatchDtoSchema17(BaseModel):
...
class HyperlocalDispatchDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = HyperlocalDispatchDtoProcessor17()
