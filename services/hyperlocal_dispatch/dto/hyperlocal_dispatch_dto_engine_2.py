...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_2
...
@dataclass
class HyperlocalDispatchDtoEntity2:
...
class HyperlocalDispatchDtoSchema2(BaseModel):
...
class HyperlocalDispatchDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = HyperlocalDispatchDtoProcessor2()
