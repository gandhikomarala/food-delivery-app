...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_12
...
@dataclass
class HyperlocalDispatchDtoEntity12:
...
class HyperlocalDispatchDtoSchema12(BaseModel):
...
class HyperlocalDispatchDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = HyperlocalDispatchDtoProcessor12()
