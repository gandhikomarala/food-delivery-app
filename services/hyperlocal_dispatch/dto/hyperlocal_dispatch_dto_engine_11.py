...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_11
...
@dataclass
class HyperlocalDispatchDtoEntity11:
...
class HyperlocalDispatchDtoSchema11(BaseModel):
...
class HyperlocalDispatchDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = HyperlocalDispatchDtoProcessor11()
