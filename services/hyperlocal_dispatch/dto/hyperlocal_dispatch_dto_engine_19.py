...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_19
...
@dataclass
class HyperlocalDispatchDtoEntity19:
...
class HyperlocalDispatchDtoSchema19(BaseModel):
...
class HyperlocalDispatchDtoProcessor19:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema19) -> Dict[str, Any]:
...
default_processor_19 = HyperlocalDispatchDtoProcessor19()
