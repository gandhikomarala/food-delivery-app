...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_10
...
@dataclass
class HyperlocalDispatchDtoEntity10:
...
class HyperlocalDispatchDtoSchema10(BaseModel):
...
class HyperlocalDispatchDtoProcessor10:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema10) -> Dict[str, Any]:
...
default_processor_10 = HyperlocalDispatchDtoProcessor10()
