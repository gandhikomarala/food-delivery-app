...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_15
...
@dataclass
class HyperlocalDispatchDtoEntity15:
...
class HyperlocalDispatchDtoSchema15(BaseModel):
...
class HyperlocalDispatchDtoProcessor15:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema15) -> Dict[str, Any]:
...
default_processor_15 = HyperlocalDispatchDtoProcessor15()
