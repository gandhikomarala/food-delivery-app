...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_7
...
@dataclass
class HyperlocalDispatchDtoEntity7:
...
class HyperlocalDispatchDtoSchema7(BaseModel):
...
class HyperlocalDispatchDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = HyperlocalDispatchDtoProcessor7()
