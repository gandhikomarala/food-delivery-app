...
Submodule: DTO | Component ID: HYPERLOCAL_DISPATCH_DTO_5
...
@dataclass
class HyperlocalDispatchDtoEntity5:
...
class HyperlocalDispatchDtoSchema5(BaseModel):
...
class HyperlocalDispatchDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: HyperlocalDispatchDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = HyperlocalDispatchDtoProcessor5()
