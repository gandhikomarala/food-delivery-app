...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_18
...
@dataclass
class KitchenKdsMetricsEntity18:
...
class KitchenKdsMetricsSchema18(BaseModel):
...
class KitchenKdsMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsMetricsProcessor18()
