...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_6
...
@dataclass
class KitchenKdsMetricsEntity6:
...
class KitchenKdsMetricsSchema6(BaseModel):
...
class KitchenKdsMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsMetricsProcessor6()
