...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_7
...
@dataclass
class KitchenKdsMetricsEntity7:
...
class KitchenKdsMetricsSchema7(BaseModel):
...
class KitchenKdsMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsMetricsProcessor7()
