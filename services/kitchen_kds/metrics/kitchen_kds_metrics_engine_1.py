...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_1
...
@dataclass
class KitchenKdsMetricsEntity1:
...
class KitchenKdsMetricsSchema1(BaseModel):
...
class KitchenKdsMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsMetricsProcessor1()
