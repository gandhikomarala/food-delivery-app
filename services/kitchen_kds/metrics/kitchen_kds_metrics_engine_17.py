...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_17
...
@dataclass
class KitchenKdsMetricsEntity17:
...
class KitchenKdsMetricsSchema17(BaseModel):
...
class KitchenKdsMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsMetricsProcessor17()
