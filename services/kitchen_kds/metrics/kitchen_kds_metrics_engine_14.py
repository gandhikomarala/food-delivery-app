...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_14
...
@dataclass
class KitchenKdsMetricsEntity14:
...
class KitchenKdsMetricsSchema14(BaseModel):
...
class KitchenKdsMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsMetricsProcessor14()
