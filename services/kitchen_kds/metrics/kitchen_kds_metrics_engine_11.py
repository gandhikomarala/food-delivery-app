...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_11
...
@dataclass
class KitchenKdsMetricsEntity11:
...
class KitchenKdsMetricsSchema11(BaseModel):
...
class KitchenKdsMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsMetricsProcessor11()
