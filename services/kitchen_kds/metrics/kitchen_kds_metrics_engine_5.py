...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_5
...
@dataclass
class KitchenKdsMetricsEntity5:
...
class KitchenKdsMetricsSchema5(BaseModel):
...
class KitchenKdsMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsMetricsProcessor5()
