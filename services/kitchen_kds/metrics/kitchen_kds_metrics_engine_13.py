...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_13
...
@dataclass
class KitchenKdsMetricsEntity13:
...
class KitchenKdsMetricsSchema13(BaseModel):
...
class KitchenKdsMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsMetricsProcessor13()
