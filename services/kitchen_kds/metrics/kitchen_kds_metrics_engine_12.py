...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_12
...
@dataclass
class KitchenKdsMetricsEntity12:
...
class KitchenKdsMetricsSchema12(BaseModel):
...
class KitchenKdsMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsMetricsProcessor12()
