...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_10
...
@dataclass
class KitchenKdsMetricsEntity10:
...
class KitchenKdsMetricsSchema10(BaseModel):
...
class KitchenKdsMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsMetricsProcessor10()
