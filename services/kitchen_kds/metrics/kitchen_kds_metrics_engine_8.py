...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_8
...
@dataclass
class KitchenKdsMetricsEntity8:
...
class KitchenKdsMetricsSchema8(BaseModel):
...
class KitchenKdsMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsMetricsProcessor8()
