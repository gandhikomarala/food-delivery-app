...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_2
...
@dataclass
class KitchenKdsMetricsEntity2:
...
class KitchenKdsMetricsSchema2(BaseModel):
...
class KitchenKdsMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsMetricsProcessor2()
