...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_3
...
@dataclass
class KitchenKdsMetricsEntity3:
...
class KitchenKdsMetricsSchema3(BaseModel):
...
class KitchenKdsMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsMetricsProcessor3()
