...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_20
...
@dataclass
class KitchenKdsMetricsEntity20:
...
class KitchenKdsMetricsSchema20(BaseModel):
...
class KitchenKdsMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsMetricsProcessor20()
