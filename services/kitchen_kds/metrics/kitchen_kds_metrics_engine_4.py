...
Submodule: METRICS | Component ID: KITCHEN_KDS_METRICS_4
...
@dataclass
class KitchenKdsMetricsEntity4:
...
class KitchenKdsMetricsSchema4(BaseModel):
...
class KitchenKdsMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsMetricsProcessor4()
