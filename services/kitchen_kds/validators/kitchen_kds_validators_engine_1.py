...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_1
...
@dataclass
class KitchenKdsValidatorsEntity1:
...
class KitchenKdsValidatorsSchema1(BaseModel):
...
class KitchenKdsValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsValidatorsProcessor1()
