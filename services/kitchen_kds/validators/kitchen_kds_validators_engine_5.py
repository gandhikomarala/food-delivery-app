...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_5
...
@dataclass
class KitchenKdsValidatorsEntity5:
...
class KitchenKdsValidatorsSchema5(BaseModel):
...
class KitchenKdsValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsValidatorsProcessor5()
