...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_13
...
@dataclass
class KitchenKdsValidatorsEntity13:
...
class KitchenKdsValidatorsSchema13(BaseModel):
...
class KitchenKdsValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsValidatorsProcessor13()
