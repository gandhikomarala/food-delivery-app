...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_3
...
@dataclass
class KitchenKdsValidatorsEntity3:
...
class KitchenKdsValidatorsSchema3(BaseModel):
...
class KitchenKdsValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsValidatorsProcessor3()
