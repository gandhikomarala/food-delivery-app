...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_4
...
@dataclass
class KitchenKdsValidatorsEntity4:
...
class KitchenKdsValidatorsSchema4(BaseModel):
...
class KitchenKdsValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsValidatorsProcessor4()
