...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_15
...
@dataclass
class KitchenKdsValidatorsEntity15:
...
class KitchenKdsValidatorsSchema15(BaseModel):
...
class KitchenKdsValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = KitchenKdsValidatorsProcessor15()
