...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_17
...
@dataclass
class KitchenKdsValidatorsEntity17:
...
class KitchenKdsValidatorsSchema17(BaseModel):
...
class KitchenKdsValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsValidatorsProcessor17()
