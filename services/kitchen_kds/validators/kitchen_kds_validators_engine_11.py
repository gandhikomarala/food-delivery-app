...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_11
...
@dataclass
class KitchenKdsValidatorsEntity11:
...
class KitchenKdsValidatorsSchema11(BaseModel):
...
class KitchenKdsValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsValidatorsProcessor11()
