...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_2
...
@dataclass
class KitchenKdsValidatorsEntity2:
...
class KitchenKdsValidatorsSchema2(BaseModel):
...
class KitchenKdsValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsValidatorsProcessor2()
