...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_9
...
@dataclass
class KitchenKdsValidatorsEntity9:
...
class KitchenKdsValidatorsSchema9(BaseModel):
...
class KitchenKdsValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = KitchenKdsValidatorsProcessor9()
