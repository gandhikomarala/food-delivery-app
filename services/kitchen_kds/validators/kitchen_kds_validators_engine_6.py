...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_6
...
@dataclass
class KitchenKdsValidatorsEntity6:
...
class KitchenKdsValidatorsSchema6(BaseModel):
...
class KitchenKdsValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsValidatorsProcessor6()
