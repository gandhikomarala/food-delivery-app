...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_10
...
@dataclass
class KitchenKdsValidatorsEntity10:
...
class KitchenKdsValidatorsSchema10(BaseModel):
...
class KitchenKdsValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsValidatorsProcessor10()
