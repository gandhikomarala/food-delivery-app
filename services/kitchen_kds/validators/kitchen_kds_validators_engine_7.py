...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_7
...
@dataclass
class KitchenKdsValidatorsEntity7:
...
class KitchenKdsValidatorsSchema7(BaseModel):
...
class KitchenKdsValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsValidatorsProcessor7()
