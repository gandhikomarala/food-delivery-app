...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_20
...
@dataclass
class KitchenKdsValidatorsEntity20:
...
class KitchenKdsValidatorsSchema20(BaseModel):
...
class KitchenKdsValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsValidatorsProcessor20()
