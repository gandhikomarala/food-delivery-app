...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_18
...
@dataclass
class KitchenKdsValidatorsEntity18:
...
class KitchenKdsValidatorsSchema18(BaseModel):
...
class KitchenKdsValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsValidatorsProcessor18()
