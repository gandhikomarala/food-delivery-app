...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_12
...
@dataclass
class KitchenKdsValidatorsEntity12:
...
class KitchenKdsValidatorsSchema12(BaseModel):
...
class KitchenKdsValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsValidatorsProcessor12()
