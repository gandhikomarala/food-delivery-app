...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_8
...
@dataclass
class KitchenKdsValidatorsEntity8:
...
class KitchenKdsValidatorsSchema8(BaseModel):
...
class KitchenKdsValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsValidatorsProcessor8()
