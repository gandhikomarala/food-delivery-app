...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_16
...
@dataclass
class KitchenKdsValidatorsEntity16:
...
class KitchenKdsValidatorsSchema16(BaseModel):
...
class KitchenKdsValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = KitchenKdsValidatorsProcessor16()
