...
Submodule: VALIDATORS | Component ID: KITCHEN_KDS_VALIDATORS_14
...
@dataclass
class KitchenKdsValidatorsEntity14:
...
class KitchenKdsValidatorsSchema14(BaseModel):
...
class KitchenKdsValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsValidatorsProcessor14()
