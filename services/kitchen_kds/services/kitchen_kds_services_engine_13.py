...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_13
...
@dataclass
class KitchenKdsServicesEntity13:
...
class KitchenKdsServicesSchema13(BaseModel):
...
class KitchenKdsServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsServicesProcessor13()
