...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_17
...
@dataclass
class KitchenKdsServicesEntity17:
...
class KitchenKdsServicesSchema17(BaseModel):
...
class KitchenKdsServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsServicesProcessor17()
