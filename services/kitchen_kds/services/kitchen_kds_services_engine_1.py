...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_1
...
@dataclass
class KitchenKdsServicesEntity1:
...
class KitchenKdsServicesSchema1(BaseModel):
...
class KitchenKdsServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsServicesProcessor1()
