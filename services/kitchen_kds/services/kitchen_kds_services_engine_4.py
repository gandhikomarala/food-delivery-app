...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_4
...
@dataclass
class KitchenKdsServicesEntity4:
...
class KitchenKdsServicesSchema4(BaseModel):
...
class KitchenKdsServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsServicesProcessor4()
