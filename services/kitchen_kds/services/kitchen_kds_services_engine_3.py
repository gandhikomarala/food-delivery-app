...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_3
...
@dataclass
class KitchenKdsServicesEntity3:
...
class KitchenKdsServicesSchema3(BaseModel):
...
class KitchenKdsServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsServicesProcessor3()
