...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_8
...
@dataclass
class KitchenKdsServicesEntity8:
...
class KitchenKdsServicesSchema8(BaseModel):
...
class KitchenKdsServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsServicesProcessor8()
