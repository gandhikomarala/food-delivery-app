...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_20
...
@dataclass
class KitchenKdsServicesEntity20:
...
class KitchenKdsServicesSchema20(BaseModel):
...
class KitchenKdsServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsServicesProcessor20()
