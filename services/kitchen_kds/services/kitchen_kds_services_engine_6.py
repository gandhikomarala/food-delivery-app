...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_6
...
@dataclass
class KitchenKdsServicesEntity6:
...
class KitchenKdsServicesSchema6(BaseModel):
...
class KitchenKdsServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsServicesProcessor6()
