...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_2
...
@dataclass
class KitchenKdsServicesEntity2:
...
class KitchenKdsServicesSchema2(BaseModel):
...
class KitchenKdsServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsServicesProcessor2()
