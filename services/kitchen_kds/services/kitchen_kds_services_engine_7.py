...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_7
...
@dataclass
class KitchenKdsServicesEntity7:
...
class KitchenKdsServicesSchema7(BaseModel):
...
class KitchenKdsServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsServicesProcessor7()
