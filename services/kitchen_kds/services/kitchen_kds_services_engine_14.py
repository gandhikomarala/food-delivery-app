...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_14
...
@dataclass
class KitchenKdsServicesEntity14:
...
class KitchenKdsServicesSchema14(BaseModel):
...
class KitchenKdsServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsServicesProcessor14()
