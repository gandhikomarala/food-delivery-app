...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_10
...
@dataclass
class KitchenKdsServicesEntity10:
...
class KitchenKdsServicesSchema10(BaseModel):
...
class KitchenKdsServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsServicesProcessor10()
