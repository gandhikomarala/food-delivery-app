...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_5
...
@dataclass
class KitchenKdsServicesEntity5:
...
class KitchenKdsServicesSchema5(BaseModel):
...
class KitchenKdsServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsServicesProcessor5()
