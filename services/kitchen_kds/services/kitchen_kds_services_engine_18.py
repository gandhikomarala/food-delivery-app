...
Submodule: SERVICES | Component ID: KITCHEN_KDS_SERVICES_18
...
@dataclass
class KitchenKdsServicesEntity18:
...
class KitchenKdsServicesSchema18(BaseModel):
...
class KitchenKdsServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsServicesProcessor18()
