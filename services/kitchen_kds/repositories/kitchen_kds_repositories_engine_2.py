...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_2
...
@dataclass
class KitchenKdsRepositoriesEntity2:
...
class KitchenKdsRepositoriesSchema2(BaseModel):
...
class KitchenKdsRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsRepositoriesProcessor2()
