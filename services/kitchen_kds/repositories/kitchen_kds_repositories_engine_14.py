...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_14
...
@dataclass
class KitchenKdsRepositoriesEntity14:
...
class KitchenKdsRepositoriesSchema14(BaseModel):
...
class KitchenKdsRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsRepositoriesProcessor14()
