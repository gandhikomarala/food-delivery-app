...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_1
...
@dataclass
class KitchenKdsRepositoriesEntity1:
...
class KitchenKdsRepositoriesSchema1(BaseModel):
...
class KitchenKdsRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsRepositoriesProcessor1()
