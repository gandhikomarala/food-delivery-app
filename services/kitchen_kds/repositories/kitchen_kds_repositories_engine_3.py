...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_3
...
@dataclass
class KitchenKdsRepositoriesEntity3:
...
class KitchenKdsRepositoriesSchema3(BaseModel):
...
class KitchenKdsRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsRepositoriesProcessor3()
