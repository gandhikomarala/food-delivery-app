...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_18
...
@dataclass
class KitchenKdsRepositoriesEntity18:
...
class KitchenKdsRepositoriesSchema18(BaseModel):
...
class KitchenKdsRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsRepositoriesProcessor18()
