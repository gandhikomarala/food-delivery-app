...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_8
...
@dataclass
class KitchenKdsRepositoriesEntity8:
...
class KitchenKdsRepositoriesSchema8(BaseModel):
...
class KitchenKdsRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsRepositoriesProcessor8()
