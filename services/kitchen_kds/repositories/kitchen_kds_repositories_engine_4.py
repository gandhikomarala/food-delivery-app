...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_4
...
@dataclass
class KitchenKdsRepositoriesEntity4:
...
class KitchenKdsRepositoriesSchema4(BaseModel):
...
class KitchenKdsRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsRepositoriesProcessor4()
