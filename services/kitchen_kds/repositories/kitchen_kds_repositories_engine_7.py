...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_7
...
@dataclass
class KitchenKdsRepositoriesEntity7:
...
class KitchenKdsRepositoriesSchema7(BaseModel):
...
class KitchenKdsRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsRepositoriesProcessor7()
