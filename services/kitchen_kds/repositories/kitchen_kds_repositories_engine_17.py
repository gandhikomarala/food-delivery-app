...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_17
...
@dataclass
class KitchenKdsRepositoriesEntity17:
...
class KitchenKdsRepositoriesSchema17(BaseModel):
...
class KitchenKdsRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsRepositoriesProcessor17()
