...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_5
...
@dataclass
class KitchenKdsRepositoriesEntity5:
...
class KitchenKdsRepositoriesSchema5(BaseModel):
...
class KitchenKdsRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsRepositoriesProcessor5()
