...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_20
...
@dataclass
class KitchenKdsRepositoriesEntity20:
...
class KitchenKdsRepositoriesSchema20(BaseModel):
...
class KitchenKdsRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsRepositoriesProcessor20()
