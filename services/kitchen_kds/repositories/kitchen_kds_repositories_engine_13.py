...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_13
...
@dataclass
class KitchenKdsRepositoriesEntity13:
...
class KitchenKdsRepositoriesSchema13(BaseModel):
...
class KitchenKdsRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsRepositoriesProcessor13()
