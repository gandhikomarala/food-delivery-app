...
Submodule: REPOSITORIES | Component ID: KITCHEN_KDS_REPOSITORIES_6
...
@dataclass
class KitchenKdsRepositoriesEntity6:
...
class KitchenKdsRepositoriesSchema6(BaseModel):
...
class KitchenKdsRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsRepositoriesProcessor6()
