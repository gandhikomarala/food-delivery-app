...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_7
...
class KitchenKdsModelsSchema7(BaseModel):
...
class KitchenKdsModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsModelsProcessor7()
