...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_17
...
@dataclass
class KitchenKdsModelsEntity17:
...
class KitchenKdsModelsSchema17(BaseModel):
...
class KitchenKdsModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsModelsProcessor17()
