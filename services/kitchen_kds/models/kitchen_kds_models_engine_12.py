...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_12
...
@dataclass
class KitchenKdsModelsEntity12:
...
class KitchenKdsModelsSchema12(BaseModel):
...
class KitchenKdsModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsModelsProcessor12()
