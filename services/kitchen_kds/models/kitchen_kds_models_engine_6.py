...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_6
...
class KitchenKdsModelsSchema6(BaseModel):
...
class KitchenKdsModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsModelsProcessor6()
