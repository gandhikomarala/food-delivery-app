...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_20
...
@dataclass
class KitchenKdsModelsEntity20:
...
class KitchenKdsModelsSchema20(BaseModel):
...
class KitchenKdsModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsModelsProcessor20()
