...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_15
...
@dataclass
class KitchenKdsModelsEntity15:
...
class KitchenKdsModelsSchema15(BaseModel):
...
class KitchenKdsModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = KitchenKdsModelsProcessor15()
