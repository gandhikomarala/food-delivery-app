...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_18
...
@dataclass
class KitchenKdsModelsEntity18:
...
class KitchenKdsModelsSchema18(BaseModel):
...
class KitchenKdsModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsModelsProcessor18()
