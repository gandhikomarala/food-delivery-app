...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_14
...
@dataclass
class KitchenKdsModelsEntity14:
...
class KitchenKdsModelsSchema14(BaseModel):
...
class KitchenKdsModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsModelsProcessor14()
