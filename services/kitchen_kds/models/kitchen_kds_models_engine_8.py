...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_8
...
class KitchenKdsModelsSchema8(BaseModel):
...
class KitchenKdsModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsModelsProcessor8()
