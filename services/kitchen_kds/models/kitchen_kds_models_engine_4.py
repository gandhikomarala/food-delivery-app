...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_4
...
class KitchenKdsModelsSchema4(BaseModel):
...
class KitchenKdsModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsModelsProcessor4()
