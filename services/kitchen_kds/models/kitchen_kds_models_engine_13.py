...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_13
...
@dataclass
class KitchenKdsModelsEntity13:
...
class KitchenKdsModelsSchema13(BaseModel):
...
class KitchenKdsModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsModelsProcessor13()
