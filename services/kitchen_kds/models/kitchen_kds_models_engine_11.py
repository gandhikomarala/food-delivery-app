...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_11
...
@dataclass
class KitchenKdsModelsEntity11:
...
class KitchenKdsModelsSchema11(BaseModel):
...
class KitchenKdsModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsModelsProcessor11()
