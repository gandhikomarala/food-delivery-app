...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_16
...
@dataclass
class KitchenKdsModelsEntity16:
...
class KitchenKdsModelsSchema16(BaseModel):
...
class KitchenKdsModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = KitchenKdsModelsProcessor16()
