...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_2
...
class KitchenKdsModelsSchema2(BaseModel):
...
class KitchenKdsModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsModelsProcessor2()
