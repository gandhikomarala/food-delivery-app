...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_3
...
class KitchenKdsModelsSchema3(BaseModel):
...
class KitchenKdsModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsModelsProcessor3()
