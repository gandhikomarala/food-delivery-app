...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_10
...
@dataclass
class KitchenKdsModelsEntity10:
...
class KitchenKdsModelsSchema10(BaseModel):
...
class KitchenKdsModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsModelsProcessor10()
