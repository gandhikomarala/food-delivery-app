...
Submodule: MODELS | Component ID: KITCHEN_KDS_MODELS_1
...
class KitchenKdsModelsSchema1(BaseModel):
...
class KitchenKdsModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsModelsProcessor1()
