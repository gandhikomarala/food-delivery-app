...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_2
...
@dataclass
class KitchenKdsPipelinesEntity2:
...
class KitchenKdsPipelinesSchema2(BaseModel):
...
class KitchenKdsPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsPipelinesProcessor2()
