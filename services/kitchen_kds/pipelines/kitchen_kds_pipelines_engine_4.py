...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_4
...
@dataclass
class KitchenKdsPipelinesEntity4:
...
class KitchenKdsPipelinesSchema4(BaseModel):
...
class KitchenKdsPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsPipelinesProcessor4()
