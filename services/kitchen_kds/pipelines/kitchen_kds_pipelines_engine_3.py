...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_3
...
@dataclass
class KitchenKdsPipelinesEntity3:
...
class KitchenKdsPipelinesSchema3(BaseModel):
...
class KitchenKdsPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsPipelinesProcessor3()
