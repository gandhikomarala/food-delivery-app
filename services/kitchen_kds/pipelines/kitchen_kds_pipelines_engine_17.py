...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_17
...
@dataclass
class KitchenKdsPipelinesEntity17:
...
class KitchenKdsPipelinesSchema17(BaseModel):
...
class KitchenKdsPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsPipelinesProcessor17()
