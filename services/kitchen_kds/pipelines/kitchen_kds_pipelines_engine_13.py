...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_13
...
@dataclass
class KitchenKdsPipelinesEntity13:
...
class KitchenKdsPipelinesSchema13(BaseModel):
...
class KitchenKdsPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsPipelinesProcessor13()
