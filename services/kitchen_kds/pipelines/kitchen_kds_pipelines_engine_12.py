...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_12
...
@dataclass
class KitchenKdsPipelinesEntity12:
...
class KitchenKdsPipelinesSchema12(BaseModel):
...
class KitchenKdsPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsPipelinesProcessor12()
