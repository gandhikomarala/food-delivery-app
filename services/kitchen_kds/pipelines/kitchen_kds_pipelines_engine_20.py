...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_20
...
@dataclass
class KitchenKdsPipelinesEntity20:
...
class KitchenKdsPipelinesSchema20(BaseModel):
...
class KitchenKdsPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsPipelinesProcessor20()
