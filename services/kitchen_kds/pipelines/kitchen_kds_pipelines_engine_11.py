...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_11
...
@dataclass
class KitchenKdsPipelinesEntity11:
...
class KitchenKdsPipelinesSchema11(BaseModel):
...
class KitchenKdsPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsPipelinesProcessor11()
