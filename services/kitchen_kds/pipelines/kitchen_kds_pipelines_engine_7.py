...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_7
...
@dataclass
class KitchenKdsPipelinesEntity7:
...
class KitchenKdsPipelinesSchema7(BaseModel):
...
class KitchenKdsPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsPipelinesProcessor7()
