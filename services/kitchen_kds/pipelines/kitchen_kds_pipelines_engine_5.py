...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_5
...
@dataclass
class KitchenKdsPipelinesEntity5:
...
class KitchenKdsPipelinesSchema5(BaseModel):
...
class KitchenKdsPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsPipelinesProcessor5()
