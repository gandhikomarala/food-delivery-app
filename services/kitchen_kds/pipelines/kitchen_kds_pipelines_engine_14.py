...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_14
...
@dataclass
class KitchenKdsPipelinesEntity14:
...
class KitchenKdsPipelinesSchema14(BaseModel):
...
class KitchenKdsPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsPipelinesProcessor14()
