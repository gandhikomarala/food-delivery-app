...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_1
...
@dataclass
class KitchenKdsPipelinesEntity1:
...
class KitchenKdsPipelinesSchema1(BaseModel):
...
class KitchenKdsPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsPipelinesProcessor1()
