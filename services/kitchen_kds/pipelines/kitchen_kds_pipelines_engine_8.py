...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_8
...
@dataclass
class KitchenKdsPipelinesEntity8:
...
class KitchenKdsPipelinesSchema8(BaseModel):
...
class KitchenKdsPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsPipelinesProcessor8()
