...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_6
...
@dataclass
class KitchenKdsPipelinesEntity6:
...
class KitchenKdsPipelinesSchema6(BaseModel):
...
class KitchenKdsPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsPipelinesProcessor6()
