...
Submodule: PIPELINES | Component ID: KITCHEN_KDS_PIPELINES_18
...
@dataclass
class KitchenKdsPipelinesEntity18:
...
class KitchenKdsPipelinesSchema18(BaseModel):
...
class KitchenKdsPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsPipelinesProcessor18()
