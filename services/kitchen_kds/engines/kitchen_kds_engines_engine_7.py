...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_7
...
@dataclass
class KitchenKdsEnginesEntity7:
...
class KitchenKdsEnginesSchema7(BaseModel):
...
class KitchenKdsEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsEnginesProcessor7()
