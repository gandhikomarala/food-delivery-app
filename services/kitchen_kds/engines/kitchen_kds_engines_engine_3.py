...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_3
...
@dataclass
class KitchenKdsEnginesEntity3:
...
class KitchenKdsEnginesSchema3(BaseModel):
...
class KitchenKdsEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsEnginesProcessor3()
