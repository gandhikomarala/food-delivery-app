...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_11
...
@dataclass
class KitchenKdsEnginesEntity11:
...
class KitchenKdsEnginesSchema11(BaseModel):
...
class KitchenKdsEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsEnginesProcessor11()
