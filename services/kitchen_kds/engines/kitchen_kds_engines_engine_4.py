...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_4
...
@dataclass
class KitchenKdsEnginesEntity4:
...
class KitchenKdsEnginesSchema4(BaseModel):
...
class KitchenKdsEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsEnginesProcessor4()
