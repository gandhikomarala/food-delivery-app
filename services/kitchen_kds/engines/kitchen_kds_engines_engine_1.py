...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_1
...
@dataclass
class KitchenKdsEnginesEntity1:
...
class KitchenKdsEnginesSchema1(BaseModel):
...
class KitchenKdsEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsEnginesProcessor1()
