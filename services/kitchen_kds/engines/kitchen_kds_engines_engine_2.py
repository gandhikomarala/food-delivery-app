...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_2
...
@dataclass
class KitchenKdsEnginesEntity2:
...
class KitchenKdsEnginesSchema2(BaseModel):
...
class KitchenKdsEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsEnginesProcessor2()
