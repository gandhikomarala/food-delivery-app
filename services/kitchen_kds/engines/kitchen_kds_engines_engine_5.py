...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_5
...
@dataclass
class KitchenKdsEnginesEntity5:
...
class KitchenKdsEnginesSchema5(BaseModel):
...
class KitchenKdsEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsEnginesProcessor5()
