...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_20
...
@dataclass
class KitchenKdsEnginesEntity20:
...
class KitchenKdsEnginesSchema20(BaseModel):
...
class KitchenKdsEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsEnginesProcessor20()
