...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_14
...
@dataclass
class KitchenKdsEnginesEntity14:
...
class KitchenKdsEnginesSchema14(BaseModel):
...
class KitchenKdsEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsEnginesProcessor14()
