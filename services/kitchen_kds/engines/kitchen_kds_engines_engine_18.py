...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_18
...
@dataclass
class KitchenKdsEnginesEntity18:
...
class KitchenKdsEnginesSchema18(BaseModel):
...
class KitchenKdsEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsEnginesProcessor18()
