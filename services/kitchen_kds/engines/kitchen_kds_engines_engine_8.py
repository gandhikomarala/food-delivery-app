...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_8
...
@dataclass
class KitchenKdsEnginesEntity8:
...
class KitchenKdsEnginesSchema8(BaseModel):
...
class KitchenKdsEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsEnginesProcessor8()
