...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_17
...
@dataclass
class KitchenKdsEnginesEntity17:
...
class KitchenKdsEnginesSchema17(BaseModel):
...
class KitchenKdsEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsEnginesProcessor17()
