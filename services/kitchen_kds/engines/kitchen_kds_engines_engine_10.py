...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_10
...
@dataclass
class KitchenKdsEnginesEntity10:
...
class KitchenKdsEnginesSchema10(BaseModel):
...
class KitchenKdsEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsEnginesProcessor10()
