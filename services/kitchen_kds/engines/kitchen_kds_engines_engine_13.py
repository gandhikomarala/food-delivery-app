...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_13
...
@dataclass
class KitchenKdsEnginesEntity13:
...
class KitchenKdsEnginesSchema13(BaseModel):
...
class KitchenKdsEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsEnginesProcessor13()
