...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_12
...
@dataclass
class KitchenKdsEnginesEntity12:
...
class KitchenKdsEnginesSchema12(BaseModel):
...
class KitchenKdsEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsEnginesProcessor12()
