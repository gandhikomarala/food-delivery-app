...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_6
...
@dataclass
class KitchenKdsEnginesEntity6:
...
class KitchenKdsEnginesSchema6(BaseModel):
...
class KitchenKdsEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsEnginesProcessor6()
