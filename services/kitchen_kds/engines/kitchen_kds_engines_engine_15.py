...
Submodule: ENGINES | Component ID: KITCHEN_KDS_ENGINES_15
...
@dataclass
class KitchenKdsEnginesEntity15:
...
class KitchenKdsEnginesSchema15(BaseModel):
...
class KitchenKdsEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = KitchenKdsEnginesProcessor15()
