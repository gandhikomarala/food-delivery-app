...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_14
...
@dataclass
class KitchenKdsControllersEntity14:
...
class KitchenKdsControllersSchema14(BaseModel):
...
class KitchenKdsControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsControllersProcessor14()
