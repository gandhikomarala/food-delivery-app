...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_7
...
@dataclass
class KitchenKdsControllersEntity7:
...
class KitchenKdsControllersSchema7(BaseModel):
...
class KitchenKdsControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsControllersProcessor7()
