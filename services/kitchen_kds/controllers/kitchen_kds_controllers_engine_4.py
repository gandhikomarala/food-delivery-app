...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_4
...
@dataclass
class KitchenKdsControllersEntity4:
...
class KitchenKdsControllersSchema4(BaseModel):
...
class KitchenKdsControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsControllersProcessor4()
