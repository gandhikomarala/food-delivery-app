...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_6
...
@dataclass
class KitchenKdsControllersEntity6:
...
class KitchenKdsControllersSchema6(BaseModel):
...
class KitchenKdsControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsControllersProcessor6()
