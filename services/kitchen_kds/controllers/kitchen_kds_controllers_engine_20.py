...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_20
...
@dataclass
class KitchenKdsControllersEntity20:
...
class KitchenKdsControllersSchema20(BaseModel):
...
class KitchenKdsControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsControllersProcessor20()
