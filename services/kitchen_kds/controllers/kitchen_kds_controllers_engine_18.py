...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_18
...
@dataclass
class KitchenKdsControllersEntity18:
...
class KitchenKdsControllersSchema18(BaseModel):
...
class KitchenKdsControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsControllersProcessor18()
