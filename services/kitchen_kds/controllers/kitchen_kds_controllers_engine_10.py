...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_10
...
@dataclass
class KitchenKdsControllersEntity10:
...
class KitchenKdsControllersSchema10(BaseModel):
...
class KitchenKdsControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsControllersProcessor10()
