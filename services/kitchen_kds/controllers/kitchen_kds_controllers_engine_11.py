...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_11
...
@dataclass
class KitchenKdsControllersEntity11:
...
class KitchenKdsControllersSchema11(BaseModel):
...
class KitchenKdsControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsControllersProcessor11()
