...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_3
...
@dataclass
class KitchenKdsControllersEntity3:
...
class KitchenKdsControllersSchema3(BaseModel):
...
class KitchenKdsControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsControllersProcessor3()
