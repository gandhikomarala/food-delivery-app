...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_5
...
@dataclass
class KitchenKdsControllersEntity5:
...
class KitchenKdsControllersSchema5(BaseModel):
...
class KitchenKdsControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsControllersProcessor5()
