...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_15
...
@dataclass
class KitchenKdsControllersEntity15:
...
class KitchenKdsControllersSchema15(BaseModel):
...
class KitchenKdsControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = KitchenKdsControllersProcessor15()
