...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_13
...
@dataclass
class KitchenKdsControllersEntity13:
...
class KitchenKdsControllersSchema13(BaseModel):
...
class KitchenKdsControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsControllersProcessor13()
