...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_16
...
@dataclass
class KitchenKdsControllersEntity16:
...
class KitchenKdsControllersSchema16(BaseModel):
...
class KitchenKdsControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = KitchenKdsControllersProcessor16()
