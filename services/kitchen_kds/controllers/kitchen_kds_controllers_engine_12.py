...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_12
...
@dataclass
class KitchenKdsControllersEntity12:
...
class KitchenKdsControllersSchema12(BaseModel):
...
class KitchenKdsControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsControllersProcessor12()
