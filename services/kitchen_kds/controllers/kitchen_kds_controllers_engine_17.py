...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_17
...
@dataclass
class KitchenKdsControllersEntity17:
...
class KitchenKdsControllersSchema17(BaseModel):
...
class KitchenKdsControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsControllersProcessor17()
