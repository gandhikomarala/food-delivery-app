...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_2
...
@dataclass
class KitchenKdsControllersEntity2:
...
class KitchenKdsControllersSchema2(BaseModel):
...
class KitchenKdsControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsControllersProcessor2()
