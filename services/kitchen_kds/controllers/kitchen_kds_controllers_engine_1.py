...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_1
...
@dataclass
class KitchenKdsControllersEntity1:
...
class KitchenKdsControllersSchema1(BaseModel):
...
class KitchenKdsControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsControllersProcessor1()
