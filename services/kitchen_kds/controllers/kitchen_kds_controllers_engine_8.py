...
Submodule: CONTROLLERS | Component ID: KITCHEN_KDS_CONTROLLERS_8
...
@dataclass
class KitchenKdsControllersEntity8:
...
class KitchenKdsControllersSchema8(BaseModel):
...
class KitchenKdsControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsControllersProcessor8()
