...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_1
...
class KitchenKdsDtoSchema1(BaseModel):
...
class KitchenKdsDtoProcessor1:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsDtoProcessor1()
