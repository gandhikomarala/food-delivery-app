...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_5
...
class KitchenKdsDtoSchema5(BaseModel):
...
class KitchenKdsDtoProcessor5:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsDtoProcessor5()
