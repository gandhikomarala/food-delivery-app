...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_11
...
class KitchenKdsDtoSchema11(BaseModel):
...
class KitchenKdsDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsDtoProcessor11()
