...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_2
...
class KitchenKdsDtoSchema2(BaseModel):
...
class KitchenKdsDtoProcessor2:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsDtoProcessor2()
