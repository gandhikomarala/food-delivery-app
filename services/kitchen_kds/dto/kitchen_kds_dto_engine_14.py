...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_14
...
class KitchenKdsDtoSchema14(BaseModel):
...
class KitchenKdsDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsDtoProcessor14()
