...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_8
...
class KitchenKdsDtoSchema8(BaseModel):
...
class KitchenKdsDtoProcessor8:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsDtoProcessor8()
