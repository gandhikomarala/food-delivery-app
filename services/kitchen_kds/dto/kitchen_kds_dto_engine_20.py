...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_20
...
class KitchenKdsDtoSchema20(BaseModel):
...
class KitchenKdsDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsDtoProcessor20()
