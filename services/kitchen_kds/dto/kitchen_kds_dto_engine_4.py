...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_4
...
class KitchenKdsDtoSchema4(BaseModel):
...
class KitchenKdsDtoProcessor4:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsDtoProcessor4()
