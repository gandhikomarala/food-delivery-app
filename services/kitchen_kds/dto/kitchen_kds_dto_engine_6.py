...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_6
...
class KitchenKdsDtoSchema6(BaseModel):
...
class KitchenKdsDtoProcessor6:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsDtoProcessor6()
