...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_18
...
class KitchenKdsDtoSchema18(BaseModel):
...
class KitchenKdsDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsDtoProcessor18()
