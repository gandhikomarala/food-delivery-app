...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_7
...
class KitchenKdsDtoSchema7(BaseModel):
...
class KitchenKdsDtoProcessor7:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsDtoProcessor7()
