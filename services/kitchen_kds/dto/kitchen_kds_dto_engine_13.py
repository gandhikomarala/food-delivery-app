...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_13
...
class KitchenKdsDtoSchema13(BaseModel):
...
class KitchenKdsDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsDtoProcessor13()
