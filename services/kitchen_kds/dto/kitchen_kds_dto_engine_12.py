...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_12
...
class KitchenKdsDtoSchema12(BaseModel):
...
class KitchenKdsDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsDtoProcessor12()
