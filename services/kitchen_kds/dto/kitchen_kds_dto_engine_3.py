...
Submodule: DTO | Component ID: KITCHEN_KDS_DTO_3
...
class KitchenKdsDtoSchema3(BaseModel):
...
class KitchenKdsDtoProcessor3:
    ...
    async def execute_transaction(self, request: KitchenKdsDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsDtoProcessor3()
