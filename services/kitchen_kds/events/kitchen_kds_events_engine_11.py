...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_11
...
@dataclass
class KitchenKdsEventsEntity11:
...
class KitchenKdsEventsSchema11(BaseModel):
...
class KitchenKdsEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = KitchenKdsEventsProcessor11()
