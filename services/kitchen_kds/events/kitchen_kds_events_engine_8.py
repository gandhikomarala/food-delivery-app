...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_8
...
class KitchenKdsEventsSchema8(BaseModel):
...
class KitchenKdsEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = KitchenKdsEventsProcessor8()
