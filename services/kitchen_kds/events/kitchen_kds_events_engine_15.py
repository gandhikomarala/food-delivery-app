...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_15
...
@dataclass
class KitchenKdsEventsEntity15:
...
class KitchenKdsEventsSchema15(BaseModel):
...
class KitchenKdsEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = KitchenKdsEventsProcessor15()
