...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_1
...
class KitchenKdsEventsSchema1(BaseModel):
...
class KitchenKdsEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = KitchenKdsEventsProcessor1()
