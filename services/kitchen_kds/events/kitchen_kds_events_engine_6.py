...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_6
...
class KitchenKdsEventsSchema6(BaseModel):
...
class KitchenKdsEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = KitchenKdsEventsProcessor6()
