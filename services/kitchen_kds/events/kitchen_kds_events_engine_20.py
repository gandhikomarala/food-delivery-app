...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_20
...
@dataclass
class KitchenKdsEventsEntity20:
...
class KitchenKdsEventsSchema20(BaseModel):
...
class KitchenKdsEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = KitchenKdsEventsProcessor20()
