...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_18
...
@dataclass
class KitchenKdsEventsEntity18:
...
class KitchenKdsEventsSchema18(BaseModel):
...
class KitchenKdsEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = KitchenKdsEventsProcessor18()
