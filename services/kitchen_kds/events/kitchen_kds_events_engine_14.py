...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_14
...
@dataclass
class KitchenKdsEventsEntity14:
...
class KitchenKdsEventsSchema14(BaseModel):
...
class KitchenKdsEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = KitchenKdsEventsProcessor14()
