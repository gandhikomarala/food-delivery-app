...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_3
...
class KitchenKdsEventsSchema3(BaseModel):
...
class KitchenKdsEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = KitchenKdsEventsProcessor3()
