...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_5
...
class KitchenKdsEventsSchema5(BaseModel):
...
class KitchenKdsEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = KitchenKdsEventsProcessor5()
