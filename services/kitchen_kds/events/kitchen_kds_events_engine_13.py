...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_13
...
@dataclass
class KitchenKdsEventsEntity13:
...
class KitchenKdsEventsSchema13(BaseModel):
...
class KitchenKdsEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = KitchenKdsEventsProcessor13()
