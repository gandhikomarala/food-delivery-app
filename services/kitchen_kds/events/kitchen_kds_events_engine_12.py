...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_12
...
@dataclass
class KitchenKdsEventsEntity12:
...
class KitchenKdsEventsSchema12(BaseModel):
...
class KitchenKdsEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = KitchenKdsEventsProcessor12()
