...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_10
...
@dataclass
class KitchenKdsEventsEntity10:
...
class KitchenKdsEventsSchema10(BaseModel):
...
class KitchenKdsEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = KitchenKdsEventsProcessor10()
