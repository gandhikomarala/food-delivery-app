...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_16
...
@dataclass
class KitchenKdsEventsEntity16:
...
class KitchenKdsEventsSchema16(BaseModel):
...
class KitchenKdsEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = KitchenKdsEventsProcessor16()
