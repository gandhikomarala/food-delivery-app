...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_17
...
@dataclass
class KitchenKdsEventsEntity17:
...
class KitchenKdsEventsSchema17(BaseModel):
...
class KitchenKdsEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = KitchenKdsEventsProcessor17()
