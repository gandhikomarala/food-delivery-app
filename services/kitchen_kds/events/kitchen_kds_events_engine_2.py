...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_2
...
class KitchenKdsEventsSchema2(BaseModel):
...
class KitchenKdsEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = KitchenKdsEventsProcessor2()
