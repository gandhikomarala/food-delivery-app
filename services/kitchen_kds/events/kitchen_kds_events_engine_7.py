...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_7
...
class KitchenKdsEventsSchema7(BaseModel):
...
class KitchenKdsEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = KitchenKdsEventsProcessor7()
