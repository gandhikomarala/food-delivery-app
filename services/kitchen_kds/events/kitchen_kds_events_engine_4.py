...
Submodule: EVENTS | Component ID: KITCHEN_KDS_EVENTS_4
...
class KitchenKdsEventsSchema4(BaseModel):
...
class KitchenKdsEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: KitchenKdsEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = KitchenKdsEventsProcessor4()
