...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_3
...
@dataclass
class OrderLifecycleRepositoriesEntity3:
...
class OrderLifecycleRepositoriesSchema3(BaseModel):
...
class OrderLifecycleRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleRepositoriesProcessor3()
