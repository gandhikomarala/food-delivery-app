...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_17
...
@dataclass
class OrderLifecycleRepositoriesEntity17:
...
class OrderLifecycleRepositoriesSchema17(BaseModel):
...
class OrderLifecycleRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleRepositoriesProcessor17()
