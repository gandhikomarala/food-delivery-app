...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_8
...
@dataclass
class OrderLifecycleRepositoriesEntity8:
...
class OrderLifecycleRepositoriesSchema8(BaseModel):
...
class OrderLifecycleRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecycleRepositoriesProcessor8()
