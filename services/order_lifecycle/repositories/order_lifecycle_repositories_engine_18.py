...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_18
...
@dataclass
class OrderLifecycleRepositoriesEntity18:
...
class OrderLifecycleRepositoriesSchema18(BaseModel):
...
class OrderLifecycleRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = OrderLifecycleRepositoriesProcessor18()
