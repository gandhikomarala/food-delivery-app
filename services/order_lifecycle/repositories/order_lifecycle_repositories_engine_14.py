...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_14
...
@dataclass
class OrderLifecycleRepositoriesEntity14:
...
class OrderLifecycleRepositoriesSchema14(BaseModel):
...
class OrderLifecycleRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleRepositoriesProcessor14()
