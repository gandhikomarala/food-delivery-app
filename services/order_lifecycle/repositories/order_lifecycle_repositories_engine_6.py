...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_6
...
@dataclass
class OrderLifecycleRepositoriesEntity6:
...
class OrderLifecycleRepositoriesSchema6(BaseModel):
...
class OrderLifecycleRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleRepositoriesProcessor6()
