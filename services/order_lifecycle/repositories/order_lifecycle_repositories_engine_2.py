...
Submodule: REPOSITORIES | Component ID: ORDER_LIFECYCLE_REPOSITORIES_2
...
@dataclass
class OrderLifecycleRepositoriesEntity2:
...
class OrderLifecycleRepositoriesSchema2(BaseModel):
...
class OrderLifecycleRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleRepositoriesProcessor2()
