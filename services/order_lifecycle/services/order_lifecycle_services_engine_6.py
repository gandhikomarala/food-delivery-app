...
Submodule: SERVICES | Component ID: ORDER_LIFECYCLE_SERVICES_6
...
@dataclass
class OrderLifecycleServicesEntity6:
...
class OrderLifecycleServicesSchema6(BaseModel):
...
class OrderLifecycleServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleServicesProcessor6()
