...
Submodule: SERVICES | Component ID: ORDER_LIFECYCLE_SERVICES_3
...
@dataclass
class OrderLifecycleServicesEntity3:
...
class OrderLifecycleServicesSchema3(BaseModel):
...
class OrderLifecycleServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleServicesProcessor3()
