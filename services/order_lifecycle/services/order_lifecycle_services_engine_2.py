...
Submodule: SERVICES | Component ID: ORDER_LIFECYCLE_SERVICES_2
...
@dataclass
class OrderLifecycleServicesEntity2:
...
class OrderLifecycleServicesSchema2(BaseModel):
...
class OrderLifecycleServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleServicesProcessor2()
