...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_17
...
@dataclass
class OrderLifecycleEnginesEntity17:
...
class OrderLifecycleEnginesSchema17(BaseModel):
...
class OrderLifecycleEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleEnginesProcessor17()
