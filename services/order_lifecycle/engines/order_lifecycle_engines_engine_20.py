...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_20
...
@dataclass
class OrderLifecycleEnginesEntity20:
...
class OrderLifecycleEnginesSchema20(BaseModel):
...
class OrderLifecycleEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleEnginesProcessor20()
