...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_3
...
@dataclass
class OrderLifecycleEnginesEntity3:
...
class OrderLifecycleEnginesSchema3(BaseModel):
...
class OrderLifecycleEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleEnginesProcessor3()
