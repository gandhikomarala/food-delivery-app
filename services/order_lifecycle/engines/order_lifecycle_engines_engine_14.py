...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_14
...
@dataclass
class OrderLifecycleEnginesEntity14:
...
class OrderLifecycleEnginesSchema14(BaseModel):
...
class OrderLifecycleEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleEnginesProcessor14()
