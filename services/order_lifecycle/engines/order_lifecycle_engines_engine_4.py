...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_4
...
@dataclass
class OrderLifecycleEnginesEntity4:
...
class OrderLifecycleEnginesSchema4(BaseModel):
...
class OrderLifecycleEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleEnginesProcessor4()
