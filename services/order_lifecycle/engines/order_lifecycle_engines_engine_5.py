...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_5
...
@dataclass
class OrderLifecycleEnginesEntity5:
...
class OrderLifecycleEnginesSchema5(BaseModel):
...
class OrderLifecycleEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = OrderLifecycleEnginesProcessor5()
