...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_2
...
@dataclass
class OrderLifecycleEnginesEntity2:
...
class OrderLifecycleEnginesSchema2(BaseModel):
...
class OrderLifecycleEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleEnginesProcessor2()
