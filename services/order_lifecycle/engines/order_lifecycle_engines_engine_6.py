...
Submodule: ENGINES | Component ID: ORDER_LIFECYCLE_ENGINES_6
...
@dataclass
class OrderLifecycleEnginesEntity6:
...
class OrderLifecycleEnginesSchema6(BaseModel):
...
class OrderLifecycleEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleEnginesProcessor6()
