...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_2
...
@dataclass
class OrderLifecyclePipelinesEntity2:
...
class OrderLifecyclePipelinesSchema2(BaseModel):
...
class OrderLifecyclePipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecyclePipelinesProcessor2()
