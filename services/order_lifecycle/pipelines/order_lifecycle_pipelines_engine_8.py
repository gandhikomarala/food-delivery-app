...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_8
...
@dataclass
class OrderLifecyclePipelinesEntity8:
...
class OrderLifecyclePipelinesSchema8(BaseModel):
...
class OrderLifecyclePipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecyclePipelinesProcessor8()
