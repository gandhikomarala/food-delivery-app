...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_20
...
@dataclass
class OrderLifecyclePipelinesEntity20:
...
class OrderLifecyclePipelinesSchema20(BaseModel):
...
class OrderLifecyclePipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecyclePipelinesProcessor20()
