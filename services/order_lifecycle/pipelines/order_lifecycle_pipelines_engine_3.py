...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_3
...
@dataclass
class OrderLifecyclePipelinesEntity3:
...
class OrderLifecyclePipelinesSchema3(BaseModel):
...
class OrderLifecyclePipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecyclePipelinesProcessor3()
