...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_14
...
@dataclass
class OrderLifecyclePipelinesEntity14:
...
class OrderLifecyclePipelinesSchema14(BaseModel):
...
class OrderLifecyclePipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecyclePipelinesProcessor14()
