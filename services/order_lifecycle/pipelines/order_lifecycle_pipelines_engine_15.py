...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_15
...
@dataclass
class OrderLifecyclePipelinesEntity15:
...
class OrderLifecyclePipelinesSchema15(BaseModel):
...
class OrderLifecyclePipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = OrderLifecyclePipelinesProcessor15()
