...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_7
...
@dataclass
class OrderLifecyclePipelinesEntity7:
...
class OrderLifecyclePipelinesSchema7(BaseModel):
...
class OrderLifecyclePipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = OrderLifecyclePipelinesProcessor7()
