...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_4
...
@dataclass
class OrderLifecyclePipelinesEntity4:
...
class OrderLifecyclePipelinesSchema4(BaseModel):
...
class OrderLifecyclePipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecyclePipelinesProcessor4()
