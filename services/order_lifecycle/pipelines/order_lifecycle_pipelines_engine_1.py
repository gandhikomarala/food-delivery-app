...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_1
...
@dataclass
class OrderLifecyclePipelinesEntity1:
...
class OrderLifecyclePipelinesSchema1(BaseModel):
...
class OrderLifecyclePipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = OrderLifecyclePipelinesProcessor1()
