...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_17
...
@dataclass
class OrderLifecyclePipelinesEntity17:
...
class OrderLifecyclePipelinesSchema17(BaseModel):
...
class OrderLifecyclePipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecyclePipelinesProcessor17()
