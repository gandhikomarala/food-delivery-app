...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_6
...
@dataclass
class OrderLifecyclePipelinesEntity6:
...
class OrderLifecyclePipelinesSchema6(BaseModel):
...
class OrderLifecyclePipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecyclePipelinesProcessor6()
