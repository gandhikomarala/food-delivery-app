...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_12
...
@dataclass
class OrderLifecyclePipelinesEntity12:
...
class OrderLifecyclePipelinesSchema12(BaseModel):
...
class OrderLifecyclePipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = OrderLifecyclePipelinesProcessor12()
