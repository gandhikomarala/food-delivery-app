...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_13
...
@dataclass
class OrderLifecyclePipelinesEntity13:
...
class OrderLifecyclePipelinesSchema13(BaseModel):
...
class OrderLifecyclePipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecyclePipelinesProcessor13()
