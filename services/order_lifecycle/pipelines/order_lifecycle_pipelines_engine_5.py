...
Submodule: PIPELINES | Component ID: ORDER_LIFECYCLE_PIPELINES_5
...
@dataclass
class OrderLifecyclePipelinesEntity5:
...
class OrderLifecyclePipelinesSchema5(BaseModel):
...
class OrderLifecyclePipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: OrderLifecyclePipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = OrderLifecyclePipelinesProcessor5()
