...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_14
...
@dataclass
class OrderLifecycleDtoEntity14:
...
class OrderLifecycleDtoSchema14(BaseModel):
...
class OrderLifecycleDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleDtoProcessor14()
