...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_7
...
@dataclass
class OrderLifecycleDtoEntity7:
...
class OrderLifecycleDtoSchema7(BaseModel):
...
class OrderLifecycleDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = OrderLifecycleDtoProcessor7()
