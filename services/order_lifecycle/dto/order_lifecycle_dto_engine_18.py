...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_18
...
@dataclass
class OrderLifecycleDtoEntity18:
...
class OrderLifecycleDtoSchema18(BaseModel):
...
class OrderLifecycleDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = OrderLifecycleDtoProcessor18()
