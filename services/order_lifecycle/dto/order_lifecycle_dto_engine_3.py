...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_3
...
@dataclass
class OrderLifecycleDtoEntity3:
...
class OrderLifecycleDtoSchema3(BaseModel):
...
class OrderLifecycleDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleDtoProcessor3()
