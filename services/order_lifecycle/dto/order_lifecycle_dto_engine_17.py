...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_17
...
@dataclass
class OrderLifecycleDtoEntity17:
...
class OrderLifecycleDtoSchema17(BaseModel):
...
class OrderLifecycleDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleDtoProcessor17()
