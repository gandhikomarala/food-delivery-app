...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_13
...
@dataclass
class OrderLifecycleDtoEntity13:
...
class OrderLifecycleDtoSchema13(BaseModel):
...
class OrderLifecycleDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleDtoProcessor13()
