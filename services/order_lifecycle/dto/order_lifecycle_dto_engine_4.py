...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_4
...
@dataclass
class OrderLifecycleDtoEntity4:
...
class OrderLifecycleDtoSchema4(BaseModel):
...
class OrderLifecycleDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleDtoProcessor4()
