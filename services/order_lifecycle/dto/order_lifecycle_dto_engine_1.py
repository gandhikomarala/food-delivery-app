...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_1
...
@dataclass
class OrderLifecycleDtoEntity1:
...
class OrderLifecycleDtoSchema1(BaseModel):
...
class OrderLifecycleDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = OrderLifecycleDtoProcessor1()
