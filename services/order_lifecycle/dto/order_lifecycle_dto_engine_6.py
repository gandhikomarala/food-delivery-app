...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_6
...
@dataclass
class OrderLifecycleDtoEntity6:
...
class OrderLifecycleDtoSchema6(BaseModel):
...
class OrderLifecycleDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleDtoProcessor6()
