...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_8
...
@dataclass
class OrderLifecycleDtoEntity8:
...
class OrderLifecycleDtoSchema8(BaseModel):
...
class OrderLifecycleDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecycleDtoProcessor8()
