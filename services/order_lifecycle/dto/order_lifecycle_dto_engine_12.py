...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_12
...
@dataclass
class OrderLifecycleDtoEntity12:
...
class OrderLifecycleDtoSchema12(BaseModel):
...
class OrderLifecycleDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = OrderLifecycleDtoProcessor12()
