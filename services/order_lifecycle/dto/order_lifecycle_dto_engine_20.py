...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_20
...
@dataclass
class OrderLifecycleDtoEntity20:
...
class OrderLifecycleDtoSchema20(BaseModel):
...
class OrderLifecycleDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleDtoProcessor20()
