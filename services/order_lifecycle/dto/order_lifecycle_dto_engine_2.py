...
Submodule: DTO | Component ID: ORDER_LIFECYCLE_DTO_2
...
@dataclass
class OrderLifecycleDtoEntity2:
...
class OrderLifecycleDtoSchema2(BaseModel):
...
class OrderLifecycleDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleDtoProcessor2()
