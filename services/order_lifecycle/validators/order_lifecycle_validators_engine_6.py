...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_6
...
@dataclass
class OrderLifecycleValidatorsEntity6:
...
class OrderLifecycleValidatorsSchema6(BaseModel):
...
class OrderLifecycleValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleValidatorsProcessor6()
