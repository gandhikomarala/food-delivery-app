...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_11
...
@dataclass
class OrderLifecycleValidatorsEntity11:
...
class OrderLifecycleValidatorsSchema11(BaseModel):
...
class OrderLifecycleValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = OrderLifecycleValidatorsProcessor11()
