...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_1
...
@dataclass
class OrderLifecycleValidatorsEntity1:
...
class OrderLifecycleValidatorsSchema1(BaseModel):
...
class OrderLifecycleValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = OrderLifecycleValidatorsProcessor1()
