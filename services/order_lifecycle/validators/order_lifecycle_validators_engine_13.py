...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_13
...
@dataclass
class OrderLifecycleValidatorsEntity13:
...
class OrderLifecycleValidatorsSchema13(BaseModel):
...
class OrderLifecycleValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleValidatorsProcessor13()
