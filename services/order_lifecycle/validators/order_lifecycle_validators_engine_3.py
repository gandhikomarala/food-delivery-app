...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_3
...
@dataclass
class OrderLifecycleValidatorsEntity3:
...
class OrderLifecycleValidatorsSchema3(BaseModel):
...
class OrderLifecycleValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleValidatorsProcessor3()
