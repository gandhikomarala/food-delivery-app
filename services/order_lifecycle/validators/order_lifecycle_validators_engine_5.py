...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_5
...
@dataclass
class OrderLifecycleValidatorsEntity5:
...
class OrderLifecycleValidatorsSchema5(BaseModel):
...
class OrderLifecycleValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = OrderLifecycleValidatorsProcessor5()
