...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_14
...
@dataclass
class OrderLifecycleValidatorsEntity14:
...
class OrderLifecycleValidatorsSchema14(BaseModel):
...
class OrderLifecycleValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleValidatorsProcessor14()
