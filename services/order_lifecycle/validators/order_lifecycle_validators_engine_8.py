...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_8
...
@dataclass
class OrderLifecycleValidatorsEntity8:
...
class OrderLifecycleValidatorsSchema8(BaseModel):
...
class OrderLifecycleValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecycleValidatorsProcessor8()
