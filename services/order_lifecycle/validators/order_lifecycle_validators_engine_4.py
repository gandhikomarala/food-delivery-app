...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_4
...
@dataclass
class OrderLifecycleValidatorsEntity4:
...
class OrderLifecycleValidatorsSchema4(BaseModel):
...
class OrderLifecycleValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleValidatorsProcessor4()
