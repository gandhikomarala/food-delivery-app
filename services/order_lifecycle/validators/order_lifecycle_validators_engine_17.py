...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_17
...
@dataclass
class OrderLifecycleValidatorsEntity17:
...
class OrderLifecycleValidatorsSchema17(BaseModel):
...
class OrderLifecycleValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleValidatorsProcessor17()
