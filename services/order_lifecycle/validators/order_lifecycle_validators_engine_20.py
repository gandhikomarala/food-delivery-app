...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_20
...
@dataclass
class OrderLifecycleValidatorsEntity20:
...
class OrderLifecycleValidatorsSchema20(BaseModel):
...
class OrderLifecycleValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleValidatorsProcessor20()
