...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_12
...
@dataclass
class OrderLifecycleValidatorsEntity12:
...
class OrderLifecycleValidatorsSchema12(BaseModel):
...
class OrderLifecycleValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = OrderLifecycleValidatorsProcessor12()
