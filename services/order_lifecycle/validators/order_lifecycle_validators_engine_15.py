...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_15
...
@dataclass
class OrderLifecycleValidatorsEntity15:
...
class OrderLifecycleValidatorsSchema15(BaseModel):
...
class OrderLifecycleValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = OrderLifecycleValidatorsProcessor15()
