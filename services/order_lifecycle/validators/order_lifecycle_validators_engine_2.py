...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_2
...
@dataclass
class OrderLifecycleValidatorsEntity2:
...
class OrderLifecycleValidatorsSchema2(BaseModel):
...
class OrderLifecycleValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleValidatorsProcessor2()
