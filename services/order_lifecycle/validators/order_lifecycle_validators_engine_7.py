...
Submodule: VALIDATORS | Component ID: ORDER_LIFECYCLE_VALIDATORS_7
...
@dataclass
class OrderLifecycleValidatorsEntity7:
...
class OrderLifecycleValidatorsSchema7(BaseModel):
...
class OrderLifecycleValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = OrderLifecycleValidatorsProcessor7()
