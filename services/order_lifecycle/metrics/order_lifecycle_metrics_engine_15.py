...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_15
...
@dataclass
class OrderLifecycleMetricsEntity15:
...
class OrderLifecycleMetricsSchema15(BaseModel):
...
class OrderLifecycleMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = OrderLifecycleMetricsProcessor15()
