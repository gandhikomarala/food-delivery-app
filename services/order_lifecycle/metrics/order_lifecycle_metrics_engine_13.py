...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_13
...
@dataclass
class OrderLifecycleMetricsEntity13:
...
class OrderLifecycleMetricsSchema13(BaseModel):
...
class OrderLifecycleMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleMetricsProcessor13()
