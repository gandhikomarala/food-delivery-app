...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_3
...
@dataclass
class OrderLifecycleMetricsEntity3:
...
class OrderLifecycleMetricsSchema3(BaseModel):
...
class OrderLifecycleMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleMetricsProcessor3()
