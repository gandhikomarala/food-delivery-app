...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_2
...
@dataclass
class OrderLifecycleMetricsEntity2:
...
class OrderLifecycleMetricsSchema2(BaseModel):
...
class OrderLifecycleMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleMetricsProcessor2()
