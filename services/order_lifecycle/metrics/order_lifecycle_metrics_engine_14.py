...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_14
...
@dataclass
class OrderLifecycleMetricsEntity14:
...
class OrderLifecycleMetricsSchema14(BaseModel):
...
class OrderLifecycleMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleMetricsProcessor14()
