...
Submodule: METRICS | Component ID: ORDER_LIFECYCLE_METRICS_6
...
@dataclass
class OrderLifecycleMetricsEntity6:
...
class OrderLifecycleMetricsSchema6(BaseModel):
...
class OrderLifecycleMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleMetricsProcessor6()
