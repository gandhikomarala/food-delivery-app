...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_13
...
@dataclass
class OrderLifecycleEventsEntity13:
...
class OrderLifecycleEventsSchema13(BaseModel):
...
class OrderLifecycleEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleEventsProcessor13()
