...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_6
...
@dataclass
class OrderLifecycleEventsEntity6:
...
class OrderLifecycleEventsSchema6(BaseModel):
...
class OrderLifecycleEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleEventsProcessor6()
