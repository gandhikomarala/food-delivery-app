...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_20
...
@dataclass
class OrderLifecycleEventsEntity20:
...
class OrderLifecycleEventsSchema20(BaseModel):
...
class OrderLifecycleEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleEventsProcessor20()
