...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_2
...
@dataclass
class OrderLifecycleEventsEntity2:
...
class OrderLifecycleEventsSchema2(BaseModel):
...
class OrderLifecycleEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleEventsProcessor2()
