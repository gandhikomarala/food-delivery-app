...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_3
...
@dataclass
class OrderLifecycleEventsEntity3:
...
class OrderLifecycleEventsSchema3(BaseModel):
...
class OrderLifecycleEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleEventsProcessor3()
