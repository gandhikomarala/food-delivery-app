...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_14
...
@dataclass
class OrderLifecycleEventsEntity14:
...
class OrderLifecycleEventsSchema14(BaseModel):
...
class OrderLifecycleEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleEventsProcessor14()
