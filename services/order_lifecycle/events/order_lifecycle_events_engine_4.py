...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_4
...
@dataclass
class OrderLifecycleEventsEntity4:
...
class OrderLifecycleEventsSchema4(BaseModel):
...
class OrderLifecycleEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleEventsProcessor4()
