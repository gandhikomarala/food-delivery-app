...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_17
...
@dataclass
class OrderLifecycleEventsEntity17:
...
class OrderLifecycleEventsSchema17(BaseModel):
...
class OrderLifecycleEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleEventsProcessor17()
