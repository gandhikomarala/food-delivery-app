...
Submodule: EVENTS | Component ID: ORDER_LIFECYCLE_EVENTS_15
...
@dataclass
class OrderLifecycleEventsEntity15:
...
class OrderLifecycleEventsSchema15(BaseModel):
...
class OrderLifecycleEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = OrderLifecycleEventsProcessor15()
