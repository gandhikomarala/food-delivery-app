...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_7
...
@dataclass
class OrderLifecycleControllersEntity7:
...
class OrderLifecycleControllersSchema7(BaseModel):
...
class OrderLifecycleControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = OrderLifecycleControllersProcessor7()
