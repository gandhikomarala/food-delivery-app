...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_8
...
@dataclass
class OrderLifecycleControllersEntity8:
...
class OrderLifecycleControllersSchema8(BaseModel):
...
class OrderLifecycleControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecycleControllersProcessor8()
