...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_14
...
@dataclass
class OrderLifecycleControllersEntity14:
...
class OrderLifecycleControllersSchema14(BaseModel):
...
class OrderLifecycleControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleControllersProcessor14()
