...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_20
...
@dataclass
class OrderLifecycleControllersEntity20:
...
class OrderLifecycleControllersSchema20(BaseModel):
...
class OrderLifecycleControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleControllersProcessor20()
