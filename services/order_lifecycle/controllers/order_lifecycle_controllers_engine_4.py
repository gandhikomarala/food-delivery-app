...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_4
...
@dataclass
class OrderLifecycleControllersEntity4:
...
class OrderLifecycleControllersSchema4(BaseModel):
...
class OrderLifecycleControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleControllersProcessor4()
