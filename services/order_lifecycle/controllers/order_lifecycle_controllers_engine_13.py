...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_13
...
@dataclass
class OrderLifecycleControllersEntity13:
...
class OrderLifecycleControllersSchema13(BaseModel):
...
class OrderLifecycleControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleControllersProcessor13()
