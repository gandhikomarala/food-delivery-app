...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_2
...
@dataclass
class OrderLifecycleControllersEntity2:
...
class OrderLifecycleControllersSchema2(BaseModel):
...
class OrderLifecycleControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleControllersProcessor2()
