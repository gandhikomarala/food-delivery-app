...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_6
...
@dataclass
class OrderLifecycleControllersEntity6:
...
class OrderLifecycleControllersSchema6(BaseModel):
...
class OrderLifecycleControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleControllersProcessor6()
