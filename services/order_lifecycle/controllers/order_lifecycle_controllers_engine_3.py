...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_3
...
@dataclass
class OrderLifecycleControllersEntity3:
...
class OrderLifecycleControllersSchema3(BaseModel):
...
class OrderLifecycleControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleControllersProcessor3()
