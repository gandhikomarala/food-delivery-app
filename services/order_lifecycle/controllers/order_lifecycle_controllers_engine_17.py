...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_17
...
@dataclass
class OrderLifecycleControllersEntity17:
...
class OrderLifecycleControllersSchema17(BaseModel):
...
class OrderLifecycleControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = OrderLifecycleControllersProcessor17()
