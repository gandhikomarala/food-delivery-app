...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_12
...
@dataclass
class OrderLifecycleControllersEntity12:
...
class OrderLifecycleControllersSchema12(BaseModel):
...
class OrderLifecycleControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = OrderLifecycleControllersProcessor12()
