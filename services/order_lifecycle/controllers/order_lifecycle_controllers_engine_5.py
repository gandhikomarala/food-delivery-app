...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_5
...
@dataclass
class OrderLifecycleControllersEntity5:
...
class OrderLifecycleControllersSchema5(BaseModel):
...
class OrderLifecycleControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = OrderLifecycleControllersProcessor5()
