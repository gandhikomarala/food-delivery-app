...
Submodule: CONTROLLERS | Component ID: ORDER_LIFECYCLE_CONTROLLERS_1
...
@dataclass
class OrderLifecycleControllersEntity1:
...
class OrderLifecycleControllersSchema1(BaseModel):
...
class OrderLifecycleControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = OrderLifecycleControllersProcessor1()
