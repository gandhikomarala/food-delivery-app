...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_14
...
@dataclass
class OrderLifecycleModelsEntity14:
...
class OrderLifecycleModelsSchema14(BaseModel):
...
class OrderLifecycleModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = OrderLifecycleModelsProcessor14()
