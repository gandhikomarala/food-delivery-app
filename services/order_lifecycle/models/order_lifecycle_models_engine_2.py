...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_2
...
@dataclass
class OrderLifecycleModelsEntity2:
...
class OrderLifecycleModelsSchema2(BaseModel):
...
class OrderLifecycleModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = OrderLifecycleModelsProcessor2()
