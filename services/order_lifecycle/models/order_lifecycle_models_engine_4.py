...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_4
...
@dataclass
class OrderLifecycleModelsEntity4:
...
class OrderLifecycleModelsSchema4(BaseModel):
...
class OrderLifecycleModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = OrderLifecycleModelsProcessor4()
