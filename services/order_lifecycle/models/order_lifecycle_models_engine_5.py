...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_5
...
@dataclass
class OrderLifecycleModelsEntity5:
...
class OrderLifecycleModelsSchema5(BaseModel):
...
class OrderLifecycleModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = OrderLifecycleModelsProcessor5()
