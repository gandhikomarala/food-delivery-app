...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_6
...
@dataclass
class OrderLifecycleModelsEntity6:
...
class OrderLifecycleModelsSchema6(BaseModel):
...
class OrderLifecycleModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = OrderLifecycleModelsProcessor6()
