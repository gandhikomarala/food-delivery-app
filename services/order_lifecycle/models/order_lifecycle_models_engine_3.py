...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_3
...
@dataclass
class OrderLifecycleModelsEntity3:
...
class OrderLifecycleModelsSchema3(BaseModel):
...
class OrderLifecycleModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = OrderLifecycleModelsProcessor3()
