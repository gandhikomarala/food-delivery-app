...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_1
...
@dataclass
class OrderLifecycleModelsEntity1:
...
class OrderLifecycleModelsSchema1(BaseModel):
...
class OrderLifecycleModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = OrderLifecycleModelsProcessor1()
