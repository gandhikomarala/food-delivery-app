...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_20
...
@dataclass
class OrderLifecycleModelsEntity20:
...
class OrderLifecycleModelsSchema20(BaseModel):
...
class OrderLifecycleModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = OrderLifecycleModelsProcessor20()
