...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_10
...
@dataclass
class OrderLifecycleModelsEntity10:
...
class OrderLifecycleModelsSchema10(BaseModel):
...
class OrderLifecycleModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = OrderLifecycleModelsProcessor10()
