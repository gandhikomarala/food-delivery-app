...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_18
...
@dataclass
class OrderLifecycleModelsEntity18:
...
class OrderLifecycleModelsSchema18(BaseModel):
...
class OrderLifecycleModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = OrderLifecycleModelsProcessor18()
