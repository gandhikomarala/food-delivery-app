...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_12
...
@dataclass
class OrderLifecycleModelsEntity12:
...
class OrderLifecycleModelsSchema12(BaseModel):
...
class OrderLifecycleModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = OrderLifecycleModelsProcessor12()
