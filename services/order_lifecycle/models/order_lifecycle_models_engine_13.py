...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_13
...
@dataclass
class OrderLifecycleModelsEntity13:
...
class OrderLifecycleModelsSchema13(BaseModel):
...
class OrderLifecycleModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = OrderLifecycleModelsProcessor13()
