...
Submodule: MODELS | Component ID: ORDER_LIFECYCLE_MODELS_8
...
@dataclass
class OrderLifecycleModelsEntity8:
...
class OrderLifecycleModelsSchema8(BaseModel):
...
class OrderLifecycleModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: OrderLifecycleModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = OrderLifecycleModelsProcessor8()
