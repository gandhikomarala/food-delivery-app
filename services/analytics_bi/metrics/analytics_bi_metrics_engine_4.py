...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_4
...
@dataclass
class AnalyticsBiMetricsEntity4:
...
class AnalyticsBiMetricsSchema4(BaseModel):
...
class AnalyticsBiMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiMetricsProcessor4()
