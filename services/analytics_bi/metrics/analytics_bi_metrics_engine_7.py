...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_7
...
@dataclass
class AnalyticsBiMetricsEntity7:
...
class AnalyticsBiMetricsSchema7(BaseModel):
...
class AnalyticsBiMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiMetricsProcessor7()
