...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_17
...
@dataclass
class AnalyticsBiMetricsEntity17:
...
class AnalyticsBiMetricsSchema17(BaseModel):
...
class AnalyticsBiMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiMetricsProcessor17()
