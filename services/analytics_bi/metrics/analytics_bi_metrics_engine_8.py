...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_8
...
@dataclass
class AnalyticsBiMetricsEntity8:
...
class AnalyticsBiMetricsSchema8(BaseModel):
...
class AnalyticsBiMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiMetricsProcessor8()
