...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_18
...
@dataclass
class AnalyticsBiMetricsEntity18:
...
class AnalyticsBiMetricsSchema18(BaseModel):
...
class AnalyticsBiMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiMetricsProcessor18()
