...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_6
...
@dataclass
class AnalyticsBiMetricsEntity6:
...
class AnalyticsBiMetricsSchema6(BaseModel):
...
class AnalyticsBiMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiMetricsProcessor6()
