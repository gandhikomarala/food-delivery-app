...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_14
...
@dataclass
class AnalyticsBiMetricsEntity14:
...
class AnalyticsBiMetricsSchema14(BaseModel):
...
class AnalyticsBiMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiMetricsProcessor14()
