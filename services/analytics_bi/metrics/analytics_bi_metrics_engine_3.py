...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_3
...
@dataclass
class AnalyticsBiMetricsEntity3:
...
class AnalyticsBiMetricsSchema3(BaseModel):
...
class AnalyticsBiMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiMetricsProcessor3()
