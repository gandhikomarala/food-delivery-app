...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_12
...
@dataclass
class AnalyticsBiMetricsEntity12:
...
class AnalyticsBiMetricsSchema12(BaseModel):
...
class AnalyticsBiMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiMetricsProcessor12()
