...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_2
...
@dataclass
class AnalyticsBiMetricsEntity2:
...
class AnalyticsBiMetricsSchema2(BaseModel):
...
class AnalyticsBiMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiMetricsProcessor2()
