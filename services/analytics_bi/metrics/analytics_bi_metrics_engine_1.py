...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_1
...
@dataclass
class AnalyticsBiMetricsEntity1:
...
class AnalyticsBiMetricsSchema1(BaseModel):
...
class AnalyticsBiMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiMetricsProcessor1()
