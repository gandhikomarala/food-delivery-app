...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_13
...
@dataclass
class AnalyticsBiMetricsEntity13:
...
class AnalyticsBiMetricsSchema13(BaseModel):
...
class AnalyticsBiMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiMetricsProcessor13()
