...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_10
...
@dataclass
class AnalyticsBiMetricsEntity10:
...
class AnalyticsBiMetricsSchema10(BaseModel):
...
class AnalyticsBiMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiMetricsProcessor10()
