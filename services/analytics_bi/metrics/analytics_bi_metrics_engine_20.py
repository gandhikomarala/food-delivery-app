...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_20
...
@dataclass
class AnalyticsBiMetricsEntity20:
...
class AnalyticsBiMetricsSchema20(BaseModel):
...
class AnalyticsBiMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiMetricsProcessor20()
