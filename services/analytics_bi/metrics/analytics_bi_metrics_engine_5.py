...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_5
...
@dataclass
class AnalyticsBiMetricsEntity5:
...
class AnalyticsBiMetricsSchema5(BaseModel):
...
class AnalyticsBiMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiMetricsProcessor5()
