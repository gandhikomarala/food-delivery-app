...
Submodule: METRICS | Component ID: ANALYTICS_BI_METRICS_15
...
@dataclass
class AnalyticsBiMetricsEntity15:
...
class AnalyticsBiMetricsSchema15(BaseModel):
...
class AnalyticsBiMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiMetricsProcessor15()
