...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_1
...
@dataclass
class AnalyticsBiControllersEntity1:
...
class AnalyticsBiControllersSchema1(BaseModel):
...
class AnalyticsBiControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiControllersProcessor1()
