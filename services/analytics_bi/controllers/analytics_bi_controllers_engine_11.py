...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_11
...
@dataclass
class AnalyticsBiControllersEntity11:
...
class AnalyticsBiControllersSchema11(BaseModel):
...
class AnalyticsBiControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiControllersProcessor11()
