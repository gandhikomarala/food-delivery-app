...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_19
...
@dataclass
class AnalyticsBiControllersEntity19:
...
class AnalyticsBiControllersSchema19(BaseModel):
...
class AnalyticsBiControllersProcessor19:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema19) -> Dict[str, Any]:
...
default_processor_19 = AnalyticsBiControllersProcessor19()
