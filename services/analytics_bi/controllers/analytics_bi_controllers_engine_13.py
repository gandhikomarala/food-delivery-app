...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_13
...
@dataclass
class AnalyticsBiControllersEntity13:
...
class AnalyticsBiControllersSchema13(BaseModel):
...
class AnalyticsBiControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiControllersProcessor13()
