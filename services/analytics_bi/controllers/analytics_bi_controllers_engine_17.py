...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_17
...
@dataclass
class AnalyticsBiControllersEntity17:
...
class AnalyticsBiControllersSchema17(BaseModel):
...
class AnalyticsBiControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiControllersProcessor17()
