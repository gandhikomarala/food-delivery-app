...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_12
...
@dataclass
class AnalyticsBiControllersEntity12:
...
class AnalyticsBiControllersSchema12(BaseModel):
...
class AnalyticsBiControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiControllersProcessor12()
