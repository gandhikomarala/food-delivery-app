...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_8
...
@dataclass
class AnalyticsBiControllersEntity8:
...
class AnalyticsBiControllersSchema8(BaseModel):
...
class AnalyticsBiControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiControllersProcessor8()
