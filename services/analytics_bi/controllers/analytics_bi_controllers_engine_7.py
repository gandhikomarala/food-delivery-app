...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_7
...
@dataclass
class AnalyticsBiControllersEntity7:
...
class AnalyticsBiControllersSchema7(BaseModel):
...
class AnalyticsBiControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiControllersProcessor7()
