...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_10
...
@dataclass
class AnalyticsBiControllersEntity10:
...
class AnalyticsBiControllersSchema10(BaseModel):
...
class AnalyticsBiControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiControllersProcessor10()
