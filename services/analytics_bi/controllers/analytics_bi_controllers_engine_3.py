...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_3
...
@dataclass
class AnalyticsBiControllersEntity3:
...
class AnalyticsBiControllersSchema3(BaseModel):
...
class AnalyticsBiControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiControllersProcessor3()
