...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_14
...
@dataclass
class AnalyticsBiControllersEntity14:
...
class AnalyticsBiControllersSchema14(BaseModel):
...
class AnalyticsBiControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiControllersProcessor14()
