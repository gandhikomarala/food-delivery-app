...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_16
...
@dataclass
class AnalyticsBiControllersEntity16:
...
class AnalyticsBiControllersSchema16(BaseModel):
...
class AnalyticsBiControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiControllersProcessor16()
