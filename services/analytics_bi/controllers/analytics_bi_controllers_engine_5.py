...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_5
...
@dataclass
class AnalyticsBiControllersEntity5:
...
class AnalyticsBiControllersSchema5(BaseModel):
...
class AnalyticsBiControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiControllersProcessor5()
