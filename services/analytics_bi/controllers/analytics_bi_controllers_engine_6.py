...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_6
...
@dataclass
class AnalyticsBiControllersEntity6:
...
class AnalyticsBiControllersSchema6(BaseModel):
...
class AnalyticsBiControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiControllersProcessor6()
