...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_2
...
@dataclass
class AnalyticsBiControllersEntity2:
...
class AnalyticsBiControllersSchema2(BaseModel):
...
class AnalyticsBiControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiControllersProcessor2()
