...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_15
...
@dataclass
class AnalyticsBiControllersEntity15:
...
class AnalyticsBiControllersSchema15(BaseModel):
...
class AnalyticsBiControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiControllersProcessor15()
