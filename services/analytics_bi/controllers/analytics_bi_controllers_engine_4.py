...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_4
...
@dataclass
class AnalyticsBiControllersEntity4:
...
class AnalyticsBiControllersSchema4(BaseModel):
...
class AnalyticsBiControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiControllersProcessor4()
