...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_20
...
@dataclass
class AnalyticsBiControllersEntity20:
...
class AnalyticsBiControllersSchema20(BaseModel):
...
class AnalyticsBiControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiControllersProcessor20()
