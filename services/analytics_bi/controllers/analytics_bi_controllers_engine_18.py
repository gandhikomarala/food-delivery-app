...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_18
...
@dataclass
class AnalyticsBiControllersEntity18:
...
class AnalyticsBiControllersSchema18(BaseModel):
...
class AnalyticsBiControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiControllersProcessor18()
