...
Submodule: CONTROLLERS | Component ID: ANALYTICS_BI_CONTROLLERS_9
...
@dataclass
class AnalyticsBiControllersEntity9:
...
class AnalyticsBiControllersSchema9(BaseModel):
...
class AnalyticsBiControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiControllersProcessor9()
