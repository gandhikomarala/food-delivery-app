...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_16
...
@dataclass
class AnalyticsBiEnginesEntity16:
...
class AnalyticsBiEnginesSchema16(BaseModel):
...
class AnalyticsBiEnginesProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiEnginesProcessor16()
