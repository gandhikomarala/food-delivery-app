...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_15
...
@dataclass
class AnalyticsBiEnginesEntity15:
...
class AnalyticsBiEnginesSchema15(BaseModel):
...
class AnalyticsBiEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiEnginesProcessor15()
