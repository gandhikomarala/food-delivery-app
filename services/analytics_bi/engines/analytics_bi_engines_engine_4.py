...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_4
...
@dataclass
class AnalyticsBiEnginesEntity4:
...
class AnalyticsBiEnginesSchema4(BaseModel):
...
class AnalyticsBiEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiEnginesProcessor4()
