...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_3
...
@dataclass
class AnalyticsBiEnginesEntity3:
...
class AnalyticsBiEnginesSchema3(BaseModel):
...
class AnalyticsBiEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiEnginesProcessor3()
