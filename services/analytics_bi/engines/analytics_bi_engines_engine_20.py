...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_20
...
@dataclass
class AnalyticsBiEnginesEntity20:
...
class AnalyticsBiEnginesSchema20(BaseModel):
...
class AnalyticsBiEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiEnginesProcessor20()
