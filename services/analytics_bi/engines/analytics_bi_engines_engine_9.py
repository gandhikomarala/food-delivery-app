...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_9
...
@dataclass
class AnalyticsBiEnginesEntity9:
...
class AnalyticsBiEnginesSchema9(BaseModel):
...
class AnalyticsBiEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiEnginesProcessor9()
