...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_11
...
@dataclass
class AnalyticsBiEnginesEntity11:
...
class AnalyticsBiEnginesSchema11(BaseModel):
...
class AnalyticsBiEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiEnginesProcessor11()
