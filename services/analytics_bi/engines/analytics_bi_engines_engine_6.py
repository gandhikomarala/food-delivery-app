...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_6
...
@dataclass
class AnalyticsBiEnginesEntity6:
...
class AnalyticsBiEnginesSchema6(BaseModel):
...
class AnalyticsBiEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiEnginesProcessor6()
