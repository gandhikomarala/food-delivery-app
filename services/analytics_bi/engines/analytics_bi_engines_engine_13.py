...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_13
...
@dataclass
class AnalyticsBiEnginesEntity13:
...
class AnalyticsBiEnginesSchema13(BaseModel):
...
class AnalyticsBiEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiEnginesProcessor13()
