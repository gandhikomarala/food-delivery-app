...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_7
...
@dataclass
class AnalyticsBiEnginesEntity7:
...
class AnalyticsBiEnginesSchema7(BaseModel):
...
class AnalyticsBiEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiEnginesProcessor7()
