...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_8
...
@dataclass
class AnalyticsBiEnginesEntity8:
...
class AnalyticsBiEnginesSchema8(BaseModel):
...
class AnalyticsBiEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiEnginesProcessor8()
