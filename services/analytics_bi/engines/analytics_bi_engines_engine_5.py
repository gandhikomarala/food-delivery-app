...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_5
...
@dataclass
class AnalyticsBiEnginesEntity5:
...
class AnalyticsBiEnginesSchema5(BaseModel):
...
class AnalyticsBiEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiEnginesProcessor5()
