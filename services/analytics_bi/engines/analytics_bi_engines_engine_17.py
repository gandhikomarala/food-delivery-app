...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_17
...
@dataclass
class AnalyticsBiEnginesEntity17:
...
class AnalyticsBiEnginesSchema17(BaseModel):
...
class AnalyticsBiEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiEnginesProcessor17()
