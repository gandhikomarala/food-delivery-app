...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_18
...
@dataclass
class AnalyticsBiEnginesEntity18:
...
class AnalyticsBiEnginesSchema18(BaseModel):
...
class AnalyticsBiEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiEnginesProcessor18()
