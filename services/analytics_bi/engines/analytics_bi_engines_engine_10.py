...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_10
...
@dataclass
class AnalyticsBiEnginesEntity10:
...
class AnalyticsBiEnginesSchema10(BaseModel):
...
class AnalyticsBiEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiEnginesProcessor10()
