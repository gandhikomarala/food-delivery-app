...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_14
...
@dataclass
class AnalyticsBiEnginesEntity14:
...
class AnalyticsBiEnginesSchema14(BaseModel):
...
class AnalyticsBiEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiEnginesProcessor14()
