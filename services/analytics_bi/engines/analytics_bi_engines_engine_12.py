...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_12
...
@dataclass
class AnalyticsBiEnginesEntity12:
...
class AnalyticsBiEnginesSchema12(BaseModel):
...
class AnalyticsBiEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiEnginesProcessor12()
