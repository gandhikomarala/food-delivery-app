...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_1
...
@dataclass
class AnalyticsBiEnginesEntity1:
...
class AnalyticsBiEnginesSchema1(BaseModel):
...
class AnalyticsBiEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiEnginesProcessor1()
