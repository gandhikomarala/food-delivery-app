...
Submodule: ENGINES | Component ID: ANALYTICS_BI_ENGINES_2
...
@dataclass
class AnalyticsBiEnginesEntity2:
...
class AnalyticsBiEnginesSchema2(BaseModel):
...
class AnalyticsBiEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiEnginesProcessor2()
