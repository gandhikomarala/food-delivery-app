...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_11
...
@dataclass
class AnalyticsBiPipelinesEntity11:
...
class AnalyticsBiPipelinesSchema11(BaseModel):
...
class AnalyticsBiPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiPipelinesProcessor11()
