...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_13
...
@dataclass
class AnalyticsBiPipelinesEntity13:
...
class AnalyticsBiPipelinesSchema13(BaseModel):
...
class AnalyticsBiPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiPipelinesProcessor13()
