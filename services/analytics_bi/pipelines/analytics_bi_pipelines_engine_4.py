...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_4
...
@dataclass
class AnalyticsBiPipelinesEntity4:
...
class AnalyticsBiPipelinesSchema4(BaseModel):
...
class AnalyticsBiPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiPipelinesProcessor4()
