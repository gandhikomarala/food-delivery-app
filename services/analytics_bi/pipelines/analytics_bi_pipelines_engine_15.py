...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_15
...
@dataclass
class AnalyticsBiPipelinesEntity15:
...
class AnalyticsBiPipelinesSchema15(BaseModel):
...
class AnalyticsBiPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiPipelinesProcessor15()
