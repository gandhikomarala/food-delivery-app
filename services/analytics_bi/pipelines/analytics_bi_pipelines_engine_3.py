...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_3
...
@dataclass
class AnalyticsBiPipelinesEntity3:
...
class AnalyticsBiPipelinesSchema3(BaseModel):
...
class AnalyticsBiPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiPipelinesProcessor3()
