...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_1
...
@dataclass
class AnalyticsBiPipelinesEntity1:
...
class AnalyticsBiPipelinesSchema1(BaseModel):
...
class AnalyticsBiPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiPipelinesProcessor1()
