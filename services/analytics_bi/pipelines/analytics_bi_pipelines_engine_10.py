...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_10
...
@dataclass
class AnalyticsBiPipelinesEntity10:
...
class AnalyticsBiPipelinesSchema10(BaseModel):
...
class AnalyticsBiPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiPipelinesProcessor10()
