...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_5
...
@dataclass
class AnalyticsBiPipelinesEntity5:
...
class AnalyticsBiPipelinesSchema5(BaseModel):
...
class AnalyticsBiPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiPipelinesProcessor5()
