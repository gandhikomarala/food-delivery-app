...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_12
...
@dataclass
class AnalyticsBiPipelinesEntity12:
...
class AnalyticsBiPipelinesSchema12(BaseModel):
...
class AnalyticsBiPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiPipelinesProcessor12()
