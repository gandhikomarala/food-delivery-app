...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_7
...
@dataclass
class AnalyticsBiPipelinesEntity7:
...
class AnalyticsBiPipelinesSchema7(BaseModel):
...
class AnalyticsBiPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiPipelinesProcessor7()
