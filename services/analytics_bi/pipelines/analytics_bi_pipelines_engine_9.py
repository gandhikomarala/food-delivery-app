...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_9
...
@dataclass
class AnalyticsBiPipelinesEntity9:
...
class AnalyticsBiPipelinesSchema9(BaseModel):
...
class AnalyticsBiPipelinesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiPipelinesProcessor9()
