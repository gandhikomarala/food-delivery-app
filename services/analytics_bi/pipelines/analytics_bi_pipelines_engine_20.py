...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_20
...
@dataclass
class AnalyticsBiPipelinesEntity20:
...
class AnalyticsBiPipelinesSchema20(BaseModel):
...
class AnalyticsBiPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiPipelinesProcessor20()
