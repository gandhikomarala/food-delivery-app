...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_8
...
@dataclass
class AnalyticsBiPipelinesEntity8:
...
class AnalyticsBiPipelinesSchema8(BaseModel):
...
class AnalyticsBiPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiPipelinesProcessor8()
