...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_6
...
@dataclass
class AnalyticsBiPipelinesEntity6:
...
class AnalyticsBiPipelinesSchema6(BaseModel):
...
class AnalyticsBiPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiPipelinesProcessor6()
