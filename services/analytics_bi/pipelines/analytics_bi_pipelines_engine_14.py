...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_14
...
@dataclass
class AnalyticsBiPipelinesEntity14:
...
class AnalyticsBiPipelinesSchema14(BaseModel):
...
class AnalyticsBiPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiPipelinesProcessor14()
