...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_18
...
@dataclass
class AnalyticsBiPipelinesEntity18:
...
class AnalyticsBiPipelinesSchema18(BaseModel):
...
class AnalyticsBiPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiPipelinesProcessor18()
