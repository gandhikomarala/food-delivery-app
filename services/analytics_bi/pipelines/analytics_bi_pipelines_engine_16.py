...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_16
...
@dataclass
class AnalyticsBiPipelinesEntity16:
...
class AnalyticsBiPipelinesSchema16(BaseModel):
...
class AnalyticsBiPipelinesProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiPipelinesProcessor16()
