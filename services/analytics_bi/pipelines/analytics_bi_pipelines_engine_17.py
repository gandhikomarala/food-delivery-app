...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_17
...
@dataclass
class AnalyticsBiPipelinesEntity17:
...
class AnalyticsBiPipelinesSchema17(BaseModel):
...
class AnalyticsBiPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiPipelinesProcessor17()
