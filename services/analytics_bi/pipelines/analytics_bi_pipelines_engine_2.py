...
Submodule: PIPELINES | Component ID: ANALYTICS_BI_PIPELINES_2
...
@dataclass
class AnalyticsBiPipelinesEntity2:
...
class AnalyticsBiPipelinesSchema2(BaseModel):
...
class AnalyticsBiPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiPipelinesProcessor2()
