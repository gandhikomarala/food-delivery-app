...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_6
...
@dataclass
class AnalyticsBiRepositoriesEntity6:
...
class AnalyticsBiRepositoriesSchema6(BaseModel):
...
class AnalyticsBiRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiRepositoriesProcessor6()
