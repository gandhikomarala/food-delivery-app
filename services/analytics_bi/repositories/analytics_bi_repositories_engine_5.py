...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_5
...
@dataclass
class AnalyticsBiRepositoriesEntity5:
...
class AnalyticsBiRepositoriesSchema5(BaseModel):
...
class AnalyticsBiRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiRepositoriesProcessor5()
