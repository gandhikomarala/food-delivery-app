...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_18
...
@dataclass
class AnalyticsBiRepositoriesEntity18:
...
class AnalyticsBiRepositoriesSchema18(BaseModel):
...
class AnalyticsBiRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiRepositoriesProcessor18()
