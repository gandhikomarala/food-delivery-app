...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_1
...
@dataclass
class AnalyticsBiRepositoriesEntity1:
...
class AnalyticsBiRepositoriesSchema1(BaseModel):
...
class AnalyticsBiRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiRepositoriesProcessor1()
