...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_3
...
@dataclass
class AnalyticsBiRepositoriesEntity3:
...
class AnalyticsBiRepositoriesSchema3(BaseModel):
...
class AnalyticsBiRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiRepositoriesProcessor3()
