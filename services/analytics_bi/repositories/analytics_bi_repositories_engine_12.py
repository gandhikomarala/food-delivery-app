...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_12
...
@dataclass
class AnalyticsBiRepositoriesEntity12:
...
class AnalyticsBiRepositoriesSchema12(BaseModel):
...
class AnalyticsBiRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiRepositoriesProcessor12()
