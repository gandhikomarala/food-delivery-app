...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_14
...
@dataclass
class AnalyticsBiRepositoriesEntity14:
...
class AnalyticsBiRepositoriesSchema14(BaseModel):
...
class AnalyticsBiRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiRepositoriesProcessor14()
