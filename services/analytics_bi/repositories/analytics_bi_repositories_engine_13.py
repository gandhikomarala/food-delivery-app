...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_13
...
@dataclass
class AnalyticsBiRepositoriesEntity13:
...
class AnalyticsBiRepositoriesSchema13(BaseModel):
...
class AnalyticsBiRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiRepositoriesProcessor13()
