...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_9
...
@dataclass
class AnalyticsBiRepositoriesEntity9:
...
class AnalyticsBiRepositoriesSchema9(BaseModel):
...
class AnalyticsBiRepositoriesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiRepositoriesProcessor9()
