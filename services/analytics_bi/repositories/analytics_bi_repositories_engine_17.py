...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_17
...
@dataclass
class AnalyticsBiRepositoriesEntity17:
...
class AnalyticsBiRepositoriesSchema17(BaseModel):
...
class AnalyticsBiRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiRepositoriesProcessor17()
