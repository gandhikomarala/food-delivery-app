...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_20
...
@dataclass
class AnalyticsBiRepositoriesEntity20:
...
class AnalyticsBiRepositoriesSchema20(BaseModel):
...
class AnalyticsBiRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiRepositoriesProcessor20()
