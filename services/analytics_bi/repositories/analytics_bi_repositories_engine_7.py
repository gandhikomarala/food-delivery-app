...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_7
...
@dataclass
class AnalyticsBiRepositoriesEntity7:
...
class AnalyticsBiRepositoriesSchema7(BaseModel):
...
class AnalyticsBiRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiRepositoriesProcessor7()
