...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_4
...
@dataclass
class AnalyticsBiRepositoriesEntity4:
...
class AnalyticsBiRepositoriesSchema4(BaseModel):
...
class AnalyticsBiRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiRepositoriesProcessor4()
