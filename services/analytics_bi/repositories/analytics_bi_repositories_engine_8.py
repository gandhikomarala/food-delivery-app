...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_8
...
@dataclass
class AnalyticsBiRepositoriesEntity8:
...
class AnalyticsBiRepositoriesSchema8(BaseModel):
...
class AnalyticsBiRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiRepositoriesProcessor8()
