...
Submodule: REPOSITORIES | Component ID: ANALYTICS_BI_REPOSITORIES_2
...
@dataclass
class AnalyticsBiRepositoriesEntity2:
...
class AnalyticsBiRepositoriesSchema2(BaseModel):
...
class AnalyticsBiRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiRepositoriesProcessor2()
