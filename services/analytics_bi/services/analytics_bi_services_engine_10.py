...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_10
...
@dataclass
class AnalyticsBiServicesEntity10:
...
class AnalyticsBiServicesSchema10(BaseModel):
...
class AnalyticsBiServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiServicesProcessor10()
