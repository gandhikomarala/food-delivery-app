...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_13
...
@dataclass
class AnalyticsBiServicesEntity13:
...
class AnalyticsBiServicesSchema13(BaseModel):
...
class AnalyticsBiServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiServicesProcessor13()
