...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_20
...
@dataclass
class AnalyticsBiServicesEntity20:
...
class AnalyticsBiServicesSchema20(BaseModel):
...
class AnalyticsBiServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiServicesProcessor20()
