...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_3
...
@dataclass
class AnalyticsBiServicesEntity3:
...
class AnalyticsBiServicesSchema3(BaseModel):
...
class AnalyticsBiServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiServicesProcessor3()
