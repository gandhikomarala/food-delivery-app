...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_17
...
@dataclass
class AnalyticsBiServicesEntity17:
...
class AnalyticsBiServicesSchema17(BaseModel):
...
class AnalyticsBiServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiServicesProcessor17()
