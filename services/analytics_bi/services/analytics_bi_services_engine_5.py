...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_5
...
@dataclass
class AnalyticsBiServicesEntity5:
...
class AnalyticsBiServicesSchema5(BaseModel):
...
class AnalyticsBiServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiServicesProcessor5()
