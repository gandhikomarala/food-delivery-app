...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_4
...
@dataclass
class AnalyticsBiServicesEntity4:
...
class AnalyticsBiServicesSchema4(BaseModel):
...
class AnalyticsBiServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiServicesProcessor4()
