...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_15
...
@dataclass
class AnalyticsBiServicesEntity15:
...
class AnalyticsBiServicesSchema15(BaseModel):
...
class AnalyticsBiServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiServicesProcessor15()
