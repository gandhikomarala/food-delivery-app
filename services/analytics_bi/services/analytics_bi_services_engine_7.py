...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_7
...
@dataclass
class AnalyticsBiServicesEntity7:
...
class AnalyticsBiServicesSchema7(BaseModel):
...
class AnalyticsBiServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiServicesProcessor7()
