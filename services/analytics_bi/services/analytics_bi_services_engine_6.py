...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_6
...
@dataclass
class AnalyticsBiServicesEntity6:
...
class AnalyticsBiServicesSchema6(BaseModel):
...
class AnalyticsBiServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiServicesProcessor6()
