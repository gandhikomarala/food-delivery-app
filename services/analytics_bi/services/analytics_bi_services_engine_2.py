...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_2
...
@dataclass
class AnalyticsBiServicesEntity2:
...
class AnalyticsBiServicesSchema2(BaseModel):
...
class AnalyticsBiServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiServicesProcessor2()
