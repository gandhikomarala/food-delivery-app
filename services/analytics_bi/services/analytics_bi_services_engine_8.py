...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_8
...
@dataclass
class AnalyticsBiServicesEntity8:
...
class AnalyticsBiServicesSchema8(BaseModel):
...
class AnalyticsBiServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiServicesProcessor8()
