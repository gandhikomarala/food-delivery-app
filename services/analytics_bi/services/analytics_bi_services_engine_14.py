...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_14
...
@dataclass
class AnalyticsBiServicesEntity14:
...
class AnalyticsBiServicesSchema14(BaseModel):
...
class AnalyticsBiServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiServicesProcessor14()
