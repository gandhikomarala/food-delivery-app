...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_9
...
@dataclass
class AnalyticsBiServicesEntity9:
...
class AnalyticsBiServicesSchema9(BaseModel):
...
class AnalyticsBiServicesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiServicesProcessor9()
