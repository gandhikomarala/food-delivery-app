...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_12
...
@dataclass
class AnalyticsBiServicesEntity12:
...
class AnalyticsBiServicesSchema12(BaseModel):
...
class AnalyticsBiServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiServicesProcessor12()
