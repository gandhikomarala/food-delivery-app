...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_1
...
@dataclass
class AnalyticsBiServicesEntity1:
...
class AnalyticsBiServicesSchema1(BaseModel):
...
class AnalyticsBiServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiServicesProcessor1()
