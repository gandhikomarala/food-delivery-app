...
Submodule: SERVICES | Component ID: ANALYTICS_BI_SERVICES_18
...
@dataclass
class AnalyticsBiServicesEntity18:
...
class AnalyticsBiServicesSchema18(BaseModel):
...
class AnalyticsBiServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiServicesProcessor18()
