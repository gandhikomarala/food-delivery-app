...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_17
...
class AnalyticsBiDtoSchema17(BaseModel):
...
class AnalyticsBiDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiDtoProcessor17()
