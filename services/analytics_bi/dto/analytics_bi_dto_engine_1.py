...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_1
...
class AnalyticsBiDtoSchema1(BaseModel):
...
class AnalyticsBiDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiDtoProcessor1()
