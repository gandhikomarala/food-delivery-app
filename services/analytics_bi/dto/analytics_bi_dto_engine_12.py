...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_12
...
class AnalyticsBiDtoSchema12(BaseModel):
...
class AnalyticsBiDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiDtoProcessor12()
