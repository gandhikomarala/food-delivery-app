...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_2
...
class AnalyticsBiDtoSchema2(BaseModel):
...
class AnalyticsBiDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiDtoProcessor2()
