...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_8
...
class AnalyticsBiDtoSchema8(BaseModel):
...
class AnalyticsBiDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiDtoProcessor8()
