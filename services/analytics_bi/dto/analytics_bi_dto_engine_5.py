...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_5
...
class AnalyticsBiDtoSchema5(BaseModel):
...
class AnalyticsBiDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiDtoProcessor5()
