...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_14
...
class AnalyticsBiDtoSchema14(BaseModel):
...
class AnalyticsBiDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiDtoProcessor14()
