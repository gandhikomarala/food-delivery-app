...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_20
...
class AnalyticsBiDtoSchema20(BaseModel):
...
class AnalyticsBiDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiDtoProcessor20()
