...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_18
...
class AnalyticsBiDtoSchema18(BaseModel):
...
class AnalyticsBiDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiDtoProcessor18()
