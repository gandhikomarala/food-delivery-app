...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_6
...
class AnalyticsBiDtoSchema6(BaseModel):
...
class AnalyticsBiDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiDtoProcessor6()
