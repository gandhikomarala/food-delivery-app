...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_19
...
class AnalyticsBiDtoSchema19(BaseModel):
...
class AnalyticsBiDtoProcessor19:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema19) -> Dict[str, Any]:
...
default_processor_19 = AnalyticsBiDtoProcessor19()
