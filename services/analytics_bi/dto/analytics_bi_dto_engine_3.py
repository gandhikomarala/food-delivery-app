...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_3
...
class AnalyticsBiDtoSchema3(BaseModel):
...
class AnalyticsBiDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiDtoProcessor3()
