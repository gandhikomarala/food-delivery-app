...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_7
...
class AnalyticsBiDtoSchema7(BaseModel):
...
class AnalyticsBiDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiDtoProcessor7()
