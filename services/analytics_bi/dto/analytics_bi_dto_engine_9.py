...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_9
...
class AnalyticsBiDtoSchema9(BaseModel):
...
class AnalyticsBiDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiDtoProcessor9()
