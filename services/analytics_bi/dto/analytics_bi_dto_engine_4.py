...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_4
...
class AnalyticsBiDtoSchema4(BaseModel):
...
class AnalyticsBiDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiDtoProcessor4()
