...
Submodule: DTO | Component ID: ANALYTICS_BI_DTO_13
...
class AnalyticsBiDtoSchema13(BaseModel):
...
class AnalyticsBiDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiDtoProcessor13()
