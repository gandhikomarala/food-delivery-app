...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_20
...
@dataclass
class AnalyticsBiEventsEntity20:
...
class AnalyticsBiEventsSchema20(BaseModel):
...
class AnalyticsBiEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiEventsProcessor20()
