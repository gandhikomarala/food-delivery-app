...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_10
...
@dataclass
class AnalyticsBiEventsEntity10:
...
class AnalyticsBiEventsSchema10(BaseModel):
...
class AnalyticsBiEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiEventsProcessor10()
