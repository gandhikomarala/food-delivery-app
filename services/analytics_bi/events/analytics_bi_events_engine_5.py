...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_5
...
@dataclass
class AnalyticsBiEventsEntity5:
...
class AnalyticsBiEventsSchema5(BaseModel):
...
class AnalyticsBiEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiEventsProcessor5()
