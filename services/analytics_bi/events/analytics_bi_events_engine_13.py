...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_13
...
@dataclass
class AnalyticsBiEventsEntity13:
...
class AnalyticsBiEventsSchema13(BaseModel):
...
class AnalyticsBiEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiEventsProcessor13()
