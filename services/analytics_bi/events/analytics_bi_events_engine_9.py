...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_9
...
@dataclass
class AnalyticsBiEventsEntity9:
...
class AnalyticsBiEventsSchema9(BaseModel):
...
class AnalyticsBiEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiEventsProcessor9()
