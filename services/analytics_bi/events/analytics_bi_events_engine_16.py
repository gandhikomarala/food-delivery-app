...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_16
...
@dataclass
class AnalyticsBiEventsEntity16:
...
class AnalyticsBiEventsSchema16(BaseModel):
...
class AnalyticsBiEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiEventsProcessor16()
