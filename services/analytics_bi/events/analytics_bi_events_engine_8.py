...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_8
...
@dataclass
class AnalyticsBiEventsEntity8:
...
class AnalyticsBiEventsSchema8(BaseModel):
...
class AnalyticsBiEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiEventsProcessor8()
