...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_1
...
@dataclass
class AnalyticsBiEventsEntity1:
...
class AnalyticsBiEventsSchema1(BaseModel):
...
class AnalyticsBiEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiEventsProcessor1()
