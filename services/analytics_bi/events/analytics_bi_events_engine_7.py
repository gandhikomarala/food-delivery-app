...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_7
...
@dataclass
class AnalyticsBiEventsEntity7:
...
class AnalyticsBiEventsSchema7(BaseModel):
...
class AnalyticsBiEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiEventsProcessor7()
