...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_11
...
@dataclass
class AnalyticsBiEventsEntity11:
...
class AnalyticsBiEventsSchema11(BaseModel):
...
class AnalyticsBiEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiEventsProcessor11()
