...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_4
...
@dataclass
class AnalyticsBiEventsEntity4:
...
class AnalyticsBiEventsSchema4(BaseModel):
...
class AnalyticsBiEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiEventsProcessor4()
