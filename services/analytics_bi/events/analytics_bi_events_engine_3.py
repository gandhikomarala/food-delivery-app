...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_3
...
@dataclass
class AnalyticsBiEventsEntity3:
...
class AnalyticsBiEventsSchema3(BaseModel):
...
class AnalyticsBiEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiEventsProcessor3()
