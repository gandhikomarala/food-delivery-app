...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_2
...
@dataclass
class AnalyticsBiEventsEntity2:
...
class AnalyticsBiEventsSchema2(BaseModel):
...
class AnalyticsBiEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiEventsProcessor2()
