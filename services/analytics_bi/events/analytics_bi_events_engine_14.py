...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_14
...
@dataclass
class AnalyticsBiEventsEntity14:
...
class AnalyticsBiEventsSchema14(BaseModel):
...
class AnalyticsBiEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiEventsProcessor14()
