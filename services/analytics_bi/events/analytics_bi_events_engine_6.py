...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_6
...
@dataclass
class AnalyticsBiEventsEntity6:
...
class AnalyticsBiEventsSchema6(BaseModel):
...
class AnalyticsBiEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiEventsProcessor6()
