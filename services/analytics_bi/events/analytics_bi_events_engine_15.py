...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_15
...
@dataclass
class AnalyticsBiEventsEntity15:
...
class AnalyticsBiEventsSchema15(BaseModel):
...
class AnalyticsBiEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiEventsProcessor15()
