...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_17
...
@dataclass
class AnalyticsBiEventsEntity17:
...
class AnalyticsBiEventsSchema17(BaseModel):
...
class AnalyticsBiEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiEventsProcessor17()
