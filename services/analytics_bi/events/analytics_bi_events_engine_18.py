...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_18
...
@dataclass
class AnalyticsBiEventsEntity18:
...
class AnalyticsBiEventsSchema18(BaseModel):
...
class AnalyticsBiEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiEventsProcessor18()
