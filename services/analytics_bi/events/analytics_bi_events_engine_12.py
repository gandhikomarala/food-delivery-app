...
Submodule: EVENTS | Component ID: ANALYTICS_BI_EVENTS_12
...
@dataclass
class AnalyticsBiEventsEntity12:
...
class AnalyticsBiEventsSchema12(BaseModel):
...
class AnalyticsBiEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiEventsProcessor12()
