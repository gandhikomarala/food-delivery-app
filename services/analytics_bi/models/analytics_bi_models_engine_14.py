...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_14
...
@dataclass
class AnalyticsBiModelsEntity14:
...
class AnalyticsBiModelsSchema14(BaseModel):
...
class AnalyticsBiModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiModelsProcessor14()
