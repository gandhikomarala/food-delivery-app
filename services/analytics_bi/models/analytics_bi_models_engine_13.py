...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_13
...
@dataclass
class AnalyticsBiModelsEntity13:
...
class AnalyticsBiModelsSchema13(BaseModel):
...
class AnalyticsBiModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiModelsProcessor13()
