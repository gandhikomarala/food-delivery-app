...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_19
...
@dataclass
class AnalyticsBiModelsEntity19:
...
class AnalyticsBiModelsSchema19(BaseModel):
...
class AnalyticsBiModelsProcessor19:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema19) -> Dict[str, Any]:
...
default_processor_19 = AnalyticsBiModelsProcessor19()
