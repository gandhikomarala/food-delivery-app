...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_17
...
@dataclass
class AnalyticsBiModelsEntity17:
...
class AnalyticsBiModelsSchema17(BaseModel):
...
class AnalyticsBiModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiModelsProcessor17()
