...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_5
...
@dataclass
class AnalyticsBiModelsEntity5:
...
class AnalyticsBiModelsSchema5(BaseModel):
...
class AnalyticsBiModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiModelsProcessor5()
