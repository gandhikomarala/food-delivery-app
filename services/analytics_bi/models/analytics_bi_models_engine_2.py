...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_2
...
@dataclass
class AnalyticsBiModelsEntity2:
...
class AnalyticsBiModelsSchema2(BaseModel):
...
class AnalyticsBiModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiModelsProcessor2()
