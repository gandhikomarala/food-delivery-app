...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_12
...
@dataclass
class AnalyticsBiModelsEntity12:
...
class AnalyticsBiModelsSchema12(BaseModel):
...
class AnalyticsBiModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiModelsProcessor12()
