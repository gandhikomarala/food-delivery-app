...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_3
...
@dataclass
class AnalyticsBiModelsEntity3:
...
class AnalyticsBiModelsSchema3(BaseModel):
...
class AnalyticsBiModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiModelsProcessor3()
