...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_11
...
@dataclass
class AnalyticsBiModelsEntity11:
...
class AnalyticsBiModelsSchema11(BaseModel):
...
class AnalyticsBiModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiModelsProcessor11()
