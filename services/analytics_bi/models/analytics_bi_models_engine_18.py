...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_18
...
@dataclass
class AnalyticsBiModelsEntity18:
...
class AnalyticsBiModelsSchema18(BaseModel):
...
class AnalyticsBiModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiModelsProcessor18()
