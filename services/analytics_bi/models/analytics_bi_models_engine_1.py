...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_1
...
@dataclass
class AnalyticsBiModelsEntity1:
...
class AnalyticsBiModelsSchema1(BaseModel):
...
class AnalyticsBiModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiModelsProcessor1()
