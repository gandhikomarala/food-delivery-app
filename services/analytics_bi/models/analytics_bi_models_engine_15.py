...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_15
...
@dataclass
class AnalyticsBiModelsEntity15:
...
class AnalyticsBiModelsSchema15(BaseModel):
...
class AnalyticsBiModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiModelsProcessor15()
