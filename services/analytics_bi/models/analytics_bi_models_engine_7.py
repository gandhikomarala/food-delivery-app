...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_7
...
@dataclass
class AnalyticsBiModelsEntity7:
...
class AnalyticsBiModelsSchema7(BaseModel):
...
class AnalyticsBiModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiModelsProcessor7()
