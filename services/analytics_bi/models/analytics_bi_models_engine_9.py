...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_9
...
@dataclass
class AnalyticsBiModelsEntity9:
...
class AnalyticsBiModelsSchema9(BaseModel):
...
class AnalyticsBiModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiModelsProcessor9()
