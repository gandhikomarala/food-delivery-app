...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_6
...
@dataclass
class AnalyticsBiModelsEntity6:
...
class AnalyticsBiModelsSchema6(BaseModel):
...
class AnalyticsBiModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiModelsProcessor6()
