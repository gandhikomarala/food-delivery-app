...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_8
...
@dataclass
class AnalyticsBiModelsEntity8:
...
class AnalyticsBiModelsSchema8(BaseModel):
...
class AnalyticsBiModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiModelsProcessor8()
