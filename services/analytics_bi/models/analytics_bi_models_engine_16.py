...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_16
...
@dataclass
class AnalyticsBiModelsEntity16:
...
class AnalyticsBiModelsSchema16(BaseModel):
...
class AnalyticsBiModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiModelsProcessor16()
