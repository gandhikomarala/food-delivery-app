...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_10
...
@dataclass
class AnalyticsBiModelsEntity10:
...
class AnalyticsBiModelsSchema10(BaseModel):
...
class AnalyticsBiModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiModelsProcessor10()
