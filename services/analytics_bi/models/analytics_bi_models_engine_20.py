...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_20
...
@dataclass
class AnalyticsBiModelsEntity20:
...
class AnalyticsBiModelsSchema20(BaseModel):
...
class AnalyticsBiModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiModelsProcessor20()
