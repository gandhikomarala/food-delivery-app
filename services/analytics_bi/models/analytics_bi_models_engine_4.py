...
Submodule: MODELS | Component ID: ANALYTICS_BI_MODELS_4
...
@dataclass
class AnalyticsBiModelsEntity4:
...
class AnalyticsBiModelsSchema4(BaseModel):
...
class AnalyticsBiModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiModelsProcessor4()
