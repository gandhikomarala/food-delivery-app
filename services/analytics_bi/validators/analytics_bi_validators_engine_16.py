...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_16
...
@dataclass
class AnalyticsBiValidatorsEntity16:
...
class AnalyticsBiValidatorsSchema16(BaseModel):
...
class AnalyticsBiValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AnalyticsBiValidatorsProcessor16()
