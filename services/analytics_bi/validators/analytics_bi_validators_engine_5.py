...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_5
...
@dataclass
class AnalyticsBiValidatorsEntity5:
...
class AnalyticsBiValidatorsSchema5(BaseModel):
...
class AnalyticsBiValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AnalyticsBiValidatorsProcessor5()
