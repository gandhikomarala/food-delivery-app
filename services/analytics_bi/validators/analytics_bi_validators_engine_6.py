...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_6
...
@dataclass
class AnalyticsBiValidatorsEntity6:
...
class AnalyticsBiValidatorsSchema6(BaseModel):
...
class AnalyticsBiValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AnalyticsBiValidatorsProcessor6()
