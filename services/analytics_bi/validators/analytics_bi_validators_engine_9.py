...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_9
...
@dataclass
class AnalyticsBiValidatorsEntity9:
...
class AnalyticsBiValidatorsSchema9(BaseModel):
...
class AnalyticsBiValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AnalyticsBiValidatorsProcessor9()
