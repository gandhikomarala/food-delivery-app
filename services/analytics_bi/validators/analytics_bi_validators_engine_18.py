...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_18
...
@dataclass
class AnalyticsBiValidatorsEntity18:
...
class AnalyticsBiValidatorsSchema18(BaseModel):
...
class AnalyticsBiValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AnalyticsBiValidatorsProcessor18()
