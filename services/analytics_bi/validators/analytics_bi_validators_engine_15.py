...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_15
...
@dataclass
class AnalyticsBiValidatorsEntity15:
...
class AnalyticsBiValidatorsSchema15(BaseModel):
...
class AnalyticsBiValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AnalyticsBiValidatorsProcessor15()
