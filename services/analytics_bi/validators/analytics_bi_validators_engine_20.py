...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_20
...
@dataclass
class AnalyticsBiValidatorsEntity20:
...
class AnalyticsBiValidatorsSchema20(BaseModel):
...
class AnalyticsBiValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AnalyticsBiValidatorsProcessor20()
