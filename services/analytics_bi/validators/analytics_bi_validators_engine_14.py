...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_14
...
@dataclass
class AnalyticsBiValidatorsEntity14:
...
class AnalyticsBiValidatorsSchema14(BaseModel):
...
class AnalyticsBiValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AnalyticsBiValidatorsProcessor14()
