...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_4
...
@dataclass
class AnalyticsBiValidatorsEntity4:
...
class AnalyticsBiValidatorsSchema4(BaseModel):
...
class AnalyticsBiValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AnalyticsBiValidatorsProcessor4()
