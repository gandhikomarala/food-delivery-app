...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_17
...
@dataclass
class AnalyticsBiValidatorsEntity17:
...
class AnalyticsBiValidatorsSchema17(BaseModel):
...
class AnalyticsBiValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AnalyticsBiValidatorsProcessor17()
