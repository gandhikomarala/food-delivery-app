...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_13
...
@dataclass
class AnalyticsBiValidatorsEntity13:
...
class AnalyticsBiValidatorsSchema13(BaseModel):
...
class AnalyticsBiValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AnalyticsBiValidatorsProcessor13()
