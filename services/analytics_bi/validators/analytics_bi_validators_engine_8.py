...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_8
...
@dataclass
class AnalyticsBiValidatorsEntity8:
...
class AnalyticsBiValidatorsSchema8(BaseModel):
...
class AnalyticsBiValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AnalyticsBiValidatorsProcessor8()
