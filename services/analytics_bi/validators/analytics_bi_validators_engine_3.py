...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_3
...
@dataclass
class AnalyticsBiValidatorsEntity3:
...
class AnalyticsBiValidatorsSchema3(BaseModel):
...
class AnalyticsBiValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AnalyticsBiValidatorsProcessor3()
