...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_7
...
@dataclass
class AnalyticsBiValidatorsEntity7:
...
class AnalyticsBiValidatorsSchema7(BaseModel):
...
class AnalyticsBiValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AnalyticsBiValidatorsProcessor7()
