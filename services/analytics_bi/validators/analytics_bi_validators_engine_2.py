...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_2
...
@dataclass
class AnalyticsBiValidatorsEntity2:
...
class AnalyticsBiValidatorsSchema2(BaseModel):
...
class AnalyticsBiValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AnalyticsBiValidatorsProcessor2()
