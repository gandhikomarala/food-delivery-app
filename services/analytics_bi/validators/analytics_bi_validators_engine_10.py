...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_10
...
@dataclass
class AnalyticsBiValidatorsEntity10:
...
class AnalyticsBiValidatorsSchema10(BaseModel):
...
class AnalyticsBiValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AnalyticsBiValidatorsProcessor10()
