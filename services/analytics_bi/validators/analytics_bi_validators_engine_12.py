...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_12
...
@dataclass
class AnalyticsBiValidatorsEntity12:
...
class AnalyticsBiValidatorsSchema12(BaseModel):
...
class AnalyticsBiValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AnalyticsBiValidatorsProcessor12()
