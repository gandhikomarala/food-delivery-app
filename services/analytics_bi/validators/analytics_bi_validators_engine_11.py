...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_11
...
@dataclass
class AnalyticsBiValidatorsEntity11:
...
class AnalyticsBiValidatorsSchema11(BaseModel):
...
class AnalyticsBiValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AnalyticsBiValidatorsProcessor11()
