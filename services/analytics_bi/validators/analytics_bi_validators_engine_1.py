...
Submodule: VALIDATORS | Component ID: ANALYTICS_BI_VALIDATORS_1
...
@dataclass
class AnalyticsBiValidatorsEntity1:
...
class AnalyticsBiValidatorsSchema1(BaseModel):
...
class AnalyticsBiValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AnalyticsBiValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AnalyticsBiValidatorsProcessor1()
