...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_12
...
@dataclass
class AuthSecurityPipelinesEntity12:
...
class AuthSecurityPipelinesSchema12(BaseModel):
...
class AuthSecurityPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityPipelinesProcessor12()
