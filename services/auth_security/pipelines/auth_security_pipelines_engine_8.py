...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_8
...
@dataclass
class AuthSecurityPipelinesEntity8:
...
class AuthSecurityPipelinesSchema8(BaseModel):
...
class AuthSecurityPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityPipelinesProcessor8()
