...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_3
...
@dataclass
class AuthSecurityPipelinesEntity3:
...
class AuthSecurityPipelinesSchema3(BaseModel):
...
class AuthSecurityPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityPipelinesProcessor3()
