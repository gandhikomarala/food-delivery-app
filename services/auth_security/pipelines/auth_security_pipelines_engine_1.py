...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_1
...
@dataclass
class AuthSecurityPipelinesEntity1:
...
class AuthSecurityPipelinesSchema1(BaseModel):
...
class AuthSecurityPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityPipelinesProcessor1()
