...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_14
...
@dataclass
class AuthSecurityPipelinesEntity14:
...
class AuthSecurityPipelinesSchema14(BaseModel):
...
class AuthSecurityPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityPipelinesProcessor14()
