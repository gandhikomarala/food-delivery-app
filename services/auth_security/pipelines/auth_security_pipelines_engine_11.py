...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_11
...
@dataclass
class AuthSecurityPipelinesEntity11:
...
class AuthSecurityPipelinesSchema11(BaseModel):
...
class AuthSecurityPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityPipelinesProcessor11()
