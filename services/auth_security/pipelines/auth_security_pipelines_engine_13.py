...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_13
...
@dataclass
class AuthSecurityPipelinesEntity13:
...
class AuthSecurityPipelinesSchema13(BaseModel):
...
class AuthSecurityPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityPipelinesProcessor13()
