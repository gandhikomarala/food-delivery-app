...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_20
...
@dataclass
class AuthSecurityPipelinesEntity20:
...
class AuthSecurityPipelinesSchema20(BaseModel):
...
class AuthSecurityPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityPipelinesProcessor20()
