...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_4
...
@dataclass
class AuthSecurityPipelinesEntity4:
...
class AuthSecurityPipelinesSchema4(BaseModel):
...
class AuthSecurityPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityPipelinesProcessor4()
