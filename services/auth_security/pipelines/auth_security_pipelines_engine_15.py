...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_15
...
@dataclass
class AuthSecurityPipelinesEntity15:
...
class AuthSecurityPipelinesSchema15(BaseModel):
...
class AuthSecurityPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityPipelinesProcessor15()
