...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_2
...
@dataclass
class AuthSecurityPipelinesEntity2:
...
class AuthSecurityPipelinesSchema2(BaseModel):
...
class AuthSecurityPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityPipelinesProcessor2()
