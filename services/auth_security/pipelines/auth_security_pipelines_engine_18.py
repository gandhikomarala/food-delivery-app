...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_18
...
@dataclass
class AuthSecurityPipelinesEntity18:
...
class AuthSecurityPipelinesSchema18(BaseModel):
...
class AuthSecurityPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityPipelinesProcessor18()
