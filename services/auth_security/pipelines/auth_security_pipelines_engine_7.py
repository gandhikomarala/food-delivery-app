...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_7
...
@dataclass
class AuthSecurityPipelinesEntity7:
...
class AuthSecurityPipelinesSchema7(BaseModel):
...
class AuthSecurityPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityPipelinesProcessor7()
