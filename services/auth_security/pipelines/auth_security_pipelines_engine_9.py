...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_9
...
@dataclass
class AuthSecurityPipelinesEntity9:
...
class AuthSecurityPipelinesSchema9(BaseModel):
...
class AuthSecurityPipelinesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityPipelinesProcessor9()
