...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_17
...
@dataclass
class AuthSecurityPipelinesEntity17:
...
class AuthSecurityPipelinesSchema17(BaseModel):
...
class AuthSecurityPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityPipelinesProcessor17()
