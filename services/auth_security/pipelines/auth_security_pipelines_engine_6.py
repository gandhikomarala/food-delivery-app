...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_6
...
@dataclass
class AuthSecurityPipelinesEntity6:
...
class AuthSecurityPipelinesSchema6(BaseModel):
...
class AuthSecurityPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityPipelinesProcessor6()
