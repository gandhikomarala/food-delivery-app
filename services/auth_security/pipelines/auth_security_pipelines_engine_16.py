...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_16
...
@dataclass
class AuthSecurityPipelinesEntity16:
...
class AuthSecurityPipelinesSchema16(BaseModel):
...
class AuthSecurityPipelinesProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityPipelinesProcessor16()
