...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_10
...
@dataclass
class AuthSecurityPipelinesEntity10:
...
class AuthSecurityPipelinesSchema10(BaseModel):
...
class AuthSecurityPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityPipelinesProcessor10()
