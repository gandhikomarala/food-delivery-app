...
Submodule: PIPELINES | Component ID: AUTH_SECURITY_PIPELINES_5
...
@dataclass
class AuthSecurityPipelinesEntity5:
...
class AuthSecurityPipelinesSchema5(BaseModel):
...
class AuthSecurityPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityPipelinesProcessor5()
