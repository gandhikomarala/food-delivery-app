...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_10
...
@dataclass
class AuthSecurityValidatorsEntity10:
...
class AuthSecurityValidatorsSchema10(BaseModel):
...
class AuthSecurityValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityValidatorsProcessor10()
