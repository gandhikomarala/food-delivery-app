...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_7
...
@dataclass
class AuthSecurityValidatorsEntity7:
...
class AuthSecurityValidatorsSchema7(BaseModel):
...
class AuthSecurityValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityValidatorsProcessor7()
