...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_18
...
@dataclass
class AuthSecurityValidatorsEntity18:
...
class AuthSecurityValidatorsSchema18(BaseModel):
...
class AuthSecurityValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityValidatorsProcessor18()
