...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_15
...
@dataclass
class AuthSecurityValidatorsEntity15:
...
class AuthSecurityValidatorsSchema15(BaseModel):
...
class AuthSecurityValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityValidatorsProcessor15()
