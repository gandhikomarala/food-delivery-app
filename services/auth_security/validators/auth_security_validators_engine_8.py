...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_8
...
@dataclass
class AuthSecurityValidatorsEntity8:
...
class AuthSecurityValidatorsSchema8(BaseModel):
...
class AuthSecurityValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityValidatorsProcessor8()
