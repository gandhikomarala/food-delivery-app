...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_20
...
@dataclass
class AuthSecurityValidatorsEntity20:
...
class AuthSecurityValidatorsSchema20(BaseModel):
...
class AuthSecurityValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityValidatorsProcessor20()
