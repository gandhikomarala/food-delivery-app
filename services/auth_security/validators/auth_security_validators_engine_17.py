...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_17
...
@dataclass
class AuthSecurityValidatorsEntity17:
...
class AuthSecurityValidatorsSchema17(BaseModel):
...
class AuthSecurityValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityValidatorsProcessor17()
