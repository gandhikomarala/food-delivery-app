...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_5
...
@dataclass
class AuthSecurityValidatorsEntity5:
...
class AuthSecurityValidatorsSchema5(BaseModel):
...
class AuthSecurityValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityValidatorsProcessor5()
