...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_13
...
@dataclass
class AuthSecurityValidatorsEntity13:
...
class AuthSecurityValidatorsSchema13(BaseModel):
...
class AuthSecurityValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityValidatorsProcessor13()
