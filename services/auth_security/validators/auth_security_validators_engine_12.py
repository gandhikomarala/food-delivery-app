...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_12
...
@dataclass
class AuthSecurityValidatorsEntity12:
...
class AuthSecurityValidatorsSchema12(BaseModel):
...
class AuthSecurityValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityValidatorsProcessor12()
