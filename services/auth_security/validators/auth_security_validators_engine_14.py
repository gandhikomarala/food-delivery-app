...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_14
...
@dataclass
class AuthSecurityValidatorsEntity14:
...
class AuthSecurityValidatorsSchema14(BaseModel):
...
class AuthSecurityValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityValidatorsProcessor14()
