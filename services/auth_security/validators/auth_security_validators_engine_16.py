...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_16
...
@dataclass
class AuthSecurityValidatorsEntity16:
...
class AuthSecurityValidatorsSchema16(BaseModel):
...
class AuthSecurityValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityValidatorsProcessor16()
