...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_4
...
@dataclass
class AuthSecurityValidatorsEntity4:
...
class AuthSecurityValidatorsSchema4(BaseModel):
...
class AuthSecurityValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityValidatorsProcessor4()
