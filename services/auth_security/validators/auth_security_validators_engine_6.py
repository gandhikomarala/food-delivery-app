...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_6
...
@dataclass
class AuthSecurityValidatorsEntity6:
...
class AuthSecurityValidatorsSchema6(BaseModel):
...
class AuthSecurityValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityValidatorsProcessor6()
