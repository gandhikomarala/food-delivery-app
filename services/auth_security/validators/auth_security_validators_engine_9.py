...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_9
...
@dataclass
class AuthSecurityValidatorsEntity9:
...
class AuthSecurityValidatorsSchema9(BaseModel):
...
class AuthSecurityValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityValidatorsProcessor9()
