...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_19
...
@dataclass
class AuthSecurityValidatorsEntity19:
...
class AuthSecurityValidatorsSchema19(BaseModel):
...
class AuthSecurityValidatorsProcessor19:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema19) -> Dict[str, Any]:
...
default_processor_19 = AuthSecurityValidatorsProcessor19()
