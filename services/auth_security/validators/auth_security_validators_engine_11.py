...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_11
...
@dataclass
class AuthSecurityValidatorsEntity11:
...
class AuthSecurityValidatorsSchema11(BaseModel):
...
class AuthSecurityValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityValidatorsProcessor11()
