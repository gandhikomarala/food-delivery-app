...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_3
...
@dataclass
class AuthSecurityValidatorsEntity3:
...
class AuthSecurityValidatorsSchema3(BaseModel):
...
class AuthSecurityValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityValidatorsProcessor3()
