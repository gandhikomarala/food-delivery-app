...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_1
...
@dataclass
class AuthSecurityValidatorsEntity1:
...
class AuthSecurityValidatorsSchema1(BaseModel):
...
class AuthSecurityValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityValidatorsProcessor1()
