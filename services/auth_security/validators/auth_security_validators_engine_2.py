...
Submodule: VALIDATORS | Component ID: AUTH_SECURITY_VALIDATORS_2
...
@dataclass
class AuthSecurityValidatorsEntity2:
...
class AuthSecurityValidatorsSchema2(BaseModel):
...
class AuthSecurityValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityValidatorsProcessor2()
