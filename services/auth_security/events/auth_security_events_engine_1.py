...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_1
...
@dataclass
class AuthSecurityEventsEntity1:
...
class AuthSecurityEventsSchema1(BaseModel):
...
class AuthSecurityEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityEventsProcessor1()
