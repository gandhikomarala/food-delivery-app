...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_15
...
@dataclass
class AuthSecurityEventsEntity15:
...
class AuthSecurityEventsSchema15(BaseModel):
...
class AuthSecurityEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityEventsProcessor15()
