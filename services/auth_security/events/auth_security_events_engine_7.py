...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_7
...
@dataclass
class AuthSecurityEventsEntity7:
...
class AuthSecurityEventsSchema7(BaseModel):
...
class AuthSecurityEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityEventsProcessor7()
