...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_17
...
@dataclass
class AuthSecurityEventsEntity17:
...
class AuthSecurityEventsSchema17(BaseModel):
...
class AuthSecurityEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityEventsProcessor17()
