...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_11
...
@dataclass
class AuthSecurityEventsEntity11:
...
class AuthSecurityEventsSchema11(BaseModel):
...
class AuthSecurityEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityEventsProcessor11()
