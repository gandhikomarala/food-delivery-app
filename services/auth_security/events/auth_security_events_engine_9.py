...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_9
...
@dataclass
class AuthSecurityEventsEntity9:
...
class AuthSecurityEventsSchema9(BaseModel):
...
class AuthSecurityEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityEventsProcessor9()
