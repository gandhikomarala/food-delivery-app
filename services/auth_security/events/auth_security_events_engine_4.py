...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_4
...
@dataclass
class AuthSecurityEventsEntity4:
...
class AuthSecurityEventsSchema4(BaseModel):
...
class AuthSecurityEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityEventsProcessor4()
