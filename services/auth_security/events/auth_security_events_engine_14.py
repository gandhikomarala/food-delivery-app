...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_14
...
@dataclass
class AuthSecurityEventsEntity14:
...
class AuthSecurityEventsSchema14(BaseModel):
...
class AuthSecurityEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityEventsProcessor14()
