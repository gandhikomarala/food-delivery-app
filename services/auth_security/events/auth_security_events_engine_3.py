...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_3
...
@dataclass
class AuthSecurityEventsEntity3:
...
class AuthSecurityEventsSchema3(BaseModel):
...
class AuthSecurityEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityEventsProcessor3()
