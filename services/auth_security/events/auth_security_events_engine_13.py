...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_13
...
@dataclass
class AuthSecurityEventsEntity13:
...
class AuthSecurityEventsSchema13(BaseModel):
...
class AuthSecurityEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityEventsProcessor13()
