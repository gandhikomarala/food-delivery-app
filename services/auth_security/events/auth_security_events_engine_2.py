...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_2
...
@dataclass
class AuthSecurityEventsEntity2:
...
class AuthSecurityEventsSchema2(BaseModel):
...
class AuthSecurityEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityEventsProcessor2()
