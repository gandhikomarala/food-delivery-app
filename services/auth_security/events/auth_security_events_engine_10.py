...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_10
...
@dataclass
class AuthSecurityEventsEntity10:
...
class AuthSecurityEventsSchema10(BaseModel):
...
class AuthSecurityEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityEventsProcessor10()
