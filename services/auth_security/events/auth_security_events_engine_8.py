...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_8
...
@dataclass
class AuthSecurityEventsEntity8:
...
class AuthSecurityEventsSchema8(BaseModel):
...
class AuthSecurityEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityEventsProcessor8()
