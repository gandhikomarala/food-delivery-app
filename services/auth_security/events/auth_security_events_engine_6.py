...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_6
...
@dataclass
class AuthSecurityEventsEntity6:
...
class AuthSecurityEventsSchema6(BaseModel):
...
class AuthSecurityEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityEventsProcessor6()
