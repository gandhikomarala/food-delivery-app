...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_20
...
@dataclass
class AuthSecurityEventsEntity20:
...
class AuthSecurityEventsSchema20(BaseModel):
...
class AuthSecurityEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityEventsProcessor20()
