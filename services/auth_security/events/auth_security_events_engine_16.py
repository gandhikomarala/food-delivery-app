...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_16
...
@dataclass
class AuthSecurityEventsEntity16:
...
class AuthSecurityEventsSchema16(BaseModel):
...
class AuthSecurityEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityEventsProcessor16()
