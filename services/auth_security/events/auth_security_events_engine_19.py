...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_19
...
@dataclass
class AuthSecurityEventsEntity19:
...
class AuthSecurityEventsSchema19(BaseModel):
...
class AuthSecurityEventsProcessor19:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema19) -> Dict[str, Any]:
...
default_processor_19 = AuthSecurityEventsProcessor19()
