...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_18
...
@dataclass
class AuthSecurityEventsEntity18:
...
class AuthSecurityEventsSchema18(BaseModel):
...
class AuthSecurityEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityEventsProcessor18()
