...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_12
...
@dataclass
class AuthSecurityEventsEntity12:
...
class AuthSecurityEventsSchema12(BaseModel):
...
class AuthSecurityEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityEventsProcessor12()
