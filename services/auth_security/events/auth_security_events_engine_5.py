...
Submodule: EVENTS | Component ID: AUTH_SECURITY_EVENTS_5
...
@dataclass
class AuthSecurityEventsEntity5:
...
class AuthSecurityEventsSchema5(BaseModel):
...
class AuthSecurityEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityEventsProcessor5()
