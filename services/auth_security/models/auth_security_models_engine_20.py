...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_20
...
@dataclass
class AuthSecurityModelsEntity20:
...
class AuthSecurityModelsSchema20(BaseModel):
...
class AuthSecurityModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityModelsProcessor20()
