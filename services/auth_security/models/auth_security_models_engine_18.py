...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_18
...
@dataclass
class AuthSecurityModelsEntity18:
...
class AuthSecurityModelsSchema18(BaseModel):
...
class AuthSecurityModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityModelsProcessor18()
