...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_17
...
@dataclass
class AuthSecurityModelsEntity17:
...
class AuthSecurityModelsSchema17(BaseModel):
...
class AuthSecurityModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityModelsProcessor17()
