...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_12
...
@dataclass
class AuthSecurityModelsEntity12:
...
class AuthSecurityModelsSchema12(BaseModel):
...
class AuthSecurityModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityModelsProcessor12()
