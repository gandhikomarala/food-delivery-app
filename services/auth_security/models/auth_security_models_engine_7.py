...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_7
...
@dataclass
class AuthSecurityModelsEntity7:
...
class AuthSecurityModelsSchema7(BaseModel):
...
class AuthSecurityModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityModelsProcessor7()
