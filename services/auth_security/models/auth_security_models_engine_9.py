...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_9
...
@dataclass
class AuthSecurityModelsEntity9:
...
class AuthSecurityModelsSchema9(BaseModel):
...
class AuthSecurityModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityModelsProcessor9()
