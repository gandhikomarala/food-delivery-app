...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_4
...
@dataclass
class AuthSecurityModelsEntity4:
...
class AuthSecurityModelsSchema4(BaseModel):
...
class AuthSecurityModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityModelsProcessor4()
