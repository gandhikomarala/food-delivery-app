...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_13
...
@dataclass
class AuthSecurityModelsEntity13:
...
class AuthSecurityModelsSchema13(BaseModel):
...
class AuthSecurityModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityModelsProcessor13()
