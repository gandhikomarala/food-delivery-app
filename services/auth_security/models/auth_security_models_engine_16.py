...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_16
...
@dataclass
class AuthSecurityModelsEntity16:
...
class AuthSecurityModelsSchema16(BaseModel):
...
class AuthSecurityModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityModelsProcessor16()
