...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_5
...
@dataclass
class AuthSecurityModelsEntity5:
...
class AuthSecurityModelsSchema5(BaseModel):
...
class AuthSecurityModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityModelsProcessor5()
