...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_3
...
@dataclass
class AuthSecurityModelsEntity3:
...
class AuthSecurityModelsSchema3(BaseModel):
...
class AuthSecurityModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityModelsProcessor3()
