...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_10
...
@dataclass
class AuthSecurityModelsEntity10:
...
class AuthSecurityModelsSchema10(BaseModel):
...
class AuthSecurityModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityModelsProcessor10()
