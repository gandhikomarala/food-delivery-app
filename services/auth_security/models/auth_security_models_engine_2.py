...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_2
...
@dataclass
class AuthSecurityModelsEntity2:
...
class AuthSecurityModelsSchema2(BaseModel):
...
class AuthSecurityModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityModelsProcessor2()
