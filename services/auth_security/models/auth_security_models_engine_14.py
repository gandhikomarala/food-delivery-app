...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_14
...
@dataclass
class AuthSecurityModelsEntity14:
...
class AuthSecurityModelsSchema14(BaseModel):
...
class AuthSecurityModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityModelsProcessor14()
