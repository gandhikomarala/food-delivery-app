...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_11
...
@dataclass
class AuthSecurityModelsEntity11:
...
class AuthSecurityModelsSchema11(BaseModel):
...
class AuthSecurityModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityModelsProcessor11()
