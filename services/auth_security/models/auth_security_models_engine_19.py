...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_19
...
@dataclass
class AuthSecurityModelsEntity19:
...
class AuthSecurityModelsSchema19(BaseModel):
...
class AuthSecurityModelsProcessor19:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema19) -> Dict[str, Any]:
...
default_processor_19 = AuthSecurityModelsProcessor19()
