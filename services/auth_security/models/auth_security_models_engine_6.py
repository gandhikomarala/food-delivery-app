...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_6
...
@dataclass
class AuthSecurityModelsEntity6:
...
class AuthSecurityModelsSchema6(BaseModel):
...
class AuthSecurityModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityModelsProcessor6()
