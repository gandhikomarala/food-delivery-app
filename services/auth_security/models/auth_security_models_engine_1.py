...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_1
...
@dataclass
class AuthSecurityModelsEntity1:
...
class AuthSecurityModelsSchema1(BaseModel):
...
class AuthSecurityModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityModelsProcessor1()
