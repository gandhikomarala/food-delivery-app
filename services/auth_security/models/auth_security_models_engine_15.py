...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_15
...
@dataclass
class AuthSecurityModelsEntity15:
...
class AuthSecurityModelsSchema15(BaseModel):
...
class AuthSecurityModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityModelsProcessor15()
