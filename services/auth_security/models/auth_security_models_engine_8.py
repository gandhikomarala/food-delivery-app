...
Submodule: MODELS | Component ID: AUTH_SECURITY_MODELS_8
...
@dataclass
class AuthSecurityModelsEntity8:
...
class AuthSecurityModelsSchema8(BaseModel):
...
class AuthSecurityModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityModelsProcessor8()
