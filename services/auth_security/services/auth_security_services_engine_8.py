...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_8
...
@dataclass
class AuthSecurityServicesEntity8:
...
class AuthSecurityServicesSchema8(BaseModel):
...
class AuthSecurityServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityServicesProcessor8()
