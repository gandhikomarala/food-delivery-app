...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_14
...
@dataclass
class AuthSecurityServicesEntity14:
...
class AuthSecurityServicesSchema14(BaseModel):
...
class AuthSecurityServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityServicesProcessor14()
