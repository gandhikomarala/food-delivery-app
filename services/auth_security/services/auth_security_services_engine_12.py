...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_12
...
@dataclass
class AuthSecurityServicesEntity12:
...
class AuthSecurityServicesSchema12(BaseModel):
...
class AuthSecurityServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityServicesProcessor12()
