...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_13
...
@dataclass
class AuthSecurityServicesEntity13:
...
class AuthSecurityServicesSchema13(BaseModel):
...
class AuthSecurityServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityServicesProcessor13()
