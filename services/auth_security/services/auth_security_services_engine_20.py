...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_20
...
@dataclass
class AuthSecurityServicesEntity20:
...
class AuthSecurityServicesSchema20(BaseModel):
...
class AuthSecurityServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityServicesProcessor20()
