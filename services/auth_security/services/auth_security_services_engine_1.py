...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_1
...
@dataclass
class AuthSecurityServicesEntity1:
...
class AuthSecurityServicesSchema1(BaseModel):
...
class AuthSecurityServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityServicesProcessor1()
