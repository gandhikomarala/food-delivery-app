...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_2
...
@dataclass
class AuthSecurityServicesEntity2:
...
class AuthSecurityServicesSchema2(BaseModel):
...
class AuthSecurityServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityServicesProcessor2()
