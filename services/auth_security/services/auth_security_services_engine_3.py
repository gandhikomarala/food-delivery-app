...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_3
...
@dataclass
class AuthSecurityServicesEntity3:
...
class AuthSecurityServicesSchema3(BaseModel):
...
class AuthSecurityServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityServicesProcessor3()
