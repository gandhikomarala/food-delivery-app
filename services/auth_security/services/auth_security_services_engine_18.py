...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_18
...
@dataclass
class AuthSecurityServicesEntity18:
...
class AuthSecurityServicesSchema18(BaseModel):
...
class AuthSecurityServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityServicesProcessor18()
