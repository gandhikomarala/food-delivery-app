...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_5
...
@dataclass
class AuthSecurityServicesEntity5:
...
class AuthSecurityServicesSchema5(BaseModel):
...
class AuthSecurityServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityServicesProcessor5()
