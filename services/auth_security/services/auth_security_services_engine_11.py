...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_11
...
@dataclass
class AuthSecurityServicesEntity11:
...
class AuthSecurityServicesSchema11(BaseModel):
...
class AuthSecurityServicesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityServicesProcessor11()
