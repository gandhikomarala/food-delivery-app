...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_4
...
@dataclass
class AuthSecurityServicesEntity4:
...
class AuthSecurityServicesSchema4(BaseModel):
...
class AuthSecurityServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityServicesProcessor4()
