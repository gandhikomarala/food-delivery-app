...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_10
...
@dataclass
class AuthSecurityServicesEntity10:
...
class AuthSecurityServicesSchema10(BaseModel):
...
class AuthSecurityServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityServicesProcessor10()
