...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_9
...
@dataclass
class AuthSecurityServicesEntity9:
...
class AuthSecurityServicesSchema9(BaseModel):
...
class AuthSecurityServicesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityServicesProcessor9()
