...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_7
...
@dataclass
class AuthSecurityServicesEntity7:
...
class AuthSecurityServicesSchema7(BaseModel):
...
class AuthSecurityServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityServicesProcessor7()
