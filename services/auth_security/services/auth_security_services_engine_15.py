...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_15
...
@dataclass
class AuthSecurityServicesEntity15:
...
class AuthSecurityServicesSchema15(BaseModel):
...
class AuthSecurityServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityServicesProcessor15()
