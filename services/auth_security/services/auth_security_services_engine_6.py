...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_6
...
@dataclass
class AuthSecurityServicesEntity6:
...
class AuthSecurityServicesSchema6(BaseModel):
...
class AuthSecurityServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityServicesProcessor6()
