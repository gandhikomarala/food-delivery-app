...
Submodule: SERVICES | Component ID: AUTH_SECURITY_SERVICES_17
...
@dataclass
class AuthSecurityServicesEntity17:
...
class AuthSecurityServicesSchema17(BaseModel):
...
class AuthSecurityServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityServicesProcessor17()
