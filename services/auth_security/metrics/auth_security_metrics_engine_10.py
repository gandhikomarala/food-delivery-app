...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_10
...
@dataclass
class AuthSecurityMetricsEntity10:
...
class AuthSecurityMetricsSchema10(BaseModel):
...
class AuthSecurityMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityMetricsProcessor10()
