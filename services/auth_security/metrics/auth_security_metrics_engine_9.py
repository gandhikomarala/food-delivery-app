...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_9
...
@dataclass
class AuthSecurityMetricsEntity9:
...
class AuthSecurityMetricsSchema9(BaseModel):
...
class AuthSecurityMetricsProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityMetricsProcessor9()
