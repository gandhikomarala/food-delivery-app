...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_20
...
@dataclass
class AuthSecurityMetricsEntity20:
...
class AuthSecurityMetricsSchema20(BaseModel):
...
class AuthSecurityMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityMetricsProcessor20()
