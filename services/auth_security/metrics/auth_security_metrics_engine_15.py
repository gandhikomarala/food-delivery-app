...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_15
...
@dataclass
class AuthSecurityMetricsEntity15:
...
class AuthSecurityMetricsSchema15(BaseModel):
...
class AuthSecurityMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityMetricsProcessor15()
