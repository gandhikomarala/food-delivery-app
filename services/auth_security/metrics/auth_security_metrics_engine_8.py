...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_8
...
@dataclass
class AuthSecurityMetricsEntity8:
...
class AuthSecurityMetricsSchema8(BaseModel):
...
class AuthSecurityMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityMetricsProcessor8()
