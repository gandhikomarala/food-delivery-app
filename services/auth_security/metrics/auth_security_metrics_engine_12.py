...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_12
...
@dataclass
class AuthSecurityMetricsEntity12:
...
class AuthSecurityMetricsSchema12(BaseModel):
...
class AuthSecurityMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityMetricsProcessor12()
