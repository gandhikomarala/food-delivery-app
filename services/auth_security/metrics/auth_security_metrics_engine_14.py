...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_14
...
@dataclass
class AuthSecurityMetricsEntity14:
...
class AuthSecurityMetricsSchema14(BaseModel):
...
class AuthSecurityMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityMetricsProcessor14()
