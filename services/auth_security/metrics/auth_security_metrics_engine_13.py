...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_13
...
@dataclass
class AuthSecurityMetricsEntity13:
...
class AuthSecurityMetricsSchema13(BaseModel):
...
class AuthSecurityMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityMetricsProcessor13()
