...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_1
...
@dataclass
class AuthSecurityMetricsEntity1:
...
class AuthSecurityMetricsSchema1(BaseModel):
...
class AuthSecurityMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityMetricsProcessor1()
