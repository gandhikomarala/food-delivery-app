...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_2
...
@dataclass
class AuthSecurityMetricsEntity2:
...
class AuthSecurityMetricsSchema2(BaseModel):
...
class AuthSecurityMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityMetricsProcessor2()
