...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_16
...
@dataclass
class AuthSecurityMetricsEntity16:
...
class AuthSecurityMetricsSchema16(BaseModel):
...
class AuthSecurityMetricsProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityMetricsProcessor16()
