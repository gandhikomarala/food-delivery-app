...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_4
...
@dataclass
class AuthSecurityMetricsEntity4:
...
class AuthSecurityMetricsSchema4(BaseModel):
...
class AuthSecurityMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityMetricsProcessor4()
