...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_7
...
@dataclass
class AuthSecurityMetricsEntity7:
...
class AuthSecurityMetricsSchema7(BaseModel):
...
class AuthSecurityMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityMetricsProcessor7()
