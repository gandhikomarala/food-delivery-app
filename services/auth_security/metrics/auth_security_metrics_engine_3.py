...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_3
...
@dataclass
class AuthSecurityMetricsEntity3:
...
class AuthSecurityMetricsSchema3(BaseModel):
...
class AuthSecurityMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityMetricsProcessor3()
