...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_17
...
@dataclass
class AuthSecurityMetricsEntity17:
...
class AuthSecurityMetricsSchema17(BaseModel):
...
class AuthSecurityMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityMetricsProcessor17()
