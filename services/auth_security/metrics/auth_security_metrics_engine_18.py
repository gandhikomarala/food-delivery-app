...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_18
...
@dataclass
class AuthSecurityMetricsEntity18:
...
class AuthSecurityMetricsSchema18(BaseModel):
...
class AuthSecurityMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityMetricsProcessor18()
