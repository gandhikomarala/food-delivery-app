...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_5
...
@dataclass
class AuthSecurityMetricsEntity5:
...
class AuthSecurityMetricsSchema5(BaseModel):
...
class AuthSecurityMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityMetricsProcessor5()
