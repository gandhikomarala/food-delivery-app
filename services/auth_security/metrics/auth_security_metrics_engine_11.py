...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_11
...
@dataclass
class AuthSecurityMetricsEntity11:
...
class AuthSecurityMetricsSchema11(BaseModel):
...
class AuthSecurityMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityMetricsProcessor11()
