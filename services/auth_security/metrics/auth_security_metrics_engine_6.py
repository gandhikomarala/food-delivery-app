...
Submodule: METRICS | Component ID: AUTH_SECURITY_METRICS_6
...
@dataclass
class AuthSecurityMetricsEntity6:
...
class AuthSecurityMetricsSchema6(BaseModel):
...
class AuthSecurityMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityMetricsProcessor6()
