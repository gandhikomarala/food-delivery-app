...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_4
...
@dataclass
class AuthSecurityEnginesEntity4:
...
class AuthSecurityEnginesSchema4(BaseModel):
...
class AuthSecurityEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityEnginesProcessor4()
