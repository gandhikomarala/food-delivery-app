...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_13
...
@dataclass
class AuthSecurityEnginesEntity13:
...
class AuthSecurityEnginesSchema13(BaseModel):
...
class AuthSecurityEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityEnginesProcessor13()
