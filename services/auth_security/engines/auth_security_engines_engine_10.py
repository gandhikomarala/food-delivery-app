...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_10
...
@dataclass
class AuthSecurityEnginesEntity10:
...
class AuthSecurityEnginesSchema10(BaseModel):
...
class AuthSecurityEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityEnginesProcessor10()
