...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_19
...
@dataclass
class AuthSecurityEnginesEntity19:
...
class AuthSecurityEnginesSchema19(BaseModel):
...
class AuthSecurityEnginesProcessor19:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema19) -> Dict[str, Any]:
...
default_processor_19 = AuthSecurityEnginesProcessor19()
