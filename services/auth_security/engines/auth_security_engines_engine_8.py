...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_8
...
@dataclass
class AuthSecurityEnginesEntity8:
...
class AuthSecurityEnginesSchema8(BaseModel):
...
class AuthSecurityEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityEnginesProcessor8()
