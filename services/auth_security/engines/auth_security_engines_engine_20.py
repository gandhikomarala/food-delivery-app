...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_20
...
@dataclass
class AuthSecurityEnginesEntity20:
...
class AuthSecurityEnginesSchema20(BaseModel):
...
class AuthSecurityEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityEnginesProcessor20()
