...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_7
...
@dataclass
class AuthSecurityEnginesEntity7:
...
class AuthSecurityEnginesSchema7(BaseModel):
...
class AuthSecurityEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityEnginesProcessor7()
