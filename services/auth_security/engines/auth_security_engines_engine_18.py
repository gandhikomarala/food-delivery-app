...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_18
...
@dataclass
class AuthSecurityEnginesEntity18:
...
class AuthSecurityEnginesSchema18(BaseModel):
...
class AuthSecurityEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityEnginesProcessor18()
