...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_17
...
@dataclass
class AuthSecurityEnginesEntity17:
...
class AuthSecurityEnginesSchema17(BaseModel):
...
class AuthSecurityEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityEnginesProcessor17()
