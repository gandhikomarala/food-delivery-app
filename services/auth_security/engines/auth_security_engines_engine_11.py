...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_11
...
@dataclass
class AuthSecurityEnginesEntity11:
...
class AuthSecurityEnginesSchema11(BaseModel):
...
class AuthSecurityEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityEnginesProcessor11()
