...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_5
...
@dataclass
class AuthSecurityEnginesEntity5:
...
class AuthSecurityEnginesSchema5(BaseModel):
...
class AuthSecurityEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityEnginesProcessor5()
