...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_6
...
@dataclass
class AuthSecurityEnginesEntity6:
...
class AuthSecurityEnginesSchema6(BaseModel):
...
class AuthSecurityEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityEnginesProcessor6()
