...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_2
...
@dataclass
class AuthSecurityEnginesEntity2:
...
class AuthSecurityEnginesSchema2(BaseModel):
...
class AuthSecurityEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityEnginesProcessor2()
