...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_3
...
@dataclass
class AuthSecurityEnginesEntity3:
...
class AuthSecurityEnginesSchema3(BaseModel):
...
class AuthSecurityEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityEnginesProcessor3()
