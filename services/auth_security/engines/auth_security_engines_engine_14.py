...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_14
...
@dataclass
class AuthSecurityEnginesEntity14:
...
class AuthSecurityEnginesSchema14(BaseModel):
...
class AuthSecurityEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityEnginesProcessor14()
