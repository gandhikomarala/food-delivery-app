...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_1
...
@dataclass
class AuthSecurityEnginesEntity1:
...
class AuthSecurityEnginesSchema1(BaseModel):
...
class AuthSecurityEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityEnginesProcessor1()
