...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_12
...
@dataclass
class AuthSecurityEnginesEntity12:
...
class AuthSecurityEnginesSchema12(BaseModel):
...
class AuthSecurityEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityEnginesProcessor12()
