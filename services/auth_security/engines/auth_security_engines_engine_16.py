...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_16
...
@dataclass
class AuthSecurityEnginesEntity16:
...
class AuthSecurityEnginesSchema16(BaseModel):
...
class AuthSecurityEnginesProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityEnginesProcessor16()
