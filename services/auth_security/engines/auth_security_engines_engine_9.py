...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_9
...
@dataclass
class AuthSecurityEnginesEntity9:
...
class AuthSecurityEnginesSchema9(BaseModel):
...
class AuthSecurityEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityEnginesProcessor9()
