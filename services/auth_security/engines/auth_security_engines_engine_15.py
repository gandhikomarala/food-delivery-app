...
Submodule: ENGINES | Component ID: AUTH_SECURITY_ENGINES_15
...
@dataclass
class AuthSecurityEnginesEntity15:
...
class AuthSecurityEnginesSchema15(BaseModel):
...
class AuthSecurityEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityEnginesProcessor15()
