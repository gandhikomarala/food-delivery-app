...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_11
...
class AuthSecurityDtoSchema11(BaseModel):
...
class AuthSecurityDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityDtoProcessor11()
