...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_14
...
class AuthSecurityDtoSchema14(BaseModel):
...
class AuthSecurityDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityDtoProcessor14()
