...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_12
...
class AuthSecurityDtoSchema12(BaseModel):
...
class AuthSecurityDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityDtoProcessor12()
