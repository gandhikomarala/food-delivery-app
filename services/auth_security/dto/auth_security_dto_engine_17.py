...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_17
...
class AuthSecurityDtoSchema17(BaseModel):
...
class AuthSecurityDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityDtoProcessor17()
