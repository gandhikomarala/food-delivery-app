...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_1
...
class AuthSecurityDtoSchema1(BaseModel):
...
class AuthSecurityDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityDtoProcessor1()
