...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_6
...
class AuthSecurityDtoSchema6(BaseModel):
...
class AuthSecurityDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityDtoProcessor6()
