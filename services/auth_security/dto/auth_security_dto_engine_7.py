...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_7
...
class AuthSecurityDtoSchema7(BaseModel):
...
class AuthSecurityDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityDtoProcessor7()
