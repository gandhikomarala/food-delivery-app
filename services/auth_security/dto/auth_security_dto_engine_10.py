...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_10
...
class AuthSecurityDtoSchema10(BaseModel):
...
class AuthSecurityDtoProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityDtoProcessor10()
