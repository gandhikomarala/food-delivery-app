...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_2
...
class AuthSecurityDtoSchema2(BaseModel):
...
class AuthSecurityDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityDtoProcessor2()
