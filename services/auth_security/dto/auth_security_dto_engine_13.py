...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_13
...
class AuthSecurityDtoSchema13(BaseModel):
...
class AuthSecurityDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityDtoProcessor13()
