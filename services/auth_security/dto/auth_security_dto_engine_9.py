...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_9
...
class AuthSecurityDtoSchema9(BaseModel):
...
class AuthSecurityDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityDtoProcessor9()
