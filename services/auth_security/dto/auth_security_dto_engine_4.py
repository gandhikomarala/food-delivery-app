...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_4
...
class AuthSecurityDtoSchema4(BaseModel):
...
class AuthSecurityDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityDtoProcessor4()
