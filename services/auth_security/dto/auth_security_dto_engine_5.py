...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_5
...
class AuthSecurityDtoSchema5(BaseModel):
...
class AuthSecurityDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityDtoProcessor5()
