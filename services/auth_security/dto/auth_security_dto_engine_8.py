...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_8
...
class AuthSecurityDtoSchema8(BaseModel):
...
class AuthSecurityDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityDtoProcessor8()
