...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_20
...
class AuthSecurityDtoSchema20(BaseModel):
...
class AuthSecurityDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityDtoProcessor20()
