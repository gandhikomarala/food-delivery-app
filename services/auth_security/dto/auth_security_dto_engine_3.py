...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_3
...
class AuthSecurityDtoSchema3(BaseModel):
...
class AuthSecurityDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityDtoProcessor3()
