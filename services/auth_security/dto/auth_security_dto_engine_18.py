...
Submodule: DTO | Component ID: AUTH_SECURITY_DTO_18
...
class AuthSecurityDtoSchema18(BaseModel):
...
class AuthSecurityDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityDtoProcessor18()
