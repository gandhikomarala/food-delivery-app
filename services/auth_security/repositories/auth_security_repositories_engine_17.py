...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_17
...
@dataclass
class AuthSecurityRepositoriesEntity17:
...
class AuthSecurityRepositoriesSchema17(BaseModel):
...
class AuthSecurityRepositoriesProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityRepositoriesProcessor17()
