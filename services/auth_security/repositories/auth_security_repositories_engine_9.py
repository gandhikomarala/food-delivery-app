...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_9
...
@dataclass
class AuthSecurityRepositoriesEntity9:
...
class AuthSecurityRepositoriesSchema9(BaseModel):
...
class AuthSecurityRepositoriesProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityRepositoriesProcessor9()
