...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_7
...
@dataclass
class AuthSecurityRepositoriesEntity7:
...
class AuthSecurityRepositoriesSchema7(BaseModel):
...
class AuthSecurityRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityRepositoriesProcessor7()
