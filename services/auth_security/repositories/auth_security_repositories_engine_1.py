...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_1
...
@dataclass
class AuthSecurityRepositoriesEntity1:
...
class AuthSecurityRepositoriesSchema1(BaseModel):
...
class AuthSecurityRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityRepositoriesProcessor1()
