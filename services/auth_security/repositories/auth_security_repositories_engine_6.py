...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_6
...
@dataclass
class AuthSecurityRepositoriesEntity6:
...
class AuthSecurityRepositoriesSchema6(BaseModel):
...
class AuthSecurityRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityRepositoriesProcessor6()
