...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_11
...
@dataclass
class AuthSecurityRepositoriesEntity11:
...
class AuthSecurityRepositoriesSchema11(BaseModel):
...
class AuthSecurityRepositoriesProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityRepositoriesProcessor11()
