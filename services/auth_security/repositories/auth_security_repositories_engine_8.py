...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_8
...
@dataclass
class AuthSecurityRepositoriesEntity8:
...
class AuthSecurityRepositoriesSchema8(BaseModel):
...
class AuthSecurityRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityRepositoriesProcessor8()
