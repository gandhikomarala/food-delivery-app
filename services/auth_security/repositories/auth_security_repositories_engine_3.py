...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_3
...
@dataclass
class AuthSecurityRepositoriesEntity3:
...
class AuthSecurityRepositoriesSchema3(BaseModel):
...
class AuthSecurityRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityRepositoriesProcessor3()
