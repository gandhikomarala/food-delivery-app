...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_2
...
@dataclass
class AuthSecurityRepositoriesEntity2:
...
class AuthSecurityRepositoriesSchema2(BaseModel):
...
class AuthSecurityRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityRepositoriesProcessor2()
