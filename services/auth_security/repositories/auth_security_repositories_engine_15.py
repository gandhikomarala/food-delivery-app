...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_15
...
@dataclass
class AuthSecurityRepositoriesEntity15:
...
class AuthSecurityRepositoriesSchema15(BaseModel):
...
class AuthSecurityRepositoriesProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityRepositoriesProcessor15()
