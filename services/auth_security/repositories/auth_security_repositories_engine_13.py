...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_13
...
@dataclass
class AuthSecurityRepositoriesEntity13:
...
class AuthSecurityRepositoriesSchema13(BaseModel):
...
class AuthSecurityRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityRepositoriesProcessor13()
