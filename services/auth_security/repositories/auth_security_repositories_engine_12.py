...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_12
...
@dataclass
class AuthSecurityRepositoriesEntity12:
...
class AuthSecurityRepositoriesSchema12(BaseModel):
...
class AuthSecurityRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityRepositoriesProcessor12()
