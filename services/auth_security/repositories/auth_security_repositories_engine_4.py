...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_4
...
@dataclass
class AuthSecurityRepositoriesEntity4:
...
class AuthSecurityRepositoriesSchema4(BaseModel):
...
class AuthSecurityRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityRepositoriesProcessor4()
