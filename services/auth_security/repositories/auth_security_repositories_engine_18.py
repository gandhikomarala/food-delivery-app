...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_18
...
@dataclass
class AuthSecurityRepositoriesEntity18:
...
class AuthSecurityRepositoriesSchema18(BaseModel):
...
class AuthSecurityRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityRepositoriesProcessor18()
