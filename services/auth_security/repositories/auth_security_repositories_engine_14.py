...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_14
...
@dataclass
class AuthSecurityRepositoriesEntity14:
...
class AuthSecurityRepositoriesSchema14(BaseModel):
...
class AuthSecurityRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityRepositoriesProcessor14()
