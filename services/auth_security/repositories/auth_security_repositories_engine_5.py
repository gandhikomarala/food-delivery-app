...
Submodule: REPOSITORIES | Component ID: AUTH_SECURITY_REPOSITORIES_5
...
@dataclass
class AuthSecurityRepositoriesEntity5:
...
class AuthSecurityRepositoriesSchema5(BaseModel):
...
class AuthSecurityRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityRepositoriesProcessor5()
