...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_19
...
@dataclass
class AuthSecurityControllersEntity19:
...
class AuthSecurityControllersSchema19(BaseModel):
...
class AuthSecurityControllersProcessor19:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema19) -> Dict[str, Any]:
...
default_processor_19 = AuthSecurityControllersProcessor19()
