...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_13
...
@dataclass
class AuthSecurityControllersEntity13:
...
class AuthSecurityControllersSchema13(BaseModel):
...
class AuthSecurityControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = AuthSecurityControllersProcessor13()
