...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_11
...
@dataclass
class AuthSecurityControllersEntity11:
...
class AuthSecurityControllersSchema11(BaseModel):
...
class AuthSecurityControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = AuthSecurityControllersProcessor11()
