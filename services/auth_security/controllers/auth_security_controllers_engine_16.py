...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_16
...
@dataclass
class AuthSecurityControllersEntity16:
...
class AuthSecurityControllersSchema16(BaseModel):
...
class AuthSecurityControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = AuthSecurityControllersProcessor16()
