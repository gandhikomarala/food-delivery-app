...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_3
...
@dataclass
class AuthSecurityControllersEntity3:
...
class AuthSecurityControllersSchema3(BaseModel):
...
class AuthSecurityControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = AuthSecurityControllersProcessor3()
