...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_5
...
@dataclass
class AuthSecurityControllersEntity5:
...
class AuthSecurityControllersSchema5(BaseModel):
...
class AuthSecurityControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = AuthSecurityControllersProcessor5()
