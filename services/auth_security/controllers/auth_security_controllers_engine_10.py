...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_10
...
@dataclass
class AuthSecurityControllersEntity10:
...
class AuthSecurityControllersSchema10(BaseModel):
...
class AuthSecurityControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = AuthSecurityControllersProcessor10()
