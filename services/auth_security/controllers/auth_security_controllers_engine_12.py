...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_12
...
@dataclass
class AuthSecurityControllersEntity12:
...
class AuthSecurityControllersSchema12(BaseModel):
...
class AuthSecurityControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = AuthSecurityControllersProcessor12()
