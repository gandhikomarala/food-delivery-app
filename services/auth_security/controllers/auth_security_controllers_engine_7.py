...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_7
...
@dataclass
class AuthSecurityControllersEntity7:
...
class AuthSecurityControllersSchema7(BaseModel):
...
class AuthSecurityControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = AuthSecurityControllersProcessor7()
