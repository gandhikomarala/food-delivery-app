...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_4
...
@dataclass
class AuthSecurityControllersEntity4:
...
class AuthSecurityControllersSchema4(BaseModel):
...
class AuthSecurityControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = AuthSecurityControllersProcessor4()
