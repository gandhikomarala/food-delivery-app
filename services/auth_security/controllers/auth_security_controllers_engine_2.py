...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_2
...
@dataclass
class AuthSecurityControllersEntity2:
...
class AuthSecurityControllersSchema2(BaseModel):
...
class AuthSecurityControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = AuthSecurityControllersProcessor2()
