...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_17
...
@dataclass
class AuthSecurityControllersEntity17:
...
class AuthSecurityControllersSchema17(BaseModel):
...
class AuthSecurityControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = AuthSecurityControllersProcessor17()
