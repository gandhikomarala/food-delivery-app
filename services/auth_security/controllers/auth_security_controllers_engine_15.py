...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_15
...
@dataclass
class AuthSecurityControllersEntity15:
...
class AuthSecurityControllersSchema15(BaseModel):
...
class AuthSecurityControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = AuthSecurityControllersProcessor15()
