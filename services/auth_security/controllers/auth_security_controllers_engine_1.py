...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_1
...
@dataclass
class AuthSecurityControllersEntity1:
...
class AuthSecurityControllersSchema1(BaseModel):
...
class AuthSecurityControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = AuthSecurityControllersProcessor1()
