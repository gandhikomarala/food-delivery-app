...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_20
...
@dataclass
class AuthSecurityControllersEntity20:
...
class AuthSecurityControllersSchema20(BaseModel):
...
class AuthSecurityControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = AuthSecurityControllersProcessor20()
