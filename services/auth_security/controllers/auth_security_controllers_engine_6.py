...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_6
...
@dataclass
class AuthSecurityControllersEntity6:
...
class AuthSecurityControllersSchema6(BaseModel):
...
class AuthSecurityControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = AuthSecurityControllersProcessor6()
