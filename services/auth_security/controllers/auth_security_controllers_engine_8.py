...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_8
...
@dataclass
class AuthSecurityControllersEntity8:
...
class AuthSecurityControllersSchema8(BaseModel):
...
class AuthSecurityControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = AuthSecurityControllersProcessor8()
