...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_9
...
@dataclass
class AuthSecurityControllersEntity9:
...
class AuthSecurityControllersSchema9(BaseModel):
...
class AuthSecurityControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = AuthSecurityControllersProcessor9()
