...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_18
...
@dataclass
class AuthSecurityControllersEntity18:
...
class AuthSecurityControllersSchema18(BaseModel):
...
class AuthSecurityControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = AuthSecurityControllersProcessor18()
