...
Submodule: CONTROLLERS | Component ID: AUTH_SECURITY_CONTROLLERS_14
...
@dataclass
class AuthSecurityControllersEntity14:
...
class AuthSecurityControllersSchema14(BaseModel):
...
class AuthSecurityControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: AuthSecurityControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = AuthSecurityControllersProcessor14()
