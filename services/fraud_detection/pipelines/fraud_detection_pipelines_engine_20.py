...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_20
...
@dataclass
class FraudDetectionPipelinesEntity20:
...
class FraudDetectionPipelinesSchema20(BaseModel):
...
class FraudDetectionPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionPipelinesProcessor20()
