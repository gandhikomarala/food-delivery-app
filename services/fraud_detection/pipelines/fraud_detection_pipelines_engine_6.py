...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_6
...
@dataclass
class FraudDetectionPipelinesEntity6:
...
class FraudDetectionPipelinesSchema6(BaseModel):
...
class FraudDetectionPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionPipelinesProcessor6()
