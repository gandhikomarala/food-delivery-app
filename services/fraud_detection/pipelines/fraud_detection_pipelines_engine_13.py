...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_13
...
@dataclass
class FraudDetectionPipelinesEntity13:
...
class FraudDetectionPipelinesSchema13(BaseModel):
...
class FraudDetectionPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionPipelinesProcessor13()
