...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_1
...
@dataclass
class FraudDetectionPipelinesEntity1:
...
class FraudDetectionPipelinesSchema1(BaseModel):
...
class FraudDetectionPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionPipelinesProcessor1()
