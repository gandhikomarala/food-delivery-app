...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_14
...
@dataclass
class FraudDetectionPipelinesEntity14:
...
class FraudDetectionPipelinesSchema14(BaseModel):
...
class FraudDetectionPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionPipelinesProcessor14()
