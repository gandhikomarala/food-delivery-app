...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_3
...
@dataclass
class FraudDetectionPipelinesEntity3:
...
class FraudDetectionPipelinesSchema3(BaseModel):
...
class FraudDetectionPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionPipelinesProcessor3()
