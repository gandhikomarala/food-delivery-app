...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_18
...
@dataclass
class FraudDetectionPipelinesEntity18:
...
class FraudDetectionPipelinesSchema18(BaseModel):
...
class FraudDetectionPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionPipelinesProcessor18()
