...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_15
...
@dataclass
class FraudDetectionPipelinesEntity15:
...
class FraudDetectionPipelinesSchema15(BaseModel):
...
class FraudDetectionPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionPipelinesProcessor15()
