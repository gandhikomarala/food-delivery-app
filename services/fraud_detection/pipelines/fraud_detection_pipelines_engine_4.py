...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_4
...
@dataclass
class FraudDetectionPipelinesEntity4:
...
class FraudDetectionPipelinesSchema4(BaseModel):
...
class FraudDetectionPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionPipelinesProcessor4()
