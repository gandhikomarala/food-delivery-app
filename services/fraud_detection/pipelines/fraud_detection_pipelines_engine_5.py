...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_5
...
@dataclass
class FraudDetectionPipelinesEntity5:
...
class FraudDetectionPipelinesSchema5(BaseModel):
...
class FraudDetectionPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionPipelinesProcessor5()
