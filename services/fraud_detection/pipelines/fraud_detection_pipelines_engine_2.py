...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_2
...
@dataclass
class FraudDetectionPipelinesEntity2:
...
class FraudDetectionPipelinesSchema2(BaseModel):
...
class FraudDetectionPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionPipelinesProcessor2()
