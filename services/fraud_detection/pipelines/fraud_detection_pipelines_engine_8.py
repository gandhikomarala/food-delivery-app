...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_8
...
@dataclass
class FraudDetectionPipelinesEntity8:
...
class FraudDetectionPipelinesSchema8(BaseModel):
...
class FraudDetectionPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionPipelinesProcessor8()
