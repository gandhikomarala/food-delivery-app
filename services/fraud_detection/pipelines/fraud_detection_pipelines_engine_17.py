...
Submodule: PIPELINES | Component ID: FRAUD_DETECTION_PIPELINES_17
...
@dataclass
class FraudDetectionPipelinesEntity17:
...
class FraudDetectionPipelinesSchema17(BaseModel):
...
class FraudDetectionPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionPipelinesProcessor17()
