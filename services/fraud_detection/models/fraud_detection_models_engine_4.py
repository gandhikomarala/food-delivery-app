...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_4
...
@dataclass
class FraudDetectionModelsEntity4:
...
class FraudDetectionModelsSchema4(BaseModel):
...
class FraudDetectionModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionModelsProcessor4()
