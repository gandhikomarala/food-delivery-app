...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_2
...
@dataclass
class FraudDetectionModelsEntity2:
...
class FraudDetectionModelsSchema2(BaseModel):
...
class FraudDetectionModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionModelsProcessor2()
