...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_8
...
@dataclass
class FraudDetectionModelsEntity8:
...
class FraudDetectionModelsSchema8(BaseModel):
...
class FraudDetectionModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionModelsProcessor8()
