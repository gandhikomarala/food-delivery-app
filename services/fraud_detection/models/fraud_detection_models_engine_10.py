...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_10
...
@dataclass
class FraudDetectionModelsEntity10:
...
class FraudDetectionModelsSchema10(BaseModel):
...
class FraudDetectionModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FraudDetectionModelsProcessor10()
