...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_13
...
@dataclass
class FraudDetectionModelsEntity13:
...
class FraudDetectionModelsSchema13(BaseModel):
...
class FraudDetectionModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionModelsProcessor13()
