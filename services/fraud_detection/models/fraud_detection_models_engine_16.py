...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_16
...
@dataclass
class FraudDetectionModelsEntity16:
...
class FraudDetectionModelsSchema16(BaseModel):
...
class FraudDetectionModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FraudDetectionModelsProcessor16()
