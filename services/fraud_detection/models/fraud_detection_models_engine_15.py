...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_15
...
@dataclass
class FraudDetectionModelsEntity15:
...
class FraudDetectionModelsSchema15(BaseModel):
...
class FraudDetectionModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionModelsProcessor15()
