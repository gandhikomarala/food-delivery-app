...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_11
...
@dataclass
class FraudDetectionModelsEntity11:
...
class FraudDetectionModelsSchema11(BaseModel):
...
class FraudDetectionModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FraudDetectionModelsProcessor11()
