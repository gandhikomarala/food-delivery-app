...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_17
...
@dataclass
class FraudDetectionModelsEntity17:
...
class FraudDetectionModelsSchema17(BaseModel):
...
class FraudDetectionModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionModelsProcessor17()
