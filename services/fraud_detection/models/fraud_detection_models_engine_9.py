...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_9
...
@dataclass
class FraudDetectionModelsEntity9:
...
class FraudDetectionModelsSchema9(BaseModel):
...
class FraudDetectionModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FraudDetectionModelsProcessor9()
