...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_14
...
@dataclass
class FraudDetectionModelsEntity14:
...
class FraudDetectionModelsSchema14(BaseModel):
...
class FraudDetectionModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionModelsProcessor14()
