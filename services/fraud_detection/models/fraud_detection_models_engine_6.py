...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_6
...
@dataclass
class FraudDetectionModelsEntity6:
...
class FraudDetectionModelsSchema6(BaseModel):
...
class FraudDetectionModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionModelsProcessor6()
