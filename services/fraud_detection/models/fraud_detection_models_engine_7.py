...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_7
...
@dataclass
class FraudDetectionModelsEntity7:
...
class FraudDetectionModelsSchema7(BaseModel):
...
class FraudDetectionModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FraudDetectionModelsProcessor7()
