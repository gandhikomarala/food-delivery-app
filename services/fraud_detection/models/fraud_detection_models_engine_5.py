...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_5
...
@dataclass
class FraudDetectionModelsEntity5:
...
class FraudDetectionModelsSchema5(BaseModel):
...
class FraudDetectionModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionModelsProcessor5()
