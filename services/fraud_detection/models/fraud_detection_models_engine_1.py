...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_1
...
@dataclass
class FraudDetectionModelsEntity1:
...
class FraudDetectionModelsSchema1(BaseModel):
...
class FraudDetectionModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionModelsProcessor1()
