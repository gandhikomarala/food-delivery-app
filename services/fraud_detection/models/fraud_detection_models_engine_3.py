...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_3
...
@dataclass
class FraudDetectionModelsEntity3:
...
class FraudDetectionModelsSchema3(BaseModel):
...
class FraudDetectionModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionModelsProcessor3()
