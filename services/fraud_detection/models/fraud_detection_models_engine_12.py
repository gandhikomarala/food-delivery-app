...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_12
...
@dataclass
class FraudDetectionModelsEntity12:
...
class FraudDetectionModelsSchema12(BaseModel):
...
class FraudDetectionModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionModelsProcessor12()
