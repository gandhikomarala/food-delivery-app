...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_18
...
@dataclass
class FraudDetectionModelsEntity18:
...
class FraudDetectionModelsSchema18(BaseModel):
...
class FraudDetectionModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionModelsProcessor18()
