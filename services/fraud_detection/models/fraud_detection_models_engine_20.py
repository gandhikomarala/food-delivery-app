...
Submodule: MODELS | Component ID: FRAUD_DETECTION_MODELS_20
...
@dataclass
class FraudDetectionModelsEntity20:
...
class FraudDetectionModelsSchema20(BaseModel):
...
class FraudDetectionModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionModelsProcessor20()
