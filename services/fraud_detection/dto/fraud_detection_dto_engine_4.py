...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_4
...
@dataclass
class FraudDetectionDtoEntity4:
...
class FraudDetectionDtoSchema4(BaseModel):
...
class FraudDetectionDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionDtoProcessor4()
