...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_13
...
@dataclass
class FraudDetectionDtoEntity13:
...
class FraudDetectionDtoSchema13(BaseModel):
...
class FraudDetectionDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionDtoProcessor13()
