...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_3
...
@dataclass
class FraudDetectionDtoEntity3:
...
class FraudDetectionDtoSchema3(BaseModel):
...
class FraudDetectionDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionDtoProcessor3()
