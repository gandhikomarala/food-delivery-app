...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_2
...
@dataclass
class FraudDetectionDtoEntity2:
...
class FraudDetectionDtoSchema2(BaseModel):
...
class FraudDetectionDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionDtoProcessor2()
