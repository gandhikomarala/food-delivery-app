...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_12
...
@dataclass
class FraudDetectionDtoEntity12:
...
class FraudDetectionDtoSchema12(BaseModel):
...
class FraudDetectionDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionDtoProcessor12()
