...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_18
...
@dataclass
class FraudDetectionDtoEntity18:
...
class FraudDetectionDtoSchema18(BaseModel):
...
class FraudDetectionDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionDtoProcessor18()
