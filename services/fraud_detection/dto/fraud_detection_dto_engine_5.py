...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_5
...
@dataclass
class FraudDetectionDtoEntity5:
...
class FraudDetectionDtoSchema5(BaseModel):
...
class FraudDetectionDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionDtoProcessor5()
