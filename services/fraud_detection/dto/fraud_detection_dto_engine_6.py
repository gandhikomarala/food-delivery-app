...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_6
...
@dataclass
class FraudDetectionDtoEntity6:
...
class FraudDetectionDtoSchema6(BaseModel):
...
class FraudDetectionDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionDtoProcessor6()
