...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_17
...
@dataclass
class FraudDetectionDtoEntity17:
...
class FraudDetectionDtoSchema17(BaseModel):
...
class FraudDetectionDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionDtoProcessor17()
