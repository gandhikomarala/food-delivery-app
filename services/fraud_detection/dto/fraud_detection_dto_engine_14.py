...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_14
...
@dataclass
class FraudDetectionDtoEntity14:
...
class FraudDetectionDtoSchema14(BaseModel):
...
class FraudDetectionDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionDtoProcessor14()
