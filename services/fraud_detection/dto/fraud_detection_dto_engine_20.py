...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_20
...
@dataclass
class FraudDetectionDtoEntity20:
...
class FraudDetectionDtoSchema20(BaseModel):
...
class FraudDetectionDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionDtoProcessor20()
