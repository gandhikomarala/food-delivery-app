...
Submodule: DTO | Component ID: FRAUD_DETECTION_DTO_1
...
@dataclass
class FraudDetectionDtoEntity1:
...
class FraudDetectionDtoSchema1(BaseModel):
...
class FraudDetectionDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionDtoProcessor1()
