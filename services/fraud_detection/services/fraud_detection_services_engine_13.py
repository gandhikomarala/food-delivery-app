...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_13
...
@dataclass
class FraudDetectionServicesEntity13:
...
class FraudDetectionServicesSchema13(BaseModel):
...
class FraudDetectionServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionServicesProcessor13()
