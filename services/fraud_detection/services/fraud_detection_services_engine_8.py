...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_8
...
@dataclass
class FraudDetectionServicesEntity8:
...
class FraudDetectionServicesSchema8(BaseModel):
...
class FraudDetectionServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionServicesProcessor8()
