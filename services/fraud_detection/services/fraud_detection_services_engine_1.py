...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_1
...
@dataclass
class FraudDetectionServicesEntity1:
...
class FraudDetectionServicesSchema1(BaseModel):
...
class FraudDetectionServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionServicesProcessor1()
