...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_15
...
@dataclass
class FraudDetectionServicesEntity15:
...
class FraudDetectionServicesSchema15(BaseModel):
...
class FraudDetectionServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionServicesProcessor15()
