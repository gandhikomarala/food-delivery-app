...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_20
...
@dataclass
class FraudDetectionServicesEntity20:
...
class FraudDetectionServicesSchema20(BaseModel):
...
class FraudDetectionServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionServicesProcessor20()
