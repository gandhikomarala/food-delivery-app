...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_14
...
@dataclass
class FraudDetectionServicesEntity14:
...
class FraudDetectionServicesSchema14(BaseModel):
...
class FraudDetectionServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionServicesProcessor14()
