...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_6
...
@dataclass
class FraudDetectionServicesEntity6:
...
class FraudDetectionServicesSchema6(BaseModel):
...
class FraudDetectionServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionServicesProcessor6()
