...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_18
...
@dataclass
class FraudDetectionServicesEntity18:
...
class FraudDetectionServicesSchema18(BaseModel):
...
class FraudDetectionServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionServicesProcessor18()
