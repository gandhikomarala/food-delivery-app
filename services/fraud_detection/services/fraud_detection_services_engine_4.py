...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_4
...
@dataclass
class FraudDetectionServicesEntity4:
...
class FraudDetectionServicesSchema4(BaseModel):
...
class FraudDetectionServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionServicesProcessor4()
