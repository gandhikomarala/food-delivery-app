...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_2
...
@dataclass
class FraudDetectionServicesEntity2:
...
class FraudDetectionServicesSchema2(BaseModel):
...
class FraudDetectionServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionServicesProcessor2()
