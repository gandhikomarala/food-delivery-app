...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_3
...
@dataclass
class FraudDetectionServicesEntity3:
...
class FraudDetectionServicesSchema3(BaseModel):
...
class FraudDetectionServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionServicesProcessor3()
