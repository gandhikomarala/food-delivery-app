...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_5
...
@dataclass
class FraudDetectionServicesEntity5:
...
class FraudDetectionServicesSchema5(BaseModel):
...
class FraudDetectionServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionServicesProcessor5()
