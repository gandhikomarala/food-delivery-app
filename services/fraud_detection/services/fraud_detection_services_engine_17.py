...
Submodule: SERVICES | Component ID: FRAUD_DETECTION_SERVICES_17
...
@dataclass
class FraudDetectionServicesEntity17:
...
class FraudDetectionServicesSchema17(BaseModel):
...
class FraudDetectionServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionServicesProcessor17()
