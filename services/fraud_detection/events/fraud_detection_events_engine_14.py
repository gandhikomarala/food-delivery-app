...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_14
...
@dataclass
class FraudDetectionEventsEntity14:
...
class FraudDetectionEventsSchema14(BaseModel):
...
class FraudDetectionEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionEventsProcessor14()
