...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_1
...
@dataclass
class FraudDetectionEventsEntity1:
...
class FraudDetectionEventsSchema1(BaseModel):
...
class FraudDetectionEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionEventsProcessor1()
