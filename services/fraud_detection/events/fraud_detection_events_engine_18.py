...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_18
...
@dataclass
class FraudDetectionEventsEntity18:
...
class FraudDetectionEventsSchema18(BaseModel):
...
class FraudDetectionEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionEventsProcessor18()
