...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_2
...
@dataclass
class FraudDetectionEventsEntity2:
...
class FraudDetectionEventsSchema2(BaseModel):
...
class FraudDetectionEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionEventsProcessor2()
