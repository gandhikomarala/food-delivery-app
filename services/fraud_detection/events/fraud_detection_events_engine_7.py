...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_7
...
@dataclass
class FraudDetectionEventsEntity7:
...
class FraudDetectionEventsSchema7(BaseModel):
...
class FraudDetectionEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FraudDetectionEventsProcessor7()
