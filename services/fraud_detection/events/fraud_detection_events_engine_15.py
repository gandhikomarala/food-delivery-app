...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_15
...
@dataclass
class FraudDetectionEventsEntity15:
...
class FraudDetectionEventsSchema15(BaseModel):
...
class FraudDetectionEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionEventsProcessor15()
