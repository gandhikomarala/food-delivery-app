...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_4
...
@dataclass
class FraudDetectionEventsEntity4:
...
class FraudDetectionEventsSchema4(BaseModel):
...
class FraudDetectionEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionEventsProcessor4()
