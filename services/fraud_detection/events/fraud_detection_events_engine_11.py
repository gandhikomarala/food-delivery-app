...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_11
...
@dataclass
class FraudDetectionEventsEntity11:
...
class FraudDetectionEventsSchema11(BaseModel):
...
class FraudDetectionEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FraudDetectionEventsProcessor11()
