...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_17
...
@dataclass
class FraudDetectionEventsEntity17:
...
class FraudDetectionEventsSchema17(BaseModel):
...
class FraudDetectionEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionEventsProcessor17()
