...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_3
...
@dataclass
class FraudDetectionEventsEntity3:
...
class FraudDetectionEventsSchema3(BaseModel):
...
class FraudDetectionEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionEventsProcessor3()
