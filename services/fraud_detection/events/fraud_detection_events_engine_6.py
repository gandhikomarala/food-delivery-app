...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_6
...
@dataclass
class FraudDetectionEventsEntity6:
...
class FraudDetectionEventsSchema6(BaseModel):
...
class FraudDetectionEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionEventsProcessor6()
