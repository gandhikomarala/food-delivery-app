...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_20
...
@dataclass
class FraudDetectionEventsEntity20:
...
class FraudDetectionEventsSchema20(BaseModel):
...
class FraudDetectionEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionEventsProcessor20()
