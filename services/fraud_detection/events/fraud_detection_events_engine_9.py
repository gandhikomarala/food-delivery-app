...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_9
...
@dataclass
class FraudDetectionEventsEntity9:
...
class FraudDetectionEventsSchema9(BaseModel):
...
class FraudDetectionEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = FraudDetectionEventsProcessor9()
