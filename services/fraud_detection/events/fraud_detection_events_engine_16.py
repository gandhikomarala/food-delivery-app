...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_16
...
@dataclass
class FraudDetectionEventsEntity16:
...
class FraudDetectionEventsSchema16(BaseModel):
...
class FraudDetectionEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FraudDetectionEventsProcessor16()
