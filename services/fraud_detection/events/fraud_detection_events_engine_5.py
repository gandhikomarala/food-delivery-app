...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_5
...
@dataclass
class FraudDetectionEventsEntity5:
...
class FraudDetectionEventsSchema5(BaseModel):
...
class FraudDetectionEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionEventsProcessor5()
