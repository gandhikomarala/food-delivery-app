...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_12
...
@dataclass
class FraudDetectionEventsEntity12:
...
class FraudDetectionEventsSchema12(BaseModel):
...
class FraudDetectionEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionEventsProcessor12()
