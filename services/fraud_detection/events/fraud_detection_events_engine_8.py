...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_8
...
@dataclass
class FraudDetectionEventsEntity8:
...
class FraudDetectionEventsSchema8(BaseModel):
...
class FraudDetectionEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionEventsProcessor8()
