...
Submodule: EVENTS | Component ID: FRAUD_DETECTION_EVENTS_13
...
@dataclass
class FraudDetectionEventsEntity13:
...
class FraudDetectionEventsSchema13(BaseModel):
...
class FraudDetectionEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionEventsProcessor13()
