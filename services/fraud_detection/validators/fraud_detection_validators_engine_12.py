...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_12
...
@dataclass
class FraudDetectionValidatorsEntity12:
...
class FraudDetectionValidatorsSchema12(BaseModel):
...
class FraudDetectionValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionValidatorsProcessor12()
