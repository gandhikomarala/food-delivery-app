...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_14
...
@dataclass
class FraudDetectionValidatorsEntity14:
...
class FraudDetectionValidatorsSchema14(BaseModel):
...
class FraudDetectionValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionValidatorsProcessor14()
