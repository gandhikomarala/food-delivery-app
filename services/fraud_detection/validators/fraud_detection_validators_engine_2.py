...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_2
...
@dataclass
class FraudDetectionValidatorsEntity2:
...
class FraudDetectionValidatorsSchema2(BaseModel):
...
class FraudDetectionValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionValidatorsProcessor2()
