...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_5
...
@dataclass
class FraudDetectionValidatorsEntity5:
...
class FraudDetectionValidatorsSchema5(BaseModel):
...
class FraudDetectionValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionValidatorsProcessor5()
