...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_4
...
@dataclass
class FraudDetectionValidatorsEntity4:
...
class FraudDetectionValidatorsSchema4(BaseModel):
...
class FraudDetectionValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionValidatorsProcessor4()
