...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_20
...
@dataclass
class FraudDetectionValidatorsEntity20:
...
class FraudDetectionValidatorsSchema20(BaseModel):
...
class FraudDetectionValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionValidatorsProcessor20()
