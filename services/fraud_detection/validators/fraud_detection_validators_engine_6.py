...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_6
...
@dataclass
class FraudDetectionValidatorsEntity6:
...
class FraudDetectionValidatorsSchema6(BaseModel):
...
class FraudDetectionValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionValidatorsProcessor6()
