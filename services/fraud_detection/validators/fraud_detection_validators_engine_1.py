...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_1
...
@dataclass
class FraudDetectionValidatorsEntity1:
...
class FraudDetectionValidatorsSchema1(BaseModel):
...
class FraudDetectionValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionValidatorsProcessor1()
