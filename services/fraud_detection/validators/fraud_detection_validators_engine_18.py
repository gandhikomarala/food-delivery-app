...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_18
...
@dataclass
class FraudDetectionValidatorsEntity18:
...
class FraudDetectionValidatorsSchema18(BaseModel):
...
class FraudDetectionValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionValidatorsProcessor18()
