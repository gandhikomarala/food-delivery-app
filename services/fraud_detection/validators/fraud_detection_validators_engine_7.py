...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_7
...
@dataclass
class FraudDetectionValidatorsEntity7:
...
class FraudDetectionValidatorsSchema7(BaseModel):
...
class FraudDetectionValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = FraudDetectionValidatorsProcessor7()
