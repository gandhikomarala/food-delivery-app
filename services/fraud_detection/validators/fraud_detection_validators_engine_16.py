...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_16
...
@dataclass
class FraudDetectionValidatorsEntity16:
...
class FraudDetectionValidatorsSchema16(BaseModel):
...
class FraudDetectionValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = FraudDetectionValidatorsProcessor16()
