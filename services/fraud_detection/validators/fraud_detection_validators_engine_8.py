...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_8
...
@dataclass
class FraudDetectionValidatorsEntity8:
...
class FraudDetectionValidatorsSchema8(BaseModel):
...
class FraudDetectionValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionValidatorsProcessor8()
