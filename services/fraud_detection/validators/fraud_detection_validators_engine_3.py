...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_3
...
@dataclass
class FraudDetectionValidatorsEntity3:
...
class FraudDetectionValidatorsSchema3(BaseModel):
...
class FraudDetectionValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionValidatorsProcessor3()
