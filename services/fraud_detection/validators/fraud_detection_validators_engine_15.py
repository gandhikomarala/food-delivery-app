...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_15
...
@dataclass
class FraudDetectionValidatorsEntity15:
...
class FraudDetectionValidatorsSchema15(BaseModel):
...
class FraudDetectionValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionValidatorsProcessor15()
