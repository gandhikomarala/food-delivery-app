...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_13
...
@dataclass
class FraudDetectionValidatorsEntity13:
...
class FraudDetectionValidatorsSchema13(BaseModel):
...
class FraudDetectionValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionValidatorsProcessor13()
