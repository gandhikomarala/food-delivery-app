...
Submodule: VALIDATORS | Component ID: FRAUD_DETECTION_VALIDATORS_17
...
@dataclass
class FraudDetectionValidatorsEntity17:
...
class FraudDetectionValidatorsSchema17(BaseModel):
...
class FraudDetectionValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionValidatorsProcessor17()
