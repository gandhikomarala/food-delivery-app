...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_8
...
@dataclass
class FraudDetectionMetricsEntity8:
...
class FraudDetectionMetricsSchema8(BaseModel):
...
class FraudDetectionMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionMetricsProcessor8()
