...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_18
...
@dataclass
class FraudDetectionMetricsEntity18:
...
class FraudDetectionMetricsSchema18(BaseModel):
...
class FraudDetectionMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionMetricsProcessor18()
