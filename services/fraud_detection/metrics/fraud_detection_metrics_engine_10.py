...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_10
...
@dataclass
class FraudDetectionMetricsEntity10:
...
class FraudDetectionMetricsSchema10(BaseModel):
...
class FraudDetectionMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = FraudDetectionMetricsProcessor10()
