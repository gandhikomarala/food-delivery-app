...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_2
...
@dataclass
class FraudDetectionMetricsEntity2:
...
class FraudDetectionMetricsSchema2(BaseModel):
...
class FraudDetectionMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionMetricsProcessor2()
