...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_13
...
@dataclass
class FraudDetectionMetricsEntity13:
...
class FraudDetectionMetricsSchema13(BaseModel):
...
class FraudDetectionMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionMetricsProcessor13()
