...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_1
...
@dataclass
class FraudDetectionMetricsEntity1:
...
class FraudDetectionMetricsSchema1(BaseModel):
...
class FraudDetectionMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionMetricsProcessor1()
