...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_14
...
@dataclass
class FraudDetectionMetricsEntity14:
...
class FraudDetectionMetricsSchema14(BaseModel):
...
class FraudDetectionMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionMetricsProcessor14()
