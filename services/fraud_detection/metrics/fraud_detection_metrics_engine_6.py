...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_6
...
@dataclass
class FraudDetectionMetricsEntity6:
...
class FraudDetectionMetricsSchema6(BaseModel):
...
class FraudDetectionMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionMetricsProcessor6()
