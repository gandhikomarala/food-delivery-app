...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_15
...
@dataclass
class FraudDetectionMetricsEntity15:
...
class FraudDetectionMetricsSchema15(BaseModel):
...
class FraudDetectionMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionMetricsProcessor15()
