...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_11
...
@dataclass
class FraudDetectionMetricsEntity11:
...
class FraudDetectionMetricsSchema11(BaseModel):
...
class FraudDetectionMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = FraudDetectionMetricsProcessor11()
