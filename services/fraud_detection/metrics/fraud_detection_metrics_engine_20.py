...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_20
...
@dataclass
class FraudDetectionMetricsEntity20:
...
class FraudDetectionMetricsSchema20(BaseModel):
...
class FraudDetectionMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionMetricsProcessor20()
