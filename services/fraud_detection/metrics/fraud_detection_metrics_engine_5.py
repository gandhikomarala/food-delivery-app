...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_5
...
@dataclass
class FraudDetectionMetricsEntity5:
...
class FraudDetectionMetricsSchema5(BaseModel):
...
class FraudDetectionMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionMetricsProcessor5()
