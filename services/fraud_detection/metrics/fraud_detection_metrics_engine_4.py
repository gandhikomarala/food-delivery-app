...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_4
...
@dataclass
class FraudDetectionMetricsEntity4:
...
class FraudDetectionMetricsSchema4(BaseModel):
...
class FraudDetectionMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionMetricsProcessor4()
