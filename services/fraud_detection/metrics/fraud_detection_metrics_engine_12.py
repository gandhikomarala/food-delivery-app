...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_12
...
@dataclass
class FraudDetectionMetricsEntity12:
...
class FraudDetectionMetricsSchema12(BaseModel):
...
class FraudDetectionMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionMetricsProcessor12()
