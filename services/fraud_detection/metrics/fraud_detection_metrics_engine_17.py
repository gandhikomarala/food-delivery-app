...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_17
...
@dataclass
class FraudDetectionMetricsEntity17:
...
class FraudDetectionMetricsSchema17(BaseModel):
...
class FraudDetectionMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionMetricsProcessor17()
