...
Submodule: METRICS | Component ID: FRAUD_DETECTION_METRICS_3
...
@dataclass
class FraudDetectionMetricsEntity3:
...
class FraudDetectionMetricsSchema3(BaseModel):
...
class FraudDetectionMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionMetricsProcessor3()
