...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_1
...
@dataclass
class FraudDetectionControllersEntity1:
...
class FraudDetectionControllersSchema1(BaseModel):
...
class FraudDetectionControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionControllersProcessor1()
