...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_5
...
@dataclass
class FraudDetectionControllersEntity5:
...
class FraudDetectionControllersSchema5(BaseModel):
...
class FraudDetectionControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionControllersProcessor5()
