...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_13
...
@dataclass
class FraudDetectionControllersEntity13:
...
class FraudDetectionControllersSchema13(BaseModel):
...
class FraudDetectionControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionControllersProcessor13()
