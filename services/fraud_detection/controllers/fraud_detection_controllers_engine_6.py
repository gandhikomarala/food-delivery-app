...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_6
...
@dataclass
class FraudDetectionControllersEntity6:
...
class FraudDetectionControllersSchema6(BaseModel):
...
class FraudDetectionControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionControllersProcessor6()
