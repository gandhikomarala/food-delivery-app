...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_4
...
@dataclass
class FraudDetectionControllersEntity4:
...
class FraudDetectionControllersSchema4(BaseModel):
...
class FraudDetectionControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionControllersProcessor4()
