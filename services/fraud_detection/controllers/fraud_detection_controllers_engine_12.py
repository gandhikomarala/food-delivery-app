...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_12
...
@dataclass
class FraudDetectionControllersEntity12:
...
class FraudDetectionControllersSchema12(BaseModel):
...
class FraudDetectionControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionControllersProcessor12()
