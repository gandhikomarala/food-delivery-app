...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_3
...
@dataclass
class FraudDetectionControllersEntity3:
...
class FraudDetectionControllersSchema3(BaseModel):
...
class FraudDetectionControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionControllersProcessor3()
