...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_20
...
@dataclass
class FraudDetectionControllersEntity20:
...
class FraudDetectionControllersSchema20(BaseModel):
...
class FraudDetectionControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionControllersProcessor20()
