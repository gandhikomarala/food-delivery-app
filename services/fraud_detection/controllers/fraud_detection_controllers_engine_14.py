...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_14
...
@dataclass
class FraudDetectionControllersEntity14:
...
class FraudDetectionControllersSchema14(BaseModel):
...
class FraudDetectionControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionControllersProcessor14()
