...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_18
...
@dataclass
class FraudDetectionControllersEntity18:
...
class FraudDetectionControllersSchema18(BaseModel):
...
class FraudDetectionControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionControllersProcessor18()
