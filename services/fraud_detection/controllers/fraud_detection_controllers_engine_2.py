...
Submodule: CONTROLLERS | Component ID: FRAUD_DETECTION_CONTROLLERS_2
...
@dataclass
class FraudDetectionControllersEntity2:
...
class FraudDetectionControllersSchema2(BaseModel):
...
class FraudDetectionControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionControllersProcessor2()
