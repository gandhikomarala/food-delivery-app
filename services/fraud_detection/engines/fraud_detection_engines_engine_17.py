...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_17
...
@dataclass
class FraudDetectionEnginesEntity17:
...
class FraudDetectionEnginesSchema17(BaseModel):
...
class FraudDetectionEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = FraudDetectionEnginesProcessor17()
