...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_20
...
@dataclass
class FraudDetectionEnginesEntity20:
...
class FraudDetectionEnginesSchema20(BaseModel):
...
class FraudDetectionEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = FraudDetectionEnginesProcessor20()
