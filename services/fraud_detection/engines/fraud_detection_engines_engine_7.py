...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_7
...
@dataclass
class FraudDetectionEnginesEntity7:
...
class FraudDetectionEnginesSchema7(BaseModel):
...
class FraudDetectionEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = FraudDetectionEnginesProcessor7()
