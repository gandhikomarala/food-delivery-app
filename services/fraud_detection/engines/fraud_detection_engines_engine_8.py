...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_8
...
@dataclass
class FraudDetectionEnginesEntity8:
...
class FraudDetectionEnginesSchema8(BaseModel):
...
class FraudDetectionEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = FraudDetectionEnginesProcessor8()
