...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_2
...
@dataclass
class FraudDetectionEnginesEntity2:
...
class FraudDetectionEnginesSchema2(BaseModel):
...
class FraudDetectionEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = FraudDetectionEnginesProcessor2()
