...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_14
...
@dataclass
class FraudDetectionEnginesEntity14:
...
class FraudDetectionEnginesSchema14(BaseModel):
...
class FraudDetectionEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = FraudDetectionEnginesProcessor14()
