...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_1
...
@dataclass
class FraudDetectionEnginesEntity1:
...
class FraudDetectionEnginesSchema1(BaseModel):
...
class FraudDetectionEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = FraudDetectionEnginesProcessor1()
