...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_6
...
@dataclass
class FraudDetectionEnginesEntity6:
...
class FraudDetectionEnginesSchema6(BaseModel):
...
class FraudDetectionEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = FraudDetectionEnginesProcessor6()
