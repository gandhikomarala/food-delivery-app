...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_12
...
@dataclass
class FraudDetectionEnginesEntity12:
...
class FraudDetectionEnginesSchema12(BaseModel):
...
class FraudDetectionEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = FraudDetectionEnginesProcessor12()
