...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_5
...
@dataclass
class FraudDetectionEnginesEntity5:
...
class FraudDetectionEnginesSchema5(BaseModel):
...
class FraudDetectionEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = FraudDetectionEnginesProcessor5()
