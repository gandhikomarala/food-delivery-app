...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_13
...
@dataclass
class FraudDetectionEnginesEntity13:
...
class FraudDetectionEnginesSchema13(BaseModel):
...
class FraudDetectionEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = FraudDetectionEnginesProcessor13()
