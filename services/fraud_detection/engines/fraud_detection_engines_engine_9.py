...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_9
...
@dataclass
class FraudDetectionEnginesEntity9:
...
class FraudDetectionEnginesSchema9(BaseModel):
...
class FraudDetectionEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = FraudDetectionEnginesProcessor9()
