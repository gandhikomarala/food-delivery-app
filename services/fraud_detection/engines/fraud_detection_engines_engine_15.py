...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_15
...
@dataclass
class FraudDetectionEnginesEntity15:
...
class FraudDetectionEnginesSchema15(BaseModel):
...
class FraudDetectionEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = FraudDetectionEnginesProcessor15()
