...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_4
...
@dataclass
class FraudDetectionEnginesEntity4:
...
class FraudDetectionEnginesSchema4(BaseModel):
...
class FraudDetectionEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = FraudDetectionEnginesProcessor4()
