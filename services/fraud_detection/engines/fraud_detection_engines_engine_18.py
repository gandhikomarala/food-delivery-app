...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_18
...
@dataclass
class FraudDetectionEnginesEntity18:
...
class FraudDetectionEnginesSchema18(BaseModel):
...
class FraudDetectionEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = FraudDetectionEnginesProcessor18()
