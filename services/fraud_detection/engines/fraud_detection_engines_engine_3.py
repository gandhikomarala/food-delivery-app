...
Submodule: ENGINES | Component ID: FRAUD_DETECTION_ENGINES_3
...
@dataclass
class FraudDetectionEnginesEntity3:
...
class FraudDetectionEnginesSchema3(BaseModel):
...
class FraudDetectionEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: FraudDetectionEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = FraudDetectionEnginesProcessor3()
