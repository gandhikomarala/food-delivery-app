...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_20
...
@dataclass
class LoyaltyRewardsPipelinesEntity20:
...
class LoyaltyRewardsPipelinesSchema20(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsPipelinesProcessor20()
