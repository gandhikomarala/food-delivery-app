...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_1
...
@dataclass
class LoyaltyRewardsPipelinesEntity1:
...
class LoyaltyRewardsPipelinesSchema1(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsPipelinesProcessor1()
