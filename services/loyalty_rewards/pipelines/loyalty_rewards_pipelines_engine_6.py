...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_6
...
@dataclass
class LoyaltyRewardsPipelinesEntity6:
...
class LoyaltyRewardsPipelinesSchema6(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsPipelinesProcessor6()
