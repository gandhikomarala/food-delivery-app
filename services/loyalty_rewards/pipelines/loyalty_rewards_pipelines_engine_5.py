...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_5
...
@dataclass
class LoyaltyRewardsPipelinesEntity5:
...
class LoyaltyRewardsPipelinesSchema5(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsPipelinesProcessor5()
