...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_17
...
@dataclass
class LoyaltyRewardsPipelinesEntity17:
...
class LoyaltyRewardsPipelinesSchema17(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsPipelinesProcessor17()
