...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_10
...
@dataclass
class LoyaltyRewardsPipelinesEntity10:
...
class LoyaltyRewardsPipelinesSchema10(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsPipelinesProcessor10()
