...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_18
...
@dataclass
class LoyaltyRewardsPipelinesEntity18:
...
class LoyaltyRewardsPipelinesSchema18(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsPipelinesProcessor18()
