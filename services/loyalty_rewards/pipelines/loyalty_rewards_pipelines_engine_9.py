...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_9
...
@dataclass
class LoyaltyRewardsPipelinesEntity9:
...
class LoyaltyRewardsPipelinesSchema9(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsPipelinesProcessor9()
