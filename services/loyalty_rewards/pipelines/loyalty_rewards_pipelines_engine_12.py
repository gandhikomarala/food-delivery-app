...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_12
...
@dataclass
class LoyaltyRewardsPipelinesEntity12:
...
class LoyaltyRewardsPipelinesSchema12(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsPipelinesProcessor12()
