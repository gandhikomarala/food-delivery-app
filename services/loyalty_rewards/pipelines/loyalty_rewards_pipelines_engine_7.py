...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_7
...
@dataclass
class LoyaltyRewardsPipelinesEntity7:
...
class LoyaltyRewardsPipelinesSchema7(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsPipelinesProcessor7()
