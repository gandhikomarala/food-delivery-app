...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_8
...
@dataclass
class LoyaltyRewardsPipelinesEntity8:
...
class LoyaltyRewardsPipelinesSchema8(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsPipelinesProcessor8()
