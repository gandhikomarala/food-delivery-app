...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_13
...
@dataclass
class LoyaltyRewardsPipelinesEntity13:
...
class LoyaltyRewardsPipelinesSchema13(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsPipelinesProcessor13()
