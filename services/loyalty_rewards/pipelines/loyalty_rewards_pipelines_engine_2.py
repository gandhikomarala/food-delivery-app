...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_2
...
@dataclass
class LoyaltyRewardsPipelinesEntity2:
...
class LoyaltyRewardsPipelinesSchema2(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsPipelinesProcessor2()
