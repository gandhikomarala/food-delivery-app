...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_16
...
@dataclass
class LoyaltyRewardsPipelinesEntity16:
...
class LoyaltyRewardsPipelinesSchema16(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsPipelinesProcessor16()
