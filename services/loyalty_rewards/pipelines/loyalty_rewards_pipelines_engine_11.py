...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_11
...
@dataclass
class LoyaltyRewardsPipelinesEntity11:
...
class LoyaltyRewardsPipelinesSchema11(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsPipelinesProcessor11()
