...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_14
...
@dataclass
class LoyaltyRewardsPipelinesEntity14:
...
class LoyaltyRewardsPipelinesSchema14(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsPipelinesProcessor14()
