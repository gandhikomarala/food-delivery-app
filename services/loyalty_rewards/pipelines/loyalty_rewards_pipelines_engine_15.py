...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_15
...
@dataclass
class LoyaltyRewardsPipelinesEntity15:
...
class LoyaltyRewardsPipelinesSchema15(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsPipelinesProcessor15()
