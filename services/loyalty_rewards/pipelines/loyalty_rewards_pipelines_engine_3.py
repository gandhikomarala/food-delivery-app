...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_3
...
@dataclass
class LoyaltyRewardsPipelinesEntity3:
...
class LoyaltyRewardsPipelinesSchema3(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsPipelinesProcessor3()
