...
Submodule: PIPELINES | Component ID: LOYALTY_REWARDS_PIPELINES_4
...
@dataclass
class LoyaltyRewardsPipelinesEntity4:
...
class LoyaltyRewardsPipelinesSchema4(BaseModel):
...
class LoyaltyRewardsPipelinesProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsPipelinesSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsPipelinesProcessor4()
