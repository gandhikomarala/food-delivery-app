...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_10
...
@dataclass
class LoyaltyRewardsValidatorsEntity10:
...
class LoyaltyRewardsValidatorsSchema10(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsValidatorsProcessor10()
