...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_2
...
@dataclass
class LoyaltyRewardsValidatorsEntity2:
...
class LoyaltyRewardsValidatorsSchema2(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsValidatorsProcessor2()
