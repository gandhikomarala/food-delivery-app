...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_20
...
@dataclass
class LoyaltyRewardsValidatorsEntity20:
...
class LoyaltyRewardsValidatorsSchema20(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsValidatorsProcessor20()
