...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_6
...
@dataclass
class LoyaltyRewardsValidatorsEntity6:
...
class LoyaltyRewardsValidatorsSchema6(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsValidatorsProcessor6()
