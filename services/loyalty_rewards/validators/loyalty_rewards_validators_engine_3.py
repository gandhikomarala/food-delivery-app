...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_3
...
@dataclass
class LoyaltyRewardsValidatorsEntity3:
...
class LoyaltyRewardsValidatorsSchema3(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsValidatorsProcessor3()
