...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_12
...
@dataclass
class LoyaltyRewardsValidatorsEntity12:
...
class LoyaltyRewardsValidatorsSchema12(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsValidatorsProcessor12()
