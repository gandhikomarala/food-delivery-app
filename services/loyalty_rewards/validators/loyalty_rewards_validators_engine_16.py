...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_16
...
@dataclass
class LoyaltyRewardsValidatorsEntity16:
...
class LoyaltyRewardsValidatorsSchema16(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsValidatorsProcessor16()
