...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_5
...
@dataclass
class LoyaltyRewardsValidatorsEntity5:
...
class LoyaltyRewardsValidatorsSchema5(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsValidatorsProcessor5()
