...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_15
...
@dataclass
class LoyaltyRewardsValidatorsEntity15:
...
class LoyaltyRewardsValidatorsSchema15(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsValidatorsProcessor15()
