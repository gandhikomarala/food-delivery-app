...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_7
...
@dataclass
class LoyaltyRewardsValidatorsEntity7:
...
class LoyaltyRewardsValidatorsSchema7(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsValidatorsProcessor7()
