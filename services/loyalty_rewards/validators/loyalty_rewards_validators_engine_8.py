...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_8
...
@dataclass
class LoyaltyRewardsValidatorsEntity8:
...
class LoyaltyRewardsValidatorsSchema8(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsValidatorsProcessor8()
