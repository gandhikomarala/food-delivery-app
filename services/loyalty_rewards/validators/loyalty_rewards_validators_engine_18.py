...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_18
...
@dataclass
class LoyaltyRewardsValidatorsEntity18:
...
class LoyaltyRewardsValidatorsSchema18(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsValidatorsProcessor18()
