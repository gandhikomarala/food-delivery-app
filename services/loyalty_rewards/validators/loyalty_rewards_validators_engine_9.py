...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_9
...
@dataclass
class LoyaltyRewardsValidatorsEntity9:
...
class LoyaltyRewardsValidatorsSchema9(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsValidatorsProcessor9()
