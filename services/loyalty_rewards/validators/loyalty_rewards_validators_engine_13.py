...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_13
...
@dataclass
class LoyaltyRewardsValidatorsEntity13:
...
class LoyaltyRewardsValidatorsSchema13(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsValidatorsProcessor13()
