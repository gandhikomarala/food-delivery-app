...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_4
...
@dataclass
class LoyaltyRewardsValidatorsEntity4:
...
class LoyaltyRewardsValidatorsSchema4(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsValidatorsProcessor4()
