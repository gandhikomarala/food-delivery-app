...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_11
...
@dataclass
class LoyaltyRewardsValidatorsEntity11:
...
class LoyaltyRewardsValidatorsSchema11(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsValidatorsProcessor11()
