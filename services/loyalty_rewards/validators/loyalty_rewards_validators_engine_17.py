...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_17
...
@dataclass
class LoyaltyRewardsValidatorsEntity17:
...
class LoyaltyRewardsValidatorsSchema17(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsValidatorsProcessor17()
