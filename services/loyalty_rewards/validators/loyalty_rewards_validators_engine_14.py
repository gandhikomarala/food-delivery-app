...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_14
...
@dataclass
class LoyaltyRewardsValidatorsEntity14:
...
class LoyaltyRewardsValidatorsSchema14(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsValidatorsProcessor14()
