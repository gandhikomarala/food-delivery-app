...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_19
...
@dataclass
class LoyaltyRewardsValidatorsEntity19:
...
class LoyaltyRewardsValidatorsSchema19(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsValidatorsProcessor19()
