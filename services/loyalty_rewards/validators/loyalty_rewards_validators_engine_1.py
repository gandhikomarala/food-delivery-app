...
Submodule: VALIDATORS | Component ID: LOYALTY_REWARDS_VALIDATORS_1
...
@dataclass
class LoyaltyRewardsValidatorsEntity1:
...
class LoyaltyRewardsValidatorsSchema1(BaseModel):
...
class LoyaltyRewardsValidatorsProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsValidatorsSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsValidatorsProcessor1()
