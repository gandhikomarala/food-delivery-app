...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_7
...
@dataclass
class LoyaltyRewardsDtoEntity7:
...
class LoyaltyRewardsDtoSchema7(BaseModel):
...
class LoyaltyRewardsDtoProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsDtoProcessor7()
