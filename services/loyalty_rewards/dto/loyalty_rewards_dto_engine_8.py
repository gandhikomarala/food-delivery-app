...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_8
...
@dataclass
class LoyaltyRewardsDtoEntity8:
...
class LoyaltyRewardsDtoSchema8(BaseModel):
...
class LoyaltyRewardsDtoProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsDtoProcessor8()
