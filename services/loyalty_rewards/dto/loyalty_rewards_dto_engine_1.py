...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_1
...
@dataclass
class LoyaltyRewardsDtoEntity1:
...
class LoyaltyRewardsDtoSchema1(BaseModel):
...
class LoyaltyRewardsDtoProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsDtoProcessor1()
