...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_2
...
@dataclass
class LoyaltyRewardsDtoEntity2:
...
class LoyaltyRewardsDtoSchema2(BaseModel):
...
class LoyaltyRewardsDtoProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsDtoProcessor2()
