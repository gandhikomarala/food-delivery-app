...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_10
...
@dataclass
class LoyaltyRewardsDtoEntity10:
...
class LoyaltyRewardsDtoSchema10(BaseModel):
...
class LoyaltyRewardsDtoProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsDtoProcessor10()
