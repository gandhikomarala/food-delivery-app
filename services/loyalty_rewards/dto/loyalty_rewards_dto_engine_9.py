...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_9
...
@dataclass
class LoyaltyRewardsDtoEntity9:
...
class LoyaltyRewardsDtoSchema9(BaseModel):
...
class LoyaltyRewardsDtoProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsDtoProcessor9()
