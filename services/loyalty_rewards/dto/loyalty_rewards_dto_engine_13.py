...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_13
...
@dataclass
class LoyaltyRewardsDtoEntity13:
...
class LoyaltyRewardsDtoSchema13(BaseModel):
...
class LoyaltyRewardsDtoProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsDtoProcessor13()
