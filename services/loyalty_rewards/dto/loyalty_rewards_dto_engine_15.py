...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_15
...
@dataclass
class LoyaltyRewardsDtoEntity15:
...
class LoyaltyRewardsDtoSchema15(BaseModel):
...
class LoyaltyRewardsDtoProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsDtoProcessor15()
