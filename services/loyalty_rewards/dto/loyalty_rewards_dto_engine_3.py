...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_3
...
@dataclass
class LoyaltyRewardsDtoEntity3:
...
class LoyaltyRewardsDtoSchema3(BaseModel):
...
class LoyaltyRewardsDtoProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsDtoProcessor3()
