...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_12
...
@dataclass
class LoyaltyRewardsDtoEntity12:
...
class LoyaltyRewardsDtoSchema12(BaseModel):
...
class LoyaltyRewardsDtoProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsDtoProcessor12()
