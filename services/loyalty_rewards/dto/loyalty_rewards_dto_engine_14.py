...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_14
...
@dataclass
class LoyaltyRewardsDtoEntity14:
...
class LoyaltyRewardsDtoSchema14(BaseModel):
...
class LoyaltyRewardsDtoProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsDtoProcessor14()
