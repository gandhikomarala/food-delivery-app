...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_16
...
@dataclass
class LoyaltyRewardsDtoEntity16:
...
class LoyaltyRewardsDtoSchema16(BaseModel):
...
class LoyaltyRewardsDtoProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsDtoProcessor16()
