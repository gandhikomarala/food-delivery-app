...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_11
...
@dataclass
class LoyaltyRewardsDtoEntity11:
...
class LoyaltyRewardsDtoSchema11(BaseModel):
...
class LoyaltyRewardsDtoProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsDtoProcessor11()
