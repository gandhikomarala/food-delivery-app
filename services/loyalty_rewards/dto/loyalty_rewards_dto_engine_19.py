...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_19
...
@dataclass
class LoyaltyRewardsDtoEntity19:
...
class LoyaltyRewardsDtoSchema19(BaseModel):
...
class LoyaltyRewardsDtoProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsDtoProcessor19()
