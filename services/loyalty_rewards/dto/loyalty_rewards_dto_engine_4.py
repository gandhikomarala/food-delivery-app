...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_4
...
@dataclass
class LoyaltyRewardsDtoEntity4:
...
class LoyaltyRewardsDtoSchema4(BaseModel):
...
class LoyaltyRewardsDtoProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsDtoProcessor4()
