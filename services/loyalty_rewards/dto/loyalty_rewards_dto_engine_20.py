...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_20
...
@dataclass
class LoyaltyRewardsDtoEntity20:
...
class LoyaltyRewardsDtoSchema20(BaseModel):
...
class LoyaltyRewardsDtoProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsDtoProcessor20()
