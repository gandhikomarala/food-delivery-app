...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_18
...
@dataclass
class LoyaltyRewardsDtoEntity18:
...
class LoyaltyRewardsDtoSchema18(BaseModel):
...
class LoyaltyRewardsDtoProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsDtoProcessor18()
