...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_17
...
@dataclass
class LoyaltyRewardsDtoEntity17:
...
class LoyaltyRewardsDtoSchema17(BaseModel):
...
class LoyaltyRewardsDtoProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsDtoProcessor17()
