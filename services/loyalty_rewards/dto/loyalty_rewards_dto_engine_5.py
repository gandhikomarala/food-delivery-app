...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_5
...
@dataclass
class LoyaltyRewardsDtoEntity5:
...
class LoyaltyRewardsDtoSchema5(BaseModel):
...
class LoyaltyRewardsDtoProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsDtoProcessor5()
