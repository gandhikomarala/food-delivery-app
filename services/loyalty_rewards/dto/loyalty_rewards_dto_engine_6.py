...
Submodule: DTO | Component ID: LOYALTY_REWARDS_DTO_6
...
@dataclass
class LoyaltyRewardsDtoEntity6:
...
class LoyaltyRewardsDtoSchema6(BaseModel):
...
class LoyaltyRewardsDtoProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsDtoSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsDtoProcessor6()
