...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_15
...
@dataclass
class LoyaltyRewardsServicesEntity15:
...
class LoyaltyRewardsServicesSchema15(BaseModel):
...
class LoyaltyRewardsServicesProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsServicesProcessor15()
