...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_16
...
@dataclass
class LoyaltyRewardsServicesEntity16:
...
class LoyaltyRewardsServicesSchema16(BaseModel):
...
class LoyaltyRewardsServicesProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsServicesProcessor16()
