...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_12
...
@dataclass
class LoyaltyRewardsServicesEntity12:
...
class LoyaltyRewardsServicesSchema12(BaseModel):
...
class LoyaltyRewardsServicesProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsServicesProcessor12()
