...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_6
...
@dataclass
class LoyaltyRewardsServicesEntity6:
...
class LoyaltyRewardsServicesSchema6(BaseModel):
...
class LoyaltyRewardsServicesProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsServicesProcessor6()
