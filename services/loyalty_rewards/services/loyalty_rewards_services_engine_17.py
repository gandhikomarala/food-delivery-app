...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_17
...
@dataclass
class LoyaltyRewardsServicesEntity17:
...
class LoyaltyRewardsServicesSchema17(BaseModel):
...
class LoyaltyRewardsServicesProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsServicesProcessor17()
