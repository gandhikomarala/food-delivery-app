...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_4
...
@dataclass
class LoyaltyRewardsServicesEntity4:
...
class LoyaltyRewardsServicesSchema4(BaseModel):
...
class LoyaltyRewardsServicesProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsServicesProcessor4()
