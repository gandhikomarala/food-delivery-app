...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_11
...
@dataclass
class LoyaltyRewardsServicesEntity11:
...
class LoyaltyRewardsServicesSchema11(BaseModel):
...
class LoyaltyRewardsServicesProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsServicesProcessor11()
