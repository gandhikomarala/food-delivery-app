...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_5
...
@dataclass
class LoyaltyRewardsServicesEntity5:
...
class LoyaltyRewardsServicesSchema5(BaseModel):
...
class LoyaltyRewardsServicesProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsServicesProcessor5()
