...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_7
...
@dataclass
class LoyaltyRewardsServicesEntity7:
...
class LoyaltyRewardsServicesSchema7(BaseModel):
...
class LoyaltyRewardsServicesProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsServicesProcessor7()
