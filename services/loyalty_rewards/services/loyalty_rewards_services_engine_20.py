...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_20
...
@dataclass
class LoyaltyRewardsServicesEntity20:
...
class LoyaltyRewardsServicesSchema20(BaseModel):
...
class LoyaltyRewardsServicesProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsServicesProcessor20()
