...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_1
...
@dataclass
class LoyaltyRewardsServicesEntity1:
...
class LoyaltyRewardsServicesSchema1(BaseModel):
...
class LoyaltyRewardsServicesProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsServicesProcessor1()
