...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_8
...
@dataclass
class LoyaltyRewardsServicesEntity8:
...
class LoyaltyRewardsServicesSchema8(BaseModel):
...
class LoyaltyRewardsServicesProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsServicesProcessor8()
