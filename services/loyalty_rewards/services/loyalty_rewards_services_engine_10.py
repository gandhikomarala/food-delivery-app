...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_10
...
@dataclass
class LoyaltyRewardsServicesEntity10:
...
class LoyaltyRewardsServicesSchema10(BaseModel):
...
class LoyaltyRewardsServicesProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsServicesProcessor10()
