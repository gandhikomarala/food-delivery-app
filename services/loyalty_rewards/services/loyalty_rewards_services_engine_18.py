...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_18
...
@dataclass
class LoyaltyRewardsServicesEntity18:
...
class LoyaltyRewardsServicesSchema18(BaseModel):
...
class LoyaltyRewardsServicesProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsServicesProcessor18()
