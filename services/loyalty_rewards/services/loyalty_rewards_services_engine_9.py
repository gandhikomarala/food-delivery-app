...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_9
...
@dataclass
class LoyaltyRewardsServicesEntity9:
...
class LoyaltyRewardsServicesSchema9(BaseModel):
...
class LoyaltyRewardsServicesProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsServicesProcessor9()
