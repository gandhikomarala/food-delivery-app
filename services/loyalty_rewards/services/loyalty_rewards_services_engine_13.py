...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_13
...
@dataclass
class LoyaltyRewardsServicesEntity13:
...
class LoyaltyRewardsServicesSchema13(BaseModel):
...
class LoyaltyRewardsServicesProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsServicesProcessor13()
