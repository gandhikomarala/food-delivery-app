...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_14
...
@dataclass
class LoyaltyRewardsServicesEntity14:
...
class LoyaltyRewardsServicesSchema14(BaseModel):
...
class LoyaltyRewardsServicesProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsServicesProcessor14()
