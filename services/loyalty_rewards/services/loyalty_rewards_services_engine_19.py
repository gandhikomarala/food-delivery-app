...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_19
...
@dataclass
class LoyaltyRewardsServicesEntity19:
...
class LoyaltyRewardsServicesSchema19(BaseModel):
...
class LoyaltyRewardsServicesProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsServicesProcessor19()
