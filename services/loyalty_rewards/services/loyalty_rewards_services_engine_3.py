...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_3
...
@dataclass
class LoyaltyRewardsServicesEntity3:
...
class LoyaltyRewardsServicesSchema3(BaseModel):
...
class LoyaltyRewardsServicesProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsServicesProcessor3()
