...
Submodule: SERVICES | Component ID: LOYALTY_REWARDS_SERVICES_2
...
@dataclass
class LoyaltyRewardsServicesEntity2:
...
class LoyaltyRewardsServicesSchema2(BaseModel):
...
class LoyaltyRewardsServicesProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsServicesSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsServicesProcessor2()
