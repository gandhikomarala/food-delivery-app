...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_12
...
@dataclass
class LoyaltyRewardsEnginesEntity12:
...
class LoyaltyRewardsEnginesSchema12(BaseModel):
...
class LoyaltyRewardsEnginesProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsEnginesProcessor12()
