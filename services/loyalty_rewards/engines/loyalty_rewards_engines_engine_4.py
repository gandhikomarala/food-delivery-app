...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_4
...
@dataclass
class LoyaltyRewardsEnginesEntity4:
...
class LoyaltyRewardsEnginesSchema4(BaseModel):
...
class LoyaltyRewardsEnginesProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsEnginesProcessor4()
