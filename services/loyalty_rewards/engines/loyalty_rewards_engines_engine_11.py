...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_11
...
@dataclass
class LoyaltyRewardsEnginesEntity11:
...
class LoyaltyRewardsEnginesSchema11(BaseModel):
...
class LoyaltyRewardsEnginesProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsEnginesProcessor11()
