...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_18
...
@dataclass
class LoyaltyRewardsEnginesEntity18:
...
class LoyaltyRewardsEnginesSchema18(BaseModel):
...
class LoyaltyRewardsEnginesProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsEnginesProcessor18()
