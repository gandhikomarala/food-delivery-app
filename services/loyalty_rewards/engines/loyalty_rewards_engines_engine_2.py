...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_2
...
@dataclass
class LoyaltyRewardsEnginesEntity2:
...
class LoyaltyRewardsEnginesSchema2(BaseModel):
...
class LoyaltyRewardsEnginesProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsEnginesProcessor2()
