...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_1
...
@dataclass
class LoyaltyRewardsEnginesEntity1:
...
class LoyaltyRewardsEnginesSchema1(BaseModel):
...
class LoyaltyRewardsEnginesProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsEnginesProcessor1()
