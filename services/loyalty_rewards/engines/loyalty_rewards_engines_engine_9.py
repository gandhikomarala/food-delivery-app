...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_9
...
@dataclass
class LoyaltyRewardsEnginesEntity9:
...
class LoyaltyRewardsEnginesSchema9(BaseModel):
...
class LoyaltyRewardsEnginesProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsEnginesProcessor9()
