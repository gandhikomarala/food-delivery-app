...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_20
...
@dataclass
class LoyaltyRewardsEnginesEntity20:
...
class LoyaltyRewardsEnginesSchema20(BaseModel):
...
class LoyaltyRewardsEnginesProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsEnginesProcessor20()
