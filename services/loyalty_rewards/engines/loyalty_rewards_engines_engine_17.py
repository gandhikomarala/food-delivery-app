...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_17
...
@dataclass
class LoyaltyRewardsEnginesEntity17:
...
class LoyaltyRewardsEnginesSchema17(BaseModel):
...
class LoyaltyRewardsEnginesProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsEnginesProcessor17()
