...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_19
...
@dataclass
class LoyaltyRewardsEnginesEntity19:
...
class LoyaltyRewardsEnginesSchema19(BaseModel):
...
class LoyaltyRewardsEnginesProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsEnginesProcessor19()
