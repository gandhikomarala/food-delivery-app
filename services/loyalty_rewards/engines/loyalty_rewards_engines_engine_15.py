...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_15
...
@dataclass
class LoyaltyRewardsEnginesEntity15:
...
class LoyaltyRewardsEnginesSchema15(BaseModel):
...
class LoyaltyRewardsEnginesProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsEnginesProcessor15()
