...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_8
...
@dataclass
class LoyaltyRewardsEnginesEntity8:
...
class LoyaltyRewardsEnginesSchema8(BaseModel):
...
class LoyaltyRewardsEnginesProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsEnginesProcessor8()
