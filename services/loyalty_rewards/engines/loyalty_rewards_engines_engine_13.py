...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_13
...
@dataclass
class LoyaltyRewardsEnginesEntity13:
...
class LoyaltyRewardsEnginesSchema13(BaseModel):
...
class LoyaltyRewardsEnginesProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsEnginesProcessor13()
