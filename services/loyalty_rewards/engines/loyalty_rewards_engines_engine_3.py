...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_3
...
@dataclass
class LoyaltyRewardsEnginesEntity3:
...
class LoyaltyRewardsEnginesSchema3(BaseModel):
...
class LoyaltyRewardsEnginesProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsEnginesProcessor3()
