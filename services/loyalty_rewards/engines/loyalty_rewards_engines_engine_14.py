...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_14
...
@dataclass
class LoyaltyRewardsEnginesEntity14:
...
class LoyaltyRewardsEnginesSchema14(BaseModel):
...
class LoyaltyRewardsEnginesProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsEnginesProcessor14()
