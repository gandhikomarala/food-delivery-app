...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_10
...
@dataclass
class LoyaltyRewardsEnginesEntity10:
...
class LoyaltyRewardsEnginesSchema10(BaseModel):
...
class LoyaltyRewardsEnginesProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsEnginesProcessor10()
