...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_6
...
@dataclass
class LoyaltyRewardsEnginesEntity6:
...
class LoyaltyRewardsEnginesSchema6(BaseModel):
...
class LoyaltyRewardsEnginesProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsEnginesProcessor6()
