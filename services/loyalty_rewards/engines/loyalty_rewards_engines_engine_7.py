...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_7
...
@dataclass
class LoyaltyRewardsEnginesEntity7:
...
class LoyaltyRewardsEnginesSchema7(BaseModel):
...
class LoyaltyRewardsEnginesProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsEnginesProcessor7()
