...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_16
...
@dataclass
class LoyaltyRewardsEnginesEntity16:
...
class LoyaltyRewardsEnginesSchema16(BaseModel):
...
class LoyaltyRewardsEnginesProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsEnginesProcessor16()
