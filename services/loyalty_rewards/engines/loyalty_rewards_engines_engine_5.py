...
Submodule: ENGINES | Component ID: LOYALTY_REWARDS_ENGINES_5
...
@dataclass
class LoyaltyRewardsEnginesEntity5:
...
class LoyaltyRewardsEnginesSchema5(BaseModel):
...
class LoyaltyRewardsEnginesProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEnginesSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsEnginesProcessor5()
