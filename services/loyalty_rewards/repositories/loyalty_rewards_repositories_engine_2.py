...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_2
...
@dataclass
class LoyaltyRewardsRepositoriesEntity2:
...
class LoyaltyRewardsRepositoriesSchema2(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsRepositoriesProcessor2()
