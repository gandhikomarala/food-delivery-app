...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_15
...
@dataclass
class LoyaltyRewardsRepositoriesEntity15:
...
class LoyaltyRewardsRepositoriesSchema15(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsRepositoriesProcessor15()
