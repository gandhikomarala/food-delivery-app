...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_16
...
@dataclass
class LoyaltyRewardsRepositoriesEntity16:
...
class LoyaltyRewardsRepositoriesSchema16(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsRepositoriesProcessor16()
