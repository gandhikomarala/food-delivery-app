...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_13
...
@dataclass
class LoyaltyRewardsRepositoriesEntity13:
...
class LoyaltyRewardsRepositoriesSchema13(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsRepositoriesProcessor13()
