...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_9
...
@dataclass
class LoyaltyRewardsRepositoriesEntity9:
...
class LoyaltyRewardsRepositoriesSchema9(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsRepositoriesProcessor9()
