...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_6
...
@dataclass
class LoyaltyRewardsRepositoriesEntity6:
...
class LoyaltyRewardsRepositoriesSchema6(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsRepositoriesProcessor6()
