...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_4
...
@dataclass
class LoyaltyRewardsRepositoriesEntity4:
...
class LoyaltyRewardsRepositoriesSchema4(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsRepositoriesProcessor4()
