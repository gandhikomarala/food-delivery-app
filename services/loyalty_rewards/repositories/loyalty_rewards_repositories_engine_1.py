...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_1
...
@dataclass
class LoyaltyRewardsRepositoriesEntity1:
...
class LoyaltyRewardsRepositoriesSchema1(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsRepositoriesProcessor1()
