...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_3
...
@dataclass
class LoyaltyRewardsRepositoriesEntity3:
...
class LoyaltyRewardsRepositoriesSchema3(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsRepositoriesProcessor3()
