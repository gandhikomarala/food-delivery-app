...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_20
...
@dataclass
class LoyaltyRewardsRepositoriesEntity20:
...
class LoyaltyRewardsRepositoriesSchema20(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsRepositoriesProcessor20()
