...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_8
...
@dataclass
class LoyaltyRewardsRepositoriesEntity8:
...
class LoyaltyRewardsRepositoriesSchema8(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsRepositoriesProcessor8()
