...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_11
...
@dataclass
class LoyaltyRewardsRepositoriesEntity11:
...
class LoyaltyRewardsRepositoriesSchema11(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsRepositoriesProcessor11()
