...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_7
...
@dataclass
class LoyaltyRewardsRepositoriesEntity7:
...
class LoyaltyRewardsRepositoriesSchema7(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsRepositoriesProcessor7()
