...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_18
...
@dataclass
class LoyaltyRewardsRepositoriesEntity18:
...
class LoyaltyRewardsRepositoriesSchema18(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsRepositoriesProcessor18()
