...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_5
...
@dataclass
class LoyaltyRewardsRepositoriesEntity5:
...
class LoyaltyRewardsRepositoriesSchema5(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsRepositoriesProcessor5()
