...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_10
...
@dataclass
class LoyaltyRewardsRepositoriesEntity10:
...
class LoyaltyRewardsRepositoriesSchema10(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsRepositoriesProcessor10()
