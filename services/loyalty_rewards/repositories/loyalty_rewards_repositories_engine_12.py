...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_12
...
@dataclass
class LoyaltyRewardsRepositoriesEntity12:
...
class LoyaltyRewardsRepositoriesSchema12(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsRepositoriesProcessor12()
