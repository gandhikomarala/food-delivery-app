...
Submodule: REPOSITORIES | Component ID: LOYALTY_REWARDS_REPOSITORIES_14
...
@dataclass
class LoyaltyRewardsRepositoriesEntity14:
...
class LoyaltyRewardsRepositoriesSchema14(BaseModel):
...
class LoyaltyRewardsRepositoriesProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsRepositoriesSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsRepositoriesProcessor14()
