...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_15
...
@dataclass
class LoyaltyRewardsModelsEntity15:
...
class LoyaltyRewardsModelsSchema15(BaseModel):
...
class LoyaltyRewardsModelsProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsModelsProcessor15()
