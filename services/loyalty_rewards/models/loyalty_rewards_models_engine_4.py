...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_4
...
@dataclass
class LoyaltyRewardsModelsEntity4:
...
class LoyaltyRewardsModelsSchema4(BaseModel):
...
class LoyaltyRewardsModelsProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsModelsProcessor4()
