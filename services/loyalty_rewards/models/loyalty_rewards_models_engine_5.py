...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_5
...
@dataclass
class LoyaltyRewardsModelsEntity5:
...
class LoyaltyRewardsModelsSchema5(BaseModel):
...
class LoyaltyRewardsModelsProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsModelsProcessor5()
