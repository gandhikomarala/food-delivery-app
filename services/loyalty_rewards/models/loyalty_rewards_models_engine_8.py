...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_8
...
@dataclass
class LoyaltyRewardsModelsEntity8:
...
class LoyaltyRewardsModelsSchema8(BaseModel):
...
class LoyaltyRewardsModelsProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsModelsProcessor8()
