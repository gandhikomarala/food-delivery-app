...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_3
...
@dataclass
class LoyaltyRewardsModelsEntity3:
...
class LoyaltyRewardsModelsSchema3(BaseModel):
...
class LoyaltyRewardsModelsProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsModelsProcessor3()
