...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_20
...
@dataclass
class LoyaltyRewardsModelsEntity20:
...
class LoyaltyRewardsModelsSchema20(BaseModel):
...
class LoyaltyRewardsModelsProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsModelsProcessor20()
