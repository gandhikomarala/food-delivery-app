...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_17
...
@dataclass
class LoyaltyRewardsModelsEntity17:
...
class LoyaltyRewardsModelsSchema17(BaseModel):
...
class LoyaltyRewardsModelsProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsModelsProcessor17()
