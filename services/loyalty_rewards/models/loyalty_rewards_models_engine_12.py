...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_12
...
@dataclass
class LoyaltyRewardsModelsEntity12:
...
class LoyaltyRewardsModelsSchema12(BaseModel):
...
class LoyaltyRewardsModelsProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsModelsProcessor12()
