...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_11
...
@dataclass
class LoyaltyRewardsModelsEntity11:
...
class LoyaltyRewardsModelsSchema11(BaseModel):
...
class LoyaltyRewardsModelsProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsModelsProcessor11()
