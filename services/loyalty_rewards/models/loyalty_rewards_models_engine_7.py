...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_7
...
@dataclass
class LoyaltyRewardsModelsEntity7:
...
class LoyaltyRewardsModelsSchema7(BaseModel):
...
class LoyaltyRewardsModelsProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsModelsProcessor7()
