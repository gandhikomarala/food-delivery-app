...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_14
...
@dataclass
class LoyaltyRewardsModelsEntity14:
...
class LoyaltyRewardsModelsSchema14(BaseModel):
...
class LoyaltyRewardsModelsProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsModelsProcessor14()
