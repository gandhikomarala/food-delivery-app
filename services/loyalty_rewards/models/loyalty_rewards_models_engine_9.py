...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_9
...
@dataclass
class LoyaltyRewardsModelsEntity9:
...
class LoyaltyRewardsModelsSchema9(BaseModel):
...
class LoyaltyRewardsModelsProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsModelsProcessor9()
