...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_16
...
@dataclass
class LoyaltyRewardsModelsEntity16:
...
class LoyaltyRewardsModelsSchema16(BaseModel):
...
class LoyaltyRewardsModelsProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsModelsProcessor16()
