...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_18
...
@dataclass
class LoyaltyRewardsModelsEntity18:
...
class LoyaltyRewardsModelsSchema18(BaseModel):
...
class LoyaltyRewardsModelsProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsModelsProcessor18()
