...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_6
...
@dataclass
class LoyaltyRewardsModelsEntity6:
...
class LoyaltyRewardsModelsSchema6(BaseModel):
...
class LoyaltyRewardsModelsProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsModelsProcessor6()
