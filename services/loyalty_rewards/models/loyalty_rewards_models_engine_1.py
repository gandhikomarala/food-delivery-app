...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_1
...
@dataclass
class LoyaltyRewardsModelsEntity1:
...
class LoyaltyRewardsModelsSchema1(BaseModel):
...
class LoyaltyRewardsModelsProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsModelsProcessor1()
