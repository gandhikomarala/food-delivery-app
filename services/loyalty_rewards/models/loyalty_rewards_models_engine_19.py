...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_19
...
@dataclass
class LoyaltyRewardsModelsEntity19:
...
class LoyaltyRewardsModelsSchema19(BaseModel):
...
class LoyaltyRewardsModelsProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsModelsProcessor19()
