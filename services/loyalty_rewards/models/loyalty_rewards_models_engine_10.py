...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_10
...
@dataclass
class LoyaltyRewardsModelsEntity10:
...
class LoyaltyRewardsModelsSchema10(BaseModel):
...
class LoyaltyRewardsModelsProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsModelsProcessor10()
