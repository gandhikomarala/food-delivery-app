...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_2
...
@dataclass
class LoyaltyRewardsModelsEntity2:
...
class LoyaltyRewardsModelsSchema2(BaseModel):
...
class LoyaltyRewardsModelsProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsModelsProcessor2()
