...
Submodule: MODELS | Component ID: LOYALTY_REWARDS_MODELS_13
...
@dataclass
class LoyaltyRewardsModelsEntity13:
...
class LoyaltyRewardsModelsSchema13(BaseModel):
...
class LoyaltyRewardsModelsProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsModelsSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsModelsProcessor13()
