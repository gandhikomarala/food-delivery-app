...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_4
...
@dataclass
class LoyaltyRewardsControllersEntity4:
...
class LoyaltyRewardsControllersSchema4(BaseModel):
...
class LoyaltyRewardsControllersProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsControllersProcessor4()
