...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_2
...
@dataclass
class LoyaltyRewardsControllersEntity2:
...
class LoyaltyRewardsControllersSchema2(BaseModel):
...
class LoyaltyRewardsControllersProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsControllersProcessor2()
