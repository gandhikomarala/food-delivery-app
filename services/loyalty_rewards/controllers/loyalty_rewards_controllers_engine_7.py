...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_7
...
@dataclass
class LoyaltyRewardsControllersEntity7:
...
class LoyaltyRewardsControllersSchema7(BaseModel):
...
class LoyaltyRewardsControllersProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsControllersProcessor7()
