...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_3
...
@dataclass
class LoyaltyRewardsControllersEntity3:
...
class LoyaltyRewardsControllersSchema3(BaseModel):
...
class LoyaltyRewardsControllersProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsControllersProcessor3()
