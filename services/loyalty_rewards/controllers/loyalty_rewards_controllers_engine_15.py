...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_15
...
@dataclass
class LoyaltyRewardsControllersEntity15:
...
class LoyaltyRewardsControllersSchema15(BaseModel):
...
class LoyaltyRewardsControllersProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsControllersProcessor15()
