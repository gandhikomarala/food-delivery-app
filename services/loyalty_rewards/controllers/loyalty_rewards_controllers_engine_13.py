...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_13
...
@dataclass
class LoyaltyRewardsControllersEntity13:
...
class LoyaltyRewardsControllersSchema13(BaseModel):
...
class LoyaltyRewardsControllersProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsControllersProcessor13()
