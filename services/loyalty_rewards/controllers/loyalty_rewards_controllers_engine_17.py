...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_17
...
@dataclass
class LoyaltyRewardsControllersEntity17:
...
class LoyaltyRewardsControllersSchema17(BaseModel):
...
class LoyaltyRewardsControllersProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsControllersProcessor17()
