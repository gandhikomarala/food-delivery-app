...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_19
...
@dataclass
class LoyaltyRewardsControllersEntity19:
...
class LoyaltyRewardsControllersSchema19(BaseModel):
...
class LoyaltyRewardsControllersProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsControllersProcessor19()
