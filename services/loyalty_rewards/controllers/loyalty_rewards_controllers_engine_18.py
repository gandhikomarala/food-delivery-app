...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_18
...
@dataclass
class LoyaltyRewardsControllersEntity18:
...
class LoyaltyRewardsControllersSchema18(BaseModel):
...
class LoyaltyRewardsControllersProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsControllersProcessor18()
