...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_6
...
@dataclass
class LoyaltyRewardsControllersEntity6:
...
class LoyaltyRewardsControllersSchema6(BaseModel):
...
class LoyaltyRewardsControllersProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsControllersProcessor6()
