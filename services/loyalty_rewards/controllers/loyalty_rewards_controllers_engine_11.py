...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_11
...
@dataclass
class LoyaltyRewardsControllersEntity11:
...
class LoyaltyRewardsControllersSchema11(BaseModel):
...
class LoyaltyRewardsControllersProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsControllersProcessor11()
