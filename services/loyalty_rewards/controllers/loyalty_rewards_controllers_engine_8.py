...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_8
...
@dataclass
class LoyaltyRewardsControllersEntity8:
...
class LoyaltyRewardsControllersSchema8(BaseModel):
...
class LoyaltyRewardsControllersProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsControllersProcessor8()
