...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_16
...
@dataclass
class LoyaltyRewardsControllersEntity16:
...
class LoyaltyRewardsControllersSchema16(BaseModel):
...
class LoyaltyRewardsControllersProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsControllersProcessor16()
