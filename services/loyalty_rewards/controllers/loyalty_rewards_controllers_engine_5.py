...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_5
...
@dataclass
class LoyaltyRewardsControllersEntity5:
...
class LoyaltyRewardsControllersSchema5(BaseModel):
...
class LoyaltyRewardsControllersProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsControllersProcessor5()
