...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_1
...
@dataclass
class LoyaltyRewardsControllersEntity1:
...
class LoyaltyRewardsControllersSchema1(BaseModel):
...
class LoyaltyRewardsControllersProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsControllersProcessor1()
