...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_20
...
@dataclass
class LoyaltyRewardsControllersEntity20:
...
class LoyaltyRewardsControllersSchema20(BaseModel):
...
class LoyaltyRewardsControllersProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsControllersProcessor20()
