...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_9
...
@dataclass
class LoyaltyRewardsControllersEntity9:
...
class LoyaltyRewardsControllersSchema9(BaseModel):
...
class LoyaltyRewardsControllersProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsControllersProcessor9()
