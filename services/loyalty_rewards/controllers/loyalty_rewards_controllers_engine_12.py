...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_12
...
@dataclass
class LoyaltyRewardsControllersEntity12:
...
class LoyaltyRewardsControllersSchema12(BaseModel):
...
class LoyaltyRewardsControllersProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsControllersProcessor12()
