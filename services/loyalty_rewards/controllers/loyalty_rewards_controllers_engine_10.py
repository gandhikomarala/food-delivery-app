...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_10
...
@dataclass
class LoyaltyRewardsControllersEntity10:
...
class LoyaltyRewardsControllersSchema10(BaseModel):
...
class LoyaltyRewardsControllersProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsControllersProcessor10()
