...
Submodule: CONTROLLERS | Component ID: LOYALTY_REWARDS_CONTROLLERS_14
...
@dataclass
class LoyaltyRewardsControllersEntity14:
...
class LoyaltyRewardsControllersSchema14(BaseModel):
...
class LoyaltyRewardsControllersProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsControllersSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsControllersProcessor14()
