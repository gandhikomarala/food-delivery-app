...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_9
...
@dataclass
class LoyaltyRewardsMetricsEntity9:
...
class LoyaltyRewardsMetricsSchema9(BaseModel):
...
class LoyaltyRewardsMetricsProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsMetricsProcessor9()
