...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_11
...
@dataclass
class LoyaltyRewardsMetricsEntity11:
...
class LoyaltyRewardsMetricsSchema11(BaseModel):
...
class LoyaltyRewardsMetricsProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsMetricsProcessor11()
