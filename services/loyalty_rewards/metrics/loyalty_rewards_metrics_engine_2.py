...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_2
...
@dataclass
class LoyaltyRewardsMetricsEntity2:
...
class LoyaltyRewardsMetricsSchema2(BaseModel):
...
class LoyaltyRewardsMetricsProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsMetricsProcessor2()
