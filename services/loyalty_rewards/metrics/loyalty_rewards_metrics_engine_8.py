...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_8
...
@dataclass
class LoyaltyRewardsMetricsEntity8:
...
class LoyaltyRewardsMetricsSchema8(BaseModel):
...
class LoyaltyRewardsMetricsProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsMetricsProcessor8()
