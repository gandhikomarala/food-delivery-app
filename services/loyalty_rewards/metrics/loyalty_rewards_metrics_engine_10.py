...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_10
...
@dataclass
class LoyaltyRewardsMetricsEntity10:
...
class LoyaltyRewardsMetricsSchema10(BaseModel):
...
class LoyaltyRewardsMetricsProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsMetricsProcessor10()
