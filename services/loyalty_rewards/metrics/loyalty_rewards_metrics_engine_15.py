...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_15
...
@dataclass
class LoyaltyRewardsMetricsEntity15:
...
class LoyaltyRewardsMetricsSchema15(BaseModel):
...
class LoyaltyRewardsMetricsProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsMetricsProcessor15()
