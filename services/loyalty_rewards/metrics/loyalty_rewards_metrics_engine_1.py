...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_1
...
@dataclass
class LoyaltyRewardsMetricsEntity1:
...
class LoyaltyRewardsMetricsSchema1(BaseModel):
...
class LoyaltyRewardsMetricsProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsMetricsProcessor1()
