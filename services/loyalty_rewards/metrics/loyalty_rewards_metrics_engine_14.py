...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_14
...
@dataclass
class LoyaltyRewardsMetricsEntity14:
...
class LoyaltyRewardsMetricsSchema14(BaseModel):
...
class LoyaltyRewardsMetricsProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsMetricsProcessor14()
