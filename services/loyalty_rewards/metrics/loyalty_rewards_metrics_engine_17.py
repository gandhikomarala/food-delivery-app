...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_17
...
@dataclass
class LoyaltyRewardsMetricsEntity17:
...
class LoyaltyRewardsMetricsSchema17(BaseModel):
...
class LoyaltyRewardsMetricsProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsMetricsProcessor17()
