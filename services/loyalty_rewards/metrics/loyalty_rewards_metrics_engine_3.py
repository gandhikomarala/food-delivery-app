...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_3
...
@dataclass
class LoyaltyRewardsMetricsEntity3:
...
class LoyaltyRewardsMetricsSchema3(BaseModel):
...
class LoyaltyRewardsMetricsProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsMetricsProcessor3()
