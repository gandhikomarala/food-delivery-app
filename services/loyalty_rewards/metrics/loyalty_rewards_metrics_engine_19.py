...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_19
...
@dataclass
class LoyaltyRewardsMetricsEntity19:
...
class LoyaltyRewardsMetricsSchema19(BaseModel):
...
class LoyaltyRewardsMetricsProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsMetricsProcessor19()
