...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_18
...
@dataclass
class LoyaltyRewardsMetricsEntity18:
...
class LoyaltyRewardsMetricsSchema18(BaseModel):
...
class LoyaltyRewardsMetricsProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsMetricsProcessor18()
