...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_5
...
@dataclass
class LoyaltyRewardsMetricsEntity5:
...
class LoyaltyRewardsMetricsSchema5(BaseModel):
...
class LoyaltyRewardsMetricsProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsMetricsProcessor5()
