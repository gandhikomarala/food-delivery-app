...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_6
...
@dataclass
class LoyaltyRewardsMetricsEntity6:
...
class LoyaltyRewardsMetricsSchema6(BaseModel):
...
class LoyaltyRewardsMetricsProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsMetricsProcessor6()
