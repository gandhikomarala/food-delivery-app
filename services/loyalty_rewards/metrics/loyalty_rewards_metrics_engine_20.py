...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_20
...
@dataclass
class LoyaltyRewardsMetricsEntity20:
...
class LoyaltyRewardsMetricsSchema20(BaseModel):
...
class LoyaltyRewardsMetricsProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsMetricsProcessor20()
