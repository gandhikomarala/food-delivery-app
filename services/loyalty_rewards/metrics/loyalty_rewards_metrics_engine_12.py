...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_12
...
@dataclass
class LoyaltyRewardsMetricsEntity12:
...
class LoyaltyRewardsMetricsSchema12(BaseModel):
...
class LoyaltyRewardsMetricsProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsMetricsProcessor12()
