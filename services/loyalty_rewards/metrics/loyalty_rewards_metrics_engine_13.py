...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_13
...
@dataclass
class LoyaltyRewardsMetricsEntity13:
...
class LoyaltyRewardsMetricsSchema13(BaseModel):
...
class LoyaltyRewardsMetricsProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsMetricsProcessor13()
