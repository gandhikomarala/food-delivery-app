...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_7
...
@dataclass
class LoyaltyRewardsMetricsEntity7:
...
class LoyaltyRewardsMetricsSchema7(BaseModel):
...
class LoyaltyRewardsMetricsProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsMetricsProcessor7()
