...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_4
...
@dataclass
class LoyaltyRewardsMetricsEntity4:
...
class LoyaltyRewardsMetricsSchema4(BaseModel):
...
class LoyaltyRewardsMetricsProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsMetricsProcessor4()
