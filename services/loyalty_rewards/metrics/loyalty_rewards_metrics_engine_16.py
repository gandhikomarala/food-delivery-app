...
Submodule: METRICS | Component ID: LOYALTY_REWARDS_METRICS_16
...
@dataclass
class LoyaltyRewardsMetricsEntity16:
...
class LoyaltyRewardsMetricsSchema16(BaseModel):
...
class LoyaltyRewardsMetricsProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsMetricsSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsMetricsProcessor16()
