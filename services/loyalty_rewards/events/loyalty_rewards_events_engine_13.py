...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_13
...
@dataclass
class LoyaltyRewardsEventsEntity13:
...
class LoyaltyRewardsEventsSchema13(BaseModel):
...
class LoyaltyRewardsEventsProcessor13:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema13) -> Dict[str, Any]:
...
default_processor_13 = LoyaltyRewardsEventsProcessor13()
