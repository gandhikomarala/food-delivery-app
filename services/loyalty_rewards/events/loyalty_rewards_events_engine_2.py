...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_2
...
@dataclass
class LoyaltyRewardsEventsEntity2:
...
class LoyaltyRewardsEventsSchema2(BaseModel):
...
class LoyaltyRewardsEventsProcessor2:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema2) -> Dict[str, Any]:
...
default_processor_2 = LoyaltyRewardsEventsProcessor2()
