...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_12
...
@dataclass
class LoyaltyRewardsEventsEntity12:
...
class LoyaltyRewardsEventsSchema12(BaseModel):
...
class LoyaltyRewardsEventsProcessor12:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema12) -> Dict[str, Any]:
...
default_processor_12 = LoyaltyRewardsEventsProcessor12()
