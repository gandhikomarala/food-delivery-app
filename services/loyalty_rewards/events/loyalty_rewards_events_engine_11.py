...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_11
...
@dataclass
class LoyaltyRewardsEventsEntity11:
...
class LoyaltyRewardsEventsSchema11(BaseModel):
...
class LoyaltyRewardsEventsProcessor11:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema11) -> Dict[str, Any]:
...
default_processor_11 = LoyaltyRewardsEventsProcessor11()
