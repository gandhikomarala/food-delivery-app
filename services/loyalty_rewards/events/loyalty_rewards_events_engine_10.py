...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_10
...
@dataclass
class LoyaltyRewardsEventsEntity10:
...
class LoyaltyRewardsEventsSchema10(BaseModel):
...
class LoyaltyRewardsEventsProcessor10:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema10) -> Dict[str, Any]:
...
default_processor_10 = LoyaltyRewardsEventsProcessor10()
