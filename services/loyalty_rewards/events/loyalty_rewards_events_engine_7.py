...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_7
...
@dataclass
class LoyaltyRewardsEventsEntity7:
...
class LoyaltyRewardsEventsSchema7(BaseModel):
...
class LoyaltyRewardsEventsProcessor7:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema7) -> Dict[str, Any]:
...
default_processor_7 = LoyaltyRewardsEventsProcessor7()
