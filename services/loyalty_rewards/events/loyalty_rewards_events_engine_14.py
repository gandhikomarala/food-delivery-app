...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_14
...
@dataclass
class LoyaltyRewardsEventsEntity14:
...
class LoyaltyRewardsEventsSchema14(BaseModel):
...
class LoyaltyRewardsEventsProcessor14:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema14) -> Dict[str, Any]:
...
default_processor_14 = LoyaltyRewardsEventsProcessor14()
