...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_9
...
@dataclass
class LoyaltyRewardsEventsEntity9:
...
class LoyaltyRewardsEventsSchema9(BaseModel):
...
class LoyaltyRewardsEventsProcessor9:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema9) -> Dict[str, Any]:
...
default_processor_9 = LoyaltyRewardsEventsProcessor9()
