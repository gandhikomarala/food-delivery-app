...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_3
...
@dataclass
class LoyaltyRewardsEventsEntity3:
...
class LoyaltyRewardsEventsSchema3(BaseModel):
...
class LoyaltyRewardsEventsProcessor3:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema3) -> Dict[str, Any]:
...
default_processor_3 = LoyaltyRewardsEventsProcessor3()
