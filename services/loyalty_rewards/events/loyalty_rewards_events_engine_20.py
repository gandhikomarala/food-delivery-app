...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_20
...
@dataclass
class LoyaltyRewardsEventsEntity20:
...
class LoyaltyRewardsEventsSchema20(BaseModel):
...
class LoyaltyRewardsEventsProcessor20:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema20) -> Dict[str, Any]:
...
default_processor_20 = LoyaltyRewardsEventsProcessor20()
