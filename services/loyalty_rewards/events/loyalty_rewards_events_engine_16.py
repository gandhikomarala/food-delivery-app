...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_16
...
@dataclass
class LoyaltyRewardsEventsEntity16:
...
class LoyaltyRewardsEventsSchema16(BaseModel):
...
class LoyaltyRewardsEventsProcessor16:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema16) -> Dict[str, Any]:
...
default_processor_16 = LoyaltyRewardsEventsProcessor16()
