...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_5
...
@dataclass
class LoyaltyRewardsEventsEntity5:
...
class LoyaltyRewardsEventsSchema5(BaseModel):
...
class LoyaltyRewardsEventsProcessor5:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema5) -> Dict[str, Any]:
...
default_processor_5 = LoyaltyRewardsEventsProcessor5()
