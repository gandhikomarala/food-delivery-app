...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_4
...
@dataclass
class LoyaltyRewardsEventsEntity4:
...
class LoyaltyRewardsEventsSchema4(BaseModel):
...
class LoyaltyRewardsEventsProcessor4:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema4) -> Dict[str, Any]:
...
default_processor_4 = LoyaltyRewardsEventsProcessor4()
