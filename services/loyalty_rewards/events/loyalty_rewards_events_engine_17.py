...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_17
...
@dataclass
class LoyaltyRewardsEventsEntity17:
...
class LoyaltyRewardsEventsSchema17(BaseModel):
...
class LoyaltyRewardsEventsProcessor17:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema17) -> Dict[str, Any]:
...
default_processor_17 = LoyaltyRewardsEventsProcessor17()
