...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_8
...
@dataclass
class LoyaltyRewardsEventsEntity8:
...
class LoyaltyRewardsEventsSchema8(BaseModel):
...
class LoyaltyRewardsEventsProcessor8:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema8) -> Dict[str, Any]:
...
default_processor_8 = LoyaltyRewardsEventsProcessor8()
