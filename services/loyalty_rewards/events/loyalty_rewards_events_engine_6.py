...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_6
...
@dataclass
class LoyaltyRewardsEventsEntity6:
...
class LoyaltyRewardsEventsSchema6(BaseModel):
...
class LoyaltyRewardsEventsProcessor6:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema6) -> Dict[str, Any]:
...
default_processor_6 = LoyaltyRewardsEventsProcessor6()
