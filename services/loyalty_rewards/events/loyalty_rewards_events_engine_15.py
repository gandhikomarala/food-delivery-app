...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_15
...
@dataclass
class LoyaltyRewardsEventsEntity15:
...
class LoyaltyRewardsEventsSchema15(BaseModel):
...
class LoyaltyRewardsEventsProcessor15:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema15) -> Dict[str, Any]:
...
default_processor_15 = LoyaltyRewardsEventsProcessor15()
