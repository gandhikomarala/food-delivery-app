...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_1
...
@dataclass
class LoyaltyRewardsEventsEntity1:
...
class LoyaltyRewardsEventsSchema1(BaseModel):
...
class LoyaltyRewardsEventsProcessor1:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema1) -> Dict[str, Any]:
...
default_processor_1 = LoyaltyRewardsEventsProcessor1()
