...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_18
...
@dataclass
class LoyaltyRewardsEventsEntity18:
...
class LoyaltyRewardsEventsSchema18(BaseModel):
...
class LoyaltyRewardsEventsProcessor18:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema18) -> Dict[str, Any]:
...
default_processor_18 = LoyaltyRewardsEventsProcessor18()
