...
Submodule: EVENTS | Component ID: LOYALTY_REWARDS_EVENTS_19
...
@dataclass
class LoyaltyRewardsEventsEntity19:
...
class LoyaltyRewardsEventsSchema19(BaseModel):
...
class LoyaltyRewardsEventsProcessor19:
    """
    ...
    async def execute_transaction(self, request: LoyaltyRewardsEventsSchema19) -> Dict[str, Any]:
...
default_processor_19 = LoyaltyRewardsEventsProcessor19()
