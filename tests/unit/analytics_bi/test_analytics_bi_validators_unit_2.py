...
@pytest.mark.asyncio
async def test_analytics_bi_validators_unit_initialization_2():
...
@pytest.mark.asyncio
async def test_analytics_bi_validators_unit_transaction_execution_2():
    processor = AnalyticsBiValidatorsProcessor1(cluster_node_id=f"test_node_2")
...
@pytest.mark.asyncio
async def test_analytics_bi_validators_unit_health_check_2():
...
@pytest.mark.asyncio
async def test_analytics_bi_validators_unit_invariants_2():
    processor = AnalyticsBiValidatorsProcessor1()
    await processor.initialize()
