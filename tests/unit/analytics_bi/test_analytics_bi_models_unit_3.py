...
@pytest.mark.asyncio
async def test_analytics_bi_models_unit_initialization_3():
...
@pytest.mark.asyncio
async def test_analytics_bi_models_unit_transaction_execution_3():
    processor = AnalyticsBiModelsProcessor1(cluster_node_id=f"test_node_3")
...
@pytest.mark.asyncio
async def test_analytics_bi_models_unit_health_check_3():
...
@pytest.mark.asyncio
async def test_analytics_bi_models_unit_invariants_3():
    processor = AnalyticsBiModelsProcessor1()
    await processor.initialize()
